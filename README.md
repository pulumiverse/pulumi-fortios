...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `fortios` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-fortios
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/aspyrmedia/pulumi-fortios/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-fortios_darwin_amd64_v1
│   └── pulumi-resource-fortios
├── pulumi-fortios_darwin_arm64
│   └── pulumi-resource-fortios
├── pulumi-fortios_linux_amd64_v1
│   └── pulumi-resource-fortios
├── pulumi-fortios_linux_arm64
│   └── pulumi-resource-fortios
├── pulumi-fortios_windows_amd64_v1
│   └── pulumi-resource-fortios.exe
└── pulumi-fortios_windows_arm64
    └── pulumi-resource-fortios.exe
```
