...
__all__ = ['HeuristicArgs', 'Heuristic']
...
class Heuristic(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HeuristicArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Configure global heuristic options. Applies to FortiOS Version `<= 7.0.0`.
        ...
        :param str resource_name: The name of the resource.
        :param HeuristicArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(HeuristicArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = HeuristicArgs.__new__(HeuristicArgs)

            __props__.__dict__["mode"] = mode
            __props__.__dict__["vdomparam"] = vdomparam
        super(Heuristic, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            mode: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'Heuristic':
        """
        ...
        __props__ = _HeuristicState.__new__(_HeuristicState)

        __props__.__dict__["mode"] = mode
        __props__.__dict__["vdomparam"] = vdomparam
        return Heuristic(resource_name, opts=opts, __props__=__props__)
