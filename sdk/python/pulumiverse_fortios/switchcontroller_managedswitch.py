...
class SwitchcontrollerManagedswitchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SwitchcontrollerManagedswitchIgmpSnoopingArgs'] igmp_snooping: Configure FortiSwitch IGMP snooping global settings. The structure of `igmp_snooping` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['SwitchcontrollerManagedswitchIpSourceGuardArgs']]] ip_source_guards: IP source guard. The structure of `ip_source_guard` block is documented below.
...
class SwitchcontrollerManagedswitch(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] fsw_wan2_admin: FortiSwitch WAN2 admin status; enable to authorize the FortiSwitch as a managed switch. Valid values: `discovered`, `disable`, `enable`.
        :param pulumi.Input[str] fsw_wan2_peer: FortiSwitch WAN2 peer port.
        :param pulumi.Input[pulumi.InputType['SwitchcontrollerManagedswitchIgmpSnoopingArgs']] igmp_snooping: Configure FortiSwitch IGMP snooping global settings. The structure of `igmp_snooping` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchcontrollerManagedswitchIpSourceGuardArgs']]]] ip_source_guards: IP source guard. The structure of `ip_source_guard` block is documented below.
        :param pulumi.Input[int] l3_discovered: Layer 3 management discovered.
        :param pulumi.Input[int] max_allowed_trunk_members: FortiSwitch maximum allowed trunk members.
        :param pulumi.Input[str] mclag_igmp_snooping_aware: Enable/disable MCLAG IGMP-snooping awareness. Valid values: `enable`, `disable`.
