...
class Forticlient(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname4 = fortios.vpnipsec.Phase1interface("trname4",
            acct_verify="disable",
        ...
        trname3 = fortios.vpnipsec.Phase2interface("trname3",
            add_route="phase1",
            ...
            src_subnet6="::/0")
        trname = fortios.vpnipsec.Forticlient("trname",
    ...
    def _internal_init(__self__,
        ...
        super(Forticlient, __self__).__init__(
            'fortios:vpnipsec/forticlient:Forticlient',
            resource_name,
            __props__,
            opts)
