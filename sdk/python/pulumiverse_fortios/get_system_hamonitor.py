...
__all__ = [
    ...
    'get_system_hamonitor',
    'get_system_hamonitor_output',
]
...
def get_system_hamonitor(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_hamonitor)
def get_system_hamonitor_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
