...
__all__ = [
    'GetCentralsnatmaplistResult',
    'AwaitableGetCentralsnatmaplistResult',
    'get_centralsnatmaplist',
    'get_centralsnatmaplist_output',
]

@pulumi.output_type
class GetCentralsnatmaplistResult:
    """
...
class AwaitableGetCentralsnatmaplistResult(GetCentralsnatmaplistResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCentralsnatmaplistResult(
            filter=self.filter,
            id=self.id,
...
def get_centralsnatmaplist(filter: Optional[str] = None,
                           vdomparam: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCentralsnatmaplistResult:
    """
...
def get_centralsnatmaplist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                  vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCentralsnatmaplistResult]:
    """
    Provides a list of `firewall.Centralsnatmap`.
