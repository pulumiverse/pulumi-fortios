...
__all__ = [
    'GetDoSpolicy6listResult',
    'AwaitableGetDoSpolicy6listResult',
    'get_do_spolicy6list',
    'get_do_spolicy6list_output',
]

@pulumi.output_type
class GetDoSpolicy6listResult:
    """
...
class AwaitableGetDoSpolicy6listResult(GetDoSpolicy6listResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDoSpolicy6listResult(
            filter=self.filter,
            id=self.id,
...
def get_do_spolicy6list(filter: Optional[str] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDoSpolicy6listResult:
    """
...
def get_do_spolicy6list_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                               vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDoSpolicy6listResult]:
    """
    Provides a list of `fortios_firewall_DoSpolicy6`.
