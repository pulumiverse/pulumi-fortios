...
__all__ = ['PolicySortArgs', 'PolicySort']

@pulumi.input_type
class PolicySortArgs:
...
class _PolicySortState:
    def __init__(__self__, *,
                 ...
                 state_policy_lists: Optional[pulumi.Input[Sequence[pulumi.Input['PolicySortStatePolicyListArgs']]]] = None,
                 status: Optional[pulumi.Input[str]] = None,
                 vdomparam: Optional[pulumi.Input[str]] = None):
        """
    ...
    def state_policy_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['PolicySortStatePolicyListArgs']]]]:
        return pulumi.get(self, "state_policy_lists")

    @state_policy_lists.setter
    def state_policy_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['PolicySortStatePolicyListArgs']]]]):
...
class PolicySort(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a PolicySort resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a PolicySort resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param PolicySortArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PolicySortArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PolicySortArgs.__new__(PolicySortArgs)
        ...
        super(PolicySort, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            sortby: Optional[pulumi.Input[str]] = None,
            sortdirection: Optional[pulumi.Input[str]] = None,
            state_policy_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PolicySortStatePolicyListArgs']]]]] = None,
            status: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'PolicySort':
        """
        ...
        __props__ = _PolicySortState.__new__(_PolicySortState)
        ...
        __props__.__dict__["status"] = status
        __props__.__dict__["vdomparam"] = vdomparam
        return PolicySort(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="statePolicyLists")
    def state_policy_lists(self) -> pulumi.Output[Sequence['outputs.PolicySortStatePolicyList']]:
        return pulumi.get(self, "state_policy_lists")
