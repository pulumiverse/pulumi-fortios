...
__all__ = [
    'GetDoSpolicyResult',
    'AwaitableGetDoSpolicyResult',
    'get_do_spolicy',
    'get_do_spolicy_output',
]

@pulumi.output_type
class GetDoSpolicyResult:
    """
    ...
    @property
    @pulumi.getter
    def anomalies(self) -> Sequence['outputs.GetDoSpolicyAnomalyResult']:
        """
    ...
    @property
    @pulumi.getter
    def dstaddrs(self) -> Sequence['outputs.GetDoSpolicyDstaddrResult']:
        """
    ...
    @property
    @pulumi.getter
    def services(self) -> Sequence['outputs.GetDoSpolicyServiceResult']:
        """
    ...
    @property
    @pulumi.getter
    def srcaddrs(self) -> Sequence['outputs.GetDoSpolicySrcaddrResult']:
        """
...
class AwaitableGetDoSpolicyResult(GetDoSpolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDoSpolicyResult(
...
def get_do_spolicy(policyid: Optional[int] = None,
                   ...
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDoSpolicyResult:
    """
...
def get_do_spolicy_output(policyid: Optional[pulumi.Input[int]] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDoSpolicyResult]:
    """
    Use this data source to get information on an fortios firewall DoSpolicy
