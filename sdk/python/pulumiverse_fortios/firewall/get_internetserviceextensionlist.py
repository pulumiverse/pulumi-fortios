...
__all__ = [
    'GetInternetserviceextensionlistResult',
    'AwaitableGetInternetserviceextensionlistResult',
    'get_internetserviceextensionlist',
    'get_internetserviceextensionlist_output',
]

@pulumi.output_type
class GetInternetserviceextensionlistResult:
    """
...
class AwaitableGetInternetserviceextensionlistResult(GetInternetserviceextensionlistResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInternetserviceextensionlistResult(
            filter=self.filter,
...
def get_internetserviceextensionlist(filter: Optional[str] = None,
                                     vdomparam: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInternetserviceextensionlistResult:
    """
...
def get_internetserviceextensionlist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                            vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetInternetserviceextensionlistResult]:
    """
    Provides a list of `firewall.Internetserviceextension`.
