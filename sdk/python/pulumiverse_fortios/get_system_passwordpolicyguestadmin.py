...
__all__ = [
    ...
    'get_system_passwordpolicyguestadmin',
    'get_system_passwordpolicyguestadmin_output',
]
...
def get_system_passwordpolicyguestadmin(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_passwordpolicyguestadmin)
def get_system_passwordpolicyguestadmin_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemPasswordpolicyguestadminResult]:
    """
    Use this data source to get information on fortios system passwordpolicyguestadmin
