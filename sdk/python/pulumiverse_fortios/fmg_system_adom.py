...
__all__ = ['FmgSystemAdomArgs', 'FmgSystemAdom']

@pulumi.input_type
class FmgSystemAdomArgs:
...
class FmgSystemAdom(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgSystemAdom("test1",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FmgSystemAdomArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports Create/Read/Update/Delete system adom for FortiManager.
        ...
        :param str resource_name: The name of the resource.
        :param FmgSystemAdomArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgSystemAdomArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgSystemAdomArgs.__new__(FmgSystemAdomArgs)
        ...
        super(FmgSystemAdom, __self__).__init__(
            'fortios:index/fmgSystemAdom:FmgSystemAdom',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            perform_policy_check_before_every_install: Optional[pulumi.Input[bool]] = None,
            status: Optional[pulumi.Input[int]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'FmgSystemAdom':
        """
        ...
        __props__ = _FmgSystemAdomState.__new__(_FmgSystemAdomState)
        ...
        __props__.__dict__["status"] = status
        __props__.__dict__["type"] = type
        return FmgSystemAdom(resource_name, opts=opts, __props__=__props__)
