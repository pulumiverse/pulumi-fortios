...
class SystemSdwanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemSdwanHealthCheckArgs']]] health_checks: SD-WAN status checking or health checking. Identify a server on the Internet and determine how SD-WAN verifies that the FortiGate can communicate with it. The structure of `health_check` block is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemSdwanMemberArgs']]] members: FortiGate interfaces added to the SD-WAN. The structure of `members` block is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemSdwanServiceArgs']]] services: Create SD-WAN rules (also called services) to control how sessions are distributed to interfaces in the SD-WAN. The structure of `service` block is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemSdwanZoneArgs']]] zones: Configure SD-WAN zones. The structure of `zone` block is documented below.
        """
...
class SystemSdwan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] fail_detect: Enable/disable SD-WAN Internet connection status checking (failure detection). Valid values: `enable`, `disable`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemSdwanHealthCheckArgs']]]] health_checks: SD-WAN status checking or health checking. Identify a server on the Internet and determine how SD-WAN verifies that the FortiGate can communicate with it. The structure of `health_check` block is documented below.
        :param pulumi.Input[str] load_balance_mode: Algorithm or mode to use for load balancing Internet traffic to SD-WAN members. Valid values: `source-ip-based`, `weight-based`, `usage-based`, `source-dest-ip-based`, `measured-volume-based`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemSdwanMemberArgs']]]] members: FortiGate interfaces added to the SD-WAN. The structure of `members` block is documented below.
        :param pulumi.Input[int] neighbor_hold_boot_time: Waiting period in seconds when switching from the primary neighbor to the secondary neighbor from the neighbor start. (0 - 10000000, default = 0).
        :param pulumi.Input[str] neighbor_hold_down: Enable/disable hold switching from the secondary neighbor to the primary neighbor. Valid values: `enable`, `disable`.
        :param pulumi.Input[int] neighbor_hold_down_time: Waiting period in seconds when switching from the secondary neighbor to the primary neighbor when hold-down is disabled. (0 - 10000000, default = 0).
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemSdwanServiceArgs']]]] services: Create SD-WAN rules (also called services) to control how sessions are distributed to interfaces in the SD-WAN. The structure of `service` block is documented below.
        :param pulumi.Input[str] speedtest_bypass_routing: Enable/disable bypass routing when speedtest on a SD-WAN member. Valid values: `disable`, `enable`.
        :param pulumi.Input[str] status: Enable/disable SD-WAN. Valid values: `disable`, `enable`.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemSdwanZoneArgs']]]] zones: Configure SD-WAN zones. The structure of `zone` block is documented below.
        """
        ...
    @overload
    def __init__(__self__,
