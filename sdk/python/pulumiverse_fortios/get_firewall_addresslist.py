...
__all__ = [
    ...
    'get_firewall_addresslist',
    'get_firewall_addresslist_output',
]
...
def get_firewall_addresslist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_addresslist)
def get_firewall_addresslist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                    vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFirewallAddresslistResult]:
    """
    Provides a list of `FirewallAddress`.
