...
__all__ = [
    ...
    'get_system_externalresource',
    'get_system_externalresource_output',
]
...
def get_system_externalresource(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_externalresource)
def get_system_externalresource_output(name: Optional[pulumi.Input[str]] = None,
