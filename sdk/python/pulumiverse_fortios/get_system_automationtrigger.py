...
__all__ = [
    ...
    'get_system_automationtrigger',
    'get_system_automationtrigger_output',
]
...
def get_system_automationtrigger(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_automationtrigger)
def get_system_automationtrigger_output(name: Optional[pulumi.Input[str]] = None,
