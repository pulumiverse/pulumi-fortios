...
__all__ = ['FmgSystemLicenseVmArgs', 'FmgSystemLicenseVm']

@pulumi.input_type
class FmgSystemLicenseVmArgs:
...
@pulumi.input_type
class _FmgSystemLicenseVmState:
    def __init__(__self__, *,
                 adom: Optional[pulumi.Input[str]] = None,
...
class FmgSystemLicenseVm(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgSystemLicenseVm("test1",
            file_content="XXX",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FmgSystemLicenseVmArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgSystemLicenseVmArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgSystemLicenseVmArgs.__new__(FmgSystemLicenseVmArgs)
        ...
        super(FmgSystemLicenseVm, __self__).__init__(
            'fortios:index/fmgSystemLicenseVm:FmgSystemLicenseVm',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            adom: Optional[pulumi.Input[str]] = None,
            file_content: Optional[pulumi.Input[str]] = None,
            target: Optional[pulumi.Input[str]] = None) -> 'FmgSystemLicenseVm':
        """
        ...
        __props__ = _FmgSystemLicenseVmState.__new__(_FmgSystemLicenseVmState)

        __props__.__dict__["adom"] = adom
        __props__.__dict__["file_content"] = file_content
        __props__.__dict__["target"] = target
        return FmgSystemLicenseVm(resource_name, opts=opts, __props__=__props__)
