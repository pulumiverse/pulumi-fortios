...
__all__ = [
    ...
    'get_firewall_multicastaddress6',
    'get_firewall_multicastaddress6_output',
]
...
def get_firewall_multicastaddress6(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_multicastaddress6)
def get_firewall_multicastaddress6_output(name: Optional[pulumi.Input[str]] = None,
