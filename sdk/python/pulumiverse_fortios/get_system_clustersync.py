...
__all__ = [
    ...
    'get_system_clustersync',
    'get_system_clustersync_output',
]
...
class GetSystemClustersyncResult:
    ...
    def session_sync_filters(self) -> Sequence['outputs.GetSystemClustersyncSessionSyncFilterResult']:
        """
...
def get_system_clustersync(sync_id: Optional[int] = None,
...
@_utilities.lift_output_func(get_system_clustersync)
def get_system_clustersync_output(sync_id: Optional[pulumi.Input[int]] = None,
