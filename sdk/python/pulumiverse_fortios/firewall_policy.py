...
class FirewallPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyInternetService6CustomGroupArgs']]] internet_service6_custom_groups: Custom Internet Service6 group name. The structure of `internet_service6_custom_group` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyInternetService6CustomArgs']]] internet_service6_customs: Custom IPv6 Internet Service name. The structure of `internet_service6_custom` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyInternetService6GroupArgs']]] internet_service6_groups: Internet Service group name. The structure of `internet_service6_group` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyInternetService6NameArgs']]] internet_service6_names: IPv6 Internet Service name. The structure of `internet_service6_name` block is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyInternetService6SrcCustomGroupArgs']]] internet_service6_src_custom_groups: Custom Internet Service6 source group name. The structure of `internet_service6_src_custom_group` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyInternetService6SrcCustomArgs']]] internet_service6_src_customs: Custom IPv6 Internet Service source name. The structure of `internet_service6_src_custom` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyInternetService6SrcGroupArgs']]] internet_service6_src_groups: Internet Service6 source group name. The structure of `internet_service6_src_group` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyInternetService6SrcNameArgs']]] internet_service6_src_names: IPv6 Internet Service source name. The structure of `internet_service6_src_name` block is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyNetworkServiceDynamicArgs']]] network_service_dynamics: Dynamic Network Service name. The structure of `network_service_dynamic` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyNetworkServiceSrcDynamicArgs']]] network_service_src_dynamics: Dynamic Network Service source name. The structure of `network_service_src_dynamic` block is documented below.
...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] internet_service: Enable/disable use of Internet Services for this policy. If enabled, destination address and service are not used.  Valid values: `enable`, `disable`.
        :param pulumi.Input[str] internet_service6: Enable/disable use of IPv6 Internet Services for this policy. If enabled, destination address and service are not used. Valid values: `enable`, `disable`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyInternetService6CustomGroupArgs']]]] internet_service6_custom_groups: Custom Internet Service6 group name. The structure of `internet_service6_custom_group` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyInternetService6CustomArgs']]]] internet_service6_customs: Custom IPv6 Internet Service name. The structure of `internet_service6_custom` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyInternetService6GroupArgs']]]] internet_service6_groups: Internet Service group name. The structure of `internet_service6_group` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyInternetService6NameArgs']]]] internet_service6_names: IPv6 Internet Service name. The structure of `internet_service6_name` block is documented below.
        :param pulumi.Input[str] internet_service6_negate: When enabled internet-service6 specifies what the service must NOT be. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] internet_service6_src: Enable/disable use of IPv6 Internet Services in source for this policy. If enabled, source address is not used. Valid values: `enable`, `disable`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyInternetService6SrcCustomGroupArgs']]]] internet_service6_src_custom_groups: Custom Internet Service6 source group name. The structure of `internet_service6_src_custom_group` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyInternetService6SrcCustomArgs']]]] internet_service6_src_customs: Custom IPv6 Internet Service source name. The structure of `internet_service6_src_custom` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyInternetService6SrcGroupArgs']]]] internet_service6_src_groups: Internet Service6 source group name. The structure of `internet_service6_src_group` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyInternetService6SrcNameArgs']]]] internet_service6_src_names: IPv6 Internet Service source name. The structure of `internet_service6_src_name` block is documented below.
        :param pulumi.Input[str] internet_service6_src_negate: When enabled internet-service6-src specifies what the service must NOT be. Valid values: `enable`, `disable`.
        ...
        :param pulumi.Input[str] natip: Policy-based IPsec VPN: source NAT IP address for outgoing traffic.
        :param pulumi.Input[str] natoutbound: Policy-based IPsec VPN: apply source NAT to outbound traffic. Valid values: `enable`, `disable`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyNetworkServiceDynamicArgs']]]] network_service_dynamics: Dynamic Network Service name. The structure of `network_service_dynamic` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicyNetworkServiceSrcDynamicArgs']]]] network_service_src_dynamics: Dynamic Network Service source name. The structure of `network_service_src_dynamic` block is documented below.
        :param pulumi.Input[str] np_acceleration: Enable/disable UTM Network Processor acceleration. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] ntlm: Enable/disable NTLM authentication. Valid values: `enable`, `disable`.
