...
__all__ = [
    ...
    'get_system_networkvisibility',
    'get_system_networkvisibility_output',
]
...
def get_system_networkvisibility(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_networkvisibility)
def get_system_networkvisibility_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemNetworkvisibilityResult]:
    """
    Use this data source to get information on fortios system networkvisibility
