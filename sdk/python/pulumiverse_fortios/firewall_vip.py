...
class FirewallVipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallVipMonitorArgs']]] monitors: Name of the health check monitor to use when polling to determine a virtual server's connectivity status. The structure of `monitor` block is documented below.
...
class FirewallVip(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] mappedport: Port number range on the destination network to which the external port number range is mapped.
        :param pulumi.Input[int] max_embryonic_connections: Maximum number of incomplete connections.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallVipMonitorArgs']]]] monitors: Name of the health check monitor to use when polling to determine a virtual server's connectivity status. The structure of `monitor` block is documented below.
        :param pulumi.Input[str] name: Virtual IP name.
        :param pulumi.Input[str] nat44: Enable/disable NAT44. Valid values: `disable`, `enable`.
        :param pulumi.Input[str] nat46: Enable/disable NAT46. Valid values: `disable`, `enable`.
        :param pulumi.Input[str] nat_source_vip: Enable/disable forcing the source NAT mapped IP to the external IP for all traffic. Valid values: `disable`, `enable`.
