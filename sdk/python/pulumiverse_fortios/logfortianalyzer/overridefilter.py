...
class OverridefilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] filter: FortiAnalyzer log filter.
...
class Overridefilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.logfortianalyzer.Overridefilter("trname",
            anomaly="enable",
            dlp_archive="enable",
            dns="enable",
            filter_type="include",
        ...
        ```sh
         $ pulumi import fortios:logfortianalyzer/overridefilter:Overridefilter labelname LogFortianalyzerOverrideFilter
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Overridefilter, __self__).__init__(
            'fortios:logfortianalyzer/overridefilter:Overridefilter',
            resource_name,
            __props__,
            opts)
