...
class FirewallProxyaddressArgs:
    def __init__(__self__, *,
                 applications: Optional[pulumi.Input[Sequence[pulumi.Input['FirewallProxyaddressApplicationArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallProxyaddressApplicationArgs']]] applications: SaaS application. The structure of `application` block is documented below.
        :param pulumi.Input[str] case_sensitivity: Enable to make the pattern case sensitive. Valid values: `disable`, `enable`.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallProxyaddressCategoryArgs']]] categories: FortiGuard category ID. The structure of `category` block is documented below.
    ...
    @property
    @pulumi.getter
    def applications(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FirewallProxyaddressApplicationArgs']]]]:
        """
    ...
    @applications.setter
    def applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FirewallProxyaddressApplicationArgs']]]]):
...
class FirewallProxyaddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 applications: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallProxyaddressApplicationArgs']]]]] = None,
                 case_sensitivity: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallProxyaddressApplicationArgs']]]] applications: SaaS application. The structure of `application` block is documented below.
        :param pulumi.Input[str] case_sensitivity: Enable to make the pattern case sensitive. Valid values: `disable`, `enable`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallProxyaddressCategoryArgs']]]] categories: FortiGuard category ID. The structure of `category` block is documented below.
        :param pulumi.Input[int] color: Integer value to determine the color of the icon in the GUI (1 - 32, default = 0, which sets value to 1).
        :param pulumi.Input[str] comment: Optional comments.
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[str] header: HTTP header name as a regular expression.
    ...
    @property
    @pulumi.getter
    def applications(self) -> pulumi.Output[Optional[Sequence['outputs.FirewallProxyaddressApplication']]]:
        """
        SaaS application. The structure of `application` block is documented below.
        """
        return pulumi.get(self, "applications")
