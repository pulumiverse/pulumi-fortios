...
__all__ = [
    ...
    'get_system_mobiletunnel',
    'get_system_mobiletunnel_output',
]
...
def get_system_mobiletunnel(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_mobiletunnel)
def get_system_mobiletunnel_output(name: Optional[pulumi.Input[str]] = None,
