...
__all__ = ['FmgFirewallSecurityPolicypackageArgs', 'FmgFirewallSecurityPolicypackage']

@pulumi.input_type
class FmgFirewallSecurityPolicypackageArgs:
...
@pulumi.input_type
class _FmgFirewallSecurityPolicypackageState:
    def __init__(__self__, *,
                 adom: Optional[pulumi.Input[str]] = None,
                 inspection_mode: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
...
class FmgFirewallSecurityPolicypackage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgFirewallSecurityPolicypackage("test1", target="FGVM64-test")
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FmgFirewallSecurityPolicypackageArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports Create/Read/Update/Delete firewall security policypackage on FortiManager which could be installed to the FortiGate later
        ...
        :param str resource_name: The name of the resource.
        :param FmgFirewallSecurityPolicypackageArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgFirewallSecurityPolicypackageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgFirewallSecurityPolicypackageArgs.__new__(FmgFirewallSecurityPolicypackageArgs)
        ...
        super(FmgFirewallSecurityPolicypackage, __self__).__init__(
            'fortios:index/fmgFirewallSecurityPolicypackage:FmgFirewallSecurityPolicypackage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            target: Optional[pulumi.Input[str]] = None,
            vdom: Optional[pulumi.Input[str]] = None) -> 'FmgFirewallSecurityPolicypackage':
        """
        ...
        __props__ = _FmgFirewallSecurityPolicypackageState.__new__(_FmgFirewallSecurityPolicypackageState)
        ...
        __props__.__dict__["target"] = target
        __props__.__dict__["vdom"] = vdom
        return FmgFirewallSecurityPolicypackage(resource_name, opts=opts, __props__=__props__)
