...
__all__ = [
    ...
    'get_system_sessionhelperlist',
    'get_system_sessionhelperlist_output',
]
...
def get_system_sessionhelperlist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_sessionhelperlist)
def get_system_sessionhelperlist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
