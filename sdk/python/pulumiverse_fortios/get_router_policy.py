...
@_utilities.lift_output_func(get_router_policy)
def get_router_policy_output(seq_num: Optional[pulumi.Input[int]] = None,
                             vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRouterPolicyResult]:
    """
    Use this data source to get information on an fortios router policy
