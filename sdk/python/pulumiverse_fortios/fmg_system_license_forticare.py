...
__all__ = ['FmgSystemLicenseForticareArgs', 'FmgSystemLicenseForticare']

@pulumi.input_type
class FmgSystemLicenseForticareArgs:
...
@pulumi.input_type
class _FmgSystemLicenseForticareState:
    def __init__(__self__, *,
                 adom: Optional[pulumi.Input[str]] = None,
...
class FmgSystemLicenseForticare(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgSystemLicenseForticare("test1",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FmgSystemLicenseForticareArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports uploading FortiCare registration code to FortiGate through FortiManager.
        ...
        :param str resource_name: The name of the resource.
        :param FmgSystemLicenseForticareArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgSystemLicenseForticareArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgSystemLicenseForticareArgs.__new__(FmgSystemLicenseForticareArgs)
        ...
        super(FmgSystemLicenseForticare, __self__).__init__(
            'fortios:index/fmgSystemLicenseForticare:FmgSystemLicenseForticare',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            adom: Optional[pulumi.Input[str]] = None,
            registration_code: Optional[pulumi.Input[str]] = None,
            target: Optional[pulumi.Input[str]] = None) -> 'FmgSystemLicenseForticare':
        """
        ...
        __props__ = _FmgSystemLicenseForticareState.__new__(_FmgSystemLicenseForticareState)

        __props__.__dict__["adom"] = adom
        __props__.__dict__["registration_code"] = registration_code
        __props__.__dict__["target"] = target
        return FmgSystemLicenseForticare(resource_name, opts=opts, __props__=__props__)
