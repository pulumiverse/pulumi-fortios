...
__all__ = [
    ...
    'get_firewallconsolidated_policy',
    'get_firewallconsolidated_policy_output',
]
...
def get_firewallconsolidated_policy(policyid: Optional[int] = None,
...
@_utilities.lift_output_func(get_firewallconsolidated_policy)
def get_firewallconsolidated_policy_output(policyid: Optional[pulumi.Input[int]] = None,
                                           vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFirewallconsolidatedPolicyResult]:
    """
    Use this data source to get information on an fortios firewallconsolidated policy
