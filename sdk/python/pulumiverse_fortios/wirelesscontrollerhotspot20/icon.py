...
class IconArgs:
    def __init__(__self__, *,
                 ...
                 icon_lists: Optional[pulumi.Input[Sequence[pulumi.Input['IconIconListArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IconIconListArgs']]] icon_lists: Icon list. The structure of `icon_list` block is documented below.
        :param pulumi.Input[str] name: Icon list ID.
    ...
    def icon_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['IconIconListArgs']]]]:
        """
    ...
    @icon_lists.setter
    def icon_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['IconIconListArgs']]]]):
...
class Icon(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dynamic_sort_subtable: Optional[pulumi.Input[str]] = None,
                 icon_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IconIconListArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 vdomparam: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        trname = fortios.wirelesscontrollerhotspot20.Icon("trname")
        ```
        ...
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IconIconListArgs']]]] icon_lists: Icon list. The structure of `icon_list` block is documented below.
        :param pulumi.Input[str] name: Icon list ID.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        super(Icon, __self__).__init__(
            'fortios:wirelesscontrollerhotspot20/icon:Icon',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            icon_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IconIconListArgs']]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'Icon':
        """
    ...
    @property
    @pulumi.getter(name="iconLists")
    def icon_lists(self) -> pulumi.Output[Optional[Sequence['outputs.IconIconList']]]:
        """
        Icon list. The structure of `icon_list` block is documented below.
        """
        return pulumi.get(self, "icon_lists")
