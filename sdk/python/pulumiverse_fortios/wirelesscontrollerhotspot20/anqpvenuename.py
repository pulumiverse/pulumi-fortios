...
class Anqpvenuename(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.wirelesscontrollerhotspot20.Anqpvenuename("trname", value_lists=[fortios.wirelesscontrollerhotspot20.AnqpvenuenameValueListArgs(
            index=1,
            lang="CN",
            value="3",
        )])
    ...
    def _internal_init(__self__,
        ...
        super(Anqpvenuename, __self__).__init__(
            'fortios:wirelesscontrollerhotspot20/anqpvenuename:Anqpvenuename',
            resource_name,
            __props__,
            opts)
