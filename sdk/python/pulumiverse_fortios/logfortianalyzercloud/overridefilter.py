...
class OverridefilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] filter: FortiAnalyzer Cloud log filter.
...
class Overridefilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import fortios:logfortianalyzercloud/overridefilter:Overridefilter labelname LogFortianalyzerCloudOverrideFilter
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Overridefilter, __self__).__init__(
            'fortios:logfortianalyzercloud/overridefilter:Overridefilter',
            resource_name,
            __props__,
            opts)
