...
__all__ = [
    ...
    'get_system_resourcelimits',
    'get_system_resourcelimits_output',
]
...
def get_system_resourcelimits(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_resourcelimits)
def get_system_resourcelimits_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
