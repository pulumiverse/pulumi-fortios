...
__all__ = [
    ...
    'get_system_sittunnel',
    'get_system_sittunnel_output',
]
...
def get_system_sittunnel(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_sittunnel)
def get_system_sittunnel_output(name: Optional[pulumi.Input[str]] = None,
