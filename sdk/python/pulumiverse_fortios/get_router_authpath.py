...
def get_router_authpath(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_authpath)
def get_router_authpath_output(name: Optional[pulumi.Input[str]] = None,
