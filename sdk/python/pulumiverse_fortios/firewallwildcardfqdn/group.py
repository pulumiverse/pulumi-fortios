...
class Group(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname1 = fortios.firewallwildcardfqdn.Custom("trname1",
            color=0,
            visibility="enable",
            wildcard_fqdn="*.ms.com")
        trname = fortios.firewallwildcardfqdn.Group("trname",
            color=0,
            visibility="enable",
            members=[fortios.firewallwildcardfqdn.GroupMemberArgs(
                name=trname1.name,
            )])
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Group, __self__).__init__(
            'fortios:firewallwildcardfqdn/group:Group',
            resource_name,
            __props__,
            opts)
