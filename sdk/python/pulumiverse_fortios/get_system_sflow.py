...
def get_system_sflow_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemSflowResult]:
    """
    Use this data source to get information on fortios system sflow
