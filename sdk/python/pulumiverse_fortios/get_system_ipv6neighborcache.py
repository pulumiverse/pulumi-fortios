...
__all__ = [
    ...
    'get_system_ipv6neighborcache',
    'get_system_ipv6neighborcache_output',
]
...
def get_system_ipv6neighborcache(fosid: Optional[int] = None,
...
@_utilities.lift_output_func(get_system_ipv6neighborcache)
def get_system_ipv6neighborcache_output(fosid: Optional[pulumi.Input[int]] = None,
