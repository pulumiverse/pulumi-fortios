...
__all__ = [
    ...
    'get_firewall_profileprotocoloptions',
    'get_firewall_profileprotocoloptions_output',
]
...
class GetFirewallProfileprotocoloptionsResult:
    ...
    @property
    @pulumi.getter
    def cifs(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsCifResult']:
        """
    ...
    @property
    @pulumi.getter
    def dns(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsDnResult']:
        """
    ...
    @property
    @pulumi.getter
    def ftps(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsFtpResult']:
        """
    ...
    @property
    @pulumi.getter
    def https(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsHttpResult']:
        """
    ...
    @property
    @pulumi.getter
    def imaps(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsImapResult']:
        """
    ...
    def mail_signatures(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsMailSignatureResult']:
        """
    ...
    @property
    @pulumi.getter
    def mapis(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsMapiResult']:
        """
    ...
    @property
    @pulumi.getter
    def nntps(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsNntpResult']:
        """
    ...
    @property
    @pulumi.getter
    def pop3s(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsPop3Result']:
        """
    ...
    @property
    @pulumi.getter
    def smtps(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsSmtpResult']:
        """
    ...
    @property
    @pulumi.getter
    def sshes(self) -> Sequence['outputs.GetFirewallProfileprotocoloptionsSshResult']:
        """
...
def get_firewall_profileprotocoloptions(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_profileprotocoloptions)
def get_firewall_profileprotocoloptions_output(name: Optional[pulumi.Input[str]] = None,
