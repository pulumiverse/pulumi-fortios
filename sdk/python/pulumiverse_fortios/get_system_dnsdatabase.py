...
__all__ = [
    ...
    'get_system_dnsdatabase',
    'get_system_dnsdatabase_output',
]
...
def get_system_dnsdatabase(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_dnsdatabase)
def get_system_dnsdatabase_output(name: Optional[pulumi.Input[str]] = None,
