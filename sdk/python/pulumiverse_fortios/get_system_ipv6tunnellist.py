...
__all__ = [
    ...
    'get_system_ipv6tunnellist',
    'get_system_ipv6tunnellist_output',
]
...
def get_system_ipv6tunnellist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_ipv6tunnellist)
def get_system_ipv6tunnellist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                     vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemIpv6tunnellistResult]:
    """
    Provides a list of `SystemIpv6tunnel`.
