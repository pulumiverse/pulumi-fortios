...
class SystemsnmpUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemsnmpUserVdomArgs']]] vdoms: SNMP access control VDOMs. The structure of `vdoms` block is documented below.
        """
...
class SystemsnmpUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] trap_status: Enable/disable traps for this SNMP user. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemsnmpUserVdomArgs']]]] vdoms: SNMP access control VDOMs. The structure of `vdoms` block is documented below.
        """
        ...
    @overload
    def __init__(__self__,
