...
__all__ = [
    ...
    'get_system_proxyarplist',
    'get_system_proxyarplist_output',
]
...
def get_system_proxyarplist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_proxyarplist)
def get_system_proxyarplist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
