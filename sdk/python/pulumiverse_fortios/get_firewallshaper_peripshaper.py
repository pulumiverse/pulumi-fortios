...
__all__ = [
    ...
    'get_firewallshaper_peripshaper',
    'get_firewallshaper_peripshaper_output',
]
...
def get_firewallshaper_peripshaper(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallshaper_peripshaper)
def get_firewallshaper_peripshaper_output(name: Optional[pulumi.Input[str]] = None,
