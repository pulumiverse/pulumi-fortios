...
class SettingArgs:
    def __init__(__self__, *,
                 ...
                 custom_field_names: Optional[pulumi.Input[Sequence[pulumi.Input['SettingCustomFieldNameArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SettingCustomFieldNameArgs']]] custom_field_names: Custom field name for CEF format logging. The structure of `custom_field_name` block is documented below.
    ...
    def custom_field_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SettingCustomFieldNameArgs']]]]:
        """
    ...
    def custom_field_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SettingCustomFieldNameArgs']]]]):
...
class Setting(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 certificate: Optional[pulumi.Input[str]] = None,
                 custom_field_names: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SettingCustomFieldNameArgs']]]]] = None,
                 dynamic_sort_subtable: Optional[pulumi.Input[str]] = None,
                 enc_algorithm: Optional[pulumi.Input[str]] = None,
                 facility: Optional[pulumi.Input[str]] = None,
                 format: Optional[pulumi.Input[str]] = None,
        ...
        trname = fortios.logsyslogd4.Setting("trname",
        ...
        :param pulumi.Input[str] certificate: Certificate used to communicate with Syslog server.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SettingCustomFieldNameArgs']]]] custom_field_names: Custom field name for CEF format logging. The structure of `custom_field_name` block is documented below.
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[str] enc_algorithm: Enable/disable reliable syslogging with TLS encryption. Valid values: `high-medium`, `high`, `low`, `disable`.
        :param pulumi.Input[str] facility: Remote syslog facility. Valid values: `kernel`, `user`, `mail`, `daemon`, `auth`, `syslog`, `lpr`, `news`, `uucp`, `cron`, `authpriv`, `ftp`, `ntp`, `audit`, `alert`, `clock`, `local0`, `local1`, `local2`, `local3`, `local4`, `local5`, `local6`, `local7`.
        :param pulumi.Input[str] format: Log format.
    ...
    def _internal_init(__self__,
        ...
        super(Setting, __self__).__init__(
            'fortios:logsyslogd4/setting:Setting',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="customFieldNames")
    def custom_field_names(self) -> pulumi.Output[Optional[Sequence['outputs.SettingCustomFieldName']]]:
        """
        Custom field name for CEF format logging. The structure of `custom_field_name` block is documented below.
        """
        return pulumi.get(self, "custom_field_names")
