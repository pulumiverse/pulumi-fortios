...
class OverridefilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] filter: Syslog 4 filter.
...
class Overridefilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.logsyslogd4.Overridefilter("trname",
            anomaly="enable",
            dns="enable",
            filter_type="include",
        ...
        ```sh
         $ pulumi import fortios:logsyslogd4/overridefilter:Overridefilter labelname LogSyslogd4OverrideFilter
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Overridefilter, __self__).__init__(
            'fortios:logsyslogd4/overridefilter:Overridefilter',
            resource_name,
            __props__,
            opts)
