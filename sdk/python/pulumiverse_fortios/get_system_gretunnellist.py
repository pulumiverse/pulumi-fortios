...
__all__ = [
    ...
    'get_system_gretunnellist',
    'get_system_gretunnellist_output',
]
...
def get_system_gretunnellist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_gretunnellist)
def get_system_gretunnellist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                    vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemGretunnellistResult]:
    """
    Provides a list of `SystemGretunnel`.
