...
__all__ = [
    ...
    'get_firewallservice_custom',
    'get_firewallservice_custom_output',
]
...
def get_firewallservice_custom(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallservice_custom)
def get_firewallservice_custom_output(name: Optional[pulumi.Input[str]] = None,
