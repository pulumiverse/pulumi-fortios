...
class AntivirusProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AntivirusProfileContentDisarmArgs'] content_disarm: AV Content Disarm and Reconstruction settings. The structure of `content_disarm` block is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AntivirusProfileExternalBlocklistArgs']]] external_blocklists: One or more external malware block lists. The structure of `external_blocklist` block is documented below.
        ...
        :param pulumi.Input['AntivirusProfileOutbreakPreventionArgs'] outbreak_prevention: Configure Virus Outbreak Prevention settings. The structure of `outbreak_prevention` block is documented below.
...
class AntivirusProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] comment: Comment.
        :param pulumi.Input[pulumi.InputType['AntivirusProfileContentDisarmArgs']] content_disarm: AV Content Disarm and Reconstruction settings. The structure of `content_disarm` block is documented below.
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[str] ems_threat_feed: Enable/disable use of EMS threat feed when performing AntiVirus scan. Analyzes files including the content of archives. Valid values: `disable`, `enable`.
        :param pulumi.Input[str] extended_log: Enable/disable extended logging for antivirus. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] external_blocklist_enable_all: Enable/disable all external blocklists. Valid values: `disable`, `enable`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AntivirusProfileExternalBlocklistArgs']]]] external_blocklists: One or more external malware block lists. The structure of `external_blocklist` block is documented below.
        :param pulumi.Input[str] feature_set: Flow/proxy feature set. Valid values: `flow`, `proxy`.
        :param pulumi.Input[str] fortiai_error_action: Action to take if FortiAI encounters an error. Valid values: `log-only`, `block`, `ignore`.
        :param pulumi.Input[str] fortiai_timeout_action: Action to take if FortiAI encounters a scan timeout. Valid values: `log-only`, `block`, `ignore`.
        :param pulumi.Input[str] fortindr_error_action: Action to take if FortiNDR encounters an error. Valid values: `log-only`, `block`, `ignore`.
        ...
        :param pulumi.Input[pulumi.InputType['AntivirusProfileOutbreakPreventionArgs']] outbreak_prevention: Configure Virus Outbreak Prevention settings. The structure of `outbreak_prevention` block is documented below.
        :param pulumi.Input[str] outbreak_prevention_archive_scan: Enable/disable outbreak-prevention archive scanning. Valid values: `disable`, `enable`.
