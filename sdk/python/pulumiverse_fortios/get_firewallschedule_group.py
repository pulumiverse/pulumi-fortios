...
__all__ = [
    ...
    'get_firewallschedule_group',
    'get_firewallschedule_group_output',
]
...
def get_firewallschedule_group(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallschedule_group)
def get_firewallschedule_group_output(name: Optional[pulumi.Input[str]] = None,
