...
class RouterRipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouterRipDistanceArgs']]] distances: distance The structure of `distance` block is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouterRipInterfaceArgs']]] interfaces: RIP interface configuration. The structure of `interface` block is documented below.
...
class RouterRip(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] default_information_originate: Enable/disable generation of default route. Valid values: `enable`, `disable`.
        :param pulumi.Input[int] default_metric: Default metric.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RouterRipDistanceArgs']]]] distances: distance The structure of `distance` block is documented below.
        ...
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[int] garbage_timer: Garbage timer in seconds.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RouterRipInterfaceArgs']]]] interfaces: RIP interface configuration. The structure of `interface` block is documented below.
        :param pulumi.Input[int] max_out_metric: Maximum metric allowed to output(0 means 'not set').
