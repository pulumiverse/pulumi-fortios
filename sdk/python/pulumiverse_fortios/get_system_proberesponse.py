...
__all__ = [
    ...
    'get_system_proberesponse',
    'get_system_proberesponse_output',
]
...
def get_system_proberesponse(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_proberesponse)
def get_system_proberesponse_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
