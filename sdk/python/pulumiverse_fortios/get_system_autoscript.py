...
__all__ = [
    ...
    'get_system_autoscript',
    'get_system_autoscript_output',
]
...
def get_system_autoscript(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_autoscript)
def get_system_autoscript_output(name: Optional[pulumi.Input[str]] = None,
