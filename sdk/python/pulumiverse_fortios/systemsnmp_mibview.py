...
__all__ = ['SystemsnmpMibviewArgs', 'SystemsnmpMibview']

@pulumi.input_type
class SystemsnmpMibviewArgs:
...
class SystemsnmpMibview(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SystemsnmpMibviewArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        SNMP Access Control MIB View configuration. Applies to FortiOS Version `>= 7.2.0`.
        ...
        :param str resource_name: The name of the resource.
        :param SystemsnmpMibviewArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SystemsnmpMibviewArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SystemsnmpMibviewArgs.__new__(SystemsnmpMibviewArgs)

            __props__.__dict__["exclude"] = exclude
            __props__.__dict__["include"] = include
            __props__.__dict__["name"] = name
            __props__.__dict__["vdomparam"] = vdomparam
        super(SystemsnmpMibview, __self__).__init__(
            'fortios:index/systemsnmpMibview:SystemsnmpMibview',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            include: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'SystemsnmpMibview':
        """
        ...
        __props__ = _SystemsnmpMibviewState.__new__(_SystemsnmpMibviewState)

        __props__.__dict__["exclude"] = exclude
        __props__.__dict__["include"] = include
        __props__.__dict__["name"] = name
        __props__.__dict__["vdomparam"] = vdomparam
        return SystemsnmpMibview(resource_name, opts=opts, __props__=__props__)
