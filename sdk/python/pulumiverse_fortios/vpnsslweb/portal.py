...
class Portal(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.vpnsslweb.Portal("trname",
            ...
            host_check="none",
            ip_mode="range",
            ip_pools=[fortios.vpnsslweb.PortalIpPoolArgs(
                name="SSLVPN_TUNNEL_ADDR1",
            )],
            ipv6_dns_server1="::",
            ipv6_dns_server2="::",
            ipv6_exclusive_routing="disable",
            ipv6_pools=[fortios.vpnsslweb.PortalIpv6PoolArgs(
    ...
    def _internal_init(__self__,
        ...
        super(Portal, __self__).__init__(
            'fortios:vpnsslweb/portal:Portal',
            resource_name,
            __props__,
            opts)
