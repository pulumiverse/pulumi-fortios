...
class Ipsecaggregate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname1_phase1interface = fortios.vpnipsec.Phase1interface("trname1Phase1interface",
            acct_verify="disable",
            ...
            wizard_type="custom",
            xauthtype="disable")
        trname1_phase2interface = fortios.vpnipsec.Phase2interface("trname1Phase2interface",
            add_route="phase1",
        ...
        trname = fortios.sys.Ipsecaggregate("trname",
            algorithm="round-robin",
            members=[fortios.sys.IpsecaggregateMemberArgs(
    ...
    def _internal_init(__self__,
        ...
        super(Ipsecaggregate, __self__).__init__(
            'fortios:sys/ipsecaggregate:Ipsecaggregate',
            resource_name,
            __props__,
            opts)
