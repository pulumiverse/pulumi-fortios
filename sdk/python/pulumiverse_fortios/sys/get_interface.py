...
def get_interface(name: Optional[str] = None,
    ...
    sample1 = fortios.sys.get_interface(name="port1")
    ...
    __ret__ = pulumi.runtime.invoke('fortios:sys/getInterface:getInterface', __args__, opts=opts, typ=GetInterfaceResult).value
