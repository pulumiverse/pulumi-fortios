...
class LicenseVm(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test2 = fortios.sys.LicenseVm("test2", file_content="")
        ```
    ...
    def _internal_init(__self__,
        ...
        super(LicenseVm, __self__).__init__(
            'fortios:sys/licenseVm:LicenseVm',
            resource_name,
            __props__,
            opts)
