...
def get_accprofile(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('fortios:sys/getAccprofile:getAccprofile', __args__, opts=opts, typ=GetAccprofileResult).value
    ...
    return AwaitableGetAccprofileResult(
        ...
        fwgrp=__ret__.fwgrp,
        fwgrp_permissions=__ret__.fwgrp_permissions,
        id=__ret__.id,
        loggrp=__ret__.loggrp,
        loggrp_permissions=__ret__.loggrp_permissions,
        name=__ret__.name,
        netgrp=__ret__.netgrp,
        netgrp_permissions=__ret__.netgrp_permissions,
        scope=__ret__.scope,
        secfabgrp=__ret__.secfabgrp,
        sysgrp=__ret__.sysgrp,
        sysgrp_permissions=__ret__.sysgrp_permissions,
        system_diagnostics=__ret__.system_diagnostics,
        system_execute_ssh=__ret__.system_execute_ssh,
        system_execute_telnet=__ret__.system_execute_telnet,
        utmgrp=__ret__.utmgrp,
        utmgrp_permissions=__ret__.utmgrp_permissions,
