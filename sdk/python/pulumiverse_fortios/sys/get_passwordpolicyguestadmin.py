...
def get_passwordpolicyguestadmin(vdomparam: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('fortios:sys/getPasswordpolicyguestadmin:getPasswordpolicyguestadmin', __args__, opts=opts, typ=GetPasswordpolicyguestadminResult).value
