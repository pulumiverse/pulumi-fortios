...
class Accprofile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test12 = fortios.sys.Accprofile("test12",
            admintimeout=10,
            admintimeout_override="disable",
            authgrp="read-write",
            ftviewgrp="read-write",
            fwgrp="custom",
            fwgrp_permission=fortios.sys.AccprofileFwgrpPermissionArgs(
                address="read-write",
                policy="read-write",
                schedule="none",
                service="none",
            ...
            loggrp="read-write",
            loggrp_permission=fortios.sys.AccprofileLoggrpPermissionArgs(
                config="none",
                data_access="none",
                report_access="none",
                threat_weight="none",
            ...
            netgrp="read-write",
            netgrp_permission=fortios.sys.AccprofileNetgrpPermissionArgs(
                cfg="none",
                packet_capture="none",
                route_cfg="none",
            ),
            ...
            sysgrp="read-write",
            sysgrp_permission=fortios.sys.AccprofileSysgrpPermissionArgs(
                admin="none",
                cfg="none",
                mnt="none",
                upd="none",
            ...
            utmgrp="custom",
            utmgrp_permission=fortios.sys.AccprofileUtmgrpPermissionArgs(
    ...
    def _internal_init(__self__,
        ...
        super(Accprofile, __self__).__init__(
            'fortios:sys/accprofile:Accprofile',
            resource_name,
            __props__,
            opts)
