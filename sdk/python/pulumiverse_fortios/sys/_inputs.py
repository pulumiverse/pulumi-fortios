...
class GeoipoverrideIp6RangeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] end_ip: Final IP address, inclusive, of the address range (format: xxx.xxx.xxx.xxx).
               
               The `ip6_range` block supports:
        :param pulumi.Input[int] id: ID number for individual entry in the IP-Range table.
        :param pulumi.Input[str] start_ip: Starting IP address, inclusive, of the address range (format: xxx.xxx.xxx.xxx).
        """
...
class InterfaceIpv6Ip6ExtraAddrArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] prefix: IPv6 address prefix.
