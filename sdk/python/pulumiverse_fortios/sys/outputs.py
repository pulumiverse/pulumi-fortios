...
class GeoipoverrideIp6Range(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str end_ip: Final IP address, inclusive, of the address range (format: xxx.xxx.xxx.xxx).
               
               The `ip6_range` block supports:
        :param int id: ID number for individual entry in the IP-Range table.
        :param str start_ip: Starting IP address, inclusive, of the address range (format: xxx.xxx.xxx.xxx).
        """
...
class InterfaceIpv6Ip6ExtraAddr(dict):
    def __init__(__self__, *,
        ...
        """
        :param str prefix: IPv6 address prefix.
