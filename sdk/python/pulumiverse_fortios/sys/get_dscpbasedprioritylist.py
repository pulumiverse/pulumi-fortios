...
def get_dscpbasedprioritylist(filter: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('fortios:sys/getDscpbasedprioritylist:getDscpbasedprioritylist', __args__, opts=opts, typ=GetDscpbasedprioritylistResult).value
