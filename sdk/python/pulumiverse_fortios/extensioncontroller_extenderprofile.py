...
__all__ = ['ExtensioncontrollerExtenderprofileArgs', 'ExtensioncontrollerExtenderprofile']

@pulumi.input_type
class ExtensioncontrollerExtenderprofileArgs:
    def __init__(__self__, *,
                 allowaccess: Optional[pulumi.Input[str]] = None,
                 bandwidth_limit: Optional[pulumi.Input[int]] = None,
                 cellular: Optional[pulumi.Input['ExtensioncontrollerExtenderprofileCellularArgs']] = None,
                 enforce_bandwidth: Optional[pulumi.Input[str]] = None,
                 extension: Optional[pulumi.Input[str]] = None,
                 fosid: Optional[pulumi.Input[int]] = None,
                 lan_extension: Optional[pulumi.Input['ExtensioncontrollerExtenderprofileLanExtensionArgs']] = None,
        ...
        :param pulumi.Input['ExtensioncontrollerExtenderprofileCellularArgs'] cellular: FortiExtender cellular configuration. The structure of `cellular` block is documented below.
        ...
        :param pulumi.Input['ExtensioncontrollerExtenderprofileLanExtensionArgs'] lan_extension: FortiExtender lan extension configuration. The structure of `lan_extension` block is documented below.
    ...
    @property
    @pulumi.getter
    def cellular(self) -> Optional[pulumi.Input['ExtensioncontrollerExtenderprofileCellularArgs']]:
        """
    ...
    @cellular.setter
    def cellular(self, value: Optional[pulumi.Input['ExtensioncontrollerExtenderprofileCellularArgs']]):
    ...
    def lan_extension(self) -> Optional[pulumi.Input['ExtensioncontrollerExtenderprofileLanExtensionArgs']]:
        """
    ...
    def lan_extension(self, value: Optional[pulumi.Input['ExtensioncontrollerExtenderprofileLanExtensionArgs']]):
...
@pulumi.input_type
class _ExtensioncontrollerExtenderprofileState:
    def __init__(__self__, *,
                 allowaccess: Optional[pulumi.Input[str]] = None,
                 bandwidth_limit: Optional[pulumi.Input[int]] = None,
                 cellular: Optional[pulumi.Input['ExtensioncontrollerExtenderprofileCellularArgs']] = None,
...
class ExtensioncontrollerExtenderprofile(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 allowaccess: Optional[pulumi.Input[str]] = None,
                 bandwidth_limit: Optional[pulumi.Input[int]] = None,
                 cellular: Optional[pulumi.Input[pulumi.InputType['ExtensioncontrollerExtenderprofileCellularArgs']]] = None,
                 enforce_bandwidth: Optional[pulumi.Input[str]] = None,
                 extension: Optional[pulumi.Input[str]] = None,
                 fosid: Optional[pulumi.Input[int]] = None,
                 lan_extension: Optional[pulumi.Input[pulumi.InputType['ExtensioncontrollerExtenderprofileLanExtensionArgs']]] = None,
                 login_password: Optional[pulumi.Input[str]] = None,
                 login_password_change: Optional[pulumi.Input[str]] = None,
                 model: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] allowaccess: Control management access to the managed extender. Separate entries with a space. Valid values: `ping`, `telnet`, `http`, `https`, `ssh`, `snmp`.
        :param pulumi.Input[int] bandwidth_limit: FortiExtender LAN extension bandwidth limit (Mbps).
        :param pulumi.Input[pulumi.InputType['ExtensioncontrollerExtenderprofileCellularArgs']] cellular: FortiExtender cellular configuration. The structure of `cellular` block is documented below.
        :param pulumi.Input[str] enforce_bandwidth: Enable/disable enforcement of bandwidth on LAN extension interface. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] extension: Extension option. Valid values: `wan-extension`, `lan-extension`.
        :param pulumi.Input[int] fosid: ID.
        :param pulumi.Input[pulumi.InputType['ExtensioncontrollerExtenderprofileLanExtensionArgs']] lan_extension: FortiExtender lan extension configuration. The structure of `lan_extension` block is documented below.
        :param pulumi.Input[str] login_password: Set the managed extender's administrator password.
        :param pulumi.Input[str] login_password_change: Change or reset the administrator password of a managed extender (yes, default, or no, default = no). Valid values: `yes`, `default`, `no`.
        :param pulumi.Input[str] model: Model. Valid values: `FX201E`, `FX211E`, `FX200F`, `FXA11F`, `FXE11F`, `FXA21F`, `FXE21F`, `FXA22F`, `FXE22F`, `FX212F`, `FX311F`, `FX312F`, `FX511F`, `FVG21F`, `FVA21F`, `FVG22F`, `FVA22F`, `FX04DA`.
        :param pulumi.Input[str] name: FortiExtender profile name.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ExtensioncontrollerExtenderprofileArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        FortiExtender extender profile configuration. Applies to FortiOS Version `>= 7.2.1`.
        ...
        :param str resource_name: The name of the resource.
        :param ExtensioncontrollerExtenderprofileArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ExtensioncontrollerExtenderprofileArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ExtensioncontrollerExtenderprofileArgs.__new__(ExtensioncontrollerExtenderprofileArgs)
        ...
        super(ExtensioncontrollerExtenderprofile, __self__).__init__(
            'fortios:index/extensioncontrollerExtenderprofile:ExtensioncontrollerExtenderprofile',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            model: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'ExtensioncontrollerExtenderprofile':
        """
        ...
        __props__ = _ExtensioncontrollerExtenderprofileState.__new__(_ExtensioncontrollerExtenderprofileState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["vdomparam"] = vdomparam
        return ExtensioncontrollerExtenderprofile(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def cellular(self) -> pulumi.Output['outputs.ExtensioncontrollerExtenderprofileCellular']:
        """
        FortiExtender cellular configuration. The structure of `cellular` block is documented below.
        """
        return pulumi.get(self, "cellular")
    ...
    @property
    @pulumi.getter(name="lanExtension")
    def lan_extension(self) -> pulumi.Output['outputs.ExtensioncontrollerExtenderprofileLanExtension']:
        """
        FortiExtender lan extension configuration. The structure of `lan_extension` block is documented below.
        """
        return pulumi.get(self, "lan_extension")
