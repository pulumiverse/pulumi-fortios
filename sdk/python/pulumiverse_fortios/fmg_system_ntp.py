...
__all__ = ['FmgSystemNtpArgs', 'FmgSystemNtp']

@pulumi.input_type
class FmgSystemNtpArgs:
...
class FmgSystemNtp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgSystemNtp("test1",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FmgSystemNtpArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgSystemNtpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgSystemNtpArgs.__new__(FmgSystemNtpArgs)
        ...
        super(FmgSystemNtp, __self__).__init__(
            'fortios:index/fmgSystemNtp:FmgSystemNtp',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            server: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            sync_interval: Optional[pulumi.Input[int]] = None) -> 'FmgSystemNtp':
        """
        ...
        __props__ = _FmgSystemNtpState.__new__(_FmgSystemNtpState)

        __props__.__dict__["server"] = server
        __props__.__dict__["status"] = status
        __props__.__dict__["sync_interval"] = sync_interval
        return FmgSystemNtp(resource_name, opts=opts, __props__=__props__)
