...
__all__ = [
    ...
    'get_system_managementtunnel',
    'get_system_managementtunnel_output',
]
...
def get_system_managementtunnel(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_managementtunnel)
def get_system_managementtunnel_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
