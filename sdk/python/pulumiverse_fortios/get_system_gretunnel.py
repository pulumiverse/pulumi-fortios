...
__all__ = [
    ...
    'get_system_gretunnel',
    'get_system_gretunnel_output',
]
...
def get_system_gretunnel(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_gretunnel)
def get_system_gretunnel_output(name: Optional[pulumi.Input[str]] = None,
