...
__all__ = [
    ...
    'get_firewall_internetservice',
    'get_firewall_internetservice_output',
]
...
def get_firewall_internetservice(fosid: Optional[int] = None,
...
@_utilities.lift_output_func(get_firewall_internetservice)
def get_firewall_internetservice_output(fosid: Optional[pulumi.Input[int]] = None,
