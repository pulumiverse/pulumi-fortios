...
def get_user_saml(name: Optional[str] = None,
    ...
    return AwaitableGetUserSamlResult(
        adfs_claim=__ret__.adfs_claim,
        auth_url=__ret__.auth_url,
        cert=__ret__.cert,
        clock_tolerance=__ret__.clock_tolerance,
        digest_method=__ret__.digest_method,
        entity_id=__ret__.entity_id,
        group_claim_type=__ret__.group_claim_type,
        ...
        limit_relaystate=__ret__.limit_relaystate,
        name=__ret__.name,
        single_logout_url=__ret__.single_logout_url,
        single_sign_on_url=__ret__.single_sign_on_url,
        user_claim_type=__ret__.user_claim_type,
        user_name=__ret__.user_name,
        vdomparam=__ret__.vdomparam)


@_utilities.lift_output_func(get_user_saml)
def get_user_saml_output(name: Optional[pulumi.Input[str]] = None,
                         vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetUserSamlResult]:
    """
    Use this data source to get information on an fortios user saml
