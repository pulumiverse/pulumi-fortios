...
__all__ = [
    ...
    'get_system_pppoeinterface',
    'get_system_pppoeinterface_output',
]
...
def get_system_pppoeinterface(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_pppoeinterface)
def get_system_pppoeinterface_output(name: Optional[pulumi.Input[str]] = None,
