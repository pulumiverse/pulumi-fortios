...
__all__ = [
    ...
    'get_systemautoupdate_pushupdate',
    'get_systemautoupdate_pushupdate_output',
]
...
def get_systemautoupdate_pushupdate(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_systemautoupdate_pushupdate)
def get_systemautoupdate_pushupdate_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
