...
def get_system_nat64_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemNat64Result]:
    """
    Use this data source to get information on fortios system nat64
