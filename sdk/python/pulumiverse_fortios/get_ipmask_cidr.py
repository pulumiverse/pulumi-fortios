...
def get_ipmask_cidr(ipmask: Optional[str] = None,
    ...
    trname_system_interface = fortios.get_system_interface(name="port3")
    trname_ipmask_cidr = fortios.get_ipmask_cidr(ipmask=trname_system_interface.ip)
    pulumi.export("output1", trname_ipmask_cidr.cidr)
    ```
    ### Example2
    ...
    pulumi.export("outputConv1", trname_ipmask_cidr.cidr)
    pulumi.export("outputConv2", trname_ipmask_cidr.cidrlists)
    pulumi.export("outputOrignal", trname_system_interface.ip)
    ```
...
@_utilities.lift_output_func(get_ipmask_cidr)
def get_ipmask_cidr_output(ipmask: Optional[pulumi.Input[Optional[str]]] = None,
