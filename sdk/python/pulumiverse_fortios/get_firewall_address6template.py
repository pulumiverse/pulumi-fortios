...
__all__ = [
    ...
    'get_firewall_address6template',
    'get_firewall_address6template_output',
]
...
def get_firewall_address6template(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_address6template)
def get_firewall_address6template_output(name: Optional[pulumi.Input[str]] = None,
