...
class ExtensioncontrollerExtenderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ExtensioncontrollerExtenderWanExtensionArgs'] wan_extension: FortiExtender wan extension configuration. The structure of `wan_extension` block is documented below.
        """
...
class ExtensioncontrollerExtender(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[int] vdom: VDOM.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        :param pulumi.Input[pulumi.InputType['ExtensioncontrollerExtenderWanExtensionArgs']] wan_extension: FortiExtender wan extension configuration. The structure of `wan_extension` block is documented below.
        """
        ...
    @overload
    def __init__(__self__,
