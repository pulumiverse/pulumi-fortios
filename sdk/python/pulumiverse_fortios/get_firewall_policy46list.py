...
__all__ = [
    ...
    'get_firewall_policy46list',
    'get_firewall_policy46list_output',
]
...
def get_firewall_policy46list(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_policy46list)
def get_firewall_policy46list_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                     vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFirewallPolicy46listResult]:
    """
    Provides a list of `FirewallPolicy46`.
