...
__all__ = [
    ...
    'get_system_centralmanagement',
    'get_system_centralmanagement_output',
]
...
def get_system_centralmanagement(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_centralmanagement)
def get_system_centralmanagement_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemCentralmanagementResult]:
    """
    Use this data source to get information on fortios system centralmanagement
