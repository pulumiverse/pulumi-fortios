...
__all__ = [
    'GetSittunnelResult',
    'AwaitableGetSittunnelResult',
    'get_sittunnel',
    'get_sittunnel_output',
]

@pulumi.output_type
class GetSittunnelResult:
    """
...
class AwaitableGetSittunnelResult(GetSittunnelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSittunnelResult(
...
def get_sittunnel(name: Optional[str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSittunnelResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('fortios:system/getSittunnel:getSittunnel', __args__, opts=opts, typ=GetSittunnelResult).value

    return AwaitableGetSittunnelResult(
...
@_utilities.lift_output_func(get_sittunnel)
def get_sittunnel_output(name: Optional[pulumi.Input[str]] = None,
                         vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSittunnelResult]:
    """
    Use this data source to get information on an fortios system sittunnel
