...
__all__ = [
    'GetPasswordpolicyguestadminResult',
    'AwaitableGetPasswordpolicyguestadminResult',
    'get_passwordpolicyguestadmin',
    'get_passwordpolicyguestadmin_output',
]

@pulumi.output_type
class GetPasswordpolicyguestadminResult:
    """
...
class AwaitableGetPasswordpolicyguestadminResult(GetPasswordpolicyguestadminResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPasswordpolicyguestadminResult(
...
def get_passwordpolicyguestadmin(vdomparam: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPasswordpolicyguestadminResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('fortios:system/getPasswordpolicyguestadmin:getPasswordpolicyguestadmin', __args__, opts=opts, typ=GetPasswordpolicyguestadminResult).value

    return AwaitableGetPasswordpolicyguestadminResult(
...
@_utilities.lift_output_func(get_passwordpolicyguestadmin)
def get_passwordpolicyguestadmin_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPasswordpolicyguestadminResult]:
    """
    Use this data source to get information on fortios system passwordpolicyguestadmin
