...
class VdomsflowArgs:
    def __init__(__self__, *,
                 ...
                 collectors: Optional[pulumi.Input[Sequence[pulumi.Input['VdomsflowCollectorArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VdomsflowCollectorArgs']]] collectors: sFlow collectors. The structure of `collectors` block is documented below.
    ...
    @property
    @pulumi.getter
    def collectors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['VdomsflowCollectorArgs']]]]:
        """
    ...
    @collectors.setter
    def collectors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['VdomsflowCollectorArgs']]]]):
...
class Vdomsflow(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 collector_ip: Optional[pulumi.Input[str]] = None,
                 collector_port: Optional[pulumi.Input[int]] = None,
                 collectors: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VdomsflowCollectorArgs']]]]] = None,
                 dynamic_sort_subtable: Optional[pulumi.Input[str]] = None,
                 get_all_tables: Optional[pulumi.Input[str]] = None,
                 interface: Optional[pulumi.Input[str]] = None,
                 interface_select_method: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] collector_ip: IP address of the sFlow collector that sFlow agents added to interfaces in this VDOM send sFlow datagrams to (default = 0.0.0.0).
        :param pulumi.Input[int] collector_port: UDP port number used for sending sFlow datagrams (configure only if required by your sFlow collector or your network configuration) (0 - 65535, default = 6343).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VdomsflowCollectorArgs']]]] collectors: sFlow collectors. The structure of `collectors` block is documented below.
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[str] get_all_tables: Get all sub-tables including unconfigured tables. Do not set this variable to true if you configure sub-table in another resource, otherwish conflicts and overwrite will occur. Options: [ false, true ]. false: Default value, do not get unconfigured tables; true: get all tables including unconfigured tables.
        :param pulumi.Input[str] interface: Specify outgoing interface to reach server.
        :param pulumi.Input[str] interface_select_method: Specify how to select outgoing interface to reach server. Valid values: `auto`, `sdwan`, `specify`.
    ...
    @property
    @pulumi.getter
    def collectors(self) -> pulumi.Output[Optional[Sequence['outputs.VdomsflowCollector']]]:
        """
        sFlow collectors. The structure of `collectors` block is documented below.
        """
        return pulumi.get(self, "collectors")
