...
__all__ = [
    ...
    'get_systemdhcp_server',
    'get_systemdhcp_server_output',
]
...
def get_systemdhcp_server(fosid: Optional[int] = None,
...
@_utilities.lift_output_func(get_systemdhcp_server)
def get_systemdhcp_server_output(fosid: Optional[pulumi.Input[int]] = None,
