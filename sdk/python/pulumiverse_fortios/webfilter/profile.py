...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.webfilter.Profile("trname",
            extended_log="disable",
            ftgd_wf=fortios.webfilter.ProfileFtgdWfArgs(
                exempt_quota="17",
                filters=[
                    fortios.webfilter.ProfileFtgdWfFilterArgs(
                        action="warning",
                        category=2,
                        id=1,
                        log="enable",
            ...
            log_all_url="disable",
            override=fortios.webfilter.ProfileOverrideArgs(
                ovrd_cookie="deny",
                ovrd_dur="15m",
            ...
            post_action="normal",
            web=fortios.webfilter.ProfileWebArgs(
                blacklist="disable",
                bword_table=0,
                bword_threshold=10,
    ...
    def _internal_init(__self__,
        ...
        super(Profile, __self__).__init__(
            'fortios:webfilter/profile:Profile',
            resource_name,
            __props__,
            opts)
