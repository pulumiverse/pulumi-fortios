...
__all__ = [
    ...
    'get_firewall_internetservicecustom',
    'get_firewall_internetservicecustom_output',
]
...
def get_firewall_internetservicecustom(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_internetservicecustom)
def get_firewall_internetservicecustom_output(name: Optional[pulumi.Input[str]] = None,
