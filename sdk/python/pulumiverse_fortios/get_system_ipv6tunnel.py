...
__all__ = [
    ...
    'get_system_ipv6tunnel',
    'get_system_ipv6tunnel_output',
]
...
def get_system_ipv6tunnel(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_ipv6tunnel)
def get_system_ipv6tunnel_output(name: Optional[pulumi.Input[str]] = None,
