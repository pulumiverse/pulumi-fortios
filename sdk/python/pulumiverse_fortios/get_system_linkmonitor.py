...
__all__ = [
    ...
    'get_system_linkmonitor',
    'get_system_linkmonitor_output',
]
...
def get_system_linkmonitor(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_linkmonitor)
def get_system_linkmonitor_output(name: Optional[pulumi.Input[str]] = None,
