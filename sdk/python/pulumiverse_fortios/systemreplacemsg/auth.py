...
class Auth(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param AuthArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AuthArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AuthArgs.__new__(AuthArgs)
        ...
        super(Auth, __self__).__init__(
            'fortios:systemreplacemsg/auth:Auth',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            header: Optional[pulumi.Input[str]] = None,
            msg_type: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'Auth':
        """
        ...
        __props__ = _AuthState.__new__(_AuthState)
        ...
        __props__.__dict__["msg_type"] = msg_type
        __props__.__dict__["vdomparam"] = vdomparam
        return Auth(resource_name, opts=opts, __props__=__props__)
