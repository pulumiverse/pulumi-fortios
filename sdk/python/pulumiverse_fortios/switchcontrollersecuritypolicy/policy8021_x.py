...
class Policy8021X(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.switchcontrollersecuritypolicy.Policy8021X("trname",
            ...
            user_groups=[fortios.switchcontrollersecuritypolicy.Policy8021XUserGroupArgs(
                name="Guest-group",
            )])
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Policy8021X, __self__).__init__(
            'fortios:switchcontrollersecuritypolicy/policy8021X:Policy8021X',
            resource_name,
            __props__,
            opts)
