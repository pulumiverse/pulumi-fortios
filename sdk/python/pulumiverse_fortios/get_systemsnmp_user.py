...
class GetSystemsnmpUserResult:
    ...
    @property
    @pulumi.getter
    def vdoms(self) -> Sequence['outputs.GetSystemsnmpUserVdomResult']:
        """
...
def get_systemsnmp_user(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_systemsnmp_user)
def get_systemsnmp_user_output(name: Optional[pulumi.Input[str]] = None,
                               vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemsnmpUserResult]:
    """
    Use this data source to get information on an fortios systemsnmp user
