...
__all__ = [
    ...
    'get_system_replacemsggrouplist',
    'get_system_replacemsggrouplist_output',
]
...
def get_system_replacemsggrouplist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_replacemsggrouplist)
def get_system_replacemsggrouplist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
