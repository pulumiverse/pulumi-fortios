...
class Overridefilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.logsyslogd.Overridefilter("trname",
            anomaly="enable",
            dns="enable",
            filter_type="include",
        ...
        ```sh
         $ pulumi import fortios:logsyslogd/overridefilter:Overridefilter labelname LogSyslogdOverrideFilter
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Overridefilter, __self__).__init__(
            'fortios:logsyslogd/overridefilter:Overridefilter',
            resource_name,
            __props__,
            opts)
