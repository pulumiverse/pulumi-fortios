...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.spamfilter.Profile("trname",
            comment="terraform test",
            external="disable",
            flow_based="disable",
            gmail=fortios.spamfilter.ProfileGmailArgs(
                log="disable",
            ),
            imap=fortios.spamfilter.ProfileImapArgs(
                action="tag",
                log="disable",
                tag_msg="Spam",
                tag_type="subject spaminfo",
            ),
            mapi=fortios.spamfilter.ProfileMapiArgs(
                action="discard",
                log="disable",
            ),
            msn_hotmail=fortios.spamfilter.ProfileMsnHotmailArgs(
                log="disable",
            ),
            pop3=fortios.spamfilter.ProfilePop3Args(
                action="tag",
                log="disable",
                tag_msg="Spam",
                tag_type="subject spaminfo",
            ),
            smtp=fortios.spamfilter.ProfileSmtpArgs(
                action="discard",
                hdrip="disable",
            ...
            spam_rbl_table=0,
            yahoo_mail=fortios.spamfilter.ProfileYahooMailArgs(
                log="disable",
            ))
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Profile, __self__).__init__(
            'fortios:spamfilter/profile:Profile',
            resource_name,
            __props__,
            opts)
