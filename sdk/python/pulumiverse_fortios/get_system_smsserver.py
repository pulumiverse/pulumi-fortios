...
__all__ = [
    ...
    'get_system_smsserver',
    'get_system_smsserver_output',
]
...
def get_system_smsserver(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_smsserver)
def get_system_smsserver_output(name: Optional[pulumi.Input[str]] = None,
