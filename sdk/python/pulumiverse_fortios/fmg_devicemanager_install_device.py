...
__all__ = ['FmgDevicemanagerInstallDeviceArgs', 'FmgDevicemanagerInstallDevice']

@pulumi.input_type
class FmgDevicemanagerInstallDeviceArgs:
...
@pulumi.input_type
class _FmgDevicemanagerInstallDeviceState:
    def __init__(__self__, *,
                 adom: Optional[pulumi.Input[str]] = None,
...
class FmgDevicemanagerInstallDevice(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgDevicemanagerInstallDevice("test1",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FmgDevicemanagerInstallDeviceArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports installing devicemanager script from FortiManager to the related device
        ...
        :param str resource_name: The name of the resource.
        :param FmgDevicemanagerInstallDeviceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgDevicemanagerInstallDeviceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgDevicemanagerInstallDeviceArgs.__new__(FmgDevicemanagerInstallDeviceArgs)
        ...
        super(FmgDevicemanagerInstallDevice, __self__).__init__(
            'fortios:index/fmgDevicemanagerInstallDevice:FmgDevicemanagerInstallDevice',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            target_devname: Optional[pulumi.Input[str]] = None,
            timeout: Optional[pulumi.Input[int]] = None,
            vdom: Optional[pulumi.Input[str]] = None) -> 'FmgDevicemanagerInstallDevice':
        """
        ...
        __props__ = _FmgDevicemanagerInstallDeviceState.__new__(_FmgDevicemanagerInstallDeviceState)

        __props__.__dict__["adom"] = adom
        __props__.__dict__["target_devname"] = target_devname
        __props__.__dict__["timeout"] = timeout
        __props__.__dict__["vdom"] = vdom
        return FmgDevicemanagerInstallDevice(resource_name, opts=opts, __props__=__props__)
