...
__all__ = [
    ...
    'get_system_replacemsgimage',
    'get_system_replacemsgimage_output',
]
...
def get_system_replacemsgimage(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_replacemsgimage)
def get_system_replacemsgimage_output(name: Optional[pulumi.Input[str]] = None,
