...
__all__ = ['FmgSystemNetworkInterfaceArgs', 'FmgSystemNetworkInterface']

@pulumi.input_type
class FmgSystemNetworkInterfaceArgs:
...
@pulumi.input_type
class _FmgSystemNetworkInterfaceState:
    def __init__(__self__, *,
                 allow_accesses: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 ip: Optional[pulumi.Input[str]] = None,
...
class FmgSystemNetworkInterface(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgSystemNetworkInterface("test1",
            allow_accesses=[
                "ping",
                "ssh",
                "https",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FmgSystemNetworkInterfaceArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports updating system network interface for FortiManager.
        ...
        :param str resource_name: The name of the resource.
        :param FmgSystemNetworkInterfaceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgSystemNetworkInterfaceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgSystemNetworkInterfaceArgs.__new__(FmgSystemNetworkInterfaceArgs)
        ...
        super(FmgSystemNetworkInterface, __self__).__init__(
            'fortios:index/fmgSystemNetworkInterface:FmgSystemNetworkInterface',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            service_accesses: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            status: Optional[pulumi.Input[str]] = None) -> 'FmgSystemNetworkInterface':
        """
        ...
        __props__ = _FmgSystemNetworkInterfaceState.__new__(_FmgSystemNetworkInterfaceState)
        ...
        __props__.__dict__["service_accesses"] = service_accesses
        __props__.__dict__["status"] = status
        return FmgSystemNetworkInterface(resource_name, opts=opts, __props__=__props__)
