...
__all__ = [
    ...
    'get_system_objecttagging',
    'get_system_objecttagging_output',
]
...
def get_system_objecttagging(category: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_objecttagging)
def get_system_objecttagging_output(category: Optional[pulumi.Input[str]] = None,
