...
__all__ = [
    ...
    'get_firewall_proxyaddrgrp',
    'get_firewall_proxyaddrgrp_output',
]
...
def get_firewall_proxyaddrgrp(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_proxyaddrgrp)
def get_firewall_proxyaddrgrp_output(name: Optional[pulumi.Input[str]] = None,
