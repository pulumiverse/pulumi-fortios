...
class FirewallAddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallAddressMacaddrArgs']]] macaddrs: Multiple MAC address ranges. The structure of `macaddr` block is documented below.
...
class FirewallAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallAddressMacaddrArgs']]]] macaddrs: Multiple MAC address ranges. The structure of `macaddr` block is documented below.
        :param pulumi.Input[str] name: Address name.
        :param pulumi.Input[str] node_ip_only: Enable/disable collection of node addresses only in Kubernetes. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] obj_id: Object ID for NSX.
        :param pulumi.Input[str] obj_tag: Tag of dynamic address object.
    ...
    @property
    @pulumi.getter
    def lists(self) -> pulumi.Output[Sequence['outputs.FirewallAddressList']]:
        """
        IP address list. The structure of `list` block is documented below.
        """
        return pulumi.get(self, "lists")
