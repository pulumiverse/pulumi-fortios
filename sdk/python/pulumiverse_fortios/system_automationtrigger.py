...
class SystemAutomationtriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemAutomationtriggerVdomArgs']]] vdoms: Virtual domain(s) that this trigger is valid for. The structure of `vdom` block is documented below.
        """
...
class SystemAutomationtrigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] trigger_weekday: Day of week for trigger. Valid values: `sunday`, `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemAutomationtriggerVdomArgs']]]] vdoms: Virtual domain(s) that this trigger is valid for. The structure of `vdom` block is documented below.
        """
        ...
    @overload
    def __init__(__self__,
