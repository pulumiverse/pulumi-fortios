...
__all__ = [
    ...
    'get_router_accesslist',
    'get_router_accesslist_output',
]
...
def get_router_accesslist(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_accesslist)
def get_router_accesslist_output(name: Optional[pulumi.Input[str]] = None,
