...
__all__ = [
    ...
    'get_router_static6list',
    'get_router_static6list_output',
]
...
def get_router_static6list(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_static6list)
def get_router_static6list_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
