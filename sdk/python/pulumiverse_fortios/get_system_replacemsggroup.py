...
__all__ = [
    ...
    'get_system_replacemsggroup',
    'get_system_replacemsggroup_output',
]
...
def get_system_replacemsggroup(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_replacemsggroup)
def get_system_replacemsggroup_output(name: Optional[pulumi.Input[str]] = None,
