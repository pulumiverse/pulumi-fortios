...
__all__ = [
    ...
    'get_router_communitylist',
    'get_router_communitylist_output',
]
...
def get_router_communitylist(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_communitylist)
def get_router_communitylist_output(name: Optional[pulumi.Input[str]] = None,
