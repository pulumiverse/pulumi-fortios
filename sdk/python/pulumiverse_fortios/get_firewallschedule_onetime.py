...
__all__ = [
    ...
    'get_firewallschedule_onetime',
    'get_firewallschedule_onetime_output',
]
...
def get_firewallschedule_onetime(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallschedule_onetime)
def get_firewallschedule_onetime_output(name: Optional[pulumi.Input[str]] = None,
