...
@_utilities.lift_output_func(get_firewall_policy64)
def get_firewall_policy64_output(policyid: Optional[pulumi.Input[int]] = None,
                                 vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFirewallPolicy64Result]:
    """
    Use this data source to get information on an fortios firewall policy64
