...
__all__ = [
    ...
    'get_system_sessionhelper',
    'get_system_sessionhelper_output',
]
...
def get_system_sessionhelper(fosid: Optional[int] = None,
...
@_utilities.lift_output_func(get_system_sessionhelper)
def get_system_sessionhelper_output(fosid: Optional[pulumi.Input[int]] = None,
