...
class Group(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname1 = fortios.firewallservice.Custom("trname1",
            ...
            udp_idle_timer=0,
            visibility="enable")
        trname = fortios.firewallservice.Group("trname",
            color=0,
            proxy="disable",
            members=[fortios.firewallservice.GroupMemberArgs(
                name=trname1.name,
            )])
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Group, __self__).__init__(
            'fortios:firewallservice/group:Group',
            resource_name,
            __props__,
            opts)
