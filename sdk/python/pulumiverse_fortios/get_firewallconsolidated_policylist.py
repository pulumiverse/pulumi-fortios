...
__all__ = [
    ...
    'get_firewallconsolidated_policylist',
    'get_firewallconsolidated_policylist_output',
]
...
def get_firewallconsolidated_policylist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallconsolidated_policylist)
def get_firewallconsolidated_policylist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                               vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFirewallconsolidatedPolicylistResult]:
    """
    Provides a list of `FirewallconsolidatedPolicy`.
