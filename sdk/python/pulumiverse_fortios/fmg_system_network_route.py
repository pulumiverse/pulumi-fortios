...
__all__ = ['FmgSystemNetworkRouteArgs', 'FmgSystemNetworkRoute']

@pulumi.input_type
class FmgSystemNetworkRouteArgs:
...
@pulumi.input_type
class _FmgSystemNetworkRouteState:
    def __init__(__self__, *,
...
class FmgSystemNetworkRoute(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgSystemNetworkRoute("test1",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FmgSystemNetworkRouteArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports updating system network route for FortiManager.
        ...
        :param str resource_name: The name of the resource.
        :param FmgSystemNetworkRouteArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgSystemNetworkRouteArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgSystemNetworkRouteArgs.__new__(FmgSystemNetworkRouteArgs)
        ...
        super(FmgSystemNetworkRoute, __self__).__init__(
            'fortios:index/fmgSystemNetworkRoute:FmgSystemNetworkRoute',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            device: Optional[pulumi.Input[str]] = None,
            gateway: Optional[pulumi.Input[str]] = None,
            route_id: Optional[pulumi.Input[int]] = None) -> 'FmgSystemNetworkRoute':
        """
        ...
        __props__ = _FmgSystemNetworkRouteState.__new__(_FmgSystemNetworkRouteState)

        __props__.__dict__["destination"] = destination
        __props__.__dict__["device"] = device
        __props__.__dict__["gateway"] = gateway
        __props__.__dict__["route_id"] = route_id
        return FmgSystemNetworkRoute(resource_name, opts=opts, __props__=__props__)
