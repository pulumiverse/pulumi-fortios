...
__all__ = [
    ...
    'get_firewall_proxypolicy',
    'get_firewall_proxypolicy_output',
]
...
def get_firewall_proxypolicy(policyid: Optional[int] = None,
...
@_utilities.lift_output_func(get_firewall_proxypolicy)
def get_firewall_proxypolicy_output(policyid: Optional[pulumi.Input[int]] = None,
