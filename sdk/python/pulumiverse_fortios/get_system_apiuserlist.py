...
__all__ = [
    ...
    'get_system_apiuserlist',
    'get_system_apiuserlist_output',
]
...
def get_system_apiuserlist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_apiuserlist)
def get_system_apiuserlist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
