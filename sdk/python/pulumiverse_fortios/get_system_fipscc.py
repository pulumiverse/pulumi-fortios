...
def get_system_fipscc(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_fipscc)
def get_system_fipscc_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
