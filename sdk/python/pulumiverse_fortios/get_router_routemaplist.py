...
__all__ = [
    ...
    'get_router_routemaplist',
    'get_router_routemaplist_output',
]
...
def get_router_routemaplist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_routemaplist)
def get_router_routemaplist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                   vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRouterRoutemaplistResult]:
    """
    Provides a list of `RouterRoutemap`.
