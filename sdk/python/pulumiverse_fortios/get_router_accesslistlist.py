...
__all__ = [
    ...
    'get_router_accesslistlist',
    'get_router_accesslistlist_output',
]
...
def get_router_accesslistlist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_accesslistlist)
def get_router_accesslistlist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
