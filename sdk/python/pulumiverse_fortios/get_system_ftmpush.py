...
def get_system_ftmpush(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_ftmpush)
def get_system_ftmpush_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
