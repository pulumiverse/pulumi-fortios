...
__all__ = [
    ...
    'get_system_arptablelist',
    'get_system_arptablelist_output',
]
...
def get_system_arptablelist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_arptablelist)
def get_system_arptablelist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
