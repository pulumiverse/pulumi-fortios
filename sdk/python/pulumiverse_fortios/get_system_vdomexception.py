...
__all__ = [
    ...
    'get_system_vdomexception',
    'get_system_vdomexception_output',
]
...
def get_system_vdomexception(fosid: Optional[int] = None,
...
@_utilities.lift_output_func(get_system_vdomexception)
def get_system_vdomexception_output(fosid: Optional[pulumi.Input[int]] = None,
