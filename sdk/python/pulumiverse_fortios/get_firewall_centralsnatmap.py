...
__all__ = [
    ...
    'get_firewall_centralsnatmap',
    'get_firewall_centralsnatmap_output',
]
...
def get_firewall_centralsnatmap(policyid: Optional[int] = None,
...
@_utilities.lift_output_func(get_firewall_centralsnatmap)
def get_firewall_centralsnatmap_output(policyid: Optional[pulumi.Input[int]] = None,
