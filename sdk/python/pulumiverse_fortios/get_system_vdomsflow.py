...
__all__ = [
    ...
    'get_system_vdomsflow',
    'get_system_vdomsflow_output',
]
...
def get_system_vdomsflow(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_vdomsflow)
def get_system_vdomsflow_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
