...
def get_system_arptable(fosid: Optional[int] = None,
...
@_utilities.lift_output_func(get_system_arptable)
def get_system_arptable_output(fosid: Optional[pulumi.Input[int]] = None,
