...
class RouterBfd6Args:
    def __init__(__self__, *,
                 ...
                 multihop_templates: Optional[pulumi.Input[Sequence[pulumi.Input['RouterBfd6MultihopTemplateArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouterBfd6MultihopTemplateArgs']]] multihop_templates: BFD IPv6 multi-hop template table. The structure of `multihop_template` block is documented below.
    ...
    def multihop_templates(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RouterBfd6MultihopTemplateArgs']]]]:
        """
    ...
    def multihop_templates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RouterBfd6MultihopTemplateArgs']]]]):
...
class RouterBfd6(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dynamic_sort_subtable: Optional[pulumi.Input[str]] = None,
                 multihop_templates: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RouterBfd6MultihopTemplateArgs']]]]] = None,
        ...
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RouterBfd6MultihopTemplateArgs']]]] multihop_templates: BFD IPv6 multi-hop template table. The structure of `multihop_template` block is documented below.
    ...
    @property
    @pulumi.getter(name="multihopTemplates")
    def multihop_templates(self) -> pulumi.Output[Optional[Sequence['outputs.RouterBfd6MultihopTemplate']]]:
        """
        BFD IPv6 multi-hop template table. The structure of `multihop_template` block is documented below.
        """
        return pulumi.get(self, "multihop_templates")
