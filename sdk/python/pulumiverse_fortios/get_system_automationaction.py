...
__all__ = [
    ...
    'get_system_automationaction',
    'get_system_automationaction_output',
]
...
class GetSystemAutomationactionResult:
    ...
    def http_headers(self) -> Sequence['outputs.GetSystemAutomationactionHttpHeaderResult']:
        """
...
def get_system_automationaction(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_automationaction)
def get_system_automationaction_output(name: Optional[pulumi.Input[str]] = None,
