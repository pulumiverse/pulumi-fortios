...
class GetSystemHaResult:
    ...
    def secondary_vclusters(self) -> Sequence['outputs.GetSystemHaSecondaryVclusterResult']:
        """
    ...
    @property
    @pulumi.getter
    def vclusters(self) -> Sequence['outputs.GetSystemHaVclusterResult']:
        """
...
def get_system_ha(vdomparam: Optional[str] = None,
    ...
    return AwaitableGetSystemHaResult(
        ...
        secondary_vclusters=__ret__.secondary_vclusters,
        ...
        vcluster_status=__ret__.vcluster_status,
        vclusters=__ret__.vclusters,
        vdom=__ret__.vdom,
