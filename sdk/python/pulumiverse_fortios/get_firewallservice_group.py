...
__all__ = [
    ...
    'get_firewallservice_group',
    'get_firewallservice_group_output',
]
...
def get_firewallservice_group(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallservice_group)
def get_firewallservice_group_output(name: Optional[pulumi.Input[str]] = None,
