...
class SwitchcontrollerFlowtrackingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SwitchcontrollerFlowtrackingCollectorArgs']]] collectors: Configure collectors for the flow. The structure of `collectors` block is documented below.
...
class SwitchcontrollerFlowtracking(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] collector_ip: Configure collector ip address.
        :param pulumi.Input[int] collector_port: Configure collector port number(0-65535, default=0).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchcontrollerFlowtrackingCollectorArgs']]]] collectors: Configure collectors for the flow. The structure of `collectors` block is documented below.
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[str] format: Configure flow tracking protocol. Valid values: `netflow1`, `netflow5`, `netflow9`, `ipfix`.
        :param pulumi.Input[str] level: Configure flow tracking level. Valid values: `vlan`, `ip`, `port`, `proto`, `mac`.
        :param pulumi.Input[int] max_export_pkt_size: Configure flow max export packet size (512-9216, default=512 bytes).
