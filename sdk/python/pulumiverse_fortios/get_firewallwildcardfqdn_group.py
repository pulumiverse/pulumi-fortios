...
__all__ = [
    ...
    'get_firewallwildcardfqdn_group',
    'get_firewallwildcardfqdn_group_output',
]
...
def get_firewallwildcardfqdn_group(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallwildcardfqdn_group)
def get_firewallwildcardfqdn_group_output(name: Optional[pulumi.Input[str]] = None,
