...
class SystemIpamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemIpamPoolArgs']]] pools: Configure IPAM pools. The structure of `pools` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['SystemIpamRuleArgs']]] rules: Configure IPAM allocation rules. The structure of `rules` block is documented below.
...
class SystemIpam(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[str] pool_subnet: Configure IPAM pool subnet, Class A - Class B subnet.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemIpamPoolArgs']]]] pools: Configure IPAM pools. The structure of `pools` block is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemIpamRuleArgs']]]] rules: Configure IPAM allocation rules. The structure of `rules` block is documented below.
        :param pulumi.Input[str] server_type: Configure the type of IPAM server to use. Valid values: `cloud`, `fabric-root`.
        :param pulumi.Input[str] status: Enable/disable IP address management services. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        """
