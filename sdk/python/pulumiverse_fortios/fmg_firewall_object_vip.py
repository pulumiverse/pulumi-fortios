...
__all__ = ['FmgFirewallObjectVipArgs', 'FmgFirewallObjectVip']

@pulumi.input_type
class FmgFirewallObjectVipArgs:
...
@pulumi.input_type
class _FmgFirewallObjectVipState:
    def __init__(__self__, *,
                 adom: Optional[pulumi.Input[str]] = None,
                 arp_reply: Optional[pulumi.Input[str]] = None,
                 comment: Optional[pulumi.Input[str]] = None,
...
class FmgFirewallObjectVip(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgFirewallObjectVip("test1",
            arp_reply="enable",
            ...
            mapped_ip="1.1.1.1",
            type="static-nat")
        test2 = fortios.FmgFirewallObjectVip("test2",
            arp_reply="disable",
            comment="test obj vip",
            config_default="enable",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FmgFirewallObjectVipArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports Create/Read/Update/Delete firewall object virtual ip for FortiManager.
        ...
        :param str resource_name: The name of the resource.
        :param FmgFirewallObjectVipArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgFirewallObjectVipArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgFirewallObjectVipArgs.__new__(FmgFirewallObjectVipArgs)
        ...
        super(FmgFirewallObjectVip, __self__).__init__(
            'fortios:index/fmgFirewallObjectVip:FmgFirewallObjectVip',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            mapped_ip: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'FmgFirewallObjectVip':
        """
        ...
        __props__ = _FmgFirewallObjectVipState.__new__(_FmgFirewallObjectVipState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["type"] = type
        return FmgFirewallObjectVip(resource_name, opts=opts, __props__=__props__)
