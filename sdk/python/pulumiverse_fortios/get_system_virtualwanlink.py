...
__all__ = [
    ...
    'get_system_virtualwanlink',
    'get_system_virtualwanlink_output',
]
...
def get_system_virtualwanlink(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_virtualwanlink)
def get_system_virtualwanlink_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
