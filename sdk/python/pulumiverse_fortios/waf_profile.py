...
class WafProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['WafProfileMethodArgs'] method: Method restriction. The structure of `method` block is documented below.
...
class WafProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] extended_log: Enable/disable extended logging. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] external: Disable/Enable external HTTP Inspection. Valid values: `disable`, `enable`.
        :param pulumi.Input[pulumi.InputType['WafProfileMethodArgs']] method: Method restriction. The structure of `method` block is documented below.
        :param pulumi.Input[str] name: WAF Profile name.
