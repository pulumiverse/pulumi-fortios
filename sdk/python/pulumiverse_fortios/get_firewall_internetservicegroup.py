...
__all__ = [
    ...
    'get_firewall_internetservicegroup',
    'get_firewall_internetservicegroup_output',
]
...
def get_firewall_internetservicegroup(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_internetservicegroup)
def get_firewall_internetservicegroup_output(name: Optional[pulumi.Input[str]] = None,
