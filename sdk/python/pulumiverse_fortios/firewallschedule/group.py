...
class Group(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname1 = fortios.firewallschedule.Recurring("trname1",
            color=0,
            day="sunday",
            end="00:00",
            start="00:00")
        trname = fortios.firewallschedule.Group("trname",
            color=0,
            members=[fortios.firewallschedule.GroupMemberArgs(
                name=trname1.name,
            )])
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Group, __self__).__init__(
            'fortios:firewallschedule/group:Group',
            resource_name,
            __props__,
            opts)
