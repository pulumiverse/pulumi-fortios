...
@_utilities.lift_output_func(get_router_ospf)
def get_router_ospf_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRouterOspfResult]:
    """
    Use this data source to get information on fortios router ospf
