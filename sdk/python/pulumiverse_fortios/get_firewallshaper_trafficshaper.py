...
__all__ = [
    ...
    'get_firewallshaper_trafficshaper',
    'get_firewallshaper_trafficshaper_output',
]
...
def get_firewallshaper_trafficshaper(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallshaper_trafficshaper)
def get_firewallshaper_trafficshaper_output(name: Optional[pulumi.Input[str]] = None,
                                            vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFirewallshaperTrafficshaperResult]:
    """
    Use this data source to get information on an fortios firewallshaper trafficshaper
