...
class DlpProfileArgs:
    def __init__(__self__, *,
                 ...
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['DlpProfileRuleArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DlpProfileRuleArgs']]] rules: Set up DLP rules for this profile. The structure of `rule` block is documented below.
    ...
    @property
    @pulumi.getter
    def rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DlpProfileRuleArgs']]]]:
        """
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DlpProfileRuleArgs']]]]):
...
class DlpProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 replacemsg_group: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DlpProfileRuleArgs']]]]] = None,
                 summary_proto: Optional[pulumi.Input[str]] = None,
                 vdomparam: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] name: Name of the DLP profile.
        :param pulumi.Input[str] replacemsg_group: Replacement message group used by this DLP profile.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DlpProfileRuleArgs']]]] rules: Set up DLP rules for this profile. The structure of `rule` block is documented below.
        :param pulumi.Input[str] summary_proto: Protocols to always log summary. Valid values: `smtp`, `pop3`, `imap`, `http-get`, `http-post`, `ftp`, `nntp`, `mapi`, `ssh`, `cifs`.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DlpProfileArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Configure DLP profiles. Applies to FortiOS Version `>= 7.2.0`.
    ...
    def _internal_init(__self__,
        ...
        super(DlpProfile, __self__).__init__(
            'fortios:index/dlpProfile:DlpProfile',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DlpProfileRuleArgs']]]]] = None,
            summary_proto: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'DlpProfile':
        """
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Optional[Sequence['outputs.DlpProfileRule']]]:
        """
        Set up DLP rules for this profile. The structure of `rule` block is documented below.
        """
        return pulumi.get(self, "rules")
