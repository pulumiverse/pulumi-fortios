...
__all__ = [
    ...
    'get_firewallservice_category',
    'get_firewallservice_category_output',
]
...
def get_firewallservice_category(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallservice_category)
def get_firewallservice_category_output(name: Optional[pulumi.Input[str]] = None,
                                        vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFirewallserviceCategoryResult]:
    """
    Use this data source to get information on an fortios firewallservice category
