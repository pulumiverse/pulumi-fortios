...
__all__ = [
    ...
    'get_firewall_internetservicedefinition',
    'get_firewall_internetservicedefinition_output',
]
...
def get_firewall_internetservicedefinition(fosid: Optional[int] = None,
...
@_utilities.lift_output_func(get_firewall_internetservicedefinition)
def get_firewall_internetservicedefinition_output(fosid: Optional[pulumi.Input[int]] = None,
