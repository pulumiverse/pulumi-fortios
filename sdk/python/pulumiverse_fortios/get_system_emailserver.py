...
__all__ = [
    ...
    'get_system_emailserver',
    'get_system_emailserver_output',
]
...
def get_system_emailserver(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_emailserver)
def get_system_emailserver_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
