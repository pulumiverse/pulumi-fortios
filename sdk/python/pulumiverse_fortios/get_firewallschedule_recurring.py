...
__all__ = [
    ...
    'get_firewallschedule_recurring',
    'get_firewallschedule_recurring_output',
]
...
def get_firewallschedule_recurring(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallschedule_recurring)
def get_firewallschedule_recurring_output(name: Optional[pulumi.Input[str]] = None,
