...
class OverridefilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] filter: Syslog 2 filter.
...
class Overridefilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.logsyslogd2.Overridefilter("trname",
            anomaly="enable",
            dns="enable",
            filter_type="include",
        ...
        ```sh
         $ pulumi import fortios:logsyslogd2/overridefilter:Overridefilter labelname LogSyslogd2OverrideFilter
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Overridefilter, __self__).__init__(
            'fortios:logsyslogd2/overridefilter:Overridefilter',
            resource_name,
            __props__,
            opts)
