...
class Setting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.logsyslogd2.Setting("trname",
        ...
        ```sh
         $ pulumi import fortios:logsyslogd2/setting:Setting labelname LogSyslogd2Setting
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Setting, __self__).__init__(
            'fortios:logsyslogd2/setting:Setting',
            resource_name,
            __props__,
            opts)
