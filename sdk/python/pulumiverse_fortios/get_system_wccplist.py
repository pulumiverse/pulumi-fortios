...
def get_system_wccplist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_wccplist)
def get_system_wccplist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
