...
__all__ = ['FmgSystemAdminProfilesArgs', 'FmgSystemAdminProfiles']

@pulumi.input_type
class FmgSystemAdminProfilesArgs:
...
@pulumi.input_type
class _FmgSystemAdminProfilesState:
    def __init__(__self__, *,
                 adom_policy_packages: Optional[pulumi.Input[str]] = None,
                 adom_switch: Optional[pulumi.Input[str]] = None,
                 assignment: Optional[pulumi.Input[str]] = None,
...
class FmgSystemAdminProfiles(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgSystemAdminProfiles("test1",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FmgSystemAdminProfilesArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports Create/Read/Update/Delete admin profiles for FortiManager
        ...
        :param str resource_name: The name of the resource.
        :param FmgSystemAdminProfilesArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgSystemAdminProfilesArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgSystemAdminProfilesArgs.__new__(FmgSystemAdminProfilesArgs)
        ...
        super(FmgSystemAdminProfiles, __self__).__init__(
            'fortios:index/fmgSystemAdminProfiles:FmgSystemAdminProfiles',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            system_setting: Optional[pulumi.Input[str]] = None,
            terminal_access: Optional[pulumi.Input[str]] = None,
            vpn_manager: Optional[pulumi.Input[str]] = None) -> 'FmgSystemAdminProfiles':
        """
        ...
        __props__ = _FmgSystemAdminProfilesState.__new__(_FmgSystemAdminProfilesState)
        ...
        __props__.__dict__["terminal_access"] = terminal_access
        __props__.__dict__["vpn_manager"] = vpn_manager
        return FmgSystemAdminProfiles(resource_name, opts=opts, __props__=__props__)
