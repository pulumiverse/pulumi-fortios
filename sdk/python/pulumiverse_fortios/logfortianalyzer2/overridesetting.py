...
class OverridesettingArgs:
    def __init__(__self__, *,
                 ...
                 serials: Optional[pulumi.Input[Sequence[pulumi.Input['OverridesettingSerialArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OverridesettingSerialArgs']]] serials: Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
    ...
    @property
    @pulumi.getter
    def serials(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OverridesettingSerialArgs']]]]:
        """
    ...
    @serials.setter
    def serials(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OverridesettingSerialArgs']]]]):
...
class Overridesetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 priority: Optional[pulumi.Input[str]] = None,
                 reliable: Optional[pulumi.Input[str]] = None,
                 serials: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OverridesettingSerialArgs']]]]] = None,
                 server: Optional[pulumi.Input[str]] = None,
                 source_ip: Optional[pulumi.Input[str]] = None,
                 ssl_min_proto_version: Optional[pulumi.Input[str]] = None,
                 status: Optional[pulumi.Input[str]] = None,
        ...
        trname = fortios.logfortianalyzer2.Overridesetting("trname",
            __change_ip=0,
            conn_timeout=10,
            enc_algorithm="high",
            faz_type=5,
        ...
        :param pulumi.Input[str] priority: Set log transmission priority. Valid values: `default`, `low`.
        :param pulumi.Input[str] reliable: Enable/disable reliable logging to FortiAnalyzer. Valid values: `enable`, `disable`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OverridesettingSerialArgs']]]] serials: Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
        :param pulumi.Input[str] server: The remote FortiAnalyzer.
        :param pulumi.Input[str] source_ip: Source IPv4 or IPv6 address used to communicate with FortiAnalyzer.
        :param pulumi.Input[str] ssl_min_proto_version: Minimum supported protocol version for SSL/TLS connections (default is to follow system global setting).
        :param pulumi.Input[str] status: Enable/disable logging to FortiAnalyzer. Valid values: `enable`, `disable`.
    ...
    def _internal_init(__self__,
        ...
        super(Overridesetting, __self__).__init__(
            'fortios:logfortianalyzer2/overridesetting:Overridesetting',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def serials(self) -> pulumi.Output[Optional[Sequence['outputs.OverridesettingSerial']]]:
        """
        Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
        """
        return pulumi.get(self, "serials")
