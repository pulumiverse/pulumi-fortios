...
class OverridefilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] filter: FortiAnalyzer 2 log filter.
...
class Overridefilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.logfortianalyzer2.Overridefilter("trname",
            anomaly="enable",
            dlp_archive="enable",
            dns="enable",
            filter_type="include",
        ...
        ```sh
         $ pulumi import fortios:logfortianalyzer2/overridefilter:Overridefilter labelname LogFortianalyzer2OverrideFilter
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Overridefilter, __self__).__init__(
            'fortios:logfortianalyzer2/overridefilter:Overridefilter',
            resource_name,
            __props__,
            opts)
