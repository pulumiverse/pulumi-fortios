...
__all__ = [
    ...
    'get_systemsnmp_sysinfo',
    'get_systemsnmp_sysinfo_output',
]
...
def get_systemsnmp_sysinfo(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_systemsnmp_sysinfo)
def get_systemsnmp_sysinfo_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
