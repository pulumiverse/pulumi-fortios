...
__all__ = [
    ...
    'get_firewall_proxyaddress',
    'get_firewall_proxyaddress_output',
]
...
def get_firewall_proxyaddress(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_proxyaddress)
def get_firewall_proxyaddress_output(name: Optional[pulumi.Input[str]] = None,
