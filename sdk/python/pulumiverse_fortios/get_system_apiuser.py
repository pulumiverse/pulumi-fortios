...
def get_system_apiuser(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_apiuser)
def get_system_apiuser_output(name: Optional[pulumi.Input[str]] = None,
                              vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemApiuserResult]:
    """
    Use this data source to get information on an fortios system apiuser
