...
__all__ = [
    ...
    'get_system_passwordpolicy',
    'get_system_passwordpolicy_output',
]
...
def get_system_passwordpolicy(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_passwordpolicy)
def get_system_passwordpolicy_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
