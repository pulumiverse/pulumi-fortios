...
__all__ = ['FmgJsonrpcRequestArgs', 'FmgJsonrpcRequest']

@pulumi.input_type
class FmgJsonrpcRequestArgs:
...
class FmgJsonrpcRequest(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FmgJsonrpcRequest("test1", json_content=\"\"\"{
          "method": "add",
          "params": [
            {
              "data": [
        ...
        \"\"\")
        test2 = fortios.FmgJsonrpcRequest("test2", json_content=\"\"\"{
          "method": "add",
          "params": [
            {
              "data": [
        ...
        \"\"\")
        test3 = fortios.FmgJsonrpcRequest("test3", json_content=\"\"\"{
          "method": "get",
          "params": [
            {
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FmgJsonrpcRequestArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FmgJsonrpcRequestArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FmgJsonrpcRequestArgs.__new__(FmgJsonrpcRequestArgs)
        ...
        super(FmgJsonrpcRequest, __self__).__init__(
            'fortios:index/fmgJsonrpcRequest:FmgJsonrpcRequest',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            comment: Optional[pulumi.Input[str]] = None,
            json_content: Optional[pulumi.Input[str]] = None,
            response: Optional[pulumi.Input[str]] = None) -> 'FmgJsonrpcRequest':
        """
        ...
        __props__ = _FmgJsonrpcRequestState.__new__(_FmgJsonrpcRequestState)

        __props__.__dict__["comment"] = comment
        __props__.__dict__["json_content"] = json_content
        __props__.__dict__["response"] = response
        return FmgJsonrpcRequest(resource_name, opts=opts, __props__=__props__)
