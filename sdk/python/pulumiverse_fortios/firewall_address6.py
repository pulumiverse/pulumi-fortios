...
class FirewallAddress6Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallAddress6MacaddrArgs']]] macaddrs: Multiple MAC address ranges. The structure of `macaddr` block is documented below.
...
class FirewallAddress6(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallAddress6MacaddrArgs']]]] macaddrs: Multiple MAC address ranges. The structure of `macaddr` block is documented below.
        :param pulumi.Input[str] name: Address name.
        :param pulumi.Input[str] obj_id: Object ID for NSX.
        :param pulumi.Input[str] sdn: SDN.
        :param pulumi.Input[str] sdn_tag: SDN Tag.
