...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.dnsfilter.Profile("trname",
            block_action="redirect",
            block_botnet="disable",
            domain_filter=fortios.dnsfilter.ProfileDomainFilterArgs(
                domain_filter_table=0,
            ),
            ftgd_dns=fortios.dnsfilter.ProfileFtgdDnsArgs(
                filters=[
                    fortios.dnsfilter.ProfileFtgdDnsFilterArgs(
                        action="block",
                        category=26,
                        id=1,
                        log="enable",
    ...
    def _internal_init(__self__,
        ...
        super(Profile, __self__).__init__(
            'fortios:dnsfilter/profile:Profile',
            resource_name,
            __props__,
            opts)
