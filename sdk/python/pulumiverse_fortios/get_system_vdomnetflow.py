...
__all__ = [
    ...
    'get_system_vdomnetflow',
    'get_system_vdomnetflow_output',
]
...
def get_system_vdomnetflow(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_vdomnetflow)
def get_system_vdomnetflow_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
