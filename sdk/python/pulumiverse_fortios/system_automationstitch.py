...
class SystemAutomationstitchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemAutomationstitchActionArgs']]] action: Action names. The structure of `action` block is documented below.
...
class SystemAutomationstitch(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemAutomationstitchActionArgs']]]] action: Action names. The structure of `action` block is documented below.
