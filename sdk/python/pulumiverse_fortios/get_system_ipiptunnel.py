...
__all__ = [
    ...
    'get_system_ipiptunnel',
    'get_system_ipiptunnel_output',
]
...
def get_system_ipiptunnel(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_ipiptunnel)
def get_system_ipiptunnel_output(name: Optional[pulumi.Input[str]] = None,
