...
__all__ = [
    ...
    'get_system_externalresourcelist',
    'get_system_externalresourcelist_output',
]
...
def get_system_externalresourcelist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_externalresourcelist)
def get_system_externalresourcelist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
