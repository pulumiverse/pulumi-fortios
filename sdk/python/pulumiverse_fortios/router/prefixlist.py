...
class PrefixlistArgs:
    def __init__(__self__, *,
                 ...
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['PrefixlistRuleArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PrefixlistRuleArgs']]] rules: IPv4 prefix list rule. The structure of `rule` block is documented below.
    ...
    @property
    @pulumi.getter
    def rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['PrefixlistRuleArgs']]]]:
        """
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['PrefixlistRuleArgs']]]]):
...
class Prefixlist(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 get_all_tables: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PrefixlistRuleArgs']]]]] = None,
                 vdomparam: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] get_all_tables: Get all sub-tables including unconfigured tables. Do not set this variable to true if you configure sub-table in another resource, otherwish conflicts and overwrite will occur. Options: [ false, true ]. false: Default value, do not get unconfigured tables; true: get all tables including unconfigured tables.
        :param pulumi.Input[str] name: Name.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PrefixlistRuleArgs']]]] rules: IPv4 prefix list rule. The structure of `rule` block is documented below.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PrefixlistRuleArgs']]]]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'Prefixlist':
        """
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Optional[Sequence['outputs.PrefixlistRule']]]:
        """
        IPv4 prefix list rule. The structure of `rule` block is documented below.
        """
        return pulumi.get(self, "rules")
