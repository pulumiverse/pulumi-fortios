...
class StaticArgs:
    ...
    def sdwan_zones(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['StaticSdwanZoneArgs']]]]:
        """
    ...
    @sdwan_zones.setter
    def sdwan_zones(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['StaticSdwanZoneArgs']]]]):
...
class Static(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_wan_link: Optional[pulumi.Input[str]] = None,
            vrf: Optional[pulumi.Input[int]] = None,
            weight: Optional[pulumi.Input[int]] = None) -> 'Static':
        """
    ...
    @property
    @pulumi.getter(name="sdwanZones")
    def sdwan_zones(self) -> pulumi.Output[Optional[Sequence['outputs.StaticSdwanZone']]]:
        """
        Choose SD-WAN Zone. The structure of `sdwan_zone` block is documented below.
        """
        return pulumi.get(self, "sdwan_zones")
