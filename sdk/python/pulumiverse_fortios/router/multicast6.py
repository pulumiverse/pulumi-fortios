...
__all__ = ['Multicast6Args', 'Multicast6']

@pulumi.input_type
class Multicast6Args:
    def __init__(__self__, *,
                 dynamic_sort_subtable: Optional[pulumi.Input[str]] = None,
                 get_all_tables: Optional[pulumi.Input[str]] = None,
                 interfaces: Optional[pulumi.Input[Sequence[pulumi.Input['Multicast6InterfaceArgs']]]] = None,
                 multicast_pmtu: Optional[pulumi.Input[str]] = None,
                 multicast_routing: Optional[pulumi.Input[str]] = None,
                 pim_sm_global: Optional[pulumi.Input['Multicast6PimSmGlobalArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['Multicast6InterfaceArgs']]] interfaces: Protocol Independent Multicast (PIM) interfaces. The structure of `interface` block is documented below.
        ...
        :param pulumi.Input['Multicast6PimSmGlobalArgs'] pim_sm_global: PIM sparse-mode global settings. The structure of `pim_sm_global` block is documented below.
    ...
    @property
    @pulumi.getter
    def interfaces(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['Multicast6InterfaceArgs']]]]:
        """
    ...
    @interfaces.setter
    def interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['Multicast6InterfaceArgs']]]]):
    ...
    def pim_sm_global(self) -> Optional[pulumi.Input['Multicast6PimSmGlobalArgs']]:
        """
    ...
    def pim_sm_global(self, value: Optional[pulumi.Input['Multicast6PimSmGlobalArgs']]):
...
class Multicast6(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 dynamic_sort_subtable: Optional[pulumi.Input[str]] = None,
                 get_all_tables: Optional[pulumi.Input[str]] = None,
                 interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Multicast6InterfaceArgs']]]]] = None,
                 multicast_pmtu: Optional[pulumi.Input[str]] = None,
                 multicast_routing: Optional[pulumi.Input[str]] = None,
                 pim_sm_global: Optional[pulumi.Input[pulumi.InputType['Multicast6PimSmGlobalArgs']]] = None,
                 vdomparam: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[str] get_all_tables: Get all sub-tables including unconfigured tables. Do not set this variable to true if you configure sub-table in another resource, otherwish conflicts and overwrite will occur. Options: [ false, true ]. false: Default value, do not get unconfigured tables; true: get all tables including unconfigured tables.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Multicast6InterfaceArgs']]]] interfaces: Protocol Independent Multicast (PIM) interfaces. The structure of `interface` block is documented below.
        :param pulumi.Input[str] multicast_pmtu: Enable/disable PMTU for IPv6 multicast. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] multicast_routing: Enable/disable IPv6 multicast routing. Valid values: `enable`, `disable`.
        :param pulumi.Input[pulumi.InputType['Multicast6PimSmGlobalArgs']] pim_sm_global: PIM sparse-mode global settings. The structure of `pim_sm_global` block is documented below.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Multicast6Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Multicast6Args.__new__(Multicast6Args)
        ...
        super(Multicast6, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            multicast_routing: Optional[pulumi.Input[str]] = None,
            pim_sm_global: Optional[pulumi.Input[pulumi.InputType['Multicast6PimSmGlobalArgs']]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'Multicast6':
        """
        ...
        __props__ = _Multicast6State.__new__(_Multicast6State)
        ...
        __props__.__dict__["pim_sm_global"] = pim_sm_global
        __props__.__dict__["vdomparam"] = vdomparam
        return Multicast6(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def interfaces(self) -> pulumi.Output[Optional[Sequence['outputs.Multicast6Interface']]]:
        """
        Protocol Independent Multicast (PIM) interfaces. The structure of `interface` block is documented below.
        """
        return pulumi.get(self, "interfaces")
    ...
    @property
    @pulumi.getter(name="pimSmGlobal")
    def pim_sm_global(self) -> pulumi.Output['outputs.Multicast6PimSmGlobal']:
        """
        PIM sparse-mode global settings. The structure of `pim_sm_global` block is documented below.
        """
        return pulumi.get(self, "pim_sm_global")
