...
class GetAccesslistResult:
    ...
    @property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetAccesslistRuleResult']:
        """
...
def get_accesslist(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('fortios:router/getAccesslist:getAccesslist', __args__, opts=opts, typ=GetAccesslistResult).value
...
@_utilities.lift_output_func(get_accesslist)
