...
__all__ = [
    ...
    'get_system_sdnconnector',
    'get_system_sdnconnector_output',
]
...
def get_system_sdnconnector(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_sdnconnector)
def get_system_sdnconnector_output(name: Optional[pulumi.Input[str]] = None,
