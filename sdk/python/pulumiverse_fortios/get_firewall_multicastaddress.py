...
__all__ = [
    ...
    'get_firewall_multicastaddress',
    'get_firewall_multicastaddress_output',
]
...
def get_firewall_multicastaddress(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewall_multicastaddress)
def get_firewall_multicastaddress_output(name: Optional[pulumi.Input[str]] = None,
