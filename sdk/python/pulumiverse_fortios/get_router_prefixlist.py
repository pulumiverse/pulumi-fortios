...
__all__ = [
    ...
    'get_router_prefixlist',
    'get_router_prefixlist_output',
]
...
def get_router_prefixlist(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_prefixlist)
def get_router_prefixlist_output(name: Optional[pulumi.Input[str]] = None,
