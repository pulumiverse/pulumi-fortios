...
__all__ = [
    ...
    'get_system_fssopolling',
    'get_system_fssopolling_output',
]
...
def get_system_fssopolling(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_fssopolling)
def get_system_fssopolling_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
