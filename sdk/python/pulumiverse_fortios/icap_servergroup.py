...
class IcapServergroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IcapServergroupServerListArgs']]] server_lists: Add ICAP servers to a list to form a server group. Optionally assign weights to each server. The structure of `server_list` block is documented below.
...
class IcapServergroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] ldb_method: Load balance method. Valid values: `weighted`, `least-session`, `active-passive`.
        :param pulumi.Input[str] name: Configure an ICAP server group consisting one or multiple forward servers. Supports failover and load balancing.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IcapServergroupServerListArgs']]]] server_lists: Add ICAP servers to a list to form a server group. Optionally assign weights to each server. The structure of `server_list` block is documented below.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        """
        ...
    @overload
