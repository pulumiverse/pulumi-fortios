...
class SystemsnmpCommunityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemsnmpCommunityVdomArgs']]] vdoms: SNMP access control VDOMs. The structure of `vdoms` block is documented below.
        """
...
class SystemsnmpCommunity(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] trap_v2c_status: Enable/disable SNMP v2c traps. Valid values: `enable`, `disable`.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemsnmpCommunityVdomArgs']]]] vdoms: SNMP access control VDOMs. The structure of `vdoms` block is documented below.
        """
        ...
    @overload
    def __init__(__self__,
