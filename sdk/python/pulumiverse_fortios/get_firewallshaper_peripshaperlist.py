...
__all__ = [
    ...
    'get_firewallshaper_peripshaperlist',
    'get_firewallshaper_peripshaperlist_output',
]
...
def get_firewallshaper_peripshaperlist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallshaper_peripshaperlist)
def get_firewallshaper_peripshaperlist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
