...
class FirewallVip46Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallVip46MonitorArgs']]] monitors: Health monitors. The structure of `monitor` block is documented below.
...
class FirewallVip46(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] mappedip: Start-mapped-IP [-end mapped-IP].
        :param pulumi.Input[str] mappedport: Mapped service port.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallVip46MonitorArgs']]]] monitors: Health monitors. The structure of `monitor` block is documented below.
        :param pulumi.Input[str] name: VIP46 name.
        :param pulumi.Input[str] portforward: Enable port forwarding. Valid values: `disable`, `enable`.
        :param pulumi.Input[str] protocol: Mapped port protocol. Valid values: `tcp`, `udp`.
