...
class WebproxyForwardservergroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname1_webproxy_forwardserver = fortios.WebproxyForwardserver("trname1WebproxyForwardserver",
            addr_type="fqdn",
            healthcheck="disable",
            ip="0.0.0.0",
        ...
        trname1_webproxy_forwardservergroup = fortios.WebproxyForwardservergroup("trname1WebproxyForwardservergroup",
            affinity="disable",
            group_down_option="block",
            ldb_method="weighted",
            server_lists=[fortios.WebproxyForwardservergroupServerListArgs(
                name=trname1_webproxy_forwardserver.name,
                weight=12,
            )])
        ```
