...
class SystemSdnconnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SystemSdnconnectorRouteArgs']]] routes: Configure GCP route. The structure of `route` block is documented below.
...
class SystemSdnconnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SystemSdnconnectorRouteArgs']]]] routes: Configure GCP route. The structure of `route` block is documented below.
        :param pulumi.Input[str] secret_key: AWS secret access key.
        :param pulumi.Input[str] secret_token: Secret token of Kubernetes service account.
        :param pulumi.Input[str] server: Server address of the remote SDN connector.
