...
__all__ = [
    ...
    'get_system_ipv6neighborcachelist',
    'get_system_ipv6neighborcachelist_output',
]
...
def get_system_ipv6neighborcachelist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_ipv6neighborcachelist)
def get_system_ipv6neighborcachelist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
