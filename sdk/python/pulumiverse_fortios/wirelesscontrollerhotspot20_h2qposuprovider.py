...
class Wirelesscontrollerhotspot20H2qposuproviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['Wirelesscontrollerhotspot20H2qposuproviderFriendlyNameArgs']]] friendly_names: OSU provider friendly name. The structure of `friendly_name` block is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['Wirelesscontrollerhotspot20H2qposuproviderServiceDescriptionArgs']]] service_descriptions: OSU service name. The structure of `service_description` block is documented below.
...
class Wirelesscontrollerhotspot20H2qposuprovider(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] dynamic_sort_subtable: Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Wirelesscontrollerhotspot20H2qposuproviderFriendlyNameArgs']]]] friendly_names: OSU provider friendly name. The structure of `friendly_name` block is documented below.
        :param pulumi.Input[str] icon: OSU provider icon.
        :param pulumi.Input[str] name: OSU provider ID.
        :param pulumi.Input[str] osu_method: OSU method list. Valid values: `oma-dm`, `soap-xml-spp`, `reserved`.
        :param pulumi.Input[str] osu_nai: OSU NAI.
        :param pulumi.Input[str] server_uri: Server URI.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Wirelesscontrollerhotspot20H2qposuproviderServiceDescriptionArgs']]]] service_descriptions: OSU service name. The structure of `service_description` block is documented below.
        :param pulumi.Input[str] vdomparam: Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        """
        ...
    @overload
