...
def get_router_routemap(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_routemap)
def get_router_routemap_output(name: Optional[pulumi.Input[str]] = None,
