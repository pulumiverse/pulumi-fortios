...
__all__ = [
    ...
    'get_systemautoupdate_schedule',
    'get_systemautoupdate_schedule_output',
]
...
def get_systemautoupdate_schedule(vdomparam: Optional[str] = None,
...
@_utilities.lift_output_func(get_systemautoupdate_schedule)
def get_systemautoupdate_schedule_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
