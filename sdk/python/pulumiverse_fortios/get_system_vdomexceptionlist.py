...
__all__ = [
    ...
    'get_system_vdomexceptionlist',
    'get_system_vdomexceptionlist_output',
]
...
def get_system_vdomexceptionlist(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_vdomexceptionlist)
def get_system_vdomexceptionlist_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                        vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemVdomexceptionlistResult]:
    """
    Provides a list of `SystemVdomexception`.
