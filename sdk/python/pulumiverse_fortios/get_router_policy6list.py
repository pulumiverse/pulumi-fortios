...
__all__ = [
    ...
    'get_router_policy6list',
    'get_router_policy6list_output',
]
...
def get_router_policy6list(filter: Optional[str] = None,
...
@_utilities.lift_output_func(get_router_policy6list)
def get_router_policy6list_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
