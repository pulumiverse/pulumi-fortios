...
class Setting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trname = fortios.logfortianalyzer3.Setting("trname",
            __change_ip=0,
            conn_timeout=10,
            enc_algorithm="high",
            faz_type=3,
        ...
        ```sh
         $ pulumi import fortios:logfortianalyzer3/setting:Setting labelname LogFortianalyzer3Setting
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Setting, __self__).__init__(
            'fortios:logfortianalyzer3/setting:Setting',
            resource_name,
            __props__,
            opts)
