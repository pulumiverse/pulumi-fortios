...
__all__ = [
    ...
    'get_firewallwildcardfqdn_custom',
    'get_firewallwildcardfqdn_custom_output',
]
...
def get_firewallwildcardfqdn_custom(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_firewallwildcardfqdn_custom)
def get_firewallwildcardfqdn_custom_output(name: Optional[pulumi.Input[str]] = None,
