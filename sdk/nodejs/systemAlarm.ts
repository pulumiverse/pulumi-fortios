 ...
 */
export class SystemAlarm extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemAlarmState, opts?: pulumi.CustomResourceOptions): SystemAlarm {
        return new SystemAlarm(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/systemAlarm:SystemAlarm';

    /**
     * Returns true if the given object is an instance of SystemAlarm.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemAlarm {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemAlarm.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: SystemAlarmArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemAlarmArgs | SystemAlarmState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemAlarm.__pulumiType, name, resourceInputs, opts);
    }
}
