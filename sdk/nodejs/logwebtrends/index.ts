...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:logwebtrends/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:logwebtrends/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "logwebtrends/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "logwebtrends/setting", _module)
