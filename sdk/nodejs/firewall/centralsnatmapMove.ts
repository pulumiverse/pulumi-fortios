...
export class CentralsnatmapMove extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CentralsnatmapMoveState, opts?: pulumi.CustomResourceOptions): CentralsnatmapMove {
        return new CentralsnatmapMove(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:firewall/centralsnatmapMove:CentralsnatmapMove';

    /**
     * Returns true if the given object is an instance of CentralsnatmapMove.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CentralsnatmapMove {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CentralsnatmapMove.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: CentralsnatmapMoveArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CentralsnatmapMoveArgs | CentralsnatmapMoveState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CentralsnatmapMoveState | undefined;
            ...
            const args = argsOrState as CentralsnatmapMoveArgs | undefined;
        ...
        super(CentralsnatmapMove.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface CentralsnatmapMoveState {
 ...
 */
export interface CentralsnatmapMoveArgs {
    comment?: pulumi.Input<string>;
    move: pulumi.Input<string>;
    policyidDst: pulumi.Input<number>;
    policyidSrc: pulumi.Input<number>;
