 ...
 */
export function getInternetservicecustom(args: GetInternetservicecustomArgs, opts?: pulumi.InvokeOptions): Promise<GetInternetservicecustomResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("fortios:firewall/getInternetservicecustom:getInternetservicecustom", {
        "name": args.name,
 ...
 * Use this data source to get information on an fortios firewall internetservicecustom
 */
export function getInternetservicecustomOutput(args: GetInternetservicecustomOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInternetservicecustomResult> {
    return pulumi.output(args).apply((a: any) => getInternetservicecustom(a, opts))
}
