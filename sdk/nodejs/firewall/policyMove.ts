...
export class PolicyMove extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyMoveState, opts?: pulumi.CustomResourceOptions): PolicyMove {
        return new PolicyMove(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:firewall/policyMove:PolicyMove';

    /**
     * Returns true if the given object is an instance of PolicyMove.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyMove {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyMove.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: PolicyMoveArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyMoveArgs | PolicyMoveState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyMoveState | undefined;
            ...
            const args = argsOrState as PolicyMoveArgs | undefined;
        ...
        super(PolicyMove.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface PolicyMoveState {
 ...
 */
export interface PolicyMoveArgs {
    comment?: pulumi.Input<string>;
    move: pulumi.Input<string>;
    policyidDst: pulumi.Input<number>;
    policyidSrc: pulumi.Input<number>;
