...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:firewall/schedule/group:Group":
                return new Group(name, <any>undefined, { urn })
            case "fortios:firewall/schedule/onetime:Onetime":
                return new Onetime(name, <any>undefined, { urn })
            case "fortios:firewall/schedule/recurring:Recurring":
...
pulumi.runtime.registerResourceModule("fortios", "firewall/schedule/group", _module)
pulumi.runtime.registerResourceModule("fortios", "firewall/schedule/onetime", _module)
pulumi.runtime.registerResourceModule("fortios", "firewall/schedule/recurring", _module)
