...
export class ProxypolicyMove extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProxypolicyMoveState, opts?: pulumi.CustomResourceOptions): ProxypolicyMove {
        return new ProxypolicyMove(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:firewall/proxypolicyMove:ProxypolicyMove';

    /**
     * Returns true if the given object is an instance of ProxypolicyMove.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProxypolicyMove {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProxypolicyMove.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ProxypolicyMoveArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProxypolicyMoveArgs | ProxypolicyMoveState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProxypolicyMoveState | undefined;
            ...
            const args = argsOrState as ProxypolicyMoveArgs | undefined;
        ...
        super(ProxypolicyMove.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ProxypolicyMoveState {
 ...
 */
export interface ProxypolicyMoveArgs {
    comment?: pulumi.Input<string>;
    move: pulumi.Input<string>;
    policyidDst: pulumi.Input<number>;
    policyidSrc: pulumi.Input<number>;
