...
export class SecuritypolicyMove extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecuritypolicyMoveState, opts?: pulumi.CustomResourceOptions): SecuritypolicyMove {
        return new SecuritypolicyMove(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:firewall/securitypolicyMove:SecuritypolicyMove';

    /**
     * Returns true if the given object is an instance of SecuritypolicyMove.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SecuritypolicyMove {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SecuritypolicyMove.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: SecuritypolicyMoveArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SecuritypolicyMoveArgs | SecuritypolicyMoveState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SecuritypolicyMoveState | undefined;
            ...
            const args = argsOrState as SecuritypolicyMoveArgs | undefined;
        ...
        super(SecuritypolicyMove.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SecuritypolicyMoveState {
 ...
 */
export interface SecuritypolicyMoveArgs {
    comment?: pulumi.Input<string>;
    move: pulumi.Input<string>;
    policyidDst: pulumi.Input<number>;
    policyidSrc: pulumi.Input<number>;
