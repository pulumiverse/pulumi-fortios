...
export class Custom extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:firewall/service/custom:Custom';
     ...
     */
    public readonly appCategories!: pulumi.Output<outputs.firewall.service.CustomAppCategory[] | undefined>;
    /**
     ...
     */
    public readonly applications!: pulumi.Output<outputs.firewall.service.CustomApplication[] | undefined>;
    /**
     * Service category.
     */
...
export interface CustomState {
     ...
     * Application category ID. The structure of `appCategory` block is documented below.
     */
    appCategories?: pulumi.Input<pulumi.Input<inputs.firewall.service.CustomAppCategory>[]>;
    /**
     * Application service type. Valid values: `disable`, `app-id`, `app-category`.
     */
     ...
     * Application ID. The structure of `application` block is documented below.
     */
    applications?: pulumi.Input<pulumi.Input<inputs.firewall.service.CustomApplication>[]>;
    /**
     * Service category.
     */
