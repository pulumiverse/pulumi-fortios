...
export const getCategorylist: typeof import("./getCategorylist").getCategorylist = null as any;
export const getCategorylistOutput: typeof import("./getCategorylist").getCategorylistOutput = null as any;
utilities.lazyLoad(exports, ["getCategorylist","getCategorylistOutput"], () => require("./getCategorylist"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:firewall/service/category:Category":
                return new Category(name, <any>undefined, { urn })
            case "fortios:firewall/service/custom:Custom":
                return new Custom(name, <any>undefined, { urn })
            case "fortios:firewall/service/group:Group":
...
pulumi.runtime.registerResourceModule("fortios", "firewall/service/category", _module)
pulumi.runtime.registerResourceModule("fortios", "firewall/service/custom", _module)
pulumi.runtime.registerResourceModule("fortios", "firewall/service/group", _module)
