 ...
 *
 * const trname = new fortios.Logsyslogd4Overridefilter("trname", {
 *     anomaly: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class Logsyslogd4Overridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logsyslogd4Overridefilter:Logsyslogd4Overridefilter';
    ...
    constructor(name: string, argsOrState?: Logsyslogd4OverridefilterArgs | Logsyslogd4OverridefilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Logsyslogd4Overridefilter.__pulumiType, name, resourceInputs, opts);
    }
}
