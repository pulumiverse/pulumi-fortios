 ...
 *
 * const trname = new fortios.logfortianalyzer.Setting("trname", {
 *     __changeIp: 0,
 *     connTimeout: 10,
 *     encAlgorithm: "high",
 *     fazType: 1,
...
export class Setting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzer/setting:Setting';
     ...
     */
    public readonly serials!: pulumi.Output<outputs.logfortianalyzer.SettingSerial[] | undefined>;
    /**
...
export interface SettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.logfortianalyzer.SettingSerial>[]>;
    /**
     * The remote FortiAnalyzer.
     */
