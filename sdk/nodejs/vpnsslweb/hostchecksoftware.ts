 ...
 *
 * const trname = new fortios.vpnsslweb.Hostchecksoftware("trname", {
 *     osType: "windows",
 *     type: "fw",
 * });
 * ```
...
export class Hostchecksoftware extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:vpnsslweb/hostchecksoftware:Hostchecksoftware';
     ...
     */
    public readonly checkItemLists!: pulumi.Output<outputs.vpnsslweb.HostchecksoftwareCheckItemList[] | undefined>;
    /**
...
export interface HostchecksoftwareState {
     ...
     * Check item list. The structure of `checkItemList` block is documented below.
     */
    checkItemLists?: pulumi.Input<pulumi.Input<inputs.vpnsslweb.HostchecksoftwareCheckItemList>[]>;
    /**
     * Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
     */
