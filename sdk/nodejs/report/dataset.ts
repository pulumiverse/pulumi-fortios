...
export class Dataset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:report/dataset:Dataset';
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.report.DatasetParameter[] | undefined>;
    /**
...
export interface DatasetState {
     ...
     * Parameters. The structure of `parameters` block is documented below.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.report.DatasetParameter>[]>;
    /**
     * Used by monitor policy.
     */
