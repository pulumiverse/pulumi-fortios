...
export class Anqpnairealm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:wirelesscontroller/hotspot20/anqpnairealm:Anqpnairealm';
     ...
     */
    public readonly naiLists!: pulumi.Output<outputs.wirelesscontroller.hotspot20.AnqpnairealmNaiList[] | undefined>;
    /**
     * NAI realm list name.
     */
...
export interface AnqpnairealmState {
     ...
     * NAI list. The structure of `naiList` block is documented below.
     */
    naiLists?: pulumi.Input<pulumi.Input<inputs.wirelesscontroller.hotspot20.AnqpnairealmNaiList>[]>;
    /**
     * NAI realm list name.
     */
