...
export class Addrgrp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:wirelesscontroller/addrgrp:Addrgrp';
     ...
     */
    public readonly addresses!: pulumi.Output<outputs.wirelesscontroller.AddrgrpAddress[] | undefined>;
    /**
...
export interface AddrgrpState {
     ...
     * Manually selected group of addresses. The structure of `addresses` block is documented below.
     */
    addresses?: pulumi.Input<pulumi.Input<inputs.wirelesscontroller.AddrgrpAddress>[]>;
    /**
     * Allow or block the clients with MAC addresses that are not in the group. Valid values: `allow`, `deny`.
     */
