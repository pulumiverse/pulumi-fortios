...
export class SystemAlias extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemAliasState, opts?: pulumi.CustomResourceOptions): SystemAlias {
        return new SystemAlias(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/systemAlias:SystemAlias';

    /**
     * Returns true if the given object is an instance of SystemAlias.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemAlias {
