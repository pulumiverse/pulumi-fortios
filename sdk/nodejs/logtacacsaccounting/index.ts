...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:logtacacsaccounting/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:logtacacsaccounting/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "logtacacsaccounting/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "logtacacsaccounting/setting", _module)
