 ...
 */
export class SwitchcontrollerptpSettings extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SwitchcontrollerptpSettingsState, opts?: pulumi.CustomResourceOptions): SwitchcontrollerptpSettings {
        return new SwitchcontrollerptpSettings(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/switchcontrollerptpSettings:SwitchcontrollerptpSettings';

    /**
     * Returns true if the given object is an instance of SwitchcontrollerptpSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SwitchcontrollerptpSettings {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SwitchcontrollerptpSettings.__pulumiType;
    }
 ...
 */
export interface SwitchcontrollerptpSettingsState {
    /**
     * Enable/disable PTP mode. Valid values: `disable`, `transparent-e2e`, `transparent-p2p`.
     */
 ...
 */
export interface SwitchcontrollerptpSettingsArgs {
    /**
     * Enable/disable PTP mode. Valid values: `disable`, `transparent-e2e`, `transparent-p2p`.
     */
    mode?: pulumi.Input<string>;
