...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:casb/profile:Profile';
     ...
     */
    public readonly saasApplications!: pulumi.Output<outputs.casb.ProfileSaasApplication[] | undefined>;
    /**
...
export interface ProfileState {
     ...
     * CASB profile SaaS application. The structure of `saasApplication` block is documented below.
     */
    saasApplications?: pulumi.Input<pulumi.Input<inputs.casb.ProfileSaasApplication>[]>;
    /**
     * Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
