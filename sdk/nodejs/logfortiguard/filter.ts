 ...
 *
 * const trname = new fortios.logfortiguard.Filter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class Filter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortiguard/filter:Filter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.logfortiguard.FilterFreeStyle[] | undefined>;
    /**
...
export interface FilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.logfortiguard.FilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
