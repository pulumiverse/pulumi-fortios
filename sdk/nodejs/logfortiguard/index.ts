...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:logfortiguard/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:logfortiguard/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:logfortiguard/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:logfortiguard/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "logfortiguard/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortiguard/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortiguard/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortiguard/setting", _module)
