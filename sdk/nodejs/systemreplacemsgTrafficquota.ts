 ...
 */
export class SystemreplacemsgTrafficquota extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemreplacemsgTrafficquotaState, opts?: pulumi.CustomResourceOptions): SystemreplacemsgTrafficquota {
        return new SystemreplacemsgTrafficquota(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/systemreplacemsgTrafficquota:SystemreplacemsgTrafficquota';

    /**
     * Returns true if the given object is an instance of SystemreplacemsgTrafficquota.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemreplacemsgTrafficquota {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemreplacemsgTrafficquota.__pulumiType;
    }
 ...
 */
export interface SystemreplacemsgTrafficquotaState {
    /**
     * Message string.
     */
 ...
 */
export interface SystemreplacemsgTrafficquotaArgs {
    /**
     * Message string.
     */
    buffer?: pulumi.Input<string>;
