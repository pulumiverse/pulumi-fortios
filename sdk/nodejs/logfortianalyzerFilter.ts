 ...
 *
 * const trname = new fortios.LogfortianalyzerFilter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class LogfortianalyzerFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logfortianalyzerFilter:LogfortianalyzerFilter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.LogfortianalyzerFilterFreeStyle[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LogfortianalyzerFilterArgs | LogfortianalyzerFilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogfortianalyzerFilter.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface LogfortianalyzerFilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.LogfortianalyzerFilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
