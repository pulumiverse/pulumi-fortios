...
export class Dnsbl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:emailfilter/dnsbl:Dnsbl';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.emailfilter.DnsblEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface DnsblState {
     ...
     * Spam filter DNSBL and ORBL server. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.emailfilter.DnsblEntry>[]>;
    /**
     * ID.
     */
