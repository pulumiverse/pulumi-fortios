...
export class Blockallowlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:emailfilter/blockallowlist:Blockallowlist';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.emailfilter.BlockallowlistEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface BlockallowlistState {
     ...
     * Anti-spam block/allow entries. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.emailfilter.BlockallowlistEntry>[]>;
    /**
     * ID.
     */
