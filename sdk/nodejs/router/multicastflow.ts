...
export class Multicastflow extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MulticastflowState, opts?: pulumi.CustomResourceOptions): Multicastflow {
        return new Multicastflow(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:router/multicastflow:Multicastflow';

    /**
     * Returns true if the given object is an instance of Multicastflow.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Multicastflow {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Multicastflow.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: MulticastflowArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MulticastflowArgs | MulticastflowState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MulticastflowState | undefined;
            ...
            const args = argsOrState as MulticastflowArgs | undefined;
        ...
        super(Multicastflow.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface MulticastflowState {
    /**
     * Comment.
     */
 ...
 */
export interface MulticastflowArgs {
    /**
     * Comment.
     */
    comments?: pulumi.Input<string>;
