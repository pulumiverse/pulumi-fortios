...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:router/ospf/neighbor:Neighbor":
                return new Neighbor(name, <any>undefined, { urn })
            case "fortios:router/ospf/network:Network":
                return new Network(name, <any>undefined, { urn })
            case "fortios:router/ospf/ospfinterface:Ospfinterface":
...
pulumi.runtime.registerResourceModule("fortios", "router/ospf/neighbor", _module)
pulumi.runtime.registerResourceModule("fortios", "router/ospf/network", _module)
pulumi.runtime.registerResourceModule("fortios", "router/ospf/ospfinterface", _module)
