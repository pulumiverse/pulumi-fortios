 ...
 *
 * const test1 = new fortios.FmgSystemAdom("test1", {
 ...
 * ```
 */
export class FmgSystemAdom extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FmgSystemAdomState, opts?: pulumi.CustomResourceOptions): FmgSystemAdom {
        return new FmgSystemAdom(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/fmgSystemAdom:FmgSystemAdom';

    /**
     * Returns true if the given object is an instance of FmgSystemAdom.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FmgSystemAdom {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FmgSystemAdom.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: FmgSystemAdomArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FmgSystemAdomArgs | FmgSystemAdomState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FmgSystemAdomState | undefined;
            ...
            const args = argsOrState as FmgSystemAdomArgs | undefined;
        ...
        super(FmgSystemAdom.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FmgSystemAdomState {
    /**
     * True or False.
     */
 ...
 */
export interface FmgSystemAdomArgs {
    /**
     * True or False.
     */
    actionWhenConflictsOccurDuringPolicyCheck?: pulumi.Input<string>;
