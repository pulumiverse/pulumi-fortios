...
export class Alarm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:sys/alarm:Alarm';
     ...
     */
    public readonly groups!: pulumi.Output<outputs.sys.AlarmGroup[] | undefined>;
    /**
...
export interface AlarmState {
     ...
     * Alarm groups. The structure of `groups` block is documented below.
     */
    groups?: pulumi.Input<pulumi.Input<inputs.sys.AlarmGroup>[]>;
    /**
     * Enable/disable alarm. Valid values: `enable`, `disable`.
     */
