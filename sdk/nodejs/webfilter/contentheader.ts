 ...
 *
 * const trname = new fortios.webfilter.Contentheader("trname", {fosid: 1});
 * ```
 *
 * ## Import
 *
...
export class Contentheader extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:webfilter/contentheader:Contentheader';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.webfilter.ContentheaderEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface ContentheaderState {
     ...
     * Configure content types used by web filter. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.webfilter.ContentheaderEntry>[]>;
    /**
     * ID.
     */
