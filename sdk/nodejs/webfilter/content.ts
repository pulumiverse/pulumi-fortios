 ...
 *
 * const trname = new fortios.webfilter.Content("trname", {fosid: 1});
 * ```
 *
 * ## Import
 *
...
export class Content extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:webfilter/content:Content';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.webfilter.ContentEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface ContentState {
     ...
     * Configure banned word entries. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.webfilter.ContentEntry>[]>;
    /**
     * ID.
     */
