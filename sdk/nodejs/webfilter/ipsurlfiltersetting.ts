 ...
 *
 * const trname = new fortios.webfilter.Ipsurlfiltersetting("trname", {
 *     distance: 1,
 *     gateway: "0.0.0.0",
 * });
 * ```
 ...
 */
export class Ipsurlfiltersetting extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpsurlfiltersettingState, opts?: pulumi.CustomResourceOptions): Ipsurlfiltersetting {
        return new Ipsurlfiltersetting(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:webfilter/ipsurlfiltersetting:Ipsurlfiltersetting';

    /**
     * Returns true if the given object is an instance of Ipsurlfiltersetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ipsurlfiltersetting {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ipsurlfiltersetting.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: IpsurlfiltersettingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IpsurlfiltersettingArgs | IpsurlfiltersettingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpsurlfiltersettingState | undefined;
            ...
            const args = argsOrState as IpsurlfiltersettingArgs | undefined;
        ...
        super(Ipsurlfiltersetting.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IpsurlfiltersettingState {
    /**
     * Interface for this route.
     */
 ...
 */
export interface IpsurlfiltersettingArgs {
    /**
     * Interface for this route.
     */
    device?: pulumi.Input<string>;
