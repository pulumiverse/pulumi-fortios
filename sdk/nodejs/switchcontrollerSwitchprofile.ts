 ...
 *
 * const trname = new fortios.SwitchcontrollerSwitchprofile("trname", {loginPasswdOverride: "enable"});
 * ```
 *
 * ## Import
 *
...
export class SwitchcontrollerSwitchprofile extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SwitchcontrollerSwitchprofileState, opts?: pulumi.CustomResourceOptions): SwitchcontrollerSwitchprofile {
        return new SwitchcontrollerSwitchprofile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/switchcontrollerSwitchprofile:SwitchcontrollerSwitchprofile';
     ...
     */
    public static isInstance(obj: any): obj is SwitchcontrollerSwitchprofile {
