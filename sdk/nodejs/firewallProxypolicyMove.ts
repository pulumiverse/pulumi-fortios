...
export class FirewallProxypolicyMove extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallProxypolicyMoveState, opts?: pulumi.CustomResourceOptions): FirewallProxypolicyMove {
        return new FirewallProxypolicyMove(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/firewallProxypolicyMove:FirewallProxypolicyMove';

    /**
     * Returns true if the given object is an instance of FirewallProxypolicyMove.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirewallProxypolicyMove {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FirewallProxypolicyMove.__pulumiType;
    }
 ...
 */
export interface FirewallProxypolicyMoveState {
 ...
 */
export interface FirewallProxypolicyMoveArgs {
    comment?: pulumi.Input<string>;
    move: pulumi.Input<string>;
    policyidDst: pulumi.Input<number>;
    policyidSrc: pulumi.Input<number>;
