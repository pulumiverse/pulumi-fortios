 ...
 *
 * const trname = new fortios.logsyslogd4.Filter("trname", {
 *     anomaly: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class Filter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logsyslogd4/filter:Filter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.logsyslogd4.FilterFreeStyle[] | undefined>;
    /**
...
export interface FilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.logsyslogd4.FilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
