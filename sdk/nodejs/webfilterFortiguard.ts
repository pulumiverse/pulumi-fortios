...
export class WebfilterFortiguard extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebfilterFortiguardState, opts?: pulumi.CustomResourceOptions): WebfilterFortiguard {
        return new WebfilterFortiguard(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/webfilterFortiguard:WebfilterFortiguard';

    /**
     * Returns true if the given object is an instance of WebfilterFortiguard.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WebfilterFortiguard {
