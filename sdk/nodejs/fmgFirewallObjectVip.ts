 ...
 *
 * const test1 = new fortios.FmgFirewallObjectVip("test1", {
 *     arpReply: "enable",
 ...
 *     type: "static-nat",
 * });
 * const test2 = new fortios.FmgFirewallObjectVip("test2", {
 *     arpReply: "disable",
 *     comment: "test obj vip",
 *     configDefault: "enable",
...
export class FmgFirewallObjectVip extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FmgFirewallObjectVipArgs | FmgFirewallObjectVipState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FmgFirewallObjectVip.__pulumiType, name, resourceInputs, opts);
    }
}
