 ...
 *
 * const trname = new fortios.Logfortianalyzer3Overridefilter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
 ...
 */
export class Logfortianalyzer3Overridefilter extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Logfortianalyzer3OverridefilterState, opts?: pulumi.CustomResourceOptions): Logfortianalyzer3Overridefilter {
        return new Logfortianalyzer3Overridefilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logfortianalyzer3Overridefilter:Logfortianalyzer3Overridefilter';

    /**
     * Returns true if the given object is an instance of Logfortianalyzer3Overridefilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Logfortianalyzer3Overridefilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Logfortianalyzer3Overridefilter.__pulumiType;
    }
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.Logfortianalyzer3OverridefilterFreeStyle[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: Logfortianalyzer3OverridefilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Logfortianalyzer3OverridefilterArgs | Logfortianalyzer3OverridefilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Logfortianalyzer3OverridefilterState | undefined;
            ...
            const args = argsOrState as Logfortianalyzer3OverridefilterArgs | undefined;
        ...
        super(Logfortianalyzer3Overridefilter.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface Logfortianalyzer3OverridefilterState {
    /**
     * Enable/disable anomaly logging. Valid values: `enable`, `disable`.
     */
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.Logfortianalyzer3OverridefilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
 ...
 */
export interface Logfortianalyzer3OverridefilterArgs {
    /**
     * Enable/disable anomaly logging. Valid values: `enable`, `disable`.
     */
    anomaly?: pulumi.Input<string>;
