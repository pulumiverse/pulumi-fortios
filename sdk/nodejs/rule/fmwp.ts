 ...
 */
export class Fmwp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FmwpState, opts?: pulumi.CustomResourceOptions): Fmwp {
        return new Fmwp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:rule/fmwp:Fmwp';

    /**
     * Returns true if the given object is an instance of Fmwp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Fmwp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Fmwp.__pulumiType;
    }
     ...
     */
    public readonly metadatas!: pulumi.Output<outputs.rule.FmwpMetadata[] | undefined>;
    /**
     * Rule name.
     */
     ...
     */
    constructor(name: string, args?: FmwpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FmwpArgs | FmwpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FmwpState | undefined;
            ...
            const args = argsOrState as FmwpArgs | undefined;
        ...
        super(Fmwp.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface FmwpState {
     ...
     * Meta data. The structure of `metadata` block is documented below.
     */
    metadatas?: pulumi.Input<pulumi.Input<inputs.rule.FmwpMetadata>[]>;
    /**
     * Rule name.
     */
