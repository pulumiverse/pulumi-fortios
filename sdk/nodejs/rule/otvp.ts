 ...
 */
export class Otvp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OtvpState, opts?: pulumi.CustomResourceOptions): Otvp {
        return new Otvp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:rule/otvp:Otvp';

    /**
     * Returns true if the given object is an instance of Otvp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Otvp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Otvp.__pulumiType;
    }
     ...
     */
    public readonly metadatas!: pulumi.Output<outputs.rule.OtvpMetadata[] | undefined>;
    /**
     * Rule name.
     */
     ...
     */
    constructor(name: string, args?: OtvpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OtvpArgs | OtvpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OtvpState | undefined;
            ...
            const args = argsOrState as OtvpArgs | undefined;
        ...
        super(Otvp.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface OtvpState {
     ...
     * Meta data. The structure of `metadata` block is documented below.
     */
    metadatas?: pulumi.Input<pulumi.Input<inputs.rule.OtvpMetadata>[]>;
    /**
     * Rule name.
     */
