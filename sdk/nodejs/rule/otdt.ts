 ...
 */
export class Otdt extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OtdtState, opts?: pulumi.CustomResourceOptions): Otdt {
        return new Otdt(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:rule/otdt:Otdt';

    /**
     * Returns true if the given object is an instance of Otdt.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Otdt {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Otdt.__pulumiType;
    }
     ...
     */
    public readonly metadatas!: pulumi.Output<outputs.rule.OtdtMetadata[] | undefined>;
    /**
     * Application name.
     */
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.rule.OtdtParameter[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: OtdtArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OtdtArgs | OtdtState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OtdtState | undefined;
            ...
            const args = argsOrState as OtdtArgs | undefined;
        ...
        super(Otdt.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface OtdtState {
     ...
     * Meta data. The structure of `metadata` block is documented below.
     */
    metadatas?: pulumi.Input<pulumi.Input<inputs.rule.OtdtMetadata>[]>;
    /**
     * Application name.
     */
     ...
     * Application parameters. The structure of `parameters` block is documented below.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.rule.OtdtParameter>[]>;
    /**
     * Application popularity.
     */
