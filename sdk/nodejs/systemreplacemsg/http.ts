...
export class Http extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HttpState, opts?: pulumi.CustomResourceOptions): Http {
        return new Http(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:systemreplacemsg/http:Http';
    ...
    constructor(name: string, argsOrState?: HttpArgs | HttpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HttpState | undefined;
            ...
            const args = argsOrState as HttpArgs | undefined;
