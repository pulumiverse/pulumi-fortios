...
export class LogfortianalyzercloudOverridesetting extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogfortianalyzercloudOverridesettingState, opts?: pulumi.CustomResourceOptions): LogfortianalyzercloudOverridesetting {
        return new LogfortianalyzercloudOverridesetting(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logfortianalyzercloudOverridesetting:LogfortianalyzercloudOverridesetting';

    /**
     * Returns true if the given object is an instance of LogfortianalyzercloudOverridesetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LogfortianalyzercloudOverridesetting {
