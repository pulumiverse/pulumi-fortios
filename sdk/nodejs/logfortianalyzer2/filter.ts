 ...
 *
 * const trname = new fortios.logfortianalyzer2.Filter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class Filter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzer2/filter:Filter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.logfortianalyzer2.FilterFreeStyle[] | undefined>;
    /**
...
export interface FilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.logfortianalyzer2.FilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
