 ...
 *
 * const trname = new fortios.logfortianalyzer2.Overridesetting("trname", {
 *     __changeIp: 0,
 *     connTimeout: 10,
 *     encAlgorithm: "high",
 *     fazType: 5,
...
export class Overridesetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzer2/overridesetting:Overridesetting';
     ...
     */
    public readonly serials!: pulumi.Output<outputs.logfortianalyzer2.OverridesettingSerial[] | undefined>;
    /**
...
export interface OverridesettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.logfortianalyzer2.OverridesettingSerial>[]>;
    /**
     * The remote FortiAnalyzer.
     */
