 ...
 *
 * const trname = new fortios.logfortianalyzer2.Setting("trname", {
 *     __changeIp: 0,
 *     connTimeout: 10,
 *     encAlgorithm: "high",
 *     fazType: 2,
...
export class Setting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzer2/setting:Setting';
     ...
     */
    public readonly serials!: pulumi.Output<outputs.logfortianalyzer2.SettingSerial[] | undefined>;
    /**
...
export interface SettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.logfortianalyzer2.SettingSerial>[]>;
    /**
     * The remote FortiAnalyzer.
     */
