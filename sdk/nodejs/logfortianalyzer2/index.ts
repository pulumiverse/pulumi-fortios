...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:logfortianalyzer2/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:logfortianalyzer2/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:logfortianalyzer2/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:logfortianalyzer2/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "logfortianalyzer2/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortianalyzer2/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortianalyzer2/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortianalyzer2/setting", _module)
