...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:firewallservice/category:Category":
                return new Category(name, <any>undefined, { urn })
            case "fortios:firewallservice/custom:Custom":
                return new Custom(name, <any>undefined, { urn })
            case "fortios:firewallservice/group:Group":
...
pulumi.runtime.registerResourceModule("fortios", "firewallservice/category", _module)
pulumi.runtime.registerResourceModule("fortios", "firewallservice/custom", _module)
pulumi.runtime.registerResourceModule("fortios", "firewallservice/group", _module)
