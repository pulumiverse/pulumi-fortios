...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:virtualpatch/profile:Profile';
     ...
     */
    public readonly exemptions!: pulumi.Output<outputs.virtualpatch.ProfileExemption[] | undefined>;
    /**
...
export interface ProfileState {
     ...
     * Exempt devices or rules. The structure of `exemption` block is documented below.
     */
    exemptions?: pulumi.Input<pulumi.Input<inputs.virtualpatch.ProfileExemption>[]>;
    /**
     * Get all sub-tables including unconfigured tables. Do not set this variable to true if you configure sub-table in another resource, otherwise, conflicts and overwrite will occur. Options: [ false, true ]. false: Default value, do not get unconfigured tables; true: get all tables including unconfigured tables.
     */
