...
export class SystemConsole extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemConsoleState, opts?: pulumi.CustomResourceOptions): SystemConsole {
        return new SystemConsole(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/systemConsole:SystemConsole';

    /**
     * Returns true if the given object is an instance of SystemConsole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemConsole {
