 ...
 *
 * const trname = new fortios.LogfortiguardFilter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
 ...
 */
export class LogfortiguardFilter extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogfortiguardFilterState, opts?: pulumi.CustomResourceOptions): LogfortiguardFilter {
        return new LogfortiguardFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logfortiguardFilter:LogfortiguardFilter';

    /**
     * Returns true if the given object is an instance of LogfortiguardFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LogfortiguardFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LogfortiguardFilter.__pulumiType;
    }
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.LogfortiguardFilterFreeStyle[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: LogfortiguardFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LogfortiguardFilterArgs | LogfortiguardFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LogfortiguardFilterState | undefined;
            ...
            const args = argsOrState as LogfortiguardFilterArgs | undefined;
        ...
        super(LogfortiguardFilter.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LogfortiguardFilterState {
    /**
     * Enable/disable anomaly logging. Valid values: `enable`, `disable`.
     */
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.LogfortiguardFilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
 ...
 */
export interface LogfortiguardFilterArgs {
    /**
     * Enable/disable anomaly logging. Valid values: `enable`, `disable`.
     */
    anomaly?: pulumi.Input<string>;
