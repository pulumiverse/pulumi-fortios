...
export class Phase1interface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:vpn/ipsec/phase1interface:Phase1interface';
     ...
     */
    public readonly backupGateways!: pulumi.Output<outputs.vpn.ipsec.Phase1interfaceBackupGateway[] | undefined>;
    /**
     ...
     */
    public readonly certificates!: pulumi.Output<outputs.vpn.ipsec.Phase1interfaceCertificate[] | undefined>;
    /**
     ...
     */
    public readonly internalDomainLists!: pulumi.Output<outputs.vpn.ipsec.Phase1interfaceInternalDomainList[] | undefined>;
    /**
     ...
     */
    public readonly ipv4ExcludeRanges!: pulumi.Output<outputs.vpn.ipsec.Phase1interfaceIpv4ExcludeRange[] | undefined>;
    /**
     * IPv4 address name.
     */
     ...
     */
    public readonly ipv6ExcludeRanges!: pulumi.Output<outputs.vpn.ipsec.Phase1interfaceIpv6ExcludeRange[] | undefined>;
    /**
     * IPv6 address name.
     */
...
export interface Phase1interfaceState {
     ...
     * Instruct unity clients about the backup gateway address(es). The structure of `backupGateway` block is documented below.
     */
    backupGateways?: pulumi.Input<pulumi.Input<inputs.vpn.ipsec.Phase1interfaceBackupGateway>[]>;
    /**
     * Message that unity client should display after connecting.
     */
     ...
     * The names of up to 4 signed personal certificates. The structure of `certificate` block is documented below.
     */
    certificates?: pulumi.Input<pulumi.Input<inputs.vpn.ipsec.Phase1interfaceCertificate>[]>;
    /**
     * Enable/disable childless IKEv2 initiation (RFC 6023). Valid values: `enable`, `disable`.
     */
     ...
     * One or more internal domain names in quotes separated by spaces. The structure of `internalDomainList` block is documented below.
     */
    internalDomainLists?: pulumi.Input<pulumi.Input<inputs.vpn.ipsec.Phase1interfaceInternalDomainList>[]>;
    /**
     * IP address reuse delay interval in seconds (0 - 28800).
     */
     ...
     * Configuration Method IPv4 exclude ranges. The structure of `ipv4ExcludeRange` block is documented below.
     */
    ipv4ExcludeRanges?: pulumi.Input<pulumi.Input<inputs.vpn.ipsec.Phase1interfaceIpv4ExcludeRange>[]>;
    /**
     * IPv4 address name.
     */
     ...
     * Configuration method IPv6 exclude ranges. The structure of `ipv6ExcludeRange` block is documented below.
     */
    ipv6ExcludeRanges?: pulumi.Input<pulumi.Input<inputs.vpn.ipsec.Phase1interfaceIpv6ExcludeRange>[]>;
    /**
     * IPv6 address name.
     */
