...
export class Portal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:vpn/ssl/web/portal:Portal';
     ...
     */
    public readonly bookmarkGroups!: pulumi.Output<outputs.vpn.ssl.web.PortalBookmarkGroup[] | undefined>;
    /**
     ...
     */
    public readonly hostCheckPolicies!: pulumi.Output<outputs.vpn.ssl.web.PortalHostCheckPolicy[] | undefined>;
    /**
     ...
     */
    public readonly ipPools!: pulumi.Output<outputs.vpn.ssl.web.PortalIpPool[] | undefined>;
    /**
     * IPv6 DNS server 1.
     */
     ...
     */
    public readonly ipv6Pools!: pulumi.Output<outputs.vpn.ssl.web.PortalIpv6Pool[] | undefined>;
    /**
     ...
     */
    public readonly ipv6SplitTunnelingRoutingAddresses!: pulumi.Output<outputs.vpn.ssl.web.PortalIpv6SplitTunnelingRoutingAddress[] | undefined>;
    /**
     ...
     */
    public readonly landingPage!: pulumi.Output<outputs.vpn.ssl.web.PortalLandingPage>;
    /**
     ...
     */
    public readonly macAddrCheckRules!: pulumi.Output<outputs.vpn.ssl.web.PortalMacAddrCheckRule[] | undefined>;
    /**
     ...
     */
    public readonly osCheckLists!: pulumi.Output<outputs.vpn.ssl.web.PortalOsCheckList[] | undefined>;
    /**
     ...
     */
    public readonly splitDns!: pulumi.Output<outputs.vpn.ssl.web.PortalSplitDn[] | undefined>;
    /**
     ...
     */
    public readonly splitTunnelingRoutingAddresses!: pulumi.Output<outputs.vpn.ssl.web.PortalSplitTunnelingRoutingAddress[] | undefined>;
    /**
...
export interface PortalState {
     ...
     * Portal bookmark group. The structure of `bookmarkGroup` block is documented below.
     */
    bookmarkGroups?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalBookmarkGroup>[]>;
    /**
     * Allow client to add source range for the tunnel traffic. Valid values: `enable`, `disable`.
     */
     ...
     * One or more policies to require the endpoint to have specific security software. The structure of `hostCheckPolicy` block is documented below.
     */
    hostCheckPolicies?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalHostCheckPolicy>[]>;
    /**
     * Method by which users of this SSL-VPN tunnel obtain IP addresses.
     */
     ...
     * IPv4 firewall source address objects reserved for SSL-VPN tunnel mode clients. The structure of `ipPools` block is documented below.
     */
    ipPools?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalIpPool>[]>;
    /**
     * IPv6 DNS server 1.
     */
     ...
     * IPv4 firewall source address objects reserved for SSL-VPN tunnel mode clients. The structure of `ipv6Pools` block is documented below.
     */
    ipv6Pools?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalIpv6Pool>[]>;
    /**
     * Enable/disable IPv6 tunnel service restriction. Valid values: `enable`, `disable`.
     */
     ...
     * IPv6 SSL-VPN tunnel mode firewall address objects that override firewall policy destination addresses to control split-tunneling access. The structure of `ipv6SplitTunnelingRoutingAddress` block is documented below.
     */
    ipv6SplitTunnelingRoutingAddresses?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalIpv6SplitTunnelingRoutingAddress>[]>;
    /**
     * Enable to negate IPv6 split tunneling routing address. Valid values: `enable`, `disable`.
     */
     ...
     * Landing page options. The structure of `landingPage` block is documented below.
     */
    landingPage?: pulumi.Input<inputs.vpn.ssl.web.PortalLandingPage>;
    /**
     * Enable/disable SSL-VPN landing page mode. Valid values: `enable`, `disable`.
     */
     ...
     * Client MAC address check rule. The structure of `macAddrCheckRule` block is documented below.
     */
    macAddrCheckRules?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalMacAddrCheckRule>[]>;
    /**
     * Download URL for Mac FortiClient.
     */
     ...
     * SSL VPN OS checks. The structure of `osCheckList` block is documented below.
     */
    osCheckLists?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalOsCheckList>[]>;
    /**
     * prefer to query IPv6 dns first if enabled. Valid values: `enable`, `disable`.
     */
     ...
     * Split DNS for SSL VPN. The structure of `splitDns` block is documented below.
     */
    splitDns?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalSplitDn>[]>;
    /**
     * Enable/disable IPv4 split tunneling. Valid values: `enable`, `disable`.
     */
     ...
     * IPv4 SSL-VPN tunnel mode firewall address objects that override firewall policy destination addresses to control split-tunneling access. The structure of `splitTunnelingRoutingAddress` block is documented below.
     */
    splitTunnelingRoutingAddresses?: pulumi.Input<pulumi.Input<inputs.vpn.ssl.web.PortalSplitTunnelingRoutingAddress>[]>;
    /**
     * Enable to negate split tunneling routing address. Valid values: `enable`, `disable`.
     */
