...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:logsyslogd/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:logsyslogd/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:logsyslogd/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:logsyslogd/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "logsyslogd/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "logsyslogd/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "logsyslogd/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "logsyslogd/setting", _module)
