...
export class UserCertificate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserCertificateState, opts?: pulumi.CustomResourceOptions): UserCertificate {
        return new UserCertificate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/userCertificate:UserCertificate';

    /**
     * Returns true if the given object is an instance of UserCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is UserCertificate {
     ...
     */
    constructor(name: string, args?: UserCertificateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: UserCertificateArgs | UserCertificateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as UserCertificateState | undefined;
            ...
            const args = argsOrState as UserCertificateArgs | undefined;
        ...
        super(UserCertificate.__pulumiType, name, resourceInputs, opts);
    }
}
