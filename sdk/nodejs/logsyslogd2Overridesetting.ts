 ...
 */
export class Logsyslogd2Overridesetting extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Logsyslogd2OverridesettingState, opts?: pulumi.CustomResourceOptions): Logsyslogd2Overridesetting {
        return new Logsyslogd2Overridesetting(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logsyslogd2Overridesetting:Logsyslogd2Overridesetting';

    /**
     * Returns true if the given object is an instance of Logsyslogd2Overridesetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Logsyslogd2Overridesetting {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Logsyslogd2Overridesetting.__pulumiType;
    }
     ...
     */
    public readonly customFieldNames!: pulumi.Output<outputs.Logsyslogd2OverridesettingCustomFieldName[] | undefined>;
    /**
 ...
 */
export interface Logsyslogd2OverridesettingState {
    /**
     * Certificate used to communicate with Syslog server.
     */
     ...
     * Custom field name for CEF format logging. The structure of `customFieldName` block is documented below.
     */
    customFieldNames?: pulumi.Input<pulumi.Input<inputs.Logsyslogd2OverridesettingCustomFieldName>[]>;
    /**
     * Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
     */
 ...
 */
export interface Logsyslogd2OverridesettingArgs {
    /**
     * Certificate used to communicate with Syslog server.
     */
    certificate?: pulumi.Input<string>;
