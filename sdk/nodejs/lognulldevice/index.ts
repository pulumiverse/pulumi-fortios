...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:lognulldevice/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:lognulldevice/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "lognulldevice/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "lognulldevice/setting", _module)
