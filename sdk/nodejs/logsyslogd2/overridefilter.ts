 ...
 *
 * const trname = new fortios.logsyslogd2.Overridefilter("trname", {
 *     anomaly: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class Overridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logsyslogd2/overridefilter:Overridefilter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.logsyslogd2.OverridefilterFreeStyle[] | undefined>;
    /**
...
export interface OverridefilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.logsyslogd2.OverridefilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
