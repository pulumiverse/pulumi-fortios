 ...
 */
export class Remotestorage extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemotestorageState, opts?: pulumi.CustomResourceOptions): Remotestorage {
        return new Remotestorage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:wanopt/remotestorage:Remotestorage';

    /**
     * Returns true if the given object is an instance of Remotestorage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Remotestorage {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Remotestorage.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: RemotestorageArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemotestorageArgs | RemotestorageState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemotestorageState | undefined;
            ...
            const args = argsOrState as RemotestorageArgs | undefined;
        ...
        super(Remotestorage.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemotestorageArgs {
    /**
     * ID that this device uses to connect to the remote device.
     */
    localCacheId?: pulumi.Input<string>;
