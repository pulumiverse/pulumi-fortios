 ...
 *
 * const trname = new fortios.Logsyslogd3Setting("trname", {
 ...
 */
export class Logsyslogd3Setting extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Logsyslogd3SettingState, opts?: pulumi.CustomResourceOptions): Logsyslogd3Setting {
        return new Logsyslogd3Setting(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logsyslogd3Setting:Logsyslogd3Setting';

    /**
     * Returns true if the given object is an instance of Logsyslogd3Setting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Logsyslogd3Setting {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Logsyslogd3Setting.__pulumiType;
    }
     ...
     */
    public readonly customFieldNames!: pulumi.Output<outputs.Logsyslogd3SettingCustomFieldName[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: Logsyslogd3SettingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Logsyslogd3SettingArgs | Logsyslogd3SettingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Logsyslogd3SettingState | undefined;
            ...
            const args = argsOrState as Logsyslogd3SettingArgs | undefined;
        ...
        super(Logsyslogd3Setting.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface Logsyslogd3SettingState {
    /**
     * Certificate used to communicate with Syslog server.
     */
     ...
     * Custom field name for CEF format logging. The structure of `customFieldName` block is documented below.
     */
    customFieldNames?: pulumi.Input<pulumi.Input<inputs.Logsyslogd3SettingCustomFieldName>[]>;
    /**
     * Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
     */
 ...
 */
export interface Logsyslogd3SettingArgs {
    /**
     * Certificate used to communicate with Syslog server.
     */
    certificate?: pulumi.Input<string>;
