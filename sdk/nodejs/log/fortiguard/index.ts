...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/fortiguard/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/fortiguard/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:log/fortiguard/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:log/fortiguard/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/fortiguard/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortiguard/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortiguard/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortiguard/setting", _module)
