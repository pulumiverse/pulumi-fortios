...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/webtrends/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/webtrends/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/webtrends/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/webtrends/setting", _module)
