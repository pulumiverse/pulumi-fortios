...
export class Setting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:log/fortianalyzer/v3/setting:Setting';
     ...
     */
    public readonly serials!: pulumi.Output<outputs.log.fortianalyzer.v3.SettingSerial[] | undefined>;
    /**
...
export interface SettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.log.fortianalyzer.v3.SettingSerial>[]>;
    /**
     * The remote FortiAnalyzer.
     */
