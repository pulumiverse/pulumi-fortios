...
export class Overridesetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:log/fortianalyzer/v2/overridesetting:Overridesetting';
     ...
     */
    public readonly serials!: pulumi.Output<outputs.log.fortianalyzer.v2.OverridesettingSerial[] | undefined>;
    /**
...
export interface OverridesettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.log.fortianalyzer.v2.OverridesettingSerial>[]>;
    /**
     * The remote FortiAnalyzer.
     */
