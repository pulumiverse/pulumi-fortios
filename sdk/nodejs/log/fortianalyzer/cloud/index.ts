...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/fortianalyzer/cloud/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/fortianalyzer/cloud/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:log/fortianalyzer/cloud/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:log/fortianalyzer/cloud/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/fortianalyzer/cloud/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortianalyzer/cloud/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortianalyzer/cloud/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortianalyzer/cloud/setting", _module)
