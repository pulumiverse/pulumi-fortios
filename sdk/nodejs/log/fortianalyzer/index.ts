...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/fortianalyzer/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/fortianalyzer/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:log/fortianalyzer/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:log/fortianalyzer/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/fortianalyzer/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortianalyzer/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortianalyzer/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "log/fortianalyzer/setting", _module)
