...
export class Filter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:log/syslogd/v3/filter:Filter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.log.syslogd.v3.FilterFreeStyle[] | undefined>;
    /**
...
export interface FilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.log.syslogd.v3.FilterFreeStyle>[]>;
    /**
     * Get all sub-tables including unconfigured tables. Do not set this variable to true if you configure sub-table in another resource, otherwish conflicts and overwrite will occur. Options: [ false, true ]. false: Default value, do not get unconfigured tables; true: get all tables including unconfigured tables.
     */
