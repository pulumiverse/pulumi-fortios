...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/syslogd/v4/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/syslogd/v4/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:log/syslogd/v4/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:log/syslogd/v4/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/syslogd/v4/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/syslogd/v4/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/syslogd/v4/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "log/syslogd/v4/setting", _module)
