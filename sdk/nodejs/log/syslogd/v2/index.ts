...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/syslogd/v2/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/syslogd/v2/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:log/syslogd/v2/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:log/syslogd/v2/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/syslogd/v2/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/syslogd/v2/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/syslogd/v2/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "log/syslogd/v2/setting", _module)
