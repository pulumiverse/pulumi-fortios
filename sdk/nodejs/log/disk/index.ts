...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/disk/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/disk/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/disk/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/disk/setting", _module)
