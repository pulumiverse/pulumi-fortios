...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/tacacsaccounting/v2/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/tacacsaccounting/v2/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/tacacsaccounting/v2/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/tacacsaccounting/v2/setting", _module)
