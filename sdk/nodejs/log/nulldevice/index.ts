...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:log/nulldevice/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:log/nulldevice/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "log/nulldevice/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "log/nulldevice/setting", _module)
