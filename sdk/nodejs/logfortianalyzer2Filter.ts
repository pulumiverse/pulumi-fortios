 ...
 *
 * const trname = new fortios.Logfortianalyzer2Filter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class Logfortianalyzer2Filter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logfortianalyzer2Filter:Logfortianalyzer2Filter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.Logfortianalyzer2FilterFreeStyle[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: Logfortianalyzer2FilterArgs | Logfortianalyzer2FilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Logfortianalyzer2Filter.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface Logfortianalyzer2FilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.Logfortianalyzer2FilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
