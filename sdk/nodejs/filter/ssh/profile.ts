...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:filter/ssh/profile:Profile';
     ...
     */
    public readonly shellCommands!: pulumi.Output<outputs.filter.ssh.ProfileShellCommand[] | undefined>;
    /**
...
export interface ProfileState {
     ...
     * SSH command filter. The structure of `shellCommands` block is documented below.
     */
    shellCommands?: pulumi.Input<pulumi.Input<inputs.filter.ssh.ProfileShellCommand>[]>;
    /**
     * Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
