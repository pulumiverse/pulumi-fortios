...
export class Bwl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:filter/spam/bwl:Bwl';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.filter.spam.BwlEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface BwlState {
     ...
     * Anti-spam black/white list entries. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.filter.spam.BwlEntry>[]>;
    /**
     * ID.
     */
