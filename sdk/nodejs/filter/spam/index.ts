...
pulumi.runtime.registerResourceModule("fortios", "filter/spam/bwl", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/spam/bword", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/spam/dnsbl", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/spam/fortishield", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/spam/iptrust", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/spam/mheader", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/spam/options", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/spam/profile", _module)
