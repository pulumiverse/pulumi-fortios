...
export class Mheader extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:filter/spam/mheader:Mheader';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.filter.spam.MheaderEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface MheaderState {
     ...
     * Spam filter mime header content. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.filter.spam.MheaderEntry>[]>;
    /**
     * ID.
     */
