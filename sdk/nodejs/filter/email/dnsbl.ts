...
export class Dnsbl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:filter/email/dnsbl:Dnsbl';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.filter.email.DnsblEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface DnsblState {
     ...
     * Spam filter DNSBL and ORBL server. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.filter.email.DnsblEntry>[]>;
    /**
     * ID.
     */
