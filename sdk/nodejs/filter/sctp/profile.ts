...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:filter/sctp/profile:Profile';
     ...
     */
    public readonly ppidFilters!: pulumi.Output<outputs.filter.sctp.ProfilePpidFilter[] | undefined>;
    /**
...
export interface ProfileState {
     ...
     * PPID filters list. The structure of `ppidFilters` block is documented below.
     */
    ppidFilters?: pulumi.Input<pulumi.Input<inputs.filter.sctp.ProfilePpidFilter>[]>;
    /**
     * Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
