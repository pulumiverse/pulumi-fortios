...
pulumi.runtime.registerResourceModule("fortios", "filter/web/content", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/contentheader", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/fortiguard", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/ftgdlocalcat", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/ftgdlocalrating", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/ipsurlfiltercachesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/ipsurlfiltersetting", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/ipsurlfiltersetting6", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/override", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/profile", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/searchengine", _module)
pulumi.runtime.registerResourceModule("fortios", "filter/web/urlfilter", _module)
