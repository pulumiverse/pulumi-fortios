...
export class Content extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:filter/web/content:Content';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.filter.web.ContentEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface ContentState {
     ...
     * Configure banned word entries. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.filter.web.ContentEntry>[]>;
    /**
     * ID.
     */
