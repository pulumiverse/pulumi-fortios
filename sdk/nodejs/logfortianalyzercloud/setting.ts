...
export class Setting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzercloud/setting:Setting';
     ...
     */
    public readonly serials!: pulumi.Output<outputs.logfortianalyzercloud.SettingSerial[] | undefined>;
    /**
...
export interface SettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.logfortianalyzercloud.SettingSerial>[]>;
    /**
     * Source IPv4 or IPv6 address used to communicate with FortiAnalyzer.
     */
