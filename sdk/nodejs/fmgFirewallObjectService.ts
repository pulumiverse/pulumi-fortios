 ...
 *
 * const test1 = new fortios.FmgFirewallObjectService("test1", {
 *     category: "Email",
 ...
 * });
 * const test2 = new fortios.FmgFirewallObjectService("test2", {
 *     category: "Web Access",
 *     comment: "test obj service",
 *     icmpCode: 3,
 *     icmpType: 2,
 *     protocol: "ICMP",
 * });
 * const test3 = new fortios.FmgFirewallObjectService("test3", {
...
export class FmgFirewallObjectService extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FmgFirewallObjectServiceArgs | FmgFirewallObjectServiceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FmgFirewallObjectService.__pulumiType, name, resourceInputs, opts);
    }
}
