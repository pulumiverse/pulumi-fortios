...
export class SpamfilterFortishield extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpamfilterFortishieldState, opts?: pulumi.CustomResourceOptions): SpamfilterFortishield {
        return new SpamfilterFortishield(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/spamfilterFortishield:SpamfilterFortishield';

    /**
     * Returns true if the given object is an instance of SpamfilterFortishield.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SpamfilterFortishield {
