...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:filefilter/profile:Profile';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.filefilter.ProfileRule[] | undefined>;
    /**
...
export interface ProfileState {
     ...
     * File filter rules. The structure of `rules` block is documented below.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.filefilter.ProfileRule>[]>;
    /**
     * Enable/disable archive contents scan. (Not for CIFS) Valid values: `disable`, `enable`.
     */
