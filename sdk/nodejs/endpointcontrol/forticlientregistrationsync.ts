...
export class Forticlientregistrationsync extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ForticlientregistrationsyncState, opts?: pulumi.CustomResourceOptions): Forticlientregistrationsync {
        return new Forticlientregistrationsync(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:endpointcontrol/forticlientregistrationsync:Forticlientregistrationsync';

    /**
     * Returns true if the given object is an instance of Forticlientregistrationsync.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Forticlientregistrationsync {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Forticlientregistrationsync.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ForticlientregistrationsyncArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ForticlientregistrationsyncArgs | ForticlientregistrationsyncState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ForticlientregistrationsyncState | undefined;
            resourceInputs["peerIp"] = state ? state.peerIp : undefined;
            resourceInputs["peerName"] = state ? state.peerName : undefined;
            resourceInputs["vdomparam"] = state ? state.vdomparam : undefined;
        } else {
            const args = argsOrState as ForticlientregistrationsyncArgs | undefined;
        ...
        super(Forticlientregistrationsync.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ForticlientregistrationsyncState {
    /**
     * IP address of the peer FortiGate for endpoint license synchronization.
     */
 ...
 */
export interface ForticlientregistrationsyncArgs {
    /**
     * IP address of the peer FortiGate for endpoint license synchronization.
     */
    peerIp: pulumi.Input<string>;
