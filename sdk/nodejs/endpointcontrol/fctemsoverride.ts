 ...
 */
export class Fctemsoverride extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FctemsoverrideState, opts?: pulumi.CustomResourceOptions): Fctemsoverride {
        return new Fctemsoverride(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:endpointcontrol/fctemsoverride:Fctemsoverride';

    /**
     * Returns true if the given object is an instance of Fctemsoverride.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Fctemsoverride {
     ...
     */
    constructor(name: string, args?: FctemsoverrideArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FctemsoverrideArgs | FctemsoverrideState, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface FctemsoverrideState {
    /**
     * FortiClient EMS call timeout in seconds (1 - 180 seconds, default = 30).
     */
 ...
 */
export interface FctemsoverrideArgs {
    /**
     * FortiClient EMS call timeout in seconds (1 - 180 seconds, default = 30).
     */
    callTimeout?: pulumi.Input<number>;
