 ...
 *
 * const trname = new fortios.LognulldeviceFilter("trname", {
 *     anomaly: "enable",
 *     dns: "enable",
 *     filterType: "include",
 ...
 */
export class LognulldeviceFilter extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LognulldeviceFilterState, opts?: pulumi.CustomResourceOptions): LognulldeviceFilter {
        return new LognulldeviceFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/lognulldeviceFilter:LognulldeviceFilter';

    /**
     * Returns true if the given object is an instance of LognulldeviceFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LognulldeviceFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LognulldeviceFilter.__pulumiType;
    }
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.LognulldeviceFilterFreeStyle[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: LognulldeviceFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LognulldeviceFilterArgs | LognulldeviceFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LognulldeviceFilterState | undefined;
            ...
            const args = argsOrState as LognulldeviceFilterArgs | undefined;
        ...
        super(LognulldeviceFilter.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LognulldeviceFilterState {
    /**
     * Enable/disable anomaly logging. Valid values: `enable`, `disable`.
     */
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.LognulldeviceFilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
 ...
 */
export interface LognulldeviceFilterArgs {
    /**
     * Enable/disable anomaly logging. Valid values: `enable`, `disable`.
     */
    anomaly?: pulumi.Input<string>;
