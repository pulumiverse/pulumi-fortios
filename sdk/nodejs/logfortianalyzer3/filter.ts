 ...
 *
 * const trname = new fortios.logfortianalyzer3.Filter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class Filter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzer3/filter:Filter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.logfortianalyzer3.FilterFreeStyle[] | undefined>;
    /**
...
export interface FilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.logfortianalyzer3.FilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
