...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "fortios:logfortianalyzer3/filter:Filter":
                return new Filter(name, <any>undefined, { urn })
            case "fortios:logfortianalyzer3/overridefilter:Overridefilter":
                return new Overridefilter(name, <any>undefined, { urn })
            case "fortios:logfortianalyzer3/overridesetting:Overridesetting":
                return new Overridesetting(name, <any>undefined, { urn })
            case "fortios:logfortianalyzer3/setting:Setting":
...
pulumi.runtime.registerResourceModule("fortios", "logfortianalyzer3/filter", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortianalyzer3/overridefilter", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortianalyzer3/overridesetting", _module)
pulumi.runtime.registerResourceModule("fortios", "logfortianalyzer3/setting", _module)
