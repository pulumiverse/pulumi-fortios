 ...
 *
 * const trname = new fortios.logfortianalyzer3.Overridefilter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class Overridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzer3/overridefilter:Overridefilter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.logfortianalyzer3.OverridefilterFreeStyle[] | undefined>;
    /**
...
export interface OverridefilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.logfortianalyzer3.OverridefilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
