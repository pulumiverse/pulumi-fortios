 ...
 *
 * const trname = new fortios.logfortianalyzer3.Setting("trname", {
 *     __changeIp: 0,
 *     connTimeout: 10,
 *     encAlgorithm: "high",
 *     fazType: 3,
...
export class Setting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzer3/setting:Setting';
     ...
     */
    public readonly serials!: pulumi.Output<outputs.logfortianalyzer3.SettingSerial[] | undefined>;
    /**
...
export interface SettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.logfortianalyzer3.SettingSerial>[]>;
    /**
     * The remote FortiAnalyzer.
     */
