 ...
 *
 * const trname = new fortios.logfortianalyzer3.Overridesetting("trname", {
 *     __changeIp: 0,
 *     connTimeout: 10,
 *     encAlgorithm: "high",
 *     fazType: 6,
...
export class Overridesetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:logfortianalyzer3/overridesetting:Overridesetting';
     ...
     */
    public readonly serials!: pulumi.Output<outputs.logfortianalyzer3.OverridesettingSerial[] | undefined>;
    /**
...
export interface OverridesettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.logfortianalyzer3.OverridesettingSerial>[]>;
    /**
     * The remote FortiAnalyzer.
     */
