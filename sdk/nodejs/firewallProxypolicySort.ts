...
export class FirewallProxypolicySort extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallProxypolicySortState, opts?: pulumi.CustomResourceOptions): FirewallProxypolicySort {
        return new FirewallProxypolicySort(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/firewallProxypolicySort:FirewallProxypolicySort';

    /**
     * Returns true if the given object is an instance of FirewallProxypolicySort.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirewallProxypolicySort {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FirewallProxypolicySort.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: FirewallProxypolicySortArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FirewallProxypolicySortArgs | FirewallProxypolicySortState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FirewallProxypolicySortState | undefined;
            ...
            const args = argsOrState as FirewallProxypolicySortArgs | undefined;
        ...
        super(FirewallProxypolicySort.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FirewallProxypolicySortState {
 ...
 */
export interface FirewallProxypolicySortArgs {
    comment?: pulumi.Input<string>;
    forceRecreate?: pulumi.Input<string>;
    sortby: pulumi.Input<string>;
    sortdirection: pulumi.Input<string>;
