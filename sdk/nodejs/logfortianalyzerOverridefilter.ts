 ...
 *
 * const trname = new fortios.LogfortianalyzerOverridefilter("trname", {
 *     anomaly: "enable",
 *     dlpArchive: "enable",
 *     dns: "enable",
 *     filterType: "include",
...
export class LogfortianalyzerOverridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logfortianalyzerOverridefilter:LogfortianalyzerOverridefilter';
     ...
     */
    public readonly freeStyles!: pulumi.Output<outputs.LogfortianalyzerOverridefilterFreeStyle[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LogfortianalyzerOverridefilterArgs | LogfortianalyzerOverridefilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogfortianalyzerOverridefilter.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface LogfortianalyzerOverridefilterState {
     ...
     * Free Style Filters The structure of `freeStyle` block is documented below.
     */
    freeStyles?: pulumi.Input<pulumi.Input<inputs.LogfortianalyzerOverridefilterFreeStyle>[]>;
    /**
     * Enable/disable GTP messages logging. Valid values: `enable`, `disable`.
     */
