 ...
 *
 * const trname = new fortios.spamfilter.Bwl("trname", {
 *     comment: "test",
 *     entries: [{
 *         action: "reject",
 *         addrType: "ipv4",
...
export class Bwl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:spamfilter/bwl:Bwl';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.spamfilter.BwlEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface BwlState {
     ...
     * Anti-spam black/white list entries. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.spamfilter.BwlEntry>[]>;
    /**
     * ID.
     */
