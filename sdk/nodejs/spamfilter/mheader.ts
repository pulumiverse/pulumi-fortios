 ...
 *
 * const trname = new fortios.spamfilter.Mheader("trname", {
 *     comment: "test",
 *     entries: [{
 *         action: "spam",
 *         fieldbody: "scstest",
...
export class Mheader extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:spamfilter/mheader:Mheader';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.spamfilter.MheaderEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface MheaderState {
     ...
     * Spam filter mime header content. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.spamfilter.MheaderEntry>[]>;
    /**
     * ID.
     */
