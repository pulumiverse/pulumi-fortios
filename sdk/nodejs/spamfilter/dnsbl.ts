 ...
 *
 * const trname = new fortios.spamfilter.Dnsbl("trname", {
 *     comment: "test",
 *     entries: [{
 *         action: "reject",
 *         server: "1.1.1.1",
...
export class Dnsbl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:spamfilter/dnsbl:Dnsbl';
     ...
     */
    public readonly entries!: pulumi.Output<outputs.spamfilter.DnsblEntry[] | undefined>;
    /**
     * ID.
     */
...
export interface DnsblState {
     ...
     * Spam filter DNSBL and ORBL server. The structure of `entries` block is documented below.
     */
    entries?: pulumi.Input<pulumi.Input<inputs.spamfilter.DnsblEntry>[]>;
    /**
     * ID.
     */
