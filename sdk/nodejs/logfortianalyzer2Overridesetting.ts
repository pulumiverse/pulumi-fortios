 ...
 *
 * const trname = new fortios.Logfortianalyzer2Overridesetting("trname", {
 *     __changeIp: 0,
 *     connTimeout: 10,
 *     encAlgorithm: "high",
 *     fazType: 5,
 ...
 */
export class Logfortianalyzer2Overridesetting extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Logfortianalyzer2OverridesettingState, opts?: pulumi.CustomResourceOptions): Logfortianalyzer2Overridesetting {
        return new Logfortianalyzer2Overridesetting(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/logfortianalyzer2Overridesetting:Logfortianalyzer2Overridesetting';

    /**
     * Returns true if the given object is an instance of Logfortianalyzer2Overridesetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Logfortianalyzer2Overridesetting {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Logfortianalyzer2Overridesetting.__pulumiType;
    }
     ...
     */
    public readonly serials!: pulumi.Output<outputs.Logfortianalyzer2OverridesettingSerial[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: Logfortianalyzer2OverridesettingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Logfortianalyzer2OverridesettingArgs | Logfortianalyzer2OverridesettingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Logfortianalyzer2Overridesetting.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface Logfortianalyzer2OverridesettingState {
     ...
     * Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
     */
    serials?: pulumi.Input<pulumi.Input<inputs.Logfortianalyzer2OverridesettingSerial>[]>;
    /**
     * The remote FortiAnalyzer.
     */
