 ...
 *
 * const trname3 = new fortios.vpnipsec.Phase1interface("trname3", {
 *     acctVerify: "disable",
 *     addGwRoute: "disable",
 *     addRoute: "enable",
 *     assignIp: "enable",
 ...
 *     xauthtype: "disable",
 * });
 * const trname2 = new fortios.vpnipsec.Phase2interface("trname2", {
 *     addRoute: "phase1",
 ...
 */
export class Phase2interface extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Phase2interfaceState, opts?: pulumi.CustomResourceOptions): Phase2interface {
        return new Phase2interface(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:vpnipsec/phase2interface:Phase2interface';

    /**
     * Returns true if the given object is an instance of Phase2interface.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Phase2interface {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Phase2interface.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: Phase2interfaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Phase2interfaceArgs | Phase2interfaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Phase2interfaceState | undefined;
            ...
            const args = argsOrState as Phase2interfaceArgs | undefined;
        ...
        super(Phase2interface.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface Phase2interfaceState {
    /**
     * Enable/disable automatic route addition. Valid values: `phase1`, `enable`, `disable`.
     */
 ...
 */
export interface Phase2interfaceArgs {
    /**
     * Enable/disable automatic route addition. Valid values: `phase1`, `enable`, `disable`.
     */
    addRoute?: pulumi.Input<string>;
