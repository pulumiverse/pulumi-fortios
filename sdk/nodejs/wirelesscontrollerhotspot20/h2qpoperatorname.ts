 ...
 *
 * const trname = new fortios.wirelesscontrollerhotspot20.H2qpoperatorname("trname", {});
 * ```
 *
 * ## Import
 *
...
export class H2qpoperatorname extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:wirelesscontrollerhotspot20/h2qpoperatorname:H2qpoperatorname';
     ...
     */
    public readonly valueLists!: pulumi.Output<outputs.wirelesscontrollerhotspot20.H2qpoperatornameValueList[] | undefined>;
    /**
...
export interface H2qpoperatornameState {
     ...
     * Name list. The structure of `valueList` block is documented below.
     */
    valueLists?: pulumi.Input<pulumi.Input<inputs.wirelesscontrollerhotspot20.H2qpoperatornameValueList>[]>;
    /**
     * Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
