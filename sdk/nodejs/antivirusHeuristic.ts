 ...
 *
 * const trname = new fortios.AntivirusHeuristic("trname", {mode: "disable"});
 * ```
 *
 * ## Import
 *
 ...
 */
export class AntivirusHeuristic extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AntivirusHeuristicState, opts?: pulumi.CustomResourceOptions): AntivirusHeuristic {
        return new AntivirusHeuristic(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/antivirusHeuristic:AntivirusHeuristic';

    /**
     * Returns true if the given object is an instance of AntivirusHeuristic.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AntivirusHeuristic {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AntivirusHeuristic.__pulumiType;
    }
 ...
 */
export interface AntivirusHeuristicState {
    /**
     * Enable/disable heuristics and determine how the system behaves if heuristics detects a problem. Valid values: `pass`, `block`, `disable`.
     */
 ...
 */
export interface AntivirusHeuristicArgs {
    /**
     * Enable/disable heuristics and determine how the system behaves if heuristics detects a problem. Valid values: `pass`, `block`, `disable`.
     */
    mode?: pulumi.Input<string>;
