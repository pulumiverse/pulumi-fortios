...
export class Ssoadmin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/ssoadmin:Ssoadmin';
     ...
     */
    public readonly vdoms!: pulumi.Output<outputs.system.SsoadminVdom[] | undefined>;
...
export interface SsoadminState {
     ...
     * Virtual domain(s) that the administrator can access. The structure of `vdom` block is documented below.
     */
    vdoms?: pulumi.Input<pulumi.Input<inputs.system.SsoadminVdom>[]>;
}
