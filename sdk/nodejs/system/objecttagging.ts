...
export class Objecttagging extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/objecttagging:Objecttagging';
     ...
     */
    public readonly tags!: pulumi.Output<outputs.system.ObjecttaggingTag[] | undefined>;
    /**
...
export interface ObjecttaggingState {
     ...
     * Tags. The structure of `tags` block is documented below.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.system.ObjecttaggingTag>[]>;
    /**
     * Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
