...
export function getAutomationaction(args: GetAutomationactionArgs, opts?: pulumi.InvokeOptions): Promise<GetAutomationactionResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/getAutomationaction:getAutomationaction", {
        "name": args.name,
...
export interface GetAutomationactionResult {
     ...
     */
    readonly emailTos: outputs.system.GetAutomationactionEmailTo[];
    /**
     ...
     */
    readonly headers: outputs.system.GetAutomationactionHeader[];
    /**
     ...
     */
    readonly httpHeaders: outputs.system.GetAutomationactionHttpHeader[];
    /**
     ...
     */
    readonly sdnConnectors: outputs.system.GetAutomationactionSdnConnector[];
    /**
     * NSX security tag.
     */
