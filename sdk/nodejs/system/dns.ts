...
export class Dns extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/dns:Dns';
     ...
     */
    public readonly domains!: pulumi.Output<outputs.system.DnsDomain[] | undefined>;
    /**
     ...
     */
    public readonly serverHostnames!: pulumi.Output<outputs.system.DnsServerHostname[] | undefined>;
    /**
...
export interface DnsState {
     ...
     * Search suffix list for hostname lookup. The structure of `domain` block is documented below.
     */
    domains?: pulumi.Input<pulumi.Input<inputs.system.DnsDomain>[]>;
    /**
     * Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
     */
     ...
     * DNS server host name list. The structure of `serverHostname` block is documented below.
     */
    serverHostnames?: pulumi.Input<pulumi.Input<inputs.system.DnsServerHostname>[]>;
    /**
     * Specify how configured servers are prioritized. Valid values: `least-rtt`, `failover`.
     */
