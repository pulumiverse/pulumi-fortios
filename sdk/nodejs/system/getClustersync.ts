...
export function getClustersync(args: GetClustersyncArgs, opts?: pulumi.InvokeOptions): Promise<GetClustersyncResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/getClustersync:getClustersync", {
        "syncId": args.syncId,
...
export interface GetClustersyncResult {
     ...
     */
    readonly downIntfsBeforeSessSyncs: outputs.system.GetClustersyncDownIntfsBeforeSessSync[];
    /**
     ...
     */
    readonly sessionSyncFilters: outputs.system.GetClustersyncSessionSyncFilter[];
    /**
     * Enable/disable IKE route announcement on the backup unit.
     */
     ...
     */
    readonly syncvds: outputs.system.GetClustersyncSyncvd[];
