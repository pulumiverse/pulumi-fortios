...
export class Automationtrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/automationtrigger:Automationtrigger';
     ...
     */
    public readonly vdoms!: pulumi.Output<outputs.system.AutomationtriggerVdom[] | undefined>;
...
export interface AutomationtriggerState {
     ...
     * Virtual domain(s) that this trigger is valid for. The structure of `vdom` block is documented below.
     */
    vdoms?: pulumi.Input<pulumi.Input<inputs.system.AutomationtriggerVdom>[]>;
}
