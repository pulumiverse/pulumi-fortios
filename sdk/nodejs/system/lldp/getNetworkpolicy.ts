...
export function getNetworkpolicy(args: GetNetworkpolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkpolicyResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/lldp/getNetworkpolicy:getNetworkpolicy", {
        "name": args.name,
...
export interface GetNetworkpolicyResult {
     ...
     */
    readonly guestVoiceSignalings: outputs.system.lldp.GetNetworkpolicyGuestVoiceSignaling[];
    /**
     * Guest. The structure of `guest` block is documented below.
     */
    readonly guests: outputs.system.lldp.GetNetworkpolicyGuest[];
    /**
     ...
     */
    readonly softphones: outputs.system.lldp.GetNetworkpolicySoftphone[];
    /**
     * Streaming Video. The structure of `streamingVideo` block is documented below.
     */
    readonly streamingVideos: outputs.system.lldp.GetNetworkpolicyStreamingVideo[];
    readonly vdomparam?: string;
    /**
     * Video Conferencing. The structure of `videoConferencing` block is documented below.
     */
    readonly videoConferencings: outputs.system.lldp.GetNetworkpolicyVideoConferencing[];
    /**
     * Video Signaling. The structure of `videoSignaling` block is documented below.
     */
    readonly videoSignalings: outputs.system.lldp.GetNetworkpolicyVideoSignaling[];
    /**
     * Voice signaling. The structure of `voiceSignaling` block is documented below.
     */
    readonly voiceSignalings: outputs.system.lldp.GetNetworkpolicyVoiceSignaling[];
    /**
     * Voice. The structure of `voice` block is documented below.
     */
    readonly voices: outputs.system.lldp.GetNetworkpolicyVoice[];
}
/**
 * Use this data source to get information on an fortios systemlldp networkpolicy
 */
