...
export class Networkpolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/lldp/networkpolicy:Networkpolicy';
     ...
     */
    public readonly guestVoiceSignaling!: pulumi.Output<outputs.system.lldp.NetworkpolicyGuestVoiceSignaling>;
    /**
     ...
     */
    public readonly softphone!: pulumi.Output<outputs.system.lldp.NetworkpolicySoftphone>;
    /**
     * Streaming Video. The structure of `streamingVideo` block is documented below.
     */
    public readonly streamingVideo!: pulumi.Output<outputs.system.lldp.NetworkpolicyStreamingVideo>;
    /**
     ...
     */
    public readonly videoConferencing!: pulumi.Output<outputs.system.lldp.NetworkpolicyVideoConferencing>;
    /**
     * Video Signaling. The structure of `videoSignaling` block is documented below.
     */
    public readonly videoSignaling!: pulumi.Output<outputs.system.lldp.NetworkpolicyVideoSignaling>;
    /**
     * Voice. The structure of `voice` block is documented below.
     */
    public readonly voice!: pulumi.Output<outputs.system.lldp.NetworkpolicyVoice>;
    /**
     * Voice signaling. The structure of `voiceSignaling` block is documented below.
     */
    public readonly voiceSignaling!: pulumi.Output<outputs.system.lldp.NetworkpolicyVoiceSignaling>;
...
export interface NetworkpolicyState {
     ...
     * Guest. The structure of `guest` block is documented below.
     */
    guest?: pulumi.Input<inputs.system.lldp.NetworkpolicyGuest>;
    /**
     * Guest Voice Signaling. The structure of `guestVoiceSignaling` block is documented below.
     */
    guestVoiceSignaling?: pulumi.Input<inputs.system.lldp.NetworkpolicyGuestVoiceSignaling>;
    /**
     * LLDP network policy name.
     */
     ...
     * Softphone. The structure of `softphone` block is documented below.
     */
    softphone?: pulumi.Input<inputs.system.lldp.NetworkpolicySoftphone>;
    /**
     * Streaming Video. The structure of `streamingVideo` block is documented below.
     */
    streamingVideo?: pulumi.Input<inputs.system.lldp.NetworkpolicyStreamingVideo>;
    /**
     * Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
     ...
     * Video Conferencing. The structure of `videoConferencing` block is documented below.
     */
    videoConferencing?: pulumi.Input<inputs.system.lldp.NetworkpolicyVideoConferencing>;
    /**
     * Video Signaling. The structure of `videoSignaling` block is documented below.
     */
    videoSignaling?: pulumi.Input<inputs.system.lldp.NetworkpolicyVideoSignaling>;
    /**
     * Voice. The structure of `voice` block is documented below.
     */
    voice?: pulumi.Input<inputs.system.lldp.NetworkpolicyVoice>;
    /**
     * Voice signaling. The structure of `voiceSignaling` block is documented below.
     */
    voiceSignaling?: pulumi.Input<inputs.system.lldp.NetworkpolicyVoiceSignaling>;
}
