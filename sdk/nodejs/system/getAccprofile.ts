...
export function getAccprofile(args: GetAccprofileArgs, opts?: pulumi.InvokeOptions): Promise<GetAccprofileResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/getAccprofile:getAccprofile", {
        "name": args.name,
...
export interface GetAccprofileResult {
     ...
     */
    readonly fwgrpPermissions: outputs.system.GetAccprofileFwgrpPermission[];
    /**
     ...
     */
    readonly loggrpPermissions: outputs.system.GetAccprofileLoggrpPermission[];
    /**
     * Profile name.
     */
     ...
     */
    readonly netgrpPermissions: outputs.system.GetAccprofileNetgrpPermission[];
    /**
     ...
     */
    readonly sysgrpPermissions: outputs.system.GetAccprofileSysgrpPermission[];
    /**
     ...
     */
    readonly utmgrpPermissions: outputs.system.GetAccprofileUtmgrpPermission[];
