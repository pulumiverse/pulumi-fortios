 ...
 */
export class Nacquar extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NacquarState, opts?: pulumi.CustomResourceOptions): Nacquar {
        return new Nacquar(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:system/replacemsg/nacquar:Nacquar';

    /**
     * Returns true if the given object is an instance of Nacquar.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Nacquar {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Nacquar.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: NacquarArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NacquarArgs | NacquarState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NacquarState | undefined;
            ...
            const args = argsOrState as NacquarArgs | undefined;
        ...
        super(Nacquar.__pulumiType, name, resourceInputs, opts);
    }
}
