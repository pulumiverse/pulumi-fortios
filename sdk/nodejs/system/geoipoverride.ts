...
export class Geoipoverride extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/geoipoverride:Geoipoverride';
     ...
     */
    public readonly ipRanges!: pulumi.Output<outputs.system.GeoipoverrideIpRange[] | undefined>;
    /**
     * Location name.
     */
...
export interface GeoipoverrideState {
     ...
     * Table of IPv6 ranges assigned to country. The structure of `ip6Range` block is documented below.
     */
    ip6Ranges?: pulumi.Input<pulumi.Input<inputs.system.GeoipoverrideIp6Range>[]>;
    /**
     * Table of IP ranges assigned to country. The structure of `ipRange` block is documented below.
     */
    ipRanges?: pulumi.Input<pulumi.Input<inputs.system.GeoipoverrideIpRange>[]>;
    /**
     * Location name.
     */
