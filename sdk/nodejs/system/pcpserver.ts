...
export class Pcpserver extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/pcpserver:Pcpserver';
     ...
     */
    public readonly pools!: pulumi.Output<outputs.system.PcpserverPool[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PcpserverArgs | PcpserverState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Pcpserver.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface PcpserverState {
     ...
     * Configure PCP pools. The structure of `pools` block is documented below.
     */
    pools?: pulumi.Input<pulumi.Input<inputs.system.PcpserverPool>[]>;
    /**
     * Enable/disable PCP server. Valid values: `enable`, `disable`.
     */
