...
export function getLinkmonitor(args: GetLinkmonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetLinkmonitorResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/getLinkmonitor:getLinkmonitor", {
        "name": args.name,
...
export interface GetLinkmonitorResult {
     ...
     */
    readonly routes: outputs.system.GetLinkmonitorRoute[];
    /**
     ...
     */
    readonly serverLists: outputs.system.GetLinkmonitorServerList[];
    /**
     ...
     */
    readonly servers: outputs.system.GetLinkmonitorServer[];
    /**
