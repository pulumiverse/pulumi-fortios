...
export function getVxlan(args: GetVxlanArgs, opts?: pulumi.InvokeOptions): Promise<GetVxlanResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/getVxlan:getVxlan", {
        "name": args.name,
...
export interface GetVxlanResult {
     ...
     */
    readonly remoteIp6s: outputs.system.GetVxlanRemoteIp6[];
    /**
     ...
     */
    readonly remoteIps: outputs.system.GetVxlanRemoteIp[];
