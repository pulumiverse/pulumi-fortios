...
export class Acme extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/acme:Acme';
     ...
     */
    public readonly accounts!: pulumi.Output<outputs.system.AcmeAccount[] | undefined>;
    /**
...
export interface AcmeState {
     ...
     * ACME accounts list. The structure of `accounts` block is documented below.
     */
    accounts?: pulumi.Input<pulumi.Input<inputs.system.AcmeAccount>[]>;
    /**
     * Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
     */
