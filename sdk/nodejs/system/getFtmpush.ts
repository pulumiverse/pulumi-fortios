 ...
 */
export function getFtmpush(args?: GetFtmpushArgs, opts?: pulumi.InvokeOptions): Promise<GetFtmpushResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("fortios:system/getFtmpush:getFtmpush", {
 ...
 */
export interface GetFtmpushArgs {
    /**
 ...
 */
export interface GetFtmpushResult {
    /**
 ...
 * Use this data source to get information on fortios system ftmpush
 */
export function getFtmpushOutput(args?: GetFtmpushOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFtmpushResult> {
    return pulumi.output(args).apply((a: any) => getFtmpush(a, opts))
}

/**
 * A collection of arguments for invoking getFtmpush.
 */
export interface GetFtmpushOutputArgs {
    /**
     * Specifies the vdom to which the data source will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
