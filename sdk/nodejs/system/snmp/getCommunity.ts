...
export function getCommunity(args: GetCommunityArgs, opts?: pulumi.InvokeOptions): Promise<GetCommunityResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/snmp/getCommunity:getCommunity", {
        "fosid": args.fosid,
...
export interface GetCommunityResult {
     ...
     */
    readonly hosts: outputs.system.snmp.GetCommunityHost[];
    /**
     * Configure IPv6 SNMP managers. The structure of `hosts6` block is documented below.
     */
    readonly hosts6s: outputs.system.snmp.GetCommunityHosts6[];
    /**
     ...
     */
    readonly vdoms: outputs.system.snmp.GetCommunityVdom[];
}
/**
 * Use this data source to get information on an fortios systemsnmp community
 */
