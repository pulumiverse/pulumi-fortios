...
export class Nat64 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/nat64:Nat64';
     ...
     */
    public readonly secondaryPrefixes!: pulumi.Output<outputs.system.Nat64SecondaryPrefix[] | undefined>;
    /**
...
export interface Nat64State {
     ...
     * Secondary NAT64 prefix. The structure of `secondaryPrefix` block is documented below.
     */
    secondaryPrefixes?: pulumi.Input<pulumi.Input<inputs.system.Nat64SecondaryPrefix>[]>;
    /**
     * Enable/disable NAT64 (default = disable). Valid values: `enable`, `disable`.
     */
