...
export class Sdnconnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/sdnconnector:Sdnconnector';
     ...
     */
    public readonly externalAccountLists!: pulumi.Output<outputs.system.SdnconnectorExternalAccountList[] | undefined>;
    /**
     * Configure GCP external IP. The structure of `externalIp` block is documented below.
     */
    public readonly externalIps!: pulumi.Output<outputs.system.SdnconnectorExternalIp[] | undefined>;
    /**
     * Configure GCP forwarding rule. The structure of `forwardingRule` block is documented below.
     */
    public readonly forwardingRules!: pulumi.Output<outputs.system.SdnconnectorForwardingRule[] | undefined>;
    /**
     * GCP project name.
     */
     ...
     */
    public readonly nics!: pulumi.Output<outputs.system.SdnconnectorNic[] | undefined>;
    /**
     * OCI certificate.
     */
     ...
     */
    public readonly routeTables!: pulumi.Output<outputs.system.SdnconnectorRouteTable[] | undefined>;
    /**
     * Configure GCP route. The structure of `route` block is documented below.
     */
    public readonly routes!: pulumi.Output<outputs.system.SdnconnectorRoute[] | undefined>;
    /**
     ...
     */
    public readonly serverLists!: pulumi.Output<outputs.system.SdnconnectorServerList[] | undefined>;
    /**
...
export interface SdnconnectorState {
     ...
     * Configure AWS external account list. The structure of `externalAccountList` block is documented below.
     */
    externalAccountLists?: pulumi.Input<pulumi.Input<inputs.system.SdnconnectorExternalAccountList>[]>;
    /**
     * Configure GCP external IP. The structure of `externalIp` block is documented below.
     */
    externalIps?: pulumi.Input<pulumi.Input<inputs.system.SdnconnectorExternalIp>[]>;
    /**
     * Configure GCP forwarding rule. The structure of `forwardingRule` block is documented below.
     */
    forwardingRules?: pulumi.Input<pulumi.Input<inputs.system.SdnconnectorForwardingRule>[]>;
    /**
     * GCP project name.
     */
     ...
     * Configure Azure network interface. The structure of `nic` block is documented below.
     */
    nics?: pulumi.Input<pulumi.Input<inputs.system.SdnconnectorNic>[]>;
    /**
     * OCI certificate.
     */
     ...
     * Configure Azure route table. The structure of `routeTable` block is documented below.
     */
    routeTables?: pulumi.Input<pulumi.Input<inputs.system.SdnconnectorRouteTable>[]>;
    /**
     * Configure GCP route. The structure of `route` block is documented below.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.system.SdnconnectorRoute>[]>;
    /**
     * AWS secret access key.
     */
     ...
     * Server address list of the remote SDN connector. The structure of `serverList` block is documented below.
     */
    serverLists?: pulumi.Input<pulumi.Input<inputs.system.SdnconnectorServerList>[]>;
    /**
     * Port number of the remote SDN connector.
     */
