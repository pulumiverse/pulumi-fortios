...
export function getNtp(args?: GetNtpArgs, opts?: pulumi.InvokeOptions): Promise<GetNtpResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/getNtp:getNtp", {
...
export interface GetNtpResult {
     ...
     */
    readonly interfaces: outputs.system.GetNtpInterface[];
    /**
     ...
     */
    readonly ntpservers: outputs.system.GetNtpNtpserver[];
    /**
