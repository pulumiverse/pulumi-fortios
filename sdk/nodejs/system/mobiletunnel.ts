...
export class Mobiletunnel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/mobiletunnel:Mobiletunnel';
     ...
     */
    public readonly networks!: pulumi.Output<outputs.system.MobiletunnelNetwork[] | undefined>;
    /**
...
export interface MobiletunnelState {
     ...
     * NEMO network configuration. The structure of `network` block is documented below.
     */
    networks?: pulumi.Input<pulumi.Input<inputs.system.MobiletunnelNetwork>[]>;
    /**
     * NMMO HA registration interval (5 - 300, default = 5).
     */
