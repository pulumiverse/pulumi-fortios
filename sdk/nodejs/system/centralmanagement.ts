...
export class Centralmanagement extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/centralmanagement:Centralmanagement';
     ...
     */
    public readonly serverLists!: pulumi.Output<outputs.system.CentralmanagementServerList[] | undefined>;
    /**
...
export interface CentralmanagementState {
     ...
     * Additional severs that the FortiGate can use for updates (for AV, IPS, updates) and ratings (for web filter and antispam ratings) servers. The structure of `serverList` block is documented below.
     */
    serverLists?: pulumi.Input<pulumi.Input<inputs.system.CentralmanagementServerList>[]>;
    /**
     * Central management type. Valid values: `fortimanager`, `fortiguard`, `none`.
     */
