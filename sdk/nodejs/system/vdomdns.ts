...
export class Vdomdns extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/vdomdns:Vdomdns';
     ...
     */
    public readonly serverHostnames!: pulumi.Output<outputs.system.VdomdnsServerHostname[] | undefined>;
    /**
...
export interface VdomdnsState {
     ...
     * DNS server host name list. The structure of `serverHostname` block is documented below.
     */
    serverHostnames?: pulumi.Input<pulumi.Input<inputs.system.VdomdnsServerHostname>[]>;
    /**
     * Specify how configured servers are prioritized. Valid values: `least-rtt`, `failover`.
     */
