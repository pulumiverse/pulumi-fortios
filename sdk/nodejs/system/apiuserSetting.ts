...
export class ApiuserSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:system/apiuserSetting:ApiuserSetting';
    ...
    public readonly trusthosts!: pulumi.Output<outputs.system.ApiuserSettingTrusthost[]>;
    /**
     * Virtual domains.
...
export interface ApiuserSettingState {
    ...
    trusthosts?: pulumi.Input<pulumi.Input<inputs.system.ApiuserSettingTrusthost>[]>;
    /**
     * Virtual domains.
     * * `trusthost-Type` - (Required) Trusthost type.
     * * `trusthost-ipv4_trusthost` - (Required) IPv4 trusted host address.
