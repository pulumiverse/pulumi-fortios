...
export function getAdmin(args: GetAdminArgs, opts?: pulumi.InvokeOptions): Promise<GetAdminResult> {
    ...
    return pulumi.runtime.invoke("fortios:system/getAdmin:getAdmin", {
        "name": args.name,
...
export interface GetAdminResult {
     ...
     */
    readonly loginTimes: outputs.system.GetAdminLoginTime[];
    /**
     ...
     */
    readonly vdoms: outputs.system.GetAdminVdom[];
    /**
