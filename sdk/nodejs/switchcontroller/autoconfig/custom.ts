...
export class Custom extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:switchcontroller/autoconfig/custom:Custom';
     ...
     */
    public readonly switchBindings!: pulumi.Output<outputs.switchcontroller.autoconfig.CustomSwitchBinding[] | undefined>;
    /**
...
export interface CustomState {
     ...
     * Switch binding list. The structure of `switchBinding` block is documented below.
     */
    switchBindings?: pulumi.Input<pulumi.Input<inputs.switchcontroller.autoconfig.CustomSwitchBinding>[]>;
    /**
     * Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
