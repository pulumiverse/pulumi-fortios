...
export class Policy8021X extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:switchcontroller/securitypolicy/policy8021X:Policy8021X';
     ...
     */
    public readonly userGroups!: pulumi.Output<outputs.switchcontroller.securitypolicy.Policy8021XUserGroup[] | undefined>;
    /**
...
export interface Policy8021XState {
     ...
     * Name of user-group to assign to this MAC Authentication Bypass (MAB) policy. The structure of `userGroup` block is documented below.
     */
    userGroups?: pulumi.Input<pulumi.Input<inputs.switchcontroller.securitypolicy.Policy8021XUserGroup>[]>;
    /**
     * Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
     */
