...
export class Queuepolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:switchcontroller/qos/queuepolicy:Queuepolicy';
     ...
     */
    public readonly cosQueues!: pulumi.Output<outputs.switchcontroller.qos.QueuepolicyCosQueue[] | undefined>;
    /**
...
export interface QueuepolicyState {
     ...
     * COS queue configuration. The structure of `cosQueue` block is documented below.
     */
    cosQueues?: pulumi.Input<pulumi.Input<inputs.switchcontroller.qos.QueuepolicyCosQueue>[]>;
    /**
     * Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -> [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -> [ a10, a2 ].
     */
