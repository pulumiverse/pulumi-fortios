 ...
 *
 * const trname = new fortios.RouterKeychain("trname", {keys: [{
...
export class RouterKeychain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortios:index/routerKeychain:RouterKeychain';
    ...
    constructor(name: string, argsOrState?: RouterKeychainArgs | RouterKeychainState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RouterKeychain.__pulumiType, name, resourceInputs, opts);
    }
}
