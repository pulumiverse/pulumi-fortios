...
export class VpnPptp extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpnPptpState, opts?: pulumi.CustomResourceOptions): VpnPptp {
        return new VpnPptp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/vpnPptp:VpnPptp';

    /**
     * Returns true if the given object is an instance of VpnPptp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VpnPptp {
