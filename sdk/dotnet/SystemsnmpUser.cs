...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemsnmpUser("trname", new()
    ///     {
    ///         AuthProto = "sha",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemsnmpUser:SystemsnmpUser")]
    public partial class SystemsnmpUser : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("vdoms")]
        public Output<ImmutableArray<Outputs.SystemsnmpUserVdom>> Vdoms { get; private set; } = null!;
        ...
        public SystemsnmpUser(string name, SystemsnmpUserArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemsnmpUser:SystemsnmpUser", name, args ?? new SystemsnmpUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemsnmpUser(string name, Input<string> id, SystemsnmpUserState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemsnmpUser:SystemsnmpUser", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemsnmpUser Get(string name, Input<string> id, SystemsnmpUserState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemsnmpUser(name, id, state, options);
        }
    }

    public sealed class SystemsnmpUserArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication protocol.
        /// </summary>
        ...
        [Input("vdoms")]
        private InputList<Inputs.SystemsnmpUserVdomArgs>? _vdoms;

        /// <summary>
        /// SNMP access control VDOMs. The structure of `vdoms` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemsnmpUserVdomArgs> Vdoms
        {
            get => _vdoms ?? (_vdoms = new InputList<Inputs.SystemsnmpUserVdomArgs>());
            set => _vdoms = value;
        }

        public SystemsnmpUserArgs()
        {
        }
        public static new SystemsnmpUserArgs Empty => new SystemsnmpUserArgs();
    }

    public sealed class SystemsnmpUserState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication protocol.
        /// </summary>
        ...
        [Input("vdoms")]
        private InputList<Inputs.SystemsnmpUserVdomGetArgs>? _vdoms;

        /// <summary>
        /// SNMP access control VDOMs. The structure of `vdoms` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemsnmpUserVdomGetArgs> Vdoms
        {
            get => _vdoms ?? (_vdoms = new InputList<Inputs.SystemsnmpUserVdomGetArgs>());
            set => _vdoms = value;
        }

        public SystemsnmpUserState()
        {
        }
        public static new SystemsnmpUserState Empty => new SystemsnmpUserState();
    }
}
