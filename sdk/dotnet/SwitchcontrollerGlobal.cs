...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SwitchcontrollerGlobal("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/switchcontrollerGlobal:SwitchcontrollerGlobal")]
    public partial class SwitchcontrollerGlobal : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.SwitchcontrollerGlobalCustomCommand>> CustomCommands { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.SwitchcontrollerGlobalDisableDiscovery>> DisableDiscoveries { get; private set; } = null!;
        ...
        public SwitchcontrollerGlobal(string name, SwitchcontrollerGlobalArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerGlobal:SwitchcontrollerGlobal", name, args ?? new SwitchcontrollerGlobalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SwitchcontrollerGlobal(string name, Input<string> id, SwitchcontrollerGlobalState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerGlobal:SwitchcontrollerGlobal", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SwitchcontrollerGlobal Get(string name, Input<string> id, SwitchcontrollerGlobalState? state = null, CustomResourceOptions? options = null)
        {
            return new SwitchcontrollerGlobal(name, id, state, options);
        }
    }

    public sealed class SwitchcontrollerGlobalArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable multiple FortiLink interfaces for redundant connections between a managed FortiSwitch and FortiGate. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        private InputList<Inputs.SwitchcontrollerGlobalCustomCommandArgs>? _customCommands;

        /// <summary>
        /// List of custom commands to be pushed to all FortiSwitches in the VDOM. The structure of `custom_command` block is documented below.
        /// </summary>
        public InputList<Inputs.SwitchcontrollerGlobalCustomCommandArgs> CustomCommands
        {
            get => _customCommands ?? (_customCommands = new InputList<Inputs.SwitchcontrollerGlobalCustomCommandArgs>());
        ...
        private InputList<Inputs.SwitchcontrollerGlobalDisableDiscoveryArgs>? _disableDiscoveries;

        /// <summary>
        /// Prevent this FortiSwitch from discovering. The structure of `disable_discovery` block is documented below.
        /// </summary>
        public InputList<Inputs.SwitchcontrollerGlobalDisableDiscoveryArgs> DisableDiscoveries
        {
            get => _disableDiscoveries ?? (_disableDiscoveries = new InputList<Inputs.SwitchcontrollerGlobalDisableDiscoveryArgs>());
        ...
        public SwitchcontrollerGlobalArgs()
        {
        }
        public static new SwitchcontrollerGlobalArgs Empty => new SwitchcontrollerGlobalArgs();
    }

    public sealed class SwitchcontrollerGlobalState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable multiple FortiLink interfaces for redundant connections between a managed FortiSwitch and FortiGate. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("customCommands")]
        private InputList<Inputs.SwitchcontrollerGlobalCustomCommandGetArgs>? _customCommands;

        /// <summary>
        /// List of custom commands to be pushed to all FortiSwitches in the VDOM. The structure of `custom_command` block is documented below.
        /// </summary>
        public InputList<Inputs.SwitchcontrollerGlobalCustomCommandGetArgs> CustomCommands
        {
            get => _customCommands ?? (_customCommands = new InputList<Inputs.SwitchcontrollerGlobalCustomCommandGetArgs>());
            set => _customCommands = value;
        }
        ...
        [Input("disableDiscoveries")]
        private InputList<Inputs.SwitchcontrollerGlobalDisableDiscoveryGetArgs>? _disableDiscoveries;

        /// <summary>
        /// Prevent this FortiSwitch from discovering. The structure of `disable_discovery` block is documented below.
        /// </summary>
        public InputList<Inputs.SwitchcontrollerGlobalDisableDiscoveryGetArgs> DisableDiscoveries
        {
            get => _disableDiscoveries ?? (_disableDiscoveries = new InputList<Inputs.SwitchcontrollerGlobalDisableDiscoveryGetArgs>());
            set => _disableDiscoveries = value;
        }
        ...
        public SwitchcontrollerGlobalState()
        {
        }
        public static new SwitchcontrollerGlobalState Empty => new SwitchcontrollerGlobalState();
    }
}
