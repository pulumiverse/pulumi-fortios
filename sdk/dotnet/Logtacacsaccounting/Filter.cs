...
namespace Pulumiverse.Fortios.Logtacacsaccounting
{
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logtacacsaccounting/filter:Filter labelname LogTacacsAccountingFilter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logtacacsaccounting/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logtacacsaccounting/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logtacacsaccounting/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
