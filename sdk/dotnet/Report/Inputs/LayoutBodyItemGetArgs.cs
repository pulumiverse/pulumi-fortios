...
namespace Pulumiverse.Fortios.Report.Inputs
{
    ...
    public sealed class LayoutBodyItemGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("lists")]
        private InputList<Inputs.LayoutBodyItemListGetArgs>? _lists;

        /// <summary>
        /// Configure report list item. The structure of `list` block is documented below.
        /// </summary>
        public InputList<Inputs.LayoutBodyItemListGetArgs> Lists
        {
            get => _lists ?? (_lists = new InputList<Inputs.LayoutBodyItemListGetArgs>());
            set => _lists = value;
        }
        ...
        [Input("parameters")]
        private InputList<Inputs.LayoutBodyItemParameterGetArgs>? _parameters;

        /// <summary>
        /// Parameters. The structure of `parameters` block is documented below.
        /// </summary>
        public InputList<Inputs.LayoutBodyItemParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.LayoutBodyItemParameterGetArgs>());
        ...
        public LayoutBodyItemGetArgs()
        {
        }
        public static new LayoutBodyItemGetArgs Empty => new LayoutBodyItemGetArgs();
    }
}
