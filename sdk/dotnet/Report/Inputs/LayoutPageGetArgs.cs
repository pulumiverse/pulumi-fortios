...
namespace Pulumiverse.Fortios.Report.Inputs
{
    ...
    public sealed class LayoutPageGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("footer")]
        public Input<Inputs.LayoutPageFooterGetArgs>? Footer { get; set; }

        /// <summary>
        /// Configure report page header. The structure of `header` block is documented below.
        /// </summary>
        [Input("header")]
        public Input<Inputs.LayoutPageHeaderGetArgs>? Header { get; set; }
        ...
        public LayoutPageGetArgs()
        {
        }
        public static new LayoutPageGetArgs Empty => new LayoutPageGetArgs();
    }
}
