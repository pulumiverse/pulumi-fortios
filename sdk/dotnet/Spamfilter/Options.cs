...
namespace Pulumiverse.Fortios.Spamfilter
{
    ...
    /// {
    ///     var trname = new Fortios.Spamfilter.Options("trname", new()
    ///     {
    ///         DnsTimeout = 7,
    ///     });
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:spamfilter/options:Options")]
    public partial class Options : global::Pulumi.CustomResource
    {
        ...
        public Options(string name, OptionsArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:spamfilter/options:Options", name, args ?? new OptionsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Options(string name, Input<string> id, OptionsState? state = null, CustomResourceOptions? options = null)
            : base("fortios:spamfilter/options:Options", name, state, MakeResourceOptions(options, id))
        {
        }
