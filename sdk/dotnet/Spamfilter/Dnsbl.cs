...
namespace Pulumiverse.Fortios.Spamfilter
{
    ...
    /// {
    ///     var trname = new Fortios.Spamfilter.Dnsbl("trname", new()
    ///     {
    ///         Comment = "test",
    ///         Entries = new[]
    ///         {
    ///             new Fortios.Spamfilter.Inputs.DnsblEntryArgs
    ///             {
    ///                 Action = "reject",
    ///                 Server = "1.1.1.1",
    ///                 Status = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:spamfilter/dnsbl:Dnsbl")]
    public partial class Dnsbl : global::Pulumi.CustomResource
    {
        ...
        public Dnsbl(string name, DnsblArgs args, CustomResourceOptions? options = null)
            : base("fortios:spamfilter/dnsbl:Dnsbl", name, args ?? new DnsblArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dnsbl(string name, Input<string> id, DnsblState? state = null, CustomResourceOptions? options = null)
            : base("fortios:spamfilter/dnsbl:Dnsbl", name, state, MakeResourceOptions(options, id))
        {
        }
