...
namespace Pulumiverse.Fortios.Spamfilter
{
    ...
    /// {
    ///     var trname = new Fortios.Spamfilter.Fortishield("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:spamfilter/fortishield:Fortishield")]
    public partial class Fortishield : global::Pulumi.CustomResource
    {
        ...
        public Fortishield(string name, FortishieldArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:spamfilter/fortishield:Fortishield", name, args ?? new FortishieldArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fortishield(string name, Input<string> id, FortishieldState? state = null, CustomResourceOptions? options = null)
            : base("fortios:spamfilter/fortishield:Fortishield", name, state, MakeResourceOptions(options, id))
        {
        }
