...
namespace Pulumiverse.Fortios.Spamfilter
{
    ...
    /// {
    ///     var trname = new Fortios.Spamfilter.Profile("trname", new()
    ///     {
    ///         Comment = "terraform test",
    ///         External = "disable",
    ///         FlowBased = "disable",
    ///         Gmail = new Fortios.Spamfilter.Inputs.ProfileGmailArgs
    ///         {
    ///             Log = "disable",
    ///         },
    ///         Imap = new Fortios.Spamfilter.Inputs.ProfileImapArgs
    ///         {
    ///             Action = "tag",
    ///             Log = "disable",
    ///             TagMsg = "Spam",
    ...
    ///         },
    ///         Mapi = new Fortios.Spamfilter.Inputs.ProfileMapiArgs
    ///         {
    ///             Action = "discard",
    ///             Log = "disable",
    ///         },
    ///         MsnHotmail = new Fortios.Spamfilter.Inputs.ProfileMsnHotmailArgs
    ///         {
    ///             Log = "disable",
    ///         },
    ///         Pop3 = new Fortios.Spamfilter.Inputs.ProfilePop3Args
    ///         {
    ///             Action = "tag",
    ///             Log = "disable",
    ///             TagMsg = "Spam",
    ///             TagType = "subject spaminfo",
    ///         },
    ///         Smtp = new Fortios.Spamfilter.Inputs.ProfileSmtpArgs
    ///         {
    ///             Action = "discard",
    ///             Hdrip = "disable",
    ...
    ///         SpamMheaderTable = 0,
    ///         SpamRblTable = 0,
    ///         YahooMail = new Fortios.Spamfilter.Inputs.ProfileYahooMailArgs
    ///         {
    ///             Log = "disable",
    ///         },
    ///     });
    ...
    /// </summary>
    [FortiosResourceType("fortios:spamfilter/profile:Profile")]
    public partial class Profile : global::Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:spamfilter/profile:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, ProfileState? state = null, CustomResourceOptions? options = null)
            : base("fortios:spamfilter/profile:Profile", name, state, MakeResourceOptions(options, id))
        {
        }
