...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/routerospfOspfinterface:RouterospfOspfinterface")]
    public partial class RouterospfOspfinterface : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Authentication type.
        /// </summary>
        ...
        /// </summary>
        [Output("md5Keys")]
        public Output<ImmutableArray<Outputs.RouterospfOspfinterfaceMd5Key>> Md5Keys { get; private set; } = null!;
        ...
        public RouterospfOspfinterface(string name, RouterospfOspfinterfaceArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/routerospfOspfinterface:RouterospfOspfinterface", name, args ?? new RouterospfOspfinterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouterospfOspfinterface(string name, Input<string> id, RouterospfOspfinterfaceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/routerospfOspfinterface:RouterospfOspfinterface", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RouterospfOspfinterface Get(string name, Input<string> id, RouterospfOspfinterfaceState? state = null, CustomResourceOptions? options = null)
        {
            return new RouterospfOspfinterface(name, id, state, options);
        }
    }

    public sealed class RouterospfOspfinterfaceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication type.
        /// </summary>
        ...
        [Input("md5Keys")]
        private InputList<Inputs.RouterospfOspfinterfaceMd5KeyArgs>? _md5Keys;

        /// <summary>
        /// MD5 key. The structure of `md5_keys` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterospfOspfinterfaceMd5KeyArgs> Md5Keys
        {
            get => _md5Keys ?? (_md5Keys = new InputList<Inputs.RouterospfOspfinterfaceMd5KeyArgs>());
            set => _md5Keys = value;
        }
        ...
        public RouterospfOspfinterfaceArgs()
        {
        }
        public static new RouterospfOspfinterfaceArgs Empty => new RouterospfOspfinterfaceArgs();
    }

    public sealed class RouterospfOspfinterfaceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication type.
        /// </summary>
        ...
        public RouterospfOspfinterfaceState()
        {
        }
        public static new RouterospfOspfinterfaceState Empty => new RouterospfOspfinterfaceState();
    }
}
