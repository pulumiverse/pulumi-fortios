...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallshaperPeripshaper("trname", new()
    ///     {
    ///         BandwidthUnit = "kbps",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallshaperPeripshaper:FirewallshaperPeripshaper")]
    public partial class FirewallshaperPeripshaper : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallshaperPeripshaper(string name, FirewallshaperPeripshaperArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallshaperPeripshaper:FirewallshaperPeripshaper", name, args ?? new FirewallshaperPeripshaperArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallshaperPeripshaper(string name, Input<string> id, FirewallshaperPeripshaperState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallshaperPeripshaper:FirewallshaperPeripshaper", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallshaperPeripshaper Get(string name, Input<string> id, FirewallshaperPeripshaperState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallshaperPeripshaper(name, id, state, options);
        }
    }

    public sealed class FirewallshaperPeripshaperArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Unit of measurement for maximum bandwidth for this shaper (Kbps, Mbps or Gbps). Valid values: `kbps`, `mbps`, `gbps`.
        /// </summary>
        ...
        public FirewallshaperPeripshaperArgs()
        {
        }
        public static new FirewallshaperPeripshaperArgs Empty => new FirewallshaperPeripshaperArgs();
    }

    public sealed class FirewallshaperPeripshaperState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Unit of measurement for maximum bandwidth for this shaper (Kbps, Mbps or Gbps). Valid values: `kbps`, `mbps`, `gbps`.
        /// </summary>
        ...
        public FirewallshaperPeripshaperState()
        {
        }
        public static new FirewallshaperPeripshaperState Empty => new FirewallshaperPeripshaperState();
    }
}
