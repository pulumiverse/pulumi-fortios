...
namespace Pulumiverse.Fortios.Extensioncontroller.Outputs
{
    ...
    [OutputType]
    public sealed class ExtenderprofileWifi
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ExtenderprofileWifiRadio1? Radio1;
        /// <summary>
        /// Radio-2 config for Wi-Fi 5GHz The structure of `radio_2` block is documented below.
        /// 
        /// The `radio_1` block supports:
        /// </summary>
        public readonly Outputs.ExtenderprofileWifiRadio2? Radio2;

        [OutputConstructor]
        private ExtenderprofileWifi(
            string? country,

            Outputs.ExtenderprofileWifiRadio1? radio1,

            Outputs.ExtenderprofileWifiRadio2? radio2)
        {
            Country = country;
            Radio1 = radio1;
            Radio2 = radio2;
