...
namespace Pulumiverse.Fortios.Extensioncontroller.Inputs
{
    ...
    public sealed class ExtenderprofileWifiGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("radio1")]
        public Input<Inputs.ExtenderprofileWifiRadio1GetArgs>? Radio1 { get; set; }
        ...
        /// </summary>
        [Input("radio2")]
        public Input<Inputs.ExtenderprofileWifiRadio2GetArgs>? Radio2 { get; set; }

        public ExtenderprofileWifiGetArgs()
        {
        }
        public static new ExtenderprofileWifiGetArgs Empty => new ExtenderprofileWifiGetArgs();
    }
}
