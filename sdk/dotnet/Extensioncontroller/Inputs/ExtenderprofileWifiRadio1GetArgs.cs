...
namespace Pulumiverse.Fortios.Extensioncontroller.Inputs
{
    ...
    public sealed class ExtenderprofileWifiRadio1GetArgs : global::Pulumi.ResourceArgs
    {
        [Input("band")]
        ...
        [Input("localVaps")]
        private InputList<Inputs.ExtenderprofileWifiRadio1LocalVapGetArgs>? _localVaps;
        public InputList<Inputs.ExtenderprofileWifiRadio1LocalVapGetArgs> LocalVaps
        {
            get => _localVaps ?? (_localVaps = new InputList<Inputs.ExtenderprofileWifiRadio1LocalVapGetArgs>());
        ...
        public ExtenderprofileWifiRadio1GetArgs()
        {
        }
        public static new ExtenderprofileWifiRadio1GetArgs Empty => new ExtenderprofileWifiRadio1GetArgs();
    }
}
