...
namespace Pulumiverse.Fortios.Extensioncontroller.Inputs
{
    ...
    public sealed class ExtenderprofileCellularModem1Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// FortiExtender auto switch configuration. The structure of `auto_switch` block is documented below.
        /// </summary>
        [Input("autoSwitch")]
        public Input<Inputs.ExtenderprofileCellularModem1AutoSwitchArgs>? AutoSwitch { get; set; }
        ...
        public ExtenderprofileCellularModem1Args()
        {
        }
        public static new ExtenderprofileCellularModem1Args Empty => new ExtenderprofileCellularModem1Args();
    }
}
