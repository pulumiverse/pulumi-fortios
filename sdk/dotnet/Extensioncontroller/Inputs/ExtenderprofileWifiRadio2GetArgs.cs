...
namespace Pulumiverse.Fortios.Extensioncontroller.Inputs
{
    ...
    public sealed class ExtenderprofileWifiRadio2GetArgs : global::Pulumi.ResourceArgs
    {
        [Input("band")]
        ...
        [Input("localVaps")]
        private InputList<Inputs.ExtenderprofileWifiRadio2LocalVapGetArgs>? _localVaps;
        public InputList<Inputs.ExtenderprofileWifiRadio2LocalVapGetArgs> LocalVaps
        {
            get => _localVaps ?? (_localVaps = new InputList<Inputs.ExtenderprofileWifiRadio2LocalVapGetArgs>());
        ...
        public ExtenderprofileWifiRadio2GetArgs()
        {
        }
        public static new ExtenderprofileWifiRadio2GetArgs Empty => new ExtenderprofileWifiRadio2GetArgs();
    }
}
