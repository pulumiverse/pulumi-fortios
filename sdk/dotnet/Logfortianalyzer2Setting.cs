...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer2Setting("trname", new()
    ///     {
    ///         __changeIp = 0,
    ///         ConnTimeout = 10,
    ///         EncAlgorithm = "high",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logfortianalyzer2Setting:Logfortianalyzer2Setting")]
    public partial class Logfortianalyzer2Setting : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Hidden attribute.
        /// </summary>
        ...
        /// </summary>
        [Output("serials")]
        public Output<ImmutableArray<Outputs.Logfortianalyzer2SettingSerial>> Serials { get; private set; } = null!;
        ...
        public Logfortianalyzer2Setting(string name, Logfortianalyzer2SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortianalyzer2Setting:Logfortianalyzer2Setting", name, args ?? new Logfortianalyzer2SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logfortianalyzer2Setting(string name, Input<string> id, Logfortianalyzer2SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortianalyzer2Setting:Logfortianalyzer2Setting", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Logfortianalyzer2Setting Get(string name, Input<string> id, Logfortianalyzer2SettingState? state = null, CustomResourceOptions? options = null)
        {
            return new Logfortianalyzer2Setting(name, id, state, options);
        }
    }

    public sealed class Logfortianalyzer2SettingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Hidden attribute.
        /// </summary>
        ...
        [Input("serials")]
        private InputList<Inputs.Logfortianalyzer2SettingSerialArgs>? _serials;

        /// <summary>
        /// Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
        /// </summary>
        public InputList<Inputs.Logfortianalyzer2SettingSerialArgs> Serials
        {
            get => _serials ?? (_serials = new InputList<Inputs.Logfortianalyzer2SettingSerialArgs>());
            set => _serials = value;
        }
        ...
        public Logfortianalyzer2SettingArgs()
        {
        }
        public static new Logfortianalyzer2SettingArgs Empty => new Logfortianalyzer2SettingArgs();
    }

    public sealed class Logfortianalyzer2SettingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Hidden attribute.
        /// </summary>
        ...
        [Input("serials")]
        private InputList<Inputs.Logfortianalyzer2SettingSerialGetArgs>? _serials;

        /// <summary>
        /// Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
        /// </summary>
        public InputList<Inputs.Logfortianalyzer2SettingSerialGetArgs> Serials
        {
            get => _serials ?? (_serials = new InputList<Inputs.Logfortianalyzer2SettingSerialGetArgs>());
            set => _serials = value;
        }
        ...
        public Logfortianalyzer2SettingState()
        {
        }
        public static new Logfortianalyzer2SettingState Empty => new Logfortianalyzer2SettingState();
    }
}
