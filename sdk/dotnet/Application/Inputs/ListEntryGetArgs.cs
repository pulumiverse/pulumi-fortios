...
namespace Pulumiverse.Fortios.Application.Inputs
{
    ...
    public sealed class ListEntryGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("applications")]
        private InputList<Inputs.ListEntryApplicationGetArgs>? _applications;

        /// <summary>
        /// ID of allowed applications. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.ListEntryApplicationGetArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.ListEntryApplicationGetArgs>());
        ...
        [Input("categories")]
        private InputList<Inputs.ListEntryCategoryGetArgs>? _categories;

        /// <summary>
        /// Category ID list. The structure of `category` block is documented below.
        /// </summary>
        public InputList<Inputs.ListEntryCategoryGetArgs> Categories
        {
            get => _categories ?? (_categories = new InputList<Inputs.ListEntryCategoryGetArgs>());
            set => _categories = value;
        }

        [Input("exclusions")]
        private InputList<Inputs.ListEntryExclusionGetArgs>? _exclusions;

        /// <summary>
        /// ID of excluded applications. The structure of `exclusion` block is documented below.
        /// </summary>
        public InputList<Inputs.ListEntryExclusionGetArgs> Exclusions
        {
            get => _exclusions ?? (_exclusions = new InputList<Inputs.ListEntryExclusionGetArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.ListEntryParameterGetArgs>? _parameters;

        /// <summary>
        /// Application parameters. The structure of `parameters` block is documented below.
        /// </summary>
        public InputList<Inputs.ListEntryParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ListEntryParameterGetArgs>());
        ...
        [Input("risks")]
        private InputList<Inputs.ListEntryRiskGetArgs>? _risks;
        ...
        /// </summary>
        public InputList<Inputs.ListEntryRiskGetArgs> Risks
        {
            get => _risks ?? (_risks = new InputList<Inputs.ListEntryRiskGetArgs>());
            set => _risks = value;
        }
        ...
        [Input("subCategories")]
        private InputList<Inputs.ListEntrySubCategoryGetArgs>? _subCategories;

        /// <summary>
        /// Application Sub-category ID list. The structure of `sub_category` block is documented below.
        /// </summary>
        public InputList<Inputs.ListEntrySubCategoryGetArgs> SubCategories
        {
            get => _subCategories ?? (_subCategories = new InputList<Inputs.ListEntrySubCategoryGetArgs>());
        ...
        public ListEntryGetArgs()
        {
        }
        public static new ListEntryGetArgs Empty => new ListEntryGetArgs();
    }
}
