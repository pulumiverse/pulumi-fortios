...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer3Setting("trname", new()
    ///     {
    ///         __changeIp = 0,
    ///         ConnTimeout = 10,
    ///         EncAlgorithm = "high",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logfortianalyzer3Setting:Logfortianalyzer3Setting")]
    public partial class Logfortianalyzer3Setting : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Hidden attribute.
        /// </summary>
        ...
        /// </summary>
        [Output("serials")]
        public Output<ImmutableArray<Outputs.Logfortianalyzer3SettingSerial>> Serials { get; private set; } = null!;
        ...
        public Logfortianalyzer3Setting(string name, Logfortianalyzer3SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortianalyzer3Setting:Logfortianalyzer3Setting", name, args ?? new Logfortianalyzer3SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logfortianalyzer3Setting(string name, Input<string> id, Logfortianalyzer3SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortianalyzer3Setting:Logfortianalyzer3Setting", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Logfortianalyzer3Setting Get(string name, Input<string> id, Logfortianalyzer3SettingState? state = null, CustomResourceOptions? options = null)
        {
            return new Logfortianalyzer3Setting(name, id, state, options);
        }
    }

    public sealed class Logfortianalyzer3SettingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Hidden attribute.
        /// </summary>
        ...
        [Input("serials")]
        private InputList<Inputs.Logfortianalyzer3SettingSerialArgs>? _serials;

        /// <summary>
        /// Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
        /// </summary>
        public InputList<Inputs.Logfortianalyzer3SettingSerialArgs> Serials
        {
            get => _serials ?? (_serials = new InputList<Inputs.Logfortianalyzer3SettingSerialArgs>());
            set => _serials = value;
        }
        ...
        public Logfortianalyzer3SettingArgs()
        {
        }
        public static new Logfortianalyzer3SettingArgs Empty => new Logfortianalyzer3SettingArgs();
    }

    public sealed class Logfortianalyzer3SettingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Hidden attribute.
        /// </summary>
        ...
        [Input("serials")]
        private InputList<Inputs.Logfortianalyzer3SettingSerialGetArgs>? _serials;

        /// <summary>
        /// Serial numbers of the FortiAnalyzer. The structure of `serial` block is documented below.
        /// </summary>
        public InputList<Inputs.Logfortianalyzer3SettingSerialGetArgs> Serials
        {
            get => _serials ?? (_serials = new InputList<Inputs.Logfortianalyzer3SettingSerialGetArgs>());
            set => _serials = value;
        }
        ...
        public Logfortianalyzer3SettingState()
        {
        }
        public static new Logfortianalyzer3SettingState Empty => new Logfortianalyzer3SettingState();
    }
}
