...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.LogdiskSetting("trname", new()
    ///     {
    ///         Diskfull = "overwrite",
    ///         DlpArchiveQuota = 0,
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logdiskSetting:LogdiskSetting")]
    public partial class LogdiskSetting : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LogdiskSetting(string name, LogdiskSettingArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/logdiskSetting:LogdiskSetting", name, args ?? new LogdiskSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogdiskSetting(string name, Input<string> id, LogdiskSettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logdiskSetting:LogdiskSetting", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogdiskSetting Get(string name, Input<string> id, LogdiskSettingState? state = null, CustomResourceOptions? options = null)
        {
            return new LogdiskSetting(name, id, state, options);
        }
    }

    public sealed class LogdiskSettingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Action to take when disk is full. The system can overwrite the oldest log messages or stop logging when the disk is full (default = overwrite). Valid values: `overwrite`, `nolog`.
        /// </summary>
        ...
        public LogdiskSettingArgs()
        {
        }
        public static new LogdiskSettingArgs Empty => new LogdiskSettingArgs();
    }

    public sealed class LogdiskSettingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Action to take when disk is full. The system can overwrite the oldest log messages or stop logging when the disk is full (default = overwrite). Valid values: `overwrite`, `nolog`.
        /// </summary>
        ...
        public LogdiskSettingState()
        {
        }
        public static new LogdiskSettingState Empty => new LogdiskSettingState();
    }
}
