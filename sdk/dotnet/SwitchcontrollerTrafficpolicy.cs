...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SwitchcontrollerTrafficpolicy("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/switchcontrollerTrafficpolicy:SwitchcontrollerTrafficpolicy")]
    public partial class SwitchcontrollerTrafficpolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SwitchcontrollerTrafficpolicy(string name, SwitchcontrollerTrafficpolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerTrafficpolicy:SwitchcontrollerTrafficpolicy", name, args ?? new SwitchcontrollerTrafficpolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SwitchcontrollerTrafficpolicy(string name, Input<string> id, SwitchcontrollerTrafficpolicyState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerTrafficpolicy:SwitchcontrollerTrafficpolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SwitchcontrollerTrafficpolicy Get(string name, Input<string> id, SwitchcontrollerTrafficpolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new SwitchcontrollerTrafficpolicy(name, id, state, options);
        }
    }

    public sealed class SwitchcontrollerTrafficpolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// COS queue(0 - 7), or unset to disable.
        /// </summary>
        ...
        public SwitchcontrollerTrafficpolicyArgs()
        {
        }
        public static new SwitchcontrollerTrafficpolicyArgs Empty => new SwitchcontrollerTrafficpolicyArgs();
    }

    public sealed class SwitchcontrollerTrafficpolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// COS queue(0 - 7), or unset to disable.
        /// </summary>
        ...
        public SwitchcontrollerTrafficpolicyState()
        {
        }
        public static new SwitchcontrollerTrafficpolicyState Empty => new SwitchcontrollerTrafficpolicyState();
    }
}
