...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/wirelesscontrollerLog:WirelesscontrollerLog")]
    public partial class WirelesscontrollerLog : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public WirelesscontrollerLog(string name, WirelesscontrollerLogArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/wirelesscontrollerLog:WirelesscontrollerLog", name, args ?? new WirelesscontrollerLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WirelesscontrollerLog(string name, Input<string> id, WirelesscontrollerLogState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/wirelesscontrollerLog:WirelesscontrollerLog", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WirelesscontrollerLog Get(string name, Input<string> id, WirelesscontrollerLogState? state = null, CustomResourceOptions? options = null)
        {
            return new WirelesscontrollerLog(name, id, state, options);
        }
    }

    public sealed class WirelesscontrollerLogArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Lowest severity level to log address group message. Valid values: `emergency`, `alert`, `critical`, `error`, `warning`, `notification`, `information`, `debug`.
        /// </summary>
        ...
        public WirelesscontrollerLogArgs()
        {
        }
        public static new WirelesscontrollerLogArgs Empty => new WirelesscontrollerLogArgs();
    }

    public sealed class WirelesscontrollerLogState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Lowest severity level to log address group message. Valid values: `emergency`, `alert`, `critical`, `error`, `warning`, `notification`, `information`, `debug`.
        /// </summary>
        ...
        public WirelesscontrollerLogState()
        {
        }
        public static new WirelesscontrollerLogState Empty => new WirelesscontrollerLogState();
    }
}
