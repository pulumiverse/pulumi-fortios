...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemPppoeinterface("trname", new()
    ///     {
    ///         AuthType = "auto",
    ///         Device = "port3",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemPppoeinterface:SystemPppoeinterface")]
    public partial class SystemPppoeinterface : global::Pulumi.CustomResource
    {
        /// <summary>
        /// PPPoE AC name.
        /// </summary>
        ...
        public SystemPppoeinterface(string name, SystemPppoeinterfaceArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemPppoeinterface:SystemPppoeinterface", name, args ?? new SystemPppoeinterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemPppoeinterface(string name, Input<string> id, SystemPppoeinterfaceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemPppoeinterface:SystemPppoeinterface", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemPppoeinterface Get(string name, Input<string> id, SystemPppoeinterfaceState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemPppoeinterface(name, id, state, options);
        }
    }

    public sealed class SystemPppoeinterfaceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// PPPoE AC name.
        /// </summary>
        ...
        public SystemPppoeinterfaceArgs()
        {
        }
        public static new SystemPppoeinterfaceArgs Empty => new SystemPppoeinterfaceArgs();
    }

    public sealed class SystemPppoeinterfaceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// PPPoE AC name.
        /// </summary>
        ...
        public SystemPppoeinterfaceState()
        {
        }
        public static new SystemPppoeinterfaceState Empty => new SystemPppoeinterfaceState();
    }
}
