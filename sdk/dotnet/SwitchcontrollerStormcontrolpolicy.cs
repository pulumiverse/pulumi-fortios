...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/switchcontrollerStormcontrolpolicy:SwitchcontrollerStormcontrolpolicy")]
    public partial class SwitchcontrollerStormcontrolpolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SwitchcontrollerStormcontrolpolicy(string name, SwitchcontrollerStormcontrolpolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerStormcontrolpolicy:SwitchcontrollerStormcontrolpolicy", name, args ?? new SwitchcontrollerStormcontrolpolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SwitchcontrollerStormcontrolpolicy(string name, Input<string> id, SwitchcontrollerStormcontrolpolicyState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerStormcontrolpolicy:SwitchcontrollerStormcontrolpolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SwitchcontrollerStormcontrolpolicy Get(string name, Input<string> id, SwitchcontrollerStormcontrolpolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new SwitchcontrollerStormcontrolpolicy(name, id, state, options);
        }
    }

    public sealed class SwitchcontrollerStormcontrolpolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable storm control to drop/allow broadcast traffic in override mode. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public SwitchcontrollerStormcontrolpolicyArgs()
        {
        }
        public static new SwitchcontrollerStormcontrolpolicyArgs Empty => new SwitchcontrollerStormcontrolpolicyArgs();
    }

    public sealed class SwitchcontrollerStormcontrolpolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable storm control to drop/allow broadcast traffic in override mode. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public SwitchcontrollerStormcontrolpolicyState()
        {
        }
        public static new SwitchcontrollerStormcontrolpolicyState Empty => new SwitchcontrollerStormcontrolpolicyState();
    }
}
