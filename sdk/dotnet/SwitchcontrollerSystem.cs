...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/switchcontrollerSystem:SwitchcontrollerSystem")]
    public partial class SwitchcontrollerSystem : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SwitchcontrollerSystem(string name, SwitchcontrollerSystemArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerSystem:SwitchcontrollerSystem", name, args ?? new SwitchcontrollerSystemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SwitchcontrollerSystem(string name, Input<string> id, SwitchcontrollerSystemState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerSystem:SwitchcontrollerSystem", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SwitchcontrollerSystem Get(string name, Input<string> id, SwitchcontrollerSystemState? state = null, CustomResourceOptions? options = null)
        {
            return new SwitchcontrollerSystem(name, id, state, options);
        }
    }

    public sealed class SwitchcontrollerSystemArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Time interval between collection of switch data (30 - 1800 sec, default = 60, 0 = disable).
        /// </summary>
        ...
        public SwitchcontrollerSystemArgs()
        {
        }
        public static new SwitchcontrollerSystemArgs Empty => new SwitchcontrollerSystemArgs();
    }

    public sealed class SwitchcontrollerSystemState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Time interval between collection of switch data (30 - 1800 sec, default = 60, 0 = disable).
        /// </summary>
        ...
        public SwitchcontrollerSystemState()
        {
        }
        public static new SwitchcontrollerSystemState Empty => new SwitchcontrollerSystemState();
    }
}
