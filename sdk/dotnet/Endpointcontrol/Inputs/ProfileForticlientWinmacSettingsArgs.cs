...
namespace Pulumiverse.Fortios.Endpointcontrol.Inputs
{
    ...
    public sealed class ProfileForticlientWinmacSettingsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ProfileForticlientWinmacSettingsForticlientEmsEntryArgs>? _forticlientEmsEntries;

        /// <summary>
        /// FortiClient EMS entries. The structure of `forticlient_ems_entries` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileForticlientWinmacSettingsForticlientEmsEntryArgs> ForticlientEmsEntries
        {
            get => _forticlientEmsEntries ?? (_forticlientEmsEntries = new InputList<Inputs.ProfileForticlientWinmacSettingsForticlientEmsEntryArgs>());
        ...
        private InputList<Inputs.ProfileForticlientWinmacSettingsForticlientOperatingSystemArgs>? _forticlientOperatingSystems;

        /// <summary>
        /// FortiClient operating system. The structure of `forticlient_operating_system` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileForticlientWinmacSettingsForticlientOperatingSystemArgs> ForticlientOperatingSystems
        {
            get => _forticlientOperatingSystems ?? (_forticlientOperatingSystems = new InputList<Inputs.ProfileForticlientWinmacSettingsForticlientOperatingSystemArgs>());
            set => _forticlientOperatingSystems = value;
        }

        [Input("forticlientOwnFiles")]
        private InputList<Inputs.ProfileForticlientWinmacSettingsForticlientOwnFileArgs>? _forticlientOwnFiles;
        ...
        /// </summary>
        public InputList<Inputs.ProfileForticlientWinmacSettingsForticlientOwnFileArgs> ForticlientOwnFiles
        {
            get => _forticlientOwnFiles ?? (_forticlientOwnFiles = new InputList<Inputs.ProfileForticlientWinmacSettingsForticlientOwnFileArgs>());
        ...
        private InputList<Inputs.ProfileForticlientWinmacSettingsForticlientRegistryEntryArgs>? _forticlientRegistryEntries;

        /// <summary>
        /// FortiClient registry entry. The structure of `forticlient_registry_entry` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileForticlientWinmacSettingsForticlientRegistryEntryArgs> ForticlientRegistryEntries
        {
            get => _forticlientRegistryEntries ?? (_forticlientRegistryEntries = new InputList<Inputs.ProfileForticlientWinmacSettingsForticlientRegistryEntryArgs>());
            set => _forticlientRegistryEntries = value;
        }

        [Input("forticlientRunningApps")]
        private InputList<Inputs.ProfileForticlientWinmacSettingsForticlientRunningAppArgs>? _forticlientRunningApps;
        ...
        /// </summary>
        public InputList<Inputs.ProfileForticlientWinmacSettingsForticlientRunningAppArgs> ForticlientRunningApps
        {
            get => _forticlientRunningApps ?? (_forticlientRunningApps = new InputList<Inputs.ProfileForticlientWinmacSettingsForticlientRunningAppArgs>());
        ...
        public ProfileForticlientWinmacSettingsArgs()
        {
        }
        public static new ProfileForticlientWinmacSettingsArgs Empty => new ProfileForticlientWinmacSettingsArgs();
    }
}
