...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemExternalresource("trname", new()
    ///     {
    ///         Category = 199,
    ///         RefreshRate = 5,
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemExternalresource:SystemExternalresource")]
    public partial class SystemExternalresource : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemExternalresource(string name, SystemExternalresourceArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemExternalresource:SystemExternalresource", name, args ?? new SystemExternalresourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemExternalresource(string name, Input<string> id, SystemExternalresourceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemExternalresource:SystemExternalresource", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemExternalresource Get(string name, Input<string> id, SystemExternalresourceState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemExternalresource(name, id, state, options);
        }
    }

    public sealed class SystemExternalresourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// User resource category.
        /// </summary>
        ...
        public SystemExternalresourceArgs()
        {
        }
        public static new SystemExternalresourceArgs Empty => new SystemExternalresourceArgs();
    }

    public sealed class SystemExternalresourceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// User resource category.
        /// </summary>
        ...
        public SystemExternalresourceState()
        {
        }
        public static new SystemExternalresourceState Empty => new SystemExternalresourceState();
    }
}
