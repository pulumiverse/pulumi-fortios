...
namespace Pulumiverse.Fortios.Switchcontrollerqos
{
    ...
    /// {
    ///     var trname = new Fortios.Switchcontrollerqos.Queuepolicy("trname", new()
    ///     {
    ///         RateBy = "kbps",
    ...
    /// </summary>
    [FortiosResourceType("fortios:switchcontrollerqos/queuepolicy:Queuepolicy")]
    public partial class Queuepolicy : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("cosQueues")]
        public Output<ImmutableArray<Outputs.QueuepolicyCosQueue>> CosQueues { get; private set; } = null!;
        ...
        public Queuepolicy(string name, QueuepolicyArgs args, CustomResourceOptions? options = null)
            : base("fortios:switchcontrollerqos/queuepolicy:Queuepolicy", name, args ?? new QueuepolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queuepolicy(string name, Input<string> id, QueuepolicyState? state = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontrollerqos/queuepolicy:Queuepolicy", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("cosQueues")]
        private InputList<Inputs.QueuepolicyCosQueueArgs>? _cosQueues;

        /// <summary>
        /// COS queue configuration. The structure of `cos_queue` block is documented below.
        /// </summary>
        public InputList<Inputs.QueuepolicyCosQueueArgs> CosQueues
        {
            get => _cosQueues ?? (_cosQueues = new InputList<Inputs.QueuepolicyCosQueueArgs>());
    ...
    {
        [Input("cosQueues")]
        private InputList<Inputs.QueuepolicyCosQueueGetArgs>? _cosQueues;

        /// <summary>
        /// COS queue configuration. The structure of `cos_queue` block is documented below.
        /// </summary>
        public InputList<Inputs.QueuepolicyCosQueueGetArgs> CosQueues
        {
            get => _cosQueues ?? (_cosQueues = new InputList<Inputs.QueuepolicyCosQueueGetArgs>());
            set => _cosQueues = value;
        }
