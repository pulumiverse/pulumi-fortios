...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemFortisandbox("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemFortisandbox:SystemFortisandbox")]
    public partial class SystemFortisandbox : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemFortisandbox(string name, SystemFortisandboxArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemFortisandbox:SystemFortisandbox", name, args ?? new SystemFortisandboxArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemFortisandbox(string name, Input<string> id, SystemFortisandboxState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemFortisandbox:SystemFortisandbox", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemFortisandbox Get(string name, Input<string> id, SystemFortisandboxState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemFortisandbox(name, id, state, options);
        }
    }

    public sealed class SystemFortisandboxArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Notifier email address.
        /// </summary>
        ...
        public SystemFortisandboxArgs()
        {
        }
        public static new SystemFortisandboxArgs Empty => new SystemFortisandboxArgs();
    }

    public sealed class SystemFortisandboxState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Notifier email address.
        /// </summary>
        ...
        public SystemFortisandboxState()
        {
        }
        public static new SystemFortisandboxState Empty => new SystemFortisandboxState();
    }
}
