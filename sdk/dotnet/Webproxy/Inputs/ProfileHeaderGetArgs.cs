...
namespace Pulumiverse.Fortios.Webproxy.Inputs
{
    ...
    public sealed class ProfileHeaderGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("dstaddr6s")]
        private InputList<Inputs.ProfileHeaderDstaddr6GetArgs>? _dstaddr6s;

        /// <summary>
        /// Destination address and address group names (IPv6). The structure of `dstaddr6` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileHeaderDstaddr6GetArgs> Dstaddr6s
        {
            get => _dstaddr6s ?? (_dstaddr6s = new InputList<Inputs.ProfileHeaderDstaddr6GetArgs>());
            set => _dstaddr6s = value;
        }

        [Input("dstaddrs")]
        private InputList<Inputs.ProfileHeaderDstaddrGetArgs>? _dstaddrs;

        /// <summary>
        /// Destination address and address group names. The structure of `dstaddr` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileHeaderDstaddrGetArgs> Dstaddrs
        {
            get => _dstaddrs ?? (_dstaddrs = new InputList<Inputs.ProfileHeaderDstaddrGetArgs>());
            set => _dstaddrs = value;
        }
        ...
        public ProfileHeaderGetArgs()
        {
        }
        public static new ProfileHeaderGetArgs Empty => new ProfileHeaderGetArgs();
    }
}
