...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallsshSetting("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallsshSetting:FirewallsshSetting")]
    public partial class FirewallsshSetting : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallsshSetting(string name, FirewallsshSettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallsshSetting:FirewallsshSetting", name, args ?? new FirewallsshSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallsshSetting(string name, Input<string> id, FirewallsshSettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallsshSetting:FirewallsshSetting", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallsshSetting Get(string name, Input<string> id, FirewallsshSettingState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallsshSetting(name, id, state, options);
        }
    }

    public sealed class FirewallsshSettingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// CA certificate used by SSH Inspection.
        /// </summary>
        ...
        public FirewallsshSettingArgs()
        {
        }
        public static new FirewallsshSettingArgs Empty => new FirewallsshSettingArgs();
    }

    public sealed class FirewallsshSettingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// CA certificate used by SSH Inspection.
        /// </summary>
        ...
        public FirewallsshSettingState()
        {
        }
        public static new FirewallsshSettingState Empty => new FirewallsshSettingState();
    }
}
