...
namespace Pulumiverse.Fortios.Firewall.Wildcardfqdn
{
    public static class GetCustomlist
    {
        ...
        public static Task<GetCustomlistResult> InvokeAsync(GetCustomlistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomlistResult>("fortios:firewall/wildcardfqdn/getCustomlist:getCustomlist", args ?? new GetCustomlistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.firewall/wildcardfqdn.Custom`.
        /// </summary>
        public static Output<GetCustomlistResult> Invoke(GetCustomlistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomlistResult>("fortios:firewall/wildcardfqdn/getCustomlist:getCustomlist", args ?? new GetCustomlistInvokeArgs(), options.WithDefaults());
    }
