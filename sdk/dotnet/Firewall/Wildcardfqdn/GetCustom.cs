...
namespace Pulumiverse.Fortios.Firewall.Wildcardfqdn
{
    public static class GetCustom
    {
        ...
        public static Task<GetCustomResult> InvokeAsync(GetCustomArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomResult>("fortios:firewall/wildcardfqdn/getCustom:getCustom", args ?? new GetCustomArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios firewallwildcardfqdn custom
        /// </summary>
        public static Output<GetCustomResult> Invoke(GetCustomInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomResult>("fortios:firewall/wildcardfqdn/getCustom:getCustom", args ?? new GetCustomInvokeArgs(), options.WithDefaults());
    }
