...
namespace Pulumiverse.Fortios.Firewall.Wildcardfqdn
{
    public static class GetGroup
    {
        ...
        public static Task<GetGroupResult> InvokeAsync(GetGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupResult>("fortios:firewall/wildcardfqdn/getGroup:getGroup", args ?? new GetGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios firewallwildcardfqdn group
        /// </summary>
        public static Output<GetGroupResult> Invoke(GetGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupResult>("fortios:firewall/wildcardfqdn/getGroup:getGroup", args ?? new GetGroupInvokeArgs(), options.WithDefaults());
    }
