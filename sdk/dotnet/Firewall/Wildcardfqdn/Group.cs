...
namespace Pulumiverse.Fortios.Firewall.Wildcardfqdn
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:firewall/wildcardfqdn/group:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("fortios:firewall/wildcardfqdn/group:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, GroupState? state = null, CustomResourceOptions? options = null)
            : base("fortios:firewall/wildcardfqdn/group:Group", name, state, MakeResourceOptions(options, id))
        {
        }
