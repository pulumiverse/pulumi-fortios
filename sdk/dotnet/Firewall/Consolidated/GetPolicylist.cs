...
namespace Pulumiverse.Fortios.Firewall.Consolidated
{
    ...
    {
        /// <summary>
        /// Provides a list of `fortios.firewall/consolidated.Policy`.
        /// </summary>
        public static Task<GetPolicylistResult> InvokeAsync(GetPolicylistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicylistResult>("fortios:firewall/consolidated/getPolicylist:getPolicylist", args ?? new GetPolicylistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.firewall/consolidated.Policy`.
        /// </summary>
        public static Output<GetPolicylistResult> Invoke(GetPolicylistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicylistResult>("fortios:firewall/consolidated/getPolicylist:getPolicylist", args ?? new GetPolicylistInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetPolicylistResult
    {
        ...
        /// <summary>
        /// A list of the `fortios.firewall/consolidated.Policy`.
        /// </summary>
