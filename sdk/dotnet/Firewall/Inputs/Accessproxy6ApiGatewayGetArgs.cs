...
namespace Pulumiverse.Fortios.Firewall.Inputs
{
    ...
    public sealed class Accessproxy6ApiGatewayGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.Accessproxy6ApiGatewayApplicationGetArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.Accessproxy6ApiGatewayApplicationGetArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.Accessproxy6ApiGatewayApplicationGetArgs>());
        ...
        /// </summary>
        [Input("quic")]
        public Input<Inputs.Accessproxy6ApiGatewayQuicGetArgs>? Quic { get; set; }

        [Input("realservers")]
        private InputList<Inputs.Accessproxy6ApiGatewayRealserverGetArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.Accessproxy6ApiGatewayRealserverGetArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.Accessproxy6ApiGatewayRealserverGetArgs>());
        ...
        private InputList<Inputs.Accessproxy6ApiGatewaySslCipherSuiteGetArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.Accessproxy6ApiGatewaySslCipherSuiteGetArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.Accessproxy6ApiGatewaySslCipherSuiteGetArgs>());
        ...
        public Accessproxy6ApiGatewayGetArgs()
        {
        }
        public static new Accessproxy6ApiGatewayGetArgs Empty => new Accessproxy6ApiGatewayGetArgs();
    }
}
