...
namespace Pulumiverse.Fortios.Firewall.Inputs
{
    ...
    public sealed class AccessproxyApiGatewayArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.AccessproxyApiGatewayApplicationArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.AccessproxyApiGatewayApplicationArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.AccessproxyApiGatewayApplicationArgs>());
        ...
        /// </summary>
        [Input("quic")]
        public Input<Inputs.AccessproxyApiGatewayQuicArgs>? Quic { get; set; }

        [Input("realservers")]
        private InputList<Inputs.AccessproxyApiGatewayRealserverArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.AccessproxyApiGatewayRealserverArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.AccessproxyApiGatewayRealserverArgs>());
        ...
        private InputList<Inputs.AccessproxyApiGatewaySslCipherSuiteArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.AccessproxyApiGatewaySslCipherSuiteArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.AccessproxyApiGatewaySslCipherSuiteArgs>());
        ...
        public AccessproxyApiGatewayArgs()
        {
        }
        public static new AccessproxyApiGatewayArgs Empty => new AccessproxyApiGatewayArgs();
    }
}
