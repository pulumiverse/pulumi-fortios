...
namespace Pulumiverse.Fortios.Firewall.Inputs
{
    ...
    public sealed class Accessproxy6ApiGatewayArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.Accessproxy6ApiGatewayApplicationArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.Accessproxy6ApiGatewayApplicationArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.Accessproxy6ApiGatewayApplicationArgs>());
        ...
        /// </summary>
        [Input("quic")]
        public Input<Inputs.Accessproxy6ApiGatewayQuicArgs>? Quic { get; set; }

        [Input("realservers")]
        private InputList<Inputs.Accessproxy6ApiGatewayRealserverArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.Accessproxy6ApiGatewayRealserverArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.Accessproxy6ApiGatewayRealserverArgs>());
        ...
        private InputList<Inputs.Accessproxy6ApiGatewaySslCipherSuiteArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.Accessproxy6ApiGatewaySslCipherSuiteArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.Accessproxy6ApiGatewaySslCipherSuiteArgs>());
        ...
        public Accessproxy6ApiGatewayArgs()
        {
        }
        public static new Accessproxy6ApiGatewayArgs Empty => new Accessproxy6ApiGatewayArgs();
    }
}
