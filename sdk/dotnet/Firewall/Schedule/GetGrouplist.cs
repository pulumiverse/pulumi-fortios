...
namespace Pulumiverse.Fortios.Firewall.Schedule
{
    public static class GetGrouplist
    {
        ...
        public static Task<GetGrouplistResult> InvokeAsync(GetGrouplistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGrouplistResult>("fortios:firewall/schedule/getGrouplist:getGrouplist", args ?? new GetGrouplistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.firewall/schedule.Group`.
        /// </summary>
        public static Output<GetGrouplistResult> Invoke(GetGrouplistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGrouplistResult>("fortios:firewall/schedule/getGrouplist:getGrouplist", args ?? new GetGrouplistInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetGrouplistResult
    {
        ...
        /// <summary>
        /// A list of the `fortios.firewall/schedule.Group`.
        /// </summary>
