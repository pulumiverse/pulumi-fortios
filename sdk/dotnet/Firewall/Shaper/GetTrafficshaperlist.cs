...
namespace Pulumiverse.Fortios.Firewall.Shaper
{
    public static class GetTrafficshaperlist
    {
        ...
        public static Task<GetTrafficshaperlistResult> InvokeAsync(GetTrafficshaperlistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrafficshaperlistResult>("fortios:firewall/shaper/getTrafficshaperlist:getTrafficshaperlist", args ?? new GetTrafficshaperlistArgs(), options.WithDefaults());
        ...
        public static Output<GetTrafficshaperlistResult> Invoke(GetTrafficshaperlistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrafficshaperlistResult>("fortios:firewall/shaper/getTrafficshaperlist:getTrafficshaperlist", args ?? new GetTrafficshaperlistInvokeArgs(), options.WithDefaults());
    }
