...
namespace Pulumiverse.Fortios.Firewall.Shaper
{
    public static class GetPeripshaper
    {
        ...
        public static Task<GetPeripshaperResult> InvokeAsync(GetPeripshaperArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPeripshaperResult>("fortios:firewall/shaper/getPeripshaper:getPeripshaper", args ?? new GetPeripshaperArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios firewallshaper peripshaper
        /// </summary>
        public static Output<GetPeripshaperResult> Invoke(GetPeripshaperInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPeripshaperResult>("fortios:firewall/shaper/getPeripshaper:getPeripshaper", args ?? new GetPeripshaperInvokeArgs(), options.WithDefaults());
    }
