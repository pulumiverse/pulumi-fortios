...
namespace Pulumiverse.Fortios.Firewall.Ipmacbinding
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:firewall/ipmacbinding/table:Table")]
    public partial class Table : global::Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("fortios:firewall/ipmacbinding/table:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, TableState? state = null, CustomResourceOptions? options = null)
            : base("fortios:firewall/ipmacbinding/table:Table", name, state, MakeResourceOptions(options, id))
        {
        }
