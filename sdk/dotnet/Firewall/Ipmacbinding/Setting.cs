...
namespace Pulumiverse.Fortios.Firewall.Ipmacbinding
{
    /// <summary>
    ...
    /// </summary>
    [FortiosResourceType("fortios:firewall/ipmacbinding/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:firewall/ipmacbinding/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:firewall/ipmacbinding/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
