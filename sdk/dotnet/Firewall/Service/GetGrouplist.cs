...
namespace Pulumiverse.Fortios.Firewall.Service
{
    ...
    {
        /// <summary>
        /// Provides a list of `fortios.firewall/service.Group`.
        /// </summary>
        public static Task<GetGrouplistResult> InvokeAsync(GetGrouplistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGrouplistResult>("fortios:firewall/service/getGrouplist:getGrouplist", args ?? new GetGrouplistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.firewall/service.Group`.
        /// </summary>
        public static Output<GetGrouplistResult> Invoke(GetGrouplistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGrouplistResult>("fortios:firewall/service/getGrouplist:getGrouplist", args ?? new GetGrouplistInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetGrouplistResult
    {
        ...
        /// <summary>
        /// A list of the `fortios.firewall/service.Group`.
        /// </summary>
