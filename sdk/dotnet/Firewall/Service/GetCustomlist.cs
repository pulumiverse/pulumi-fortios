...
namespace Pulumiverse.Fortios.Firewall.Service
{
    ...
    {
        /// <summary>
        /// Provides a list of `fortios.firewall/service.Custom`.
        /// </summary>
        public static Task<GetCustomlistResult> InvokeAsync(GetCustomlistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomlistResult>("fortios:firewall/service/getCustomlist:getCustomlist", args ?? new GetCustomlistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.firewall/service.Custom`.
        /// </summary>
        public static Output<GetCustomlistResult> Invoke(GetCustomlistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomlistResult>("fortios:firewall/service/getCustomlist:getCustomlist", args ?? new GetCustomlistInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetCustomlistResult
    {
        ...
        /// <summary>
        /// A list of the `fortios.firewall/service.Custom`.
        /// </summary>
