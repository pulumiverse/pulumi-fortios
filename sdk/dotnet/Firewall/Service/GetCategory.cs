...
namespace Pulumiverse.Fortios.Firewall.Service
{
    public static class GetCategory
    {
        ...
        public static Task<GetCategoryResult> InvokeAsync(GetCategoryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCategoryResult>("fortios:firewall/service/getCategory:getCategory", args ?? new GetCategoryArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios firewallservice category
        /// </summary>
        public static Output<GetCategoryResult> Invoke(GetCategoryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCategoryResult>("fortios:firewall/service/getCategory:getCategory", args ?? new GetCategoryInvokeArgs(), options.WithDefaults());
    }
