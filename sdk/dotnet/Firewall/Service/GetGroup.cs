...
namespace Pulumiverse.Fortios.Firewall.Service
{
    public static class GetGroup
    {
        ...
        public static Task<GetGroupResult> InvokeAsync(GetGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupResult>("fortios:firewall/service/getGroup:getGroup", args ?? new GetGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios firewallservice group
        /// </summary>
        public static Output<GetGroupResult> Invoke(GetGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupResult>("fortios:firewall/service/getGroup:getGroup", args ?? new GetGroupInvokeArgs(), options.WithDefaults());
    }
