...
namespace Pulumiverse.Fortios.Firewall.Service
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:firewall/service/category:Category")]
    public partial class Category : global::Pulumi.CustomResource
    {
        ...
        public Category(string name, CategoryArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:firewall/service/category:Category", name, args ?? new CategoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Category(string name, Input<string> id, CategoryState? state = null, CustomResourceOptions? options = null)
            : base("fortios:firewall/service/category:Category", name, state, MakeResourceOptions(options, id))
        {
        }
