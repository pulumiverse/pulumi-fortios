...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemDdns("trname", new()
    ///     {
    ///         BoundIp = "0.0.0.0",
    ///         ClearText = "disable",
    ///         DdnsAuth = "disable",
    ...
    ///         {
    ///             new Fortios.Inputs.SystemDdnsMonitorInterfaceArgs
    ///             {
    ///                 InterfaceName = "port2",
    ///             },
    ///         },
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemDdns:SystemDdns")]
    public partial class SystemDdns : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.SystemDdnsDdnsServerAddr>> DdnsServerAddrs { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.SystemDdnsMonitorInterface>> MonitorInterfaces { get; private set; } = null!;
        ...
        public SystemDdns(string name, SystemDdnsArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemDdns:SystemDdns", name, args ?? new SystemDdnsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemDdns(string name, Input<string> id, SystemDdnsState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemDdns:SystemDdns", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemDdns Get(string name, Input<string> id, SystemDdnsState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemDdns(name, id, state, options);
        }
    }

    public sealed class SystemDdnsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Address type of interface address in DDNS update. Valid values: `ipv4`, `ipv6`.
        /// </summary>
        ...
        private InputList<Inputs.SystemDdnsDdnsServerAddrArgs>? _ddnsServerAddrs;

        /// <summary>
        /// Generic DDNS server IP/FQDN list. The structure of `ddns_server_addr` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemDdnsDdnsServerAddrArgs> DdnsServerAddrs
        {
            get => _ddnsServerAddrs ?? (_ddnsServerAddrs = new InputList<Inputs.SystemDdnsDdnsServerAddrArgs>());
        ...
        private InputList<Inputs.SystemDdnsMonitorInterfaceArgs>? _monitorInterfaces;

        /// <summary>
        /// Monitored interface. The structure of `monitor_interface` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemDdnsMonitorInterfaceArgs> MonitorInterfaces
        {
            get => _monitorInterfaces ?? (_monitorInterfaces = new InputList<Inputs.SystemDdnsMonitorInterfaceArgs>());
        ...
        public SystemDdnsArgs()
        {
        }
        public static new SystemDdnsArgs Empty => new SystemDdnsArgs();
    }

    public sealed class SystemDdnsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Address type of interface address in DDNS update. Valid values: `ipv4`, `ipv6`.
        /// </summary>
        ...
        [Input("ddnsServerAddrs")]
        private InputList<Inputs.SystemDdnsDdnsServerAddrGetArgs>? _ddnsServerAddrs;

        /// <summary>
        /// Generic DDNS server IP/FQDN list. The structure of `ddns_server_addr` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemDdnsDdnsServerAddrGetArgs> DdnsServerAddrs
        {
            get => _ddnsServerAddrs ?? (_ddnsServerAddrs = new InputList<Inputs.SystemDdnsDdnsServerAddrGetArgs>());
            set => _ddnsServerAddrs = value;
        }
        ...
        private InputList<Inputs.SystemDdnsMonitorInterfaceGetArgs>? _monitorInterfaces;

        /// <summary>
        /// Monitored interface. The structure of `monitor_interface` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemDdnsMonitorInterfaceGetArgs> MonitorInterfaces
        {
            get => _monitorInterfaces ?? (_monitorInterfaces = new InputList<Inputs.SystemDdnsMonitorInterfaceGetArgs>());
            set => _monitorInterfaces = value;
        }
        ...
        public SystemDdnsState()
        {
        }
        public static new SystemDdnsState Empty => new SystemDdnsState();
    }
}
