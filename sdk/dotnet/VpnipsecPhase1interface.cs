...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname2 = new Fortios.VpnipsecPhase1interface("trname2", new()
    ///     {
    ///         AcctVerify = "disable",
    ///         AddGwRoute = "disable",
    ///         AddRoute = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/vpnipsecPhase1interface:VpnipsecPhase1interface")]
    public partial class VpnipsecPhase1interface : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.VpnipsecPhase1interfaceBackupGateway>> BackupGateways { get; private set; } = null!;
        ...
        /// </summary>
        [Output("certificates")]
        public Output<ImmutableArray<Outputs.VpnipsecPhase1interfaceCertificate>> Certificates { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.VpnipsecPhase1interfaceIpv4ExcludeRange>> Ipv4ExcludeRanges { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.VpnipsecPhase1interfaceIpv6ExcludeRange>> Ipv6ExcludeRanges { get; private set; } = null!;
        ...
        public VpnipsecPhase1interface(string name, VpnipsecPhase1interfaceArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/vpnipsecPhase1interface:VpnipsecPhase1interface", name, args ?? new VpnipsecPhase1interfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnipsecPhase1interface(string name, Input<string> id, VpnipsecPhase1interfaceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpnipsecPhase1interface:VpnipsecPhase1interface", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VpnipsecPhase1interface Get(string name, Input<string> id, VpnipsecPhase1interfaceState? state = null, CustomResourceOptions? options = null)
        {
            return new VpnipsecPhase1interface(name, id, state, options);
        }
    }

    public sealed class VpnipsecPhase1interfaceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable verification of RADIUS accounting record. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        private InputList<Inputs.VpnipsecPhase1interfaceBackupGatewayArgs>? _backupGateways;

        /// <summary>
        /// Instruct unity clients about the backup gateway address(es). The structure of `backup_gateway` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1interfaceBackupGatewayArgs> BackupGateways
        {
            get => _backupGateways ?? (_backupGateways = new InputList<Inputs.VpnipsecPhase1interfaceBackupGatewayArgs>());
        ...
        [Input("certificates")]
        private InputList<Inputs.VpnipsecPhase1interfaceCertificateArgs>? _certificates;

        /// <summary>
        /// The names of up to 4 signed personal certificates. The structure of `certificate` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1interfaceCertificateArgs> Certificates
        {
            get => _certificates ?? (_certificates = new InputList<Inputs.VpnipsecPhase1interfaceCertificateArgs>());
        ...
        private InputList<Inputs.VpnipsecPhase1interfaceIpv4ExcludeRangeArgs>? _ipv4ExcludeRanges;

        /// <summary>
        /// Configuration Method IPv4 exclude ranges. The structure of `ipv4_exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1interfaceIpv4ExcludeRangeArgs> Ipv4ExcludeRanges
        {
            get => _ipv4ExcludeRanges ?? (_ipv4ExcludeRanges = new InputList<Inputs.VpnipsecPhase1interfaceIpv4ExcludeRangeArgs>());
        ...
        private InputList<Inputs.VpnipsecPhase1interfaceIpv6ExcludeRangeArgs>? _ipv6ExcludeRanges;

        /// <summary>
        /// Configuration method IPv6 exclude ranges. The structure of `ipv6_exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1interfaceIpv6ExcludeRangeArgs> Ipv6ExcludeRanges
        {
            get => _ipv6ExcludeRanges ?? (_ipv6ExcludeRanges = new InputList<Inputs.VpnipsecPhase1interfaceIpv6ExcludeRangeArgs>());
        ...
        public VpnipsecPhase1interfaceArgs()
        {
        }
        public static new VpnipsecPhase1interfaceArgs Empty => new VpnipsecPhase1interfaceArgs();
    }

    public sealed class VpnipsecPhase1interfaceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable verification of RADIUS accounting record. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("backupGateways")]
        private InputList<Inputs.VpnipsecPhase1interfaceBackupGatewayGetArgs>? _backupGateways;

        /// <summary>
        /// Instruct unity clients about the backup gateway address(es). The structure of `backup_gateway` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1interfaceBackupGatewayGetArgs> BackupGateways
        {
            get => _backupGateways ?? (_backupGateways = new InputList<Inputs.VpnipsecPhase1interfaceBackupGatewayGetArgs>());
            set => _backupGateways = value;
        }
        ...
        [Input("certificates")]
        private InputList<Inputs.VpnipsecPhase1interfaceCertificateGetArgs>? _certificates;

        /// <summary>
        /// The names of up to 4 signed personal certificates. The structure of `certificate` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1interfaceCertificateGetArgs> Certificates
        {
            get => _certificates ?? (_certificates = new InputList<Inputs.VpnipsecPhase1interfaceCertificateGetArgs>());
            set => _certificates = value;
        }
        ...
        [Input("ipv4ExcludeRanges")]
        private InputList<Inputs.VpnipsecPhase1interfaceIpv4ExcludeRangeGetArgs>? _ipv4ExcludeRanges;

        /// <summary>
        /// Configuration Method IPv4 exclude ranges. The structure of `ipv4_exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1interfaceIpv4ExcludeRangeGetArgs> Ipv4ExcludeRanges
        {
            get => _ipv4ExcludeRanges ?? (_ipv4ExcludeRanges = new InputList<Inputs.VpnipsecPhase1interfaceIpv4ExcludeRangeGetArgs>());
            set => _ipv4ExcludeRanges = value;
        }
        ...
        [Input("ipv6ExcludeRanges")]
        private InputList<Inputs.VpnipsecPhase1interfaceIpv6ExcludeRangeGetArgs>? _ipv6ExcludeRanges;

        /// <summary>
        /// Configuration method IPv6 exclude ranges. The structure of `ipv6_exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1interfaceIpv6ExcludeRangeGetArgs> Ipv6ExcludeRanges
        {
            get => _ipv6ExcludeRanges ?? (_ipv6ExcludeRanges = new InputList<Inputs.VpnipsecPhase1interfaceIpv6ExcludeRangeGetArgs>());
            set => _ipv6ExcludeRanges = value;
        }
        ...
        public VpnipsecPhase1interfaceState()
        {
        }
        public static new VpnipsecPhase1interfaceState Empty => new VpnipsecPhase1interfaceState();
    }
}
