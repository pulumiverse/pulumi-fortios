...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var test1 = new Fortios.FmgSystemGlobal("test1", new()
    ///     {
    ///         AdomMode = "advanced",
    ///         AdomStatus = "disable",
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:index/fmgSystemGlobal:FmgSystemGlobal")]
    public partial class FmgSystemGlobal : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Adom Mode.
        /// </summary>
        ...
        public FmgSystemGlobal(string name, FmgSystemGlobalArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/fmgSystemGlobal:FmgSystemGlobal", name, args ?? new FmgSystemGlobalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FmgSystemGlobal(string name, Input<string> id, FmgSystemGlobalState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/fmgSystemGlobal:FmgSystemGlobal", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FmgSystemGlobal Get(string name, Input<string> id, FmgSystemGlobalState? state = null, CustomResourceOptions? options = null)
        {
            return new FmgSystemGlobal(name, id, state, options);
        }
    }

    public sealed class FmgSystemGlobalArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Adom Mode.
        /// </summary>
        ...
        public FmgSystemGlobalArgs()
        {
        }
        public static new FmgSystemGlobalArgs Empty => new FmgSystemGlobalArgs();
    }

    public sealed class FmgSystemGlobalState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Adom Mode.
        /// </summary>
        ...
        public FmgSystemGlobalState()
        {
        }
        public static new FmgSystemGlobalState Empty => new FmgSystemGlobalState();
    }
}
