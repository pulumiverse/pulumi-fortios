...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpRadio3Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WtpRadio3ChannelArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpRadio3ChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpRadio3ChannelArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpRadio3VapArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpRadio3VapArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpRadio3VapArgs>());
            set => _vaps = value;
        }

        public WtpRadio3Args()
        {
        }
        public static new WtpRadio3Args Empty => new WtpRadio3Args();
    }
}
