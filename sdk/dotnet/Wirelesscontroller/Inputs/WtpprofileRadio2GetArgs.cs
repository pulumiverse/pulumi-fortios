...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpprofileRadio2GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WtpprofileRadio2ChannelGetArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio2ChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpprofileRadio2ChannelGetArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpprofileRadio2VapGetArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio2VapGetArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpprofileRadio2VapGetArgs>());
            set => _vaps = value;
        }
        ...
        public WtpprofileRadio2GetArgs()
        {
        }
        public static new WtpprofileRadio2GetArgs Empty => new WtpprofileRadio2GetArgs();
    }
}
