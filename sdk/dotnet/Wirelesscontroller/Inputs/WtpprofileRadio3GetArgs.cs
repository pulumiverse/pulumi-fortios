...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpprofileRadio3GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WtpprofileRadio3ChannelGetArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio3ChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpprofileRadio3ChannelGetArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpprofileRadio3VapGetArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio3VapGetArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpprofileRadio3VapGetArgs>());
            set => _vaps = value;
        }
        ...
        public WtpprofileRadio3GetArgs()
        {
        }
        public static new WtpprofileRadio3GetArgs Empty => new WtpprofileRadio3GetArgs();
    }
}
