...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpprofileRadio1Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WtpprofileRadio1ChannelArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio1ChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpprofileRadio1ChannelArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpprofileRadio1VapArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio1VapArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpprofileRadio1VapArgs>());
            set => _vaps = value;
        }
        ...
        public WtpprofileRadio1Args()
        {
        }
        public static new WtpprofileRadio1Args Empty => new WtpprofileRadio1Args();
    }
}
