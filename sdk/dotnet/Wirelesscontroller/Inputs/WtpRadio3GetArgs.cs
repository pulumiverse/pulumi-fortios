...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpRadio3GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WtpRadio3ChannelGetArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpRadio3ChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpRadio3ChannelGetArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpRadio3VapGetArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpRadio3VapGetArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpRadio3VapGetArgs>());
            set => _vaps = value;
        }

        public WtpRadio3GetArgs()
        {
        }
        public static new WtpRadio3GetArgs Empty => new WtpRadio3GetArgs();
    }
}
