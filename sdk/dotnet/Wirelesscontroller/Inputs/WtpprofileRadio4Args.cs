...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpprofileRadio4Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WtpprofileRadio4ChannelArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio4ChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpprofileRadio4ChannelArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpprofileRadio4VapArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio4VapArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpprofileRadio4VapArgs>());
            set => _vaps = value;
        }
        ...
        public WtpprofileRadio4Args()
        {
        }
        public static new WtpprofileRadio4Args Empty => new WtpprofileRadio4Args();
    }
}
