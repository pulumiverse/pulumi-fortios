...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpRadio4Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WtpRadio4ChannelArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpRadio4ChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpRadio4ChannelArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpRadio4VapArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpRadio4VapArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpRadio4VapArgs>());
            set => _vaps = value;
        }

        public WtpRadio4Args()
        {
        }
        public static new WtpRadio4Args Empty => new WtpRadio4Args();
    }
}
