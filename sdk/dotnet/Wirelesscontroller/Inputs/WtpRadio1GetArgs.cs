...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpRadio1GetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("channels")]
        private InputList<Inputs.WtpRadio1ChannelGetArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpRadio1ChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpRadio1ChannelGetArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpRadio1VapGetArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpRadio1VapGetArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpRadio1VapGetArgs>());
            set => _vaps = value;
        }

        public WtpRadio1GetArgs()
        {
        }
        public static new WtpRadio1GetArgs Empty => new WtpRadio1GetArgs();
    }
}
