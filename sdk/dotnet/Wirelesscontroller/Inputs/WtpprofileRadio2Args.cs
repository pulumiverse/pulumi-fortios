...
namespace Pulumiverse.Fortios.Wirelesscontroller.Inputs
{
    ...
    public sealed class WtpprofileRadio2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WtpprofileRadio2ChannelArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio2ChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WtpprofileRadio2ChannelArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WtpprofileRadio2VapArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WtpprofileRadio2VapArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WtpprofileRadio2VapArgs>());
            set => _vaps = value;
        }
        ...
        public WtpprofileRadio2Args()
        {
        }
        public static new WtpprofileRadio2Args Empty => new WtpprofileRadio2Args();
    }
}
