...
namespace Pulumiverse.Fortios.Wirelesscontroller.Hotspot20
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:wirelesscontroller/hotspot20/anqpnairealm:Anqpnairealm")]
    public partial class Anqpnairealm : global::Pulumi.CustomResource
    {
        ...
        public Anqpnairealm(string name, AnqpnairealmArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:wirelesscontroller/hotspot20/anqpnairealm:Anqpnairealm", name, args ?? new AnqpnairealmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Anqpnairealm(string name, Input<string> id, AnqpnairealmState? state = null, CustomResourceOptions? options = null)
            : base("fortios:wirelesscontroller/hotspot20/anqpnairealm:Anqpnairealm", name, state, MakeResourceOptions(options, id))
        {
        }
