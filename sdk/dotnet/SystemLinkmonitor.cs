...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemLinkmonitor("trname", new()
    ///     {
    ///         AddrMode = "ipv4",
    ///         Failtime = 5,
    ///         GatewayIp = "2.2.2.2",
    ...
    ///         Servers = new[]
    ///         {
    ///             new Fortios.Inputs.SystemLinkmonitorServerArgs
    ///             {
    ///                 Address = "3.3.3.3",
    ///             },
    ///         },
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemLinkmonitor:SystemLinkmonitor")]
    public partial class SystemLinkmonitor : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("routes")]
        public Output<ImmutableArray<Outputs.SystemLinkmonitorRoute>> Routes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("serverLists")]
        public Output<ImmutableArray<Outputs.SystemLinkmonitorServerList>> ServerLists { get; private set; } = null!;
        ...
        /// </summary>
        [Output("servers")]
        public Output<ImmutableArray<Outputs.SystemLinkmonitorServer>> Servers { get; private set; } = null!;
        ...
        public SystemLinkmonitor(string name, SystemLinkmonitorArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemLinkmonitor:SystemLinkmonitor", name, args ?? new SystemLinkmonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemLinkmonitor(string name, Input<string> id, SystemLinkmonitorState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemLinkmonitor:SystemLinkmonitor", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemLinkmonitor Get(string name, Input<string> id, SystemLinkmonitorState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemLinkmonitor(name, id, state, options);
        }
    }

    public sealed class SystemLinkmonitorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Address mode (IPv4 or IPv6). Valid values: `ipv4`, `ipv6`.
        /// </summary>
        ...
        [Input("routes")]
        private InputList<Inputs.SystemLinkmonitorRouteArgs>? _routes;

        /// <summary>
        /// Subnet to monitor. The structure of `route` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemLinkmonitorRouteArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.SystemLinkmonitorRouteArgs>());
            set => _routes = value;
        }
        ...
        [Input("serverLists")]
        private InputList<Inputs.SystemLinkmonitorServerListArgs>? _serverLists;

        /// <summary>
        /// Servers for link-monitor to monitor. The structure of `server_list` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemLinkmonitorServerListArgs> ServerLists
        {
            get => _serverLists ?? (_serverLists = new InputList<Inputs.SystemLinkmonitorServerListArgs>());
        ...
        private InputList<Inputs.SystemLinkmonitorServerArgs>? _servers;

        /// <summary>
        /// IP address of the server(s) to be monitored. The structure of `server` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemLinkmonitorServerArgs> Servers
        {
            get => _servers ?? (_servers = new InputList<Inputs.SystemLinkmonitorServerArgs>());
            set => _servers = value;
        }
        ...
        public SystemLinkmonitorArgs()
        {
        }
        public static new SystemLinkmonitorArgs Empty => new SystemLinkmonitorArgs();
    }

    public sealed class SystemLinkmonitorState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Address mode (IPv4 or IPv6). Valid values: `ipv4`, `ipv6`.
        /// </summary>
        ...
        [Input("routes")]
        private InputList<Inputs.SystemLinkmonitorRouteGetArgs>? _routes;

        /// <summary>
        /// Subnet to monitor. The structure of `route` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemLinkmonitorRouteGetArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.SystemLinkmonitorRouteGetArgs>());
            set => _routes = value;
        }
        ...
        [Input("serverLists")]
        private InputList<Inputs.SystemLinkmonitorServerListGetArgs>? _serverLists;

        /// <summary>
        /// Servers for link-monitor to monitor. The structure of `server_list` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemLinkmonitorServerListGetArgs> ServerLists
        {
            get => _serverLists ?? (_serverLists = new InputList<Inputs.SystemLinkmonitorServerListGetArgs>());
            set => _serverLists = value;
        }
        ...
        [Input("servers")]
        private InputList<Inputs.SystemLinkmonitorServerGetArgs>? _servers;

        /// <summary>
        /// IP address of the server(s) to be monitored. The structure of `server` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemLinkmonitorServerGetArgs> Servers
        {
            get => _servers ?? (_servers = new InputList<Inputs.SystemLinkmonitorServerGetArgs>());
            set => _servers = value;
        }
        ...
        public SystemLinkmonitorState()
        {
        }
        public static new SystemLinkmonitorState Empty => new SystemLinkmonitorState();
    }
}
