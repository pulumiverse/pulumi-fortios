...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallIptranslation("trname", new()
    ///     {
    ///         Endip = "2.2.2.2",
    ///         MapStartip = "0.0.0.0",
    ///         Startip = "1.1.1.1",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallIptranslation:FirewallIptranslation")]
    public partial class FirewallIptranslation : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallIptranslation(string name, FirewallIptranslationArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/firewallIptranslation:FirewallIptranslation", name, args ?? new FirewallIptranslationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallIptranslation(string name, Input<string> id, FirewallIptranslationState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallIptranslation:FirewallIptranslation", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallIptranslation Get(string name, Input<string> id, FirewallIptranslationState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallIptranslation(name, id, state, options);
        }
    }

    public sealed class FirewallIptranslationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Final IPv4 address (inclusive) in the range of the addresses to be translated (format xxx.xxx.xxx.xxx, default: 0.0.0.0).
        /// </summary>
        ...
        public FirewallIptranslationArgs()
        {
        }
        public static new FirewallIptranslationArgs Empty => new FirewallIptranslationArgs();
    }

    public sealed class FirewallIptranslationState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Final IPv4 address (inclusive) in the range of the addresses to be translated (format xxx.xxx.xxx.xxx, default: 0.0.0.0).
        /// </summary>
        ...
        public FirewallIptranslationState()
        {
        }
        public static new FirewallIptranslationState Empty => new FirewallIptranslationState();
    }
}
