...
{
    public static class GetSystemAutomationaction
    {
        /// <summary>
        /// Use this data source to get information on an fortios system automationaction
        /// </summary>
        public static Task<GetSystemAutomationactionResult> InvokeAsync(GetSystemAutomationactionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSystemAutomationactionResult>("fortios:index/getSystemAutomationaction:getSystemAutomationaction", args ?? new GetSystemAutomationactionArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system automationaction
        /// </summary>
        public static Output<GetSystemAutomationactionResult> Invoke(GetSystemAutomationactionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSystemAutomationactionResult>("fortios:index/getSystemAutomationaction:getSystemAutomationaction", args ?? new GetSystemAutomationactionInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetSystemAutomationactionArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetSystemAutomationactionArgs()
        {
        }
        public static new GetSystemAutomationactionArgs Empty => new GetSystemAutomationactionArgs();
    }

    public sealed class GetSystemAutomationactionInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Specify the name of the desired system automationaction.
        /// </summary>
        ...
        public GetSystemAutomationactionInvokeArgs()
        {
        }
        public static new GetSystemAutomationactionInvokeArgs Empty => new GetSystemAutomationactionInvokeArgs();
    }


    [OutputType]
    public sealed class GetSystemAutomationactionResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemAutomationactionEmailToResult> EmailTos;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemAutomationactionHeaderResult> Headers;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemAutomationactionHttpHeaderResult> HttpHeaders;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemAutomationactionSdnConnectorResult> SdnConnectors;
        /// <summary>
        /// NSX security tag.
        /// </summary>
        ...
        [OutputConstructor]
        private GetSystemAutomationactionResult(
            string accprofile,
            ...
            ImmutableArray<Outputs.GetSystemAutomationactionEmailToResult> emailTos,
            ...
            ImmutableArray<Outputs.GetSystemAutomationactionHeaderResult> headers,

            string httpBody,

            ImmutableArray<Outputs.GetSystemAutomationactionHttpHeaderResult> httpHeaders,
            ...
            ImmutableArray<Outputs.GetSystemAutomationactionSdnConnectorResult> sdnConnectors,
