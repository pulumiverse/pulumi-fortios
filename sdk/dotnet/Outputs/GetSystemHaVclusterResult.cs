...
namespace Pulumiverse.Fortios.Outputs
{
    ...
    [OutputType]
    public sealed class GetSystemHaVclusterResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemHaVclusterVdomResult> Vdoms;

        [OutputConstructor]
        private GetSystemHaVclusterResult(
            string monitor,
            ...
            ImmutableArray<Outputs.GetSystemHaVclusterVdomResult> vdoms)
        {
            Monitor = monitor;
            Override = @override;
