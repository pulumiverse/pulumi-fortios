...
namespace Pulumiverse.Fortios.Outputs
{
    ...
    [OutputType]
    public sealed class VpnOcvpnForticlientAccess
    {
        /// <summary>
        /// FortiClient user authentication groups. The structure of `auth_groups` block is documented below.
        /// </summary>
        public readonly ImmutableArray<Outputs.VpnOcvpnForticlientAccessAuthGroup> AuthGroups;
        /// <summary>
        ...
        [OutputConstructor]
        private VpnOcvpnForticlientAccess(
            ImmutableArray<Outputs.VpnOcvpnForticlientAccessAuthGroup> authGroups,
