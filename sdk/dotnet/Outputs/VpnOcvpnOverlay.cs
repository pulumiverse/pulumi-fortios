...
namespace Pulumiverse.Fortios.Outputs
{
    ...
    [OutputType]
    public sealed class VpnOcvpnOverlay
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.VpnOcvpnOverlaySubnet> Subnets;

        [OutputConstructor]
        private VpnOcvpnOverlay(
            string? assignIp,
            ...
            ImmutableArray<Outputs.VpnOcvpnOverlaySubnet> subnets)
        {
            AssignIp = assignIp;
            Id = id;
