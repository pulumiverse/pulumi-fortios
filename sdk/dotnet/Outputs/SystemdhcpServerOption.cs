...
namespace Pulumiverse.Fortios.Outputs
{
    ...
    [OutputType]
    public sealed class SystemdhcpServerOption
    {
        /// <summary>
        /// DHCP option code.
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.SystemdhcpServerOptionVciString> VciStrings;

        [OutputConstructor]
        private SystemdhcpServerOption(
            int? code,
            ...
            ImmutableArray<Outputs.SystemdhcpServerOptionVciString> vciStrings)
        {
            Code = code;
            Id = id;
            Ip = ip;
