...
namespace Pulumiverse.Fortios.Log.Memory
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:log/memory/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:log/memory/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:log/memory/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
