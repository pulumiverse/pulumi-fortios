...
namespace Pulumiverse.Fortios.Log.Nulldevice
{
    /// <summary>
    ...
    /// </summary>
    [FortiosResourceType("fortios:log/nulldevice/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs args, CustomResourceOptions? options = null)
            : base("fortios:log/nulldevice/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:log/nulldevice/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
