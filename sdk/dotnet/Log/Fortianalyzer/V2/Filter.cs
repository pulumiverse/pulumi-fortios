...
namespace Pulumiverse.Fortios.Log.Fortianalyzer.V2
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:log/fortianalyzer/v2/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/v2/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/v2/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
