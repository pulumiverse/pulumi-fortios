...
namespace Pulumiverse.Fortios.Log.Fortianalyzer.V2
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:log/fortianalyzer/v2/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/v2/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/v2/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
