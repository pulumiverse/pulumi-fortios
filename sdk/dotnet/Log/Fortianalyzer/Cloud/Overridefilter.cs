...
namespace Pulumiverse.Fortios.Log.Fortianalyzer.Cloud
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:log/fortianalyzer/cloud/overridefilter:Overridefilter")]
    public partial class Overridefilter : global::Pulumi.CustomResource
    {
        ...
        public Overridefilter(string name, OverridefilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/cloud/overridefilter:Overridefilter", name, args ?? new OverridefilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Overridefilter(string name, Input<string> id, OverridefilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/cloud/overridefilter:Overridefilter", name, state, MakeResourceOptions(options, id))
        {
        }
