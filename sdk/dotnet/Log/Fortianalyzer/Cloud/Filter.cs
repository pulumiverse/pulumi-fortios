...
namespace Pulumiverse.Fortios.Log.Fortianalyzer.Cloud
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:log/fortianalyzer/cloud/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/cloud/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/cloud/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
