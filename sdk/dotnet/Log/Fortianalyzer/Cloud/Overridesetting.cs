...
namespace Pulumiverse.Fortios.Log.Fortianalyzer.Cloud
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:log/fortianalyzer/cloud/overridesetting:Overridesetting")]
    public partial class Overridesetting : global::Pulumi.CustomResource
    {
        ...
        public Overridesetting(string name, OverridesettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/cloud/overridesetting:Overridesetting", name, args ?? new OverridesettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Overridesetting(string name, Input<string> id, OverridesettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:log/fortianalyzer/cloud/overridesetting:Overridesetting", name, state, MakeResourceOptions(options, id))
        {
        }
