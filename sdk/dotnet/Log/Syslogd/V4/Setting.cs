...
namespace Pulumiverse.Fortios.Log.Syslogd.V4
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:log/syslogd/v4/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:log/syslogd/v4/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:log/syslogd/v4/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
