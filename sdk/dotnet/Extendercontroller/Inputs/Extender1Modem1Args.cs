...
namespace Pulumiverse.Fortios.Extendercontroller.Inputs
{
    ...
    public sealed class Extender1Modem1Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// FortiExtender auto switch configuration. The structure of `auto_switch` block is documented below.
        /// </summary>
        [Input("autoSwitch")]
        public Input<Inputs.Extender1Modem1AutoSwitchArgs>? AutoSwitch { get; set; }
        ...
        public Extender1Modem1Args()
        {
        }
        public static new Extender1Modem1Args Empty => new Extender1Modem1Args();
    }
}
