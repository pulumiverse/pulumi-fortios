...
namespace Pulumiverse.Fortios.Extendercontroller.Inputs
{
    ...
    public sealed class ExtenderprofileCellularModem2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// FortiExtender auto switch configuration. The structure of `auto_switch` block is documented below.
        /// </summary>
        [Input("autoSwitch")]
        public Input<Inputs.ExtenderprofileCellularModem2AutoSwitchArgs>? AutoSwitch { get; set; }
        ...
        public ExtenderprofileCellularModem2Args()
        {
        }
        public static new ExtenderprofileCellularModem2Args Empty => new ExtenderprofileCellularModem2Args();
    }
}
