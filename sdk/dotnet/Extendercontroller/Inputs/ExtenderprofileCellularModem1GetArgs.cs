...
namespace Pulumiverse.Fortios.Extendercontroller.Inputs
{
    ...
    public sealed class ExtenderprofileCellularModem1GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// FortiExtender auto switch configuration. The structure of `auto_switch` block is documented below.
        /// </summary>
        [Input("autoSwitch")]
        public Input<Inputs.ExtenderprofileCellularModem1AutoSwitchGetArgs>? AutoSwitch { get; set; }
        ...
        public ExtenderprofileCellularModem1GetArgs()
        {
        }
        public static new ExtenderprofileCellularModem1GetArgs Empty => new ExtenderprofileCellularModem1GetArgs();
    }
}
