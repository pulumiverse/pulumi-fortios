...
namespace Pulumiverse.Fortios.Extendercontroller.Inputs
{
    ...
    public sealed class ExtenderModem2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// FortiExtender auto switch configuration. The structure of `auto_switch` block is documented below.
        /// </summary>
        [Input("autoSwitch")]
        public Input<Inputs.ExtenderModem2AutoSwitchArgs>? AutoSwitch { get; set; }
        ...
        public ExtenderModem2Args()
        {
        }
        public static new ExtenderModem2Args Empty => new ExtenderModem2Args();
    }
}
