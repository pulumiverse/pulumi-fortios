...
namespace Pulumiverse.Fortios.Extendercontroller.Inputs
{
    ...
    public sealed class Extender1Modem2GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// FortiExtender auto switch configuration. The structure of `auto_switch` block is documented below.
        /// </summary>
        [Input("autoSwitch")]
        public Input<Inputs.Extender1Modem2AutoSwitchGetArgs>? AutoSwitch { get; set; }
        ...
        public Extender1Modem2GetArgs()
        {
        }
        public static new Extender1Modem2GetArgs Empty => new Extender1Modem2GetArgs();
    }
}
