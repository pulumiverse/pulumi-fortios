...
namespace Pulumiverse.Fortios.Extendercontroller.Inputs
{
    ...
    public sealed class ExtenderprofileLanExtensionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("backhauls")]
        private InputList<Inputs.ExtenderprofileLanExtensionBackhaulArgs>? _backhauls;

        /// <summary>
        /// LAN extension backhaul tunnel configuration. The structure of `backhaul` block is documented below.
        /// </summary>
        public InputList<Inputs.ExtenderprofileLanExtensionBackhaulArgs> Backhauls
        {
            get => _backhauls ?? (_backhauls = new InputList<Inputs.ExtenderprofileLanExtensionBackhaulArgs>());
        ...
        public ExtenderprofileLanExtensionArgs()
        {
        }
        public static new ExtenderprofileLanExtensionArgs Empty => new ExtenderprofileLanExtensionArgs();
    }
}
