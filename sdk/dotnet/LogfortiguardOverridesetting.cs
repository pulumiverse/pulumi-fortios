...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.LogfortiguardOverridesetting("trname", new()
    ///     {
    ///         Override = "disable",
    ///         Status = "disable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logfortiguardOverridesetting:LogfortiguardOverridesetting")]
    public partial class LogfortiguardOverridesetting : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LogfortiguardOverridesetting(string name, LogfortiguardOverridesettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortiguardOverridesetting:LogfortiguardOverridesetting", name, args ?? new LogfortiguardOverridesettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogfortiguardOverridesetting(string name, Input<string> id, LogfortiguardOverridesettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortiguardOverridesetting:LogfortiguardOverridesetting", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogfortiguardOverridesetting Get(string name, Input<string> id, LogfortiguardOverridesettingState? state = null, CustomResourceOptions? options = null)
        {
            return new LogfortiguardOverridesetting(name, id, state, options);
        }
    }

    public sealed class LogfortiguardOverridesettingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable FortiCloud access to configuration and data. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public LogfortiguardOverridesettingArgs()
        {
        }
        public static new LogfortiguardOverridesettingArgs Empty => new LogfortiguardOverridesettingArgs();
    }

    public sealed class LogfortiguardOverridesettingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable FortiCloud access to configuration and data. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public LogfortiguardOverridesettingState()
        {
        }
        public static new LogfortiguardOverridesettingState Empty => new LogfortiguardOverridesettingState();
    }
}
