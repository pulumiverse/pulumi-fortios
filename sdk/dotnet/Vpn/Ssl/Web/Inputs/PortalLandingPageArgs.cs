...
namespace Pulumiverse.Fortios.Vpn.Ssl.Web.Inputs
{
    ...
    public sealed class PortalLandingPageArgs : global::Pulumi.ResourceArgs
    {
        [Input("formDatas")]
        private InputList<Inputs.PortalLandingPageFormDataArgs>? _formDatas;

        /// <summary>
        /// Form data. The structure of `form_data` block is documented below.
        /// </summary>
        public InputList<Inputs.PortalLandingPageFormDataArgs> FormDatas
        {
            get => _formDatas ?? (_formDatas = new InputList<Inputs.PortalLandingPageFormDataArgs>());
        ...
        public PortalLandingPageArgs()
        {
        }
        public static new PortalLandingPageArgs Empty => new PortalLandingPageArgs();
    }
}
