...
namespace Pulumiverse.Fortios.Vpn.Certificate
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:vpn/certificate/ocspserver:Ocspserver")]
    public partial class Ocspserver : global::Pulumi.CustomResource
    {
        ...
        public Ocspserver(string name, OcspserverArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:vpn/certificate/ocspserver:Ocspserver", name, args ?? new OcspserverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ocspserver(string name, Input<string> id, OcspserverState? state = null, CustomResourceOptions? options = null)
            : base("fortios:vpn/certificate/ocspserver:Ocspserver", name, state, MakeResourceOptions(options, id))
        {
        }
