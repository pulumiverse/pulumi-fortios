...
namespace Pulumiverse.Fortios.Vpn.Ipsec
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:vpn/ipsec/phase1:Phase1")]
    public partial class Phase1 : global::Pulumi.CustomResource
    {
        ...
        public Phase1(string name, Phase1Args args, CustomResourceOptions? options = null)
            : base("fortios:vpn/ipsec/phase1:Phase1", name, args ?? new Phase1Args(), MakeResourceOptions(options, ""))
        {
        }

        private Phase1(string name, Input<string> id, Phase1State? state = null, CustomResourceOptions? options = null)
            : base("fortios:vpn/ipsec/phase1:Phase1", name, state, MakeResourceOptions(options, id))
        {
        }
