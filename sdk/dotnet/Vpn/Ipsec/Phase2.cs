...
namespace Pulumiverse.Fortios.Vpn.Ipsec
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:vpn/ipsec/phase2:Phase2")]
    public partial class Phase2 : global::Pulumi.CustomResource
    {
        ...
        public Phase2(string name, Phase2Args args, CustomResourceOptions? options = null)
            : base("fortios:vpn/ipsec/phase2:Phase2", name, args ?? new Phase2Args(), MakeResourceOptions(options, ""))
        {
        }

        private Phase2(string name, Input<string> id, Phase2State? state = null, CustomResourceOptions? options = null)
            : base("fortios:vpn/ipsec/phase2:Phase2", name, state, MakeResourceOptions(options, id))
        {
        }
