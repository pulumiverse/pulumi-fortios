...
namespace Pulumiverse.Fortios.Vpn.Inputs
{
    ...
    public sealed class OcvpnOverlayArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("subnets")]
        private InputList<Inputs.OcvpnOverlaySubnetArgs>? _subnets;

        /// <summary>
        /// Internal subnets to register with OCVPN service. The structure of `subnets` block is documented below.
        /// </summary>
        public InputList<Inputs.OcvpnOverlaySubnetArgs> Subnets
        {
            get => _subnets ?? (_subnets = new InputList<Inputs.OcvpnOverlaySubnetArgs>());
            set => _subnets = value;
        }

        public OcvpnOverlayArgs()
        {
        }
        public static new OcvpnOverlayArgs Empty => new OcvpnOverlayArgs();
    }
}
