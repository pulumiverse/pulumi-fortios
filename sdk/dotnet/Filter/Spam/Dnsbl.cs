...
namespace Pulumiverse.Fortios.Filter.Spam
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:filter/spam/dnsbl:Dnsbl")]
    public partial class Dnsbl : global::Pulumi.CustomResource
    {
        ...
        public Dnsbl(string name, DnsblArgs args, CustomResourceOptions? options = null)
            : base("fortios:filter/spam/dnsbl:Dnsbl", name, args ?? new DnsblArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dnsbl(string name, Input<string> id, DnsblState? state = null, CustomResourceOptions? options = null)
            : base("fortios:filter/spam/dnsbl:Dnsbl", name, state, MakeResourceOptions(options, id))
        {
        }
