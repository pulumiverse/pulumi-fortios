...
namespace Pulumiverse.Fortios.Filter.Spam
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:filter/spam/iptrust:Iptrust")]
    public partial class Iptrust : global::Pulumi.CustomResource
    {
        ...
        public Iptrust(string name, IptrustArgs args, CustomResourceOptions? options = null)
            : base("fortios:filter/spam/iptrust:Iptrust", name, args ?? new IptrustArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Iptrust(string name, Input<string> id, IptrustState? state = null, CustomResourceOptions? options = null)
            : base("fortios:filter/spam/iptrust:Iptrust", name, state, MakeResourceOptions(options, id))
        {
        }
