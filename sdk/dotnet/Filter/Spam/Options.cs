...
namespace Pulumiverse.Fortios.Filter.Spam
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:filter/spam/options:Options")]
    public partial class Options : global::Pulumi.CustomResource
    {
        ...
        public Options(string name, OptionsArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:filter/spam/options:Options", name, args ?? new OptionsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Options(string name, Input<string> id, OptionsState? state = null, CustomResourceOptions? options = null)
            : base("fortios:filter/spam/options:Options", name, state, MakeResourceOptions(options, id))
        {
        }
