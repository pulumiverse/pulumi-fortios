...
namespace Pulumiverse.Fortios.Filter.Dns
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:filter/dns/profile:Profile")]
    public partial class Profile : global::Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:filter/dns/profile:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, ProfileState? state = null, CustomResourceOptions? options = null)
            : base("fortios:filter/dns/profile:Profile", name, state, MakeResourceOptions(options, id))
        {
        }
