...
namespace Pulumiverse.Fortios.Filter.Web
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:filter/web/content:Content")]
    public partial class Content : global::Pulumi.CustomResource
    {
        ...
        public Content(string name, ContentArgs args, CustomResourceOptions? options = null)
            : base("fortios:filter/web/content:Content", name, args ?? new ContentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Content(string name, Input<string> id, ContentState? state = null, CustomResourceOptions? options = null)
            : base("fortios:filter/web/content:Content", name, state, MakeResourceOptions(options, id))
        {
        }
