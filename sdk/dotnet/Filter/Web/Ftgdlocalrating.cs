...
namespace Pulumiverse.Fortios.Filter.Web
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:filter/web/ftgdlocalrating:Ftgdlocalrating")]
    public partial class Ftgdlocalrating : global::Pulumi.CustomResource
    {
        ...
        public Ftgdlocalrating(string name, FtgdlocalratingArgs args, CustomResourceOptions? options = null)
            : base("fortios:filter/web/ftgdlocalrating:Ftgdlocalrating", name, args ?? new FtgdlocalratingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ftgdlocalrating(string name, Input<string> id, FtgdlocalratingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:filter/web/ftgdlocalrating:Ftgdlocalrating", name, state, MakeResourceOptions(options, id))
        {
        }
