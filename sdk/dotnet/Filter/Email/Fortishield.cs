...
namespace Pulumiverse.Fortios.Filter.Email
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:filter/email/fortishield:Fortishield")]
    public partial class Fortishield : global::Pulumi.CustomResource
    {
        ...
        public Fortishield(string name, FortishieldArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:filter/email/fortishield:Fortishield", name, args ?? new FortishieldArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fortishield(string name, Input<string> id, FortishieldState? state = null, CustomResourceOptions? options = null)
            : base("fortios:filter/email/fortishield:Fortishield", name, state, MakeResourceOptions(options, id))
        {
        }
