...
namespace Pulumiverse.Fortios.Filter.Email
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:filter/email/iptrust:Iptrust")]
    public partial class Iptrust : global::Pulumi.CustomResource
    {
        ...
        public Iptrust(string name, IptrustArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:filter/email/iptrust:Iptrust", name, args ?? new IptrustArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Iptrust(string name, Input<string> id, IptrustState? state = null, CustomResourceOptions? options = null)
            : base("fortios:filter/email/iptrust:Iptrust", name, state, MakeResourceOptions(options, id))
        {
        }
