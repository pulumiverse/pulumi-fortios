...
namespace Pulumiverse.Fortios.Logwebtrends
{
    /// <summary>
    ...
    /// {
    ///     var trname = new Fortios.Logwebtrends.Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logwebtrends/filter:Filter labelname LogWebtrendsFilter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logwebtrends/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logwebtrends/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logwebtrends/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
