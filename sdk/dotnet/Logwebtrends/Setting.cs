...
namespace Pulumiverse.Fortios.Logwebtrends
{
    ...
    /// {
    ///     var trname = new Fortios.Logwebtrends.Setting("trname", new()
    ///     {
    ///         Status = "disable",
    ///     });
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logwebtrends/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logwebtrends/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logwebtrends/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
