...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemNetworkvisibility("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemNetworkvisibility:SystemNetworkvisibility")]
    public partial class SystemNetworkvisibility : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemNetworkvisibility(string name, SystemNetworkvisibilityArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemNetworkvisibility:SystemNetworkvisibility", name, args ?? new SystemNetworkvisibilityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemNetworkvisibility(string name, Input<string> id, SystemNetworkvisibilityState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemNetworkvisibility:SystemNetworkvisibility", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemNetworkvisibility Get(string name, Input<string> id, SystemNetworkvisibilityState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemNetworkvisibility(name, id, state, options);
        }
    }

    public sealed class SystemNetworkvisibilityArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable logging of destination hostname visibility. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public SystemNetworkvisibilityArgs()
        {
        }
        public static new SystemNetworkvisibilityArgs Empty => new SystemNetworkvisibilityArgs();
    }

    public sealed class SystemNetworkvisibilityState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable logging of destination hostname visibility. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public SystemNetworkvisibilityState()
        {
        }
        public static new SystemNetworkvisibilityState Empty => new SystemNetworkvisibilityState();
    }
}
