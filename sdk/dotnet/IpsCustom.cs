...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/ipsCustom:IpsCustom")]
    public partial class IpsCustom : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IpsCustom(string name, IpsCustomArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/ipsCustom:IpsCustom", name, args ?? new IpsCustomArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpsCustom(string name, Input<string> id, IpsCustomState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/ipsCustom:IpsCustom", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IpsCustom Get(string name, Input<string> id, IpsCustomState? state = null, CustomResourceOptions? options = null)
        {
            return new IpsCustom(name, id, state, options);
        }
    }

    public sealed class IpsCustomArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Default action (pass or block) for this signature. Valid values: `pass`, `block`.
        /// </summary>
        ...
        public IpsCustomArgs()
        {
        }
        public static new IpsCustomArgs Empty => new IpsCustomArgs();
    }

    public sealed class IpsCustomState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Default action (pass or block) for this signature. Valid values: `pass`, `block`.
        /// </summary>
        ...
        public IpsCustomState()
        {
        }
        public static new IpsCustomState Empty => new IpsCustomState();
    }
}
