...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.WebproxyWisp("trname", new()
    ///     {
    ///         MaxConnections = 64,
    ///         OutgoingIp = "0.0.0.0",
    ///         ServerIp = "1.1.1.1",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/webproxyWisp:WebproxyWisp")]
    public partial class WebproxyWisp : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        public WebproxyWisp(string name, WebproxyWispArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/webproxyWisp:WebproxyWisp", name, args ?? new WebproxyWispArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebproxyWisp(string name, Input<string> id, WebproxyWispState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/webproxyWisp:WebproxyWisp", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WebproxyWisp Get(string name, Input<string> id, WebproxyWispState? state = null, CustomResourceOptions? options = null)
        {
            return new WebproxyWisp(name, id, state, options);
        }
    }

    public sealed class WebproxyWispArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        public WebproxyWispArgs()
        {
        }
        public static new WebproxyWispArgs Empty => new WebproxyWispArgs();
    }

    public sealed class WebproxyWispState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        public WebproxyWispState()
        {
        }
        public static new WebproxyWispState Empty => new WebproxyWispState();
    }
}
