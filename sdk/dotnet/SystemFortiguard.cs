...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemFortiguard("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemFortiguard:SystemFortiguard")]
    public partial class SystemFortiguard : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemFortiguard(string name, SystemFortiguardArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemFortiguard:SystemFortiguard", name, args ?? new SystemFortiguardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemFortiguard(string name, Input<string> id, SystemFortiguardState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemFortiguard:SystemFortiguard", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemFortiguard Get(string name, Input<string> id, SystemFortiguardState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemFortiguard(name, id, state, options);
        }
    }

    public sealed class SystemFortiguardArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable FortiGuard antispam request caching. Uses a small amount of memory but improves performance. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public SystemFortiguardArgs()
        {
        }
        public static new SystemFortiguardArgs Empty => new SystemFortiguardArgs();
    }

    public sealed class SystemFortiguardState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable FortiGuard antispam request caching. Uses a small amount of memory but improves performance. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public SystemFortiguardState()
        {
        }
        public static new SystemFortiguardState Empty => new SystemFortiguardState();
    }
}
