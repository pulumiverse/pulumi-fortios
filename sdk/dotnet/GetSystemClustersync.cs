...
{
    public static class GetSystemClustersync
    {
        /// <summary>
        /// Use this data source to get information on an fortios system clustersync
        /// </summary>
        public static Task<GetSystemClustersyncResult> InvokeAsync(GetSystemClustersyncArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSystemClustersyncResult>("fortios:index/getSystemClustersync:getSystemClustersync", args ?? new GetSystemClustersyncArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system clustersync
        /// </summary>
        public static Output<GetSystemClustersyncResult> Invoke(GetSystemClustersyncInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSystemClustersyncResult>("fortios:index/getSystemClustersync:getSystemClustersync", args ?? new GetSystemClustersyncInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetSystemClustersyncArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetSystemClustersyncArgs()
        {
        }
        public static new GetSystemClustersyncArgs Empty => new GetSystemClustersyncArgs();
    }

    public sealed class GetSystemClustersyncInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Specify the sync_id of the desired system clustersync.
        /// </summary>
        ...
        public GetSystemClustersyncInvokeArgs()
        {
        }
        public static new GetSystemClustersyncInvokeArgs Empty => new GetSystemClustersyncInvokeArgs();
    }


    [OutputType]
    public sealed class GetSystemClustersyncResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemClustersyncDownIntfsBeforeSessSyncResult> DownIntfsBeforeSessSyncs;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemClustersyncSessionSyncFilterResult> SessionSyncFilters;
        /// <summary>
        /// Enable/disable IKE route announcement on the backup unit.
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemClustersyncSyncvdResult> Syncvds;
        public readonly string? Vdomparam;

        [OutputConstructor]
        private GetSystemClustersyncResult(
            ImmutableArray<Outputs.GetSystemClustersyncDownIntfsBeforeSessSyncResult> downIntfsBeforeSessSyncs,
            ...
            ImmutableArray<Outputs.GetSystemClustersyncSessionSyncFilterResult> sessionSyncFilters,

            string slaveAddIkeRoutes,

            int syncId,

            ImmutableArray<Outputs.GetSystemClustersyncSyncvdResult> syncvds,
