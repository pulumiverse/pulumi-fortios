...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallIppool("trname", new()
    ///     {
    ///         ArpReply = "enable",
    ///         BlockSize = 128,
    ///         Endip = "1.0.0.20",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallIppool:FirewallIppool")]
    public partial class FirewallIppool : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallIppool(string name, FirewallIppoolArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/firewallIppool:FirewallIppool", name, args ?? new FirewallIppoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallIppool(string name, Input<string> id, FirewallIppoolState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallIppool:FirewallIppool", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallIppool Get(string name, Input<string> id, FirewallIppoolState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallIppool(name, id, state, options);
        }
    }

    public sealed class FirewallIppoolArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding NAT64 route. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public FirewallIppoolArgs()
        {
        }
        public static new FirewallIppoolArgs Empty => new FirewallIppoolArgs();
    }

    public sealed class FirewallIppoolState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding NAT64 route. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public FirewallIppoolState()
        {
        }
        public static new FirewallIppoolState Empty => new FirewallIppoolState();
    }
}
