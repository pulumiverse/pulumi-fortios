...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var v11 = new Fortios.FirewallObjectService("v11", new()
    ///     {
    ///         Category = "General",
    ///         Comment = "comment",
    ///         Fqdn = "abc.com",
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var v13 = new Fortios.FirewallObjectService("v13", new()
    ///     {
    ///         Category = "General",
    ///         Comment = "comment",
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var iCMP = new Fortios.FirewallObjectService("iCMP", new()
    ///     {
    ///         Category = "General",
    ///         Comment = "comment",
    ///         Icmpcode = "3",
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:index/firewallObjectService:FirewallObjectService")]
    public partial class FirewallObjectService : global::Pulumi.CustomResource
    {
        ...
        public FirewallObjectService(string name, FirewallObjectServiceArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/firewallObjectService:FirewallObjectService", name, args ?? new FirewallObjectServiceArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private FirewallObjectService(string name, Input<string> id, FirewallObjectServiceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallObjectService:FirewallObjectService", name, state, MakeResourceOptions(options, id))
        {
        }
