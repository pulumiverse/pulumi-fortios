...
namespace Pulumiverse.Fortios.Switchcontroller.Autoconfig
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:switchcontroller/autoconfig/custom:Custom")]
    public partial class Custom : global::Pulumi.CustomResource
    {
        ...
        public Custom(string name, CustomArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/autoconfig/custom:Custom", name, args ?? new CustomArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Custom(string name, Input<string> id, CustomState? state = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/autoconfig/custom:Custom", name, state, MakeResourceOptions(options, id))
        {
        }
