...
namespace Pulumiverse.Fortios.Switchcontroller.Inputs
{
    ...
    public sealed class ManagedswitchSnmpCommunityGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("hosts")]
        private InputList<Inputs.ManagedswitchSnmpCommunityHostGetArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.ManagedswitchSnmpCommunityHostGetArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.ManagedswitchSnmpCommunityHostGetArgs>());
            set => _hosts = value;
        }
        ...
        public ManagedswitchSnmpCommunityGetArgs()
        {
        }
        public static new ManagedswitchSnmpCommunityGetArgs Empty => new ManagedswitchSnmpCommunityGetArgs();
    }
}
