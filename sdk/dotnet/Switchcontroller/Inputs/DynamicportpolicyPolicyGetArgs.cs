...
namespace Pulumiverse.Fortios.Switchcontroller.Inputs
{
    ...
    public sealed class DynamicportpolicyPolicyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("interfaceTags")]
        private InputList<Inputs.DynamicportpolicyPolicyInterfaceTagGetArgs>? _interfaceTags;

        /// <summary>
        /// Policy matching the FortiSwitch interface object tags. The structure of `interface_tags` block is documented below.
        /// </summary>
        public InputList<Inputs.DynamicportpolicyPolicyInterfaceTagGetArgs> InterfaceTags
        {
            get => _interfaceTags ?? (_interfaceTags = new InputList<Inputs.DynamicportpolicyPolicyInterfaceTagGetArgs>());
        ...
        public DynamicportpolicyPolicyGetArgs()
        {
        }
        public static new DynamicportpolicyPolicyGetArgs Empty => new DynamicportpolicyPolicyGetArgs();
    }
}
