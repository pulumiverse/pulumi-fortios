...
namespace Pulumiverse.Fortios.Switchcontroller.Ptp
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:switchcontroller/ptp/policy:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/ptp/policy:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, PolicyState? state = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/ptp/policy:Policy", name, state, MakeResourceOptions(options, id))
        {
        }
