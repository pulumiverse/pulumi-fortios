...
namespace Pulumiverse.Fortios.Switchcontroller.Ptp
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:switchcontroller/ptp/interfacepolicy:Interfacepolicy")]
    public partial class Interfacepolicy : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("vlanPri")]
        public Output<int> VlanPri { get; private set; } = null!;
        ...
        public Interfacepolicy(string name, InterfacepolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/ptp/interfacepolicy:Interfacepolicy", name, args ?? new InterfacepolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Interfacepolicy(string name, Input<string> id, InterfacepolicyState? state = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/ptp/interfacepolicy:Interfacepolicy", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InterfacepolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("vlanPri")]
        public Input<int>? VlanPri { get; set; }
