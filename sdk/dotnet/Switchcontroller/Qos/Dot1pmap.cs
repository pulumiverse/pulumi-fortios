...
namespace Pulumiverse.Fortios.Switchcontroller.Qos
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:switchcontroller/qos/dot1pmap:Dot1pmap")]
    public partial class Dot1pmap : global::Pulumi.CustomResource
    {
        ...
        public Dot1pmap(string name, Dot1pmapArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/qos/dot1pmap:Dot1pmap", name, args ?? new Dot1pmapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dot1pmap(string name, Input<string> id, Dot1pmapState? state = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/qos/dot1pmap:Dot1pmap", name, state, MakeResourceOptions(options, id))
        {
        }
