...
namespace Pulumiverse.Fortios.Switchcontroller.Qos
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:switchcontroller/qos/queuepolicy:Queuepolicy")]
    public partial class Queuepolicy : global::Pulumi.CustomResource
    {
        ...
        public Queuepolicy(string name, QueuepolicyArgs args, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/qos/queuepolicy:Queuepolicy", name, args ?? new QueuepolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queuepolicy(string name, Input<string> id, QueuepolicyState? state = null, CustomResourceOptions? options = null)
            : base("fortios:switchcontroller/qos/queuepolicy:Queuepolicy", name, state, MakeResourceOptions(options, id))
        {
        }
