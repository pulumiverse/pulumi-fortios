...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.LognulldeviceFilter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/lognulldeviceFilter:LognulldeviceFilter")]
    public partial class LognulldeviceFilter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.LognulldeviceFilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a LognulldeviceFilter resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public LognulldeviceFilter(string name, LognulldeviceFilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/lognulldeviceFilter:LognulldeviceFilter", name, args ?? new LognulldeviceFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LognulldeviceFilter(string name, Input<string> id, LognulldeviceFilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/lognulldeviceFilter:LognulldeviceFilter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LognulldeviceFilter Get(string name, Input<string> id, LognulldeviceFilterState? state = null, CustomResourceOptions? options = null)
        {
            return new LognulldeviceFilter(name, id, state, options);
        }
    }

    public sealed class LognulldeviceFilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.LognulldeviceFilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.LognulldeviceFilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.LognulldeviceFilterFreeStyleArgs>());
        ...
        public LognulldeviceFilterArgs()
        {
        }
        public static new LognulldeviceFilterArgs Empty => new LognulldeviceFilterArgs();
    }

    public sealed class LognulldeviceFilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.LognulldeviceFilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.LognulldeviceFilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.LognulldeviceFilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public LognulldeviceFilterState()
        {
        }
        public static new LognulldeviceFilterState Empty => new LognulldeviceFilterState();
    }
}
