...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemdhcpServer("trname", new()
    ///     {
    ///         DnsService = "default",
    ///         Fosid = 1,
    ///         Interface = "port2",
    ///         IpRanges = new[]
    ///         {
    ///             new Fortios.Inputs.SystemdhcpServerIpRangeArgs
    ///             {
    ///                 EndIp = "1.1.1.22",
    ///                 Id = 1,
    ///                 StartIp = "1.1.1.1",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemdhcpServer:SystemdhcpServer")]
    public partial class SystemdhcpServer : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.SystemdhcpServerExcludeRange>> ExcludeRanges { get; private set; } = null!;
        ...
        /// </summary>
        [Output("ipRanges")]
        public Output<ImmutableArray<Outputs.SystemdhcpServerIpRange>> IpRanges { get; private set; } = null!;
        ...
        /// </summary>
        [Output("options")]
        public Output<ImmutableArray<Outputs.SystemdhcpServerOption>> Options { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.SystemdhcpServerReservedAddress>> ReservedAddresses { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tftpServers")]
        public Output<ImmutableArray<Outputs.SystemdhcpServerTftpServer>> TftpServers { get; private set; } = null!;
        ...
        /// </summary>
        [Output("vciStrings")]
        public Output<ImmutableArray<Outputs.SystemdhcpServerVciString>> VciStrings { get; private set; } = null!;
        ...
        public SystemdhcpServer(string name, SystemdhcpServerArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemdhcpServer:SystemdhcpServer", name, args ?? new SystemdhcpServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemdhcpServer(string name, Input<string> id, SystemdhcpServerState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemdhcpServer:SystemdhcpServer", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemdhcpServer Get(string name, Input<string> id, SystemdhcpServerState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemdhcpServer(name, id, state, options);
        }
    }

    public sealed class SystemdhcpServerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable auto configuration. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        [Input("excludeRanges")]
        private InputList<Inputs.SystemdhcpServerExcludeRangeArgs>? _excludeRanges;

        /// <summary>
        /// Exclude one or more ranges of IP addresses from being assigned to clients. The structure of `exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerExcludeRangeArgs> ExcludeRanges
        {
            get => _excludeRanges ?? (_excludeRanges = new InputList<Inputs.SystemdhcpServerExcludeRangeArgs>());
        ...
        [Input("ipRanges")]
        private InputList<Inputs.SystemdhcpServerIpRangeArgs>? _ipRanges;

        /// <summary>
        /// DHCP IP range configuration. The structure of `ip_range` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerIpRangeArgs> IpRanges
        {
            get => _ipRanges ?? (_ipRanges = new InputList<Inputs.SystemdhcpServerIpRangeArgs>());
            set => _ipRanges = value;
        }
        ...
        [Input("options")]
        private InputList<Inputs.SystemdhcpServerOptionArgs>? _options;

        /// <summary>
        /// DHCP options. The structure of `options` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerOptionArgs> Options
        {
            get => _options ?? (_options = new InputList<Inputs.SystemdhcpServerOptionArgs>());
            set => _options = value;
        }

        [Input("reservedAddresses")]
        private InputList<Inputs.SystemdhcpServerReservedAddressArgs>? _reservedAddresses;

        /// <summary>
        /// Options for the DHCP server to assign IP settings to specific MAC addresses. The structure of `reserved_address` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerReservedAddressArgs> ReservedAddresses
        {
            get => _reservedAddresses ?? (_reservedAddresses = new InputList<Inputs.SystemdhcpServerReservedAddressArgs>());
        ...
        [Input("tftpServers")]
        private InputList<Inputs.SystemdhcpServerTftpServerArgs>? _tftpServers;

        /// <summary>
        /// One or more hostnames or IP addresses of the TFTP servers in quotes separated by spaces. The structure of `tftp_server` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerTftpServerArgs> TftpServers
        {
            get => _tftpServers ?? (_tftpServers = new InputList<Inputs.SystemdhcpServerTftpServerArgs>());
        ...
        [Input("vciStrings")]
        private InputList<Inputs.SystemdhcpServerVciStringArgs>? _vciStrings;

        /// <summary>
        /// One or more VCI strings in quotes separated by spaces. The structure of `vci_string` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerVciStringArgs> VciStrings
        {
            get => _vciStrings ?? (_vciStrings = new InputList<Inputs.SystemdhcpServerVciStringArgs>());
        ...
        public SystemdhcpServerArgs()
        {
        }
        public static new SystemdhcpServerArgs Empty => new SystemdhcpServerArgs();
    }

    public sealed class SystemdhcpServerState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable auto configuration. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        [Input("excludeRanges")]
        private InputList<Inputs.SystemdhcpServerExcludeRangeGetArgs>? _excludeRanges;

        /// <summary>
        /// Exclude one or more ranges of IP addresses from being assigned to clients. The structure of `exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerExcludeRangeGetArgs> ExcludeRanges
        {
            get => _excludeRanges ?? (_excludeRanges = new InputList<Inputs.SystemdhcpServerExcludeRangeGetArgs>());
            set => _excludeRanges = value;
        }
        ...
        [Input("ipRanges")]
        private InputList<Inputs.SystemdhcpServerIpRangeGetArgs>? _ipRanges;

        /// <summary>
        /// DHCP IP range configuration. The structure of `ip_range` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerIpRangeGetArgs> IpRanges
        {
            get => _ipRanges ?? (_ipRanges = new InputList<Inputs.SystemdhcpServerIpRangeGetArgs>());
            set => _ipRanges = value;
        }
        ...
        [Input("options")]
        private InputList<Inputs.SystemdhcpServerOptionGetArgs>? _options;

        /// <summary>
        /// DHCP options. The structure of `options` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerOptionGetArgs> Options
        {
            get => _options ?? (_options = new InputList<Inputs.SystemdhcpServerOptionGetArgs>());
            set => _options = value;
        }

        [Input("reservedAddresses")]
        private InputList<Inputs.SystemdhcpServerReservedAddressGetArgs>? _reservedAddresses;

        /// <summary>
        /// Options for the DHCP server to assign IP settings to specific MAC addresses. The structure of `reserved_address` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerReservedAddressGetArgs> ReservedAddresses
        {
            get => _reservedAddresses ?? (_reservedAddresses = new InputList<Inputs.SystemdhcpServerReservedAddressGetArgs>());
            set => _reservedAddresses = value;
        }
        ...
        [Input("tftpServers")]
        private InputList<Inputs.SystemdhcpServerTftpServerGetArgs>? _tftpServers;

        /// <summary>
        /// One or more hostnames or IP addresses of the TFTP servers in quotes separated by spaces. The structure of `tftp_server` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerTftpServerGetArgs> TftpServers
        {
            get => _tftpServers ?? (_tftpServers = new InputList<Inputs.SystemdhcpServerTftpServerGetArgs>());
            set => _tftpServers = value;
        }
        ...
        [Input("vciStrings")]
        private InputList<Inputs.SystemdhcpServerVciStringGetArgs>? _vciStrings;

        /// <summary>
        /// One or more VCI strings in quotes separated by spaces. The structure of `vci_string` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemdhcpServerVciStringGetArgs> VciStrings
        {
            get => _vciStrings ?? (_vciStrings = new InputList<Inputs.SystemdhcpServerVciStringGetArgs>());
            set => _vciStrings = value;
        }
        ...
        public SystemdhcpServerState()
        {
        }
        public static new SystemdhcpServerState Empty => new SystemdhcpServerState();
    }
}
