...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/routerbgpNetwork:RouterbgpNetwork")]
    public partial class RouterbgpNetwork : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public RouterbgpNetwork(string name, RouterbgpNetworkArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/routerbgpNetwork:RouterbgpNetwork", name, args ?? new RouterbgpNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouterbgpNetwork(string name, Input<string> id, RouterbgpNetworkState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/routerbgpNetwork:RouterbgpNetwork", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RouterbgpNetwork Get(string name, Input<string> id, RouterbgpNetworkState? state = null, CustomResourceOptions? options = null)
        {
            return new RouterbgpNetwork(name, id, state, options);
        }
    }

    public sealed class RouterbgpNetworkArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable route as backdoor. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public RouterbgpNetworkArgs()
        {
        }
        public static new RouterbgpNetworkArgs Empty => new RouterbgpNetworkArgs();
    }

    public sealed class RouterbgpNetworkState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable route as backdoor. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public RouterbgpNetworkState()
        {
        }
        public static new RouterbgpNetworkState Empty => new RouterbgpNetworkState();
    }
}
