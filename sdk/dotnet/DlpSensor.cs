...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.DlpSensor("trname", new()
    ///     {
    ///         DlpLog = "enable",
    ///         ExtendedLog = "disable",
    ///         FlowBased = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/dlpSensor:DlpSensor")]
    public partial class DlpSensor : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        /// </summary>
        [Output("entries")]
        public Output<ImmutableArray<Outputs.DlpSensorEntry>> Entries { get; private set; } = null!;
        ...
        /// </summary>
        [Output("filters")]
        public Output<ImmutableArray<Outputs.DlpSensorFilter>> Filters { get; private set; } = null!;
        ...
        public DlpSensor(string name, DlpSensorArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/dlpSensor:DlpSensor", name, args ?? new DlpSensorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DlpSensor(string name, Input<string> id, DlpSensorState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/dlpSensor:DlpSensor", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DlpSensor Get(string name, Input<string> id, DlpSensorState? state = null, CustomResourceOptions? options = null)
        {
            return new DlpSensor(name, id, state, options);
        }
    }

    public sealed class DlpSensorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        [Input("entries")]
        private InputList<Inputs.DlpSensorEntryArgs>? _entries;

        /// <summary>
        /// DLP sensor entries. The structure of `entries` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpSensorEntryArgs> Entries
        {
            get => _entries ?? (_entries = new InputList<Inputs.DlpSensorEntryArgs>());
            set => _entries = value;
        }
        ...
        [Input("filters")]
        private InputList<Inputs.DlpSensorFilterArgs>? _filters;

        /// <summary>
        /// Set up DLP filters for this sensor. The structure of `filter` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpSensorFilterArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.DlpSensorFilterArgs>());
            set => _filters = value;
        }
        ...
        public DlpSensorArgs()
        {
        }
        public static new DlpSensorArgs Empty => new DlpSensorArgs();
    }

    public sealed class DlpSensorState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        [Input("entries")]
        private InputList<Inputs.DlpSensorEntryGetArgs>? _entries;

        /// <summary>
        /// DLP sensor entries. The structure of `entries` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpSensorEntryGetArgs> Entries
        {
            get => _entries ?? (_entries = new InputList<Inputs.DlpSensorEntryGetArgs>());
            set => _entries = value;
        }
        ...
        [Input("filters")]
        private InputList<Inputs.DlpSensorFilterGetArgs>? _filters;

        /// <summary>
        /// Set up DLP filters for this sensor. The structure of `filter` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpSensorFilterGetArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.DlpSensorFilterGetArgs>());
            set => _filters = value;
        }
        ...
        public DlpSensorState()
        {
        }
        public static new DlpSensorState Empty => new DlpSensorState();
    }
}
