...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.Logsyslogd2Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logsyslogd2Filter:Logsyslogd2Filter")]
    public partial class Logsyslogd2Filter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.Logsyslogd2FilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        public Logsyslogd2Filter(string name, Logsyslogd2FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logsyslogd2Filter:Logsyslogd2Filter", name, args ?? new Logsyslogd2FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logsyslogd2Filter(string name, Input<string> id, Logsyslogd2FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logsyslogd2Filter:Logsyslogd2Filter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Logsyslogd2Filter Get(string name, Input<string> id, Logsyslogd2FilterState? state = null, CustomResourceOptions? options = null)
        {
            return new Logsyslogd2Filter(name, id, state, options);
        }
    }

    public sealed class Logsyslogd2FilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logsyslogd2FilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logsyslogd2FilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logsyslogd2FilterFreeStyleArgs>());
        ...
        public Logsyslogd2FilterArgs()
        {
        }
        public static new Logsyslogd2FilterArgs Empty => new Logsyslogd2FilterArgs();
    }

    public sealed class Logsyslogd2FilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logsyslogd2FilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logsyslogd2FilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logsyslogd2FilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public Logsyslogd2FilterState()
        {
        }
        public static new Logsyslogd2FilterState Empty => new Logsyslogd2FilterState();
    }
}
