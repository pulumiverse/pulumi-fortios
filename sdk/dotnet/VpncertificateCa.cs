...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/vpncertificateCa:VpncertificateCa")]
    public partial class VpncertificateCa : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public VpncertificateCa(string name, VpncertificateCaArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/vpncertificateCa:VpncertificateCa", name, args ?? new VpncertificateCaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpncertificateCa(string name, Input<string> id, VpncertificateCaState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpncertificateCa:VpncertificateCa", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VpncertificateCa Get(string name, Input<string> id, VpncertificateCaState? state = null, CustomResourceOptions? options = null)
        {
            return new VpncertificateCa(name, id, state, options);
        }
    }

    public sealed class VpncertificateCaArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Number of days to wait before requesting an updated CA certificate (0 - 4294967295, 0 = disabled).
        /// </summary>
        ...
        public VpncertificateCaArgs()
        {
        }
        public static new VpncertificateCaArgs Empty => new VpncertificateCaArgs();
    }

    public sealed class VpncertificateCaState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Number of days to wait before requesting an updated CA certificate (0 - 4294967295, 0 = disabled).
        /// </summary>
        ...
        public VpncertificateCaState()
        {
        }
        public static new VpncertificateCaState Empty => new VpncertificateCaState();
    }
}
