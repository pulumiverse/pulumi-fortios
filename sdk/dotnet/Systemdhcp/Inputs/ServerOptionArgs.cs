...
namespace Pulumiverse.Fortios.Systemdhcp.Inputs
{
    ...
    public sealed class ServerOptionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// DHCP option code.
        /// </summary>
        ...
        [Input("vciStrings")]
        private InputList<Inputs.ServerOptionVciStringArgs>? _vciStrings;

        /// <summary>
        /// One or more VCI strings in quotes separated by spaces. The structure of `vci_string` block is documented below.
        /// </summary>
        public InputList<Inputs.ServerOptionVciStringArgs> VciStrings
        {
            get => _vciStrings ?? (_vciStrings = new InputList<Inputs.ServerOptionVciStringArgs>());
            set => _vciStrings = value;
        }

        public ServerOptionArgs()
        {
        }
        public static new ServerOptionArgs Empty => new ServerOptionArgs();
    }
}
