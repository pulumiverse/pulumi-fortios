...
namespace Pulumiverse.Fortios.Systemdhcp.Inputs
{
    ...
    public sealed class ServerIpRangeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// End of IP range.
        /// </summary>
        ...
        [Input("vciStrings")]
        private InputList<Inputs.ServerIpRangeVciStringArgs>? _vciStrings;

        /// <summary>
        /// One or more VCI strings in quotes separated by spaces. The structure of `vci_string` block is documented below.
        /// </summary>
        public InputList<Inputs.ServerIpRangeVciStringArgs> VciStrings
        {
            get => _vciStrings ?? (_vciStrings = new InputList<Inputs.ServerIpRangeVciStringArgs>());
            set => _vciStrings = value;
        }

        public ServerIpRangeArgs()
        {
        }
        public static new ServerIpRangeArgs Empty => new ServerIpRangeArgs();
    }
}
