...
namespace Pulumiverse.Fortios.Logfortianalyzercloud
{
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logfortianalyzercloud/filter:Filter labelname LogFortianalyzerCloudFilter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortianalyzercloud/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzercloud/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzercloud/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
