...
namespace Pulumiverse.Fortios.Logfortianalyzercloud
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortianalyzercloud/overridesetting:Overridesetting")]
    public partial class Overridesetting : global::Pulumi.CustomResource
    {
        ...
        public Overridesetting(string name, OverridesettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzercloud/overridesetting:Overridesetting", name, args ?? new OverridesettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Overridesetting(string name, Input<string> id, OverridesettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzercloud/overridesetting:Overridesetting", name, state, MakeResourceOptions(options, id))
        {
        }
