...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.WebproxyForwardserver("trname", new()
    ///     {
    ///         AddrType = "fqdn",
    ///         Healthcheck = "disable",
    ///         Ip = "0.0.0.0",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/webproxyForwardserver:WebproxyForwardserver")]
    public partial class WebproxyForwardserver : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public WebproxyForwardserver(string name, WebproxyForwardserverArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/webproxyForwardserver:WebproxyForwardserver", name, args ?? new WebproxyForwardserverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebproxyForwardserver(string name, Input<string> id, WebproxyForwardserverState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/webproxyForwardserver:WebproxyForwardserver", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WebproxyForwardserver Get(string name, Input<string> id, WebproxyForwardserverState? state = null, CustomResourceOptions? options = null)
        {
            return new WebproxyForwardserver(name, id, state, options);
        }
    }

    public sealed class WebproxyForwardserverArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Address type of the forwarding proxy server: IP or FQDN. Valid values: `ip`, `fqdn`.
        /// </summary>
        ...
        public WebproxyForwardserverArgs()
        {
        }
        public static new WebproxyForwardserverArgs Empty => new WebproxyForwardserverArgs();
    }

    public sealed class WebproxyForwardserverState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Address type of the forwarding proxy server: IP or FQDN. Valid values: `ip`, `fqdn`.
        /// </summary>
        ...
        public WebproxyForwardserverState()
        {
        }
        public static new WebproxyForwardserverState Empty => new WebproxyForwardserverState();
    }
}
