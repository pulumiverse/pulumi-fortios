...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallshaperTrafficshaper("trname", new()
    ///     {
    ///         BandwidthUnit = "kbps",
    ///         Diffserv = "disable",
    ///         Diffservcode = "000000",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallshaperTrafficshaper:FirewallshaperTrafficshaper")]
    public partial class FirewallshaperTrafficshaper : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallshaperTrafficshaper(string name, FirewallshaperTrafficshaperArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallshaperTrafficshaper:FirewallshaperTrafficshaper", name, args ?? new FirewallshaperTrafficshaperArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallshaperTrafficshaper(string name, Input<string> id, FirewallshaperTrafficshaperState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallshaperTrafficshaper:FirewallshaperTrafficshaper", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallshaperTrafficshaper Get(string name, Input<string> id, FirewallshaperTrafficshaperState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallshaperTrafficshaper(name, id, state, options);
        }
    }

    public sealed class FirewallshaperTrafficshaperArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Unit of measurement for guaranteed and maximum bandwidth for this shaper (Kbps, Mbps or Gbps). Valid values: `kbps`, `mbps`, `gbps`.
        /// </summary>
        ...
        public FirewallshaperTrafficshaperArgs()
        {
        }
        public static new FirewallshaperTrafficshaperArgs Empty => new FirewallshaperTrafficshaperArgs();
    }

    public sealed class FirewallshaperTrafficshaperState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Unit of measurement for guaranteed and maximum bandwidth for this shaper (Kbps, Mbps or Gbps). Valid values: `kbps`, `mbps`, `gbps`.
        /// </summary>
        ...
        public FirewallshaperTrafficshaperState()
        {
        }
        public static new FirewallshaperTrafficshaperState Empty => new FirewallshaperTrafficshaperState();
    }
}
