...
namespace Pulumiverse.Fortios.Logfortianalyzer
{
    /// <summary>
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer.Overridefilter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         DlpArchive = "enable",
    ///         Dns = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortianalyzer/overridefilter:Overridefilter")]
    public partial class Overridefilter : global::Pulumi.CustomResource
    {
        ...
        public Overridefilter(string name, OverridefilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer/overridefilter:Overridefilter", name, args ?? new OverridefilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Overridefilter(string name, Input<string> id, OverridefilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer/overridefilter:Overridefilter", name, state, MakeResourceOptions(options, id))
        {
        }
