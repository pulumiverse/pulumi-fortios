...
namespace Pulumiverse.Fortios.Logfortianalyzer
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer.Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         DlpArchive = "enable",
    ///         Dns = "enable",
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logfortianalyzer/filter:Filter labelname LogFortianalyzerFilter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortianalyzer/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
