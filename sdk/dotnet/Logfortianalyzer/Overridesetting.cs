...
namespace Pulumiverse.Fortios.Logfortianalyzer
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer.Overridesetting("trname", new()
    ///     {
    ///         __changeIp = 0,
    ///         ConnTimeout = 10,
    ///         EncAlgorithm = "high",
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortianalyzer/overridesetting:Overridesetting")]
    public partial class Overridesetting : global::Pulumi.CustomResource
    {
        ...
        public Overridesetting(string name, OverridesettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer/overridesetting:Overridesetting", name, args ?? new OverridesettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Overridesetting(string name, Input<string> id, OverridesettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer/overridesetting:Overridesetting", name, state, MakeResourceOptions(options, id))
        {
        }
