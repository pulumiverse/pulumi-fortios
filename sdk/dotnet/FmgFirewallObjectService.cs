...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var test1 = new Fortios.FmgFirewallObjectService("test1", new()
    ///     {
    ///         Category = "Email",
    ...
    ///     });
    /// 
    ///     var test2 = new Fortios.FmgFirewallObjectService("test2", new()
    ///     {
    ///         Category = "Web Access",
    ///         Comment = "test obj service",
    ///         IcmpCode = 3,
    ...
    ///     });
    /// 
    ///     var test3 = new Fortios.FmgFirewallObjectService("test3", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:index/fmgFirewallObjectService:FmgFirewallObjectService")]
    public partial class FmgFirewallObjectService : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FmgFirewallObjectService(string name, FmgFirewallObjectServiceArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/fmgFirewallObjectService:FmgFirewallObjectService", name, args ?? new FmgFirewallObjectServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FmgFirewallObjectService(string name, Input<string> id, FmgFirewallObjectServiceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/fmgFirewallObjectService:FmgFirewallObjectService", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FmgFirewallObjectService Get(string name, Input<string> id, FmgFirewallObjectServiceState? state = null, CustomResourceOptions? options = null)
        {
            return new FmgFirewallObjectService(name, id, state, options);
        }
    }

    public sealed class FmgFirewallObjectServiceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// ADOM name. default is 'root'.
        /// </summary>
        ...
        public FmgFirewallObjectServiceArgs()
        {
        }
        public static new FmgFirewallObjectServiceArgs Empty => new FmgFirewallObjectServiceArgs();
    }

    public sealed class FmgFirewallObjectServiceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// ADOM name. default is 'root'.
        /// </summary>
        ...
        public FmgFirewallObjectServiceState()
        {
        }
        public static new FmgFirewallObjectServiceState Empty => new FmgFirewallObjectServiceState();
    }
}
