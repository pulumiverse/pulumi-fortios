...
namespace Pulumiverse.Fortios.Vpncertificate
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:vpncertificate/remote:Remote")]
    public partial class Remote : global::Pulumi.CustomResource
    {
        ...
        public Remote(string name, RemoteArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:vpncertificate/remote:Remote", name, args ?? new RemoteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Remote(string name, Input<string> id, RemoteState? state = null, CustomResourceOptions? options = null)
            : base("fortios:vpncertificate/remote:Remote", name, state, MakeResourceOptions(options, id))
        {
        }
