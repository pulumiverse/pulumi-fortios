...
namespace Pulumiverse.Fortios.Vpncertificate
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:vpncertificate/crl:Crl")]
    public partial class Crl : global::Pulumi.CustomResource
    {
        ...
        public Crl(string name, CrlArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:vpncertificate/crl:Crl", name, args ?? new CrlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Crl(string name, Input<string> id, CrlState? state = null, CustomResourceOptions? options = null)
            : base("fortios:vpncertificate/crl:Crl", name, state, MakeResourceOptions(options, id))
        {
        }
