...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallAddress("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallAddress:FirewallAddress")]
    public partial class FirewallAddress : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("fssoGroups")]
        public Output<ImmutableArray<Outputs.FirewallAddressFssoGroup>> FssoGroups { get; private set; } = null!;
        ...
        /// </summary>
        [Output("lists")]
        public Output<ImmutableArray<Outputs.FirewallAddressList>> Lists { get; private set; } = null!;

        /// <summary>
        /// Multiple MAC address ranges. The structure of `macaddr` block is documented below.
        /// </summary>
        [Output("macaddrs")]
        public Output<ImmutableArray<Outputs.FirewallAddressMacaddr>> Macaddrs { get; private set; } = null!;
        ...
        /// </summary>
        [Output("taggings")]
        public Output<ImmutableArray<Outputs.FirewallAddressTagging>> Taggings { get; private set; } = null!;
        ...
        public FirewallAddress(string name, FirewallAddressArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallAddress:FirewallAddress", name, args ?? new FirewallAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallAddress(string name, Input<string> id, FirewallAddressState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallAddress:FirewallAddress", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallAddress Get(string name, Input<string> id, FirewallAddressState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallAddress(name, id, state, options);
        }
    }

    public sealed class FirewallAddressArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable use of this address in the static route configuration. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("fssoGroups")]
        private InputList<Inputs.FirewallAddressFssoGroupArgs>? _fssoGroups;

        /// <summary>
        /// FSSO group(s). The structure of `fsso_group` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAddressFssoGroupArgs> FssoGroups
        {
            get => _fssoGroups ?? (_fssoGroups = new InputList<Inputs.FirewallAddressFssoGroupArgs>());
        ...
        [Input("lists")]
        private InputList<Inputs.FirewallAddressListArgs>? _lists;

        /// <summary>
        /// IP address list. The structure of `list` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAddressListArgs> Lists
        {
            get => _lists ?? (_lists = new InputList<Inputs.FirewallAddressListArgs>());
            set => _lists = value;
        }

        [Input("macaddrs")]
        private InputList<Inputs.FirewallAddressMacaddrArgs>? _macaddrs;

        /// <summary>
        /// Multiple MAC address ranges. The structure of `macaddr` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAddressMacaddrArgs> Macaddrs
        {
            get => _macaddrs ?? (_macaddrs = new InputList<Inputs.FirewallAddressMacaddrArgs>());
            set => _macaddrs = value;
        }
        ...
        [Input("taggings")]
        private InputList<Inputs.FirewallAddressTaggingArgs>? _taggings;

        /// <summary>
        /// Config object tagging. The structure of `tagging` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAddressTaggingArgs> Taggings
        {
            get => _taggings ?? (_taggings = new InputList<Inputs.FirewallAddressTaggingArgs>());
            set => _taggings = value;
        }
        ...
        public FirewallAddressArgs()
        {
        }
        public static new FirewallAddressArgs Empty => new FirewallAddressArgs();
    }

    public sealed class FirewallAddressState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable use of this address in the static route configuration. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("fssoGroups")]
        private InputList<Inputs.FirewallAddressFssoGroupGetArgs>? _fssoGroups;

        /// <summary>
        /// FSSO group(s). The structure of `fsso_group` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAddressFssoGroupGetArgs> FssoGroups
        {
            get => _fssoGroups ?? (_fssoGroups = new InputList<Inputs.FirewallAddressFssoGroupGetArgs>());
            set => _fssoGroups = value;
        }
        ...
        [Input("lists")]
        private InputList<Inputs.FirewallAddressListGetArgs>? _lists;

        /// <summary>
        /// IP address list. The structure of `list` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAddressListGetArgs> Lists
        {
            get => _lists ?? (_lists = new InputList<Inputs.FirewallAddressListGetArgs>());
            set => _lists = value;
        }

        [Input("macaddrs")]
        private InputList<Inputs.FirewallAddressMacaddrGetArgs>? _macaddrs;

        /// <summary>
        /// Multiple MAC address ranges. The structure of `macaddr` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAddressMacaddrGetArgs> Macaddrs
        {
            get => _macaddrs ?? (_macaddrs = new InputList<Inputs.FirewallAddressMacaddrGetArgs>());
            set => _macaddrs = value;
        }
        ...
        [Input("taggings")]
        private InputList<Inputs.FirewallAddressTaggingGetArgs>? _taggings;

        /// <summary>
        /// Config object tagging. The structure of `tagging` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAddressTaggingGetArgs> Taggings
        {
            get => _taggings ?? (_taggings = new InputList<Inputs.FirewallAddressTaggingGetArgs>());
            set => _taggings = value;
        }
        ...
        public FirewallAddressState()
        {
        }
        public static new FirewallAddressState Empty => new FirewallAddressState();
    }
}
