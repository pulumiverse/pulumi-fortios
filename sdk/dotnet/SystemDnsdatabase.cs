...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemDnsdatabase("trname", new()
    ///     {
    ///         Authoritative = "enable",
    ///         Contact = "hostmaster",
    ///         DnsEntries = new[]
    ///         {
    ///             new Fortios.Inputs.SystemDnsdatabaseDnsEntryArgs
    ///             {
    ///                 Hostname = "sghsgh.com",
    ///                 Ttl = 3,
    ///                 Type = "MX",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemDnsdatabase:SystemDnsdatabase")]
    public partial class SystemDnsdatabase : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("dnsEntries")]
        public Output<ImmutableArray<Outputs.SystemDnsdatabaseDnsEntry>> DnsEntries { get; private set; } = null!;
        ...
        public SystemDnsdatabase(string name, SystemDnsdatabaseArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemDnsdatabase:SystemDnsdatabase", name, args ?? new SystemDnsdatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemDnsdatabase(string name, Input<string> id, SystemDnsdatabaseState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemDnsdatabase:SystemDnsdatabase", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemDnsdatabase Get(string name, Input<string> id, SystemDnsdatabaseState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemDnsdatabase(name, id, state, options);
        }
    }

    public sealed class SystemDnsdatabaseArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// DNS zone transfer IP address list.
        /// </summary>
        ...
        [Input("dnsEntries")]
        private InputList<Inputs.SystemDnsdatabaseDnsEntryArgs>? _dnsEntries;

        /// <summary>
        /// DNS entry. The structure of `dns_entry` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemDnsdatabaseDnsEntryArgs> DnsEntries
        {
            get => _dnsEntries ?? (_dnsEntries = new InputList<Inputs.SystemDnsdatabaseDnsEntryArgs>());
        ...
        public SystemDnsdatabaseArgs()
        {
        }
        public static new SystemDnsdatabaseArgs Empty => new SystemDnsdatabaseArgs();
    }

    public sealed class SystemDnsdatabaseState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// DNS zone transfer IP address list.
        /// </summary>
        ...
        [Input("dnsEntries")]
        private InputList<Inputs.SystemDnsdatabaseDnsEntryGetArgs>? _dnsEntries;

        /// <summary>
        /// DNS entry. The structure of `dns_entry` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemDnsdatabaseDnsEntryGetArgs> DnsEntries
        {
            get => _dnsEntries ?? (_dnsEntries = new InputList<Inputs.SystemDnsdatabaseDnsEntryGetArgs>());
            set => _dnsEntries = value;
        }
        ...
        public SystemDnsdatabaseState()
        {
        }
        public static new SystemDnsdatabaseState Empty => new SystemDnsdatabaseState();
    }
}
