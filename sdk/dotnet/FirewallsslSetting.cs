...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallsslSetting("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallsslSetting:FirewallsslSetting")]
    public partial class FirewallsslSetting : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallsslSetting(string name, FirewallsslSettingArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/firewallsslSetting:FirewallsslSetting", name, args ?? new FirewallsslSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallsslSetting(string name, Input<string> id, FirewallsslSettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallsslSetting:FirewallsslSetting", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallsslSetting Get(string name, Input<string> id, FirewallsslSettingState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallsslSetting(name, id, state, options);
        }
    }

    public sealed class FirewallsslSettingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable use of SSL abbreviated handshake. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public FirewallsslSettingArgs()
        {
        }
        public static new FirewallsslSettingArgs Empty => new FirewallsslSettingArgs();
    }

    public sealed class FirewallsslSettingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable use of SSL abbreviated handshake. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public FirewallsslSettingState()
        {
        }
        public static new FirewallsslSettingState Empty => new FirewallsslSettingState();
    }
}
