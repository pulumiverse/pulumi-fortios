...
namespace Pulumiverse.Fortios.Casb.Inputs
{
    ...
    public sealed class UseractivityControlOptionOperationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("values")]
        private InputList<Inputs.UseractivityControlOptionOperationValueArgs>? _values;

        /// <summary>
        /// CASB operation new values. The structure of `values` block is documented below.
        /// </summary>
        public InputList<Inputs.UseractivityControlOptionOperationValueArgs> Values
        {
            get => _values ?? (_values = new InputList<Inputs.UseractivityControlOptionOperationValueArgs>());
            set => _values = value;
        }

        public UseractivityControlOptionOperationArgs()
        {
        }
        public static new UseractivityControlOptionOperationArgs Empty => new UseractivityControlOptionOperationArgs();
    }
}
