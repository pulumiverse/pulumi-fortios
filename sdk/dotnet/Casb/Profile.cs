...
namespace Pulumiverse.Fortios.Casb
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:casb/profile:Profile")]
    public partial class Profile : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("saasApplications")]
        public Output<ImmutableArray<Outputs.ProfileSaasApplication>> SaasApplications { get; private set; } = null!;
        ...
        public Profile(string name, ProfileArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:casb/profile:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, ProfileState? state = null, CustomResourceOptions? options = null)
            : base("fortios:casb/profile:Profile", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("saasApplications")]
        private InputList<Inputs.ProfileSaasApplicationArgs>? _saasApplications;

        /// <summary>
        /// CASB profile SaaS application. The structure of `saas_application` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileSaasApplicationArgs> SaasApplications
        {
            get => _saasApplications ?? (_saasApplications = new InputList<Inputs.ProfileSaasApplicationArgs>());
            set => _saasApplications = value;
        }
    ...
    public sealed class ProfileState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("saasApplications")]
        private InputList<Inputs.ProfileSaasApplicationGetArgs>? _saasApplications;

        /// <summary>
        /// CASB profile SaaS application. The structure of `saas_application` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileSaasApplicationGetArgs> SaasApplications
        {
            get => _saasApplications ?? (_saasApplications = new InputList<Inputs.ProfileSaasApplicationGetArgs>());
            set => _saasApplications = value;
        }
