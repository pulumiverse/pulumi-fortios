...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemPasswordpolicy("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemPasswordpolicy:SystemPasswordpolicy")]
    public partial class SystemPasswordpolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemPasswordpolicy(string name, SystemPasswordpolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemPasswordpolicy:SystemPasswordpolicy", name, args ?? new SystemPasswordpolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemPasswordpolicy(string name, Input<string> id, SystemPasswordpolicyState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemPasswordpolicy:SystemPasswordpolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemPasswordpolicy Get(string name, Input<string> id, SystemPasswordpolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemPasswordpolicy(name, id, state, options);
        }
    }

    public sealed class SystemPasswordpolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Apply password policy to administrator passwords or IPsec pre-shared keys or both. Separate entries with a space. Valid values: `admin-password`, `ipsec-preshared-key`.
        /// </summary>
        ...
        public SystemPasswordpolicyArgs()
        {
        }
        public static new SystemPasswordpolicyArgs Empty => new SystemPasswordpolicyArgs();
    }

    public sealed class SystemPasswordpolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Apply password policy to administrator passwords or IPsec pre-shared keys or both. Separate entries with a space. Valid values: `admin-password`, `ipsec-preshared-key`.
        /// </summary>
        ...
        public SystemPasswordpolicyState()
        {
        }
        public static new SystemPasswordpolicyState Empty => new SystemPasswordpolicyState();
    }
}
