...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemNat64("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemNat64:SystemNat64")]
    public partial class SystemNat64 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.SystemNat64SecondaryPrefix>> SecondaryPrefixes { get; private set; } = null!;
        ...
        public SystemNat64(string name, SystemNat64Args args, CustomResourceOptions? options = null)
            : base("fortios:index/systemNat64:SystemNat64", name, args ?? new SystemNat64Args(), MakeResourceOptions(options, ""))
        {
        }

        private SystemNat64(string name, Input<string> id, SystemNat64State? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemNat64:SystemNat64", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemNat64 Get(string name, Input<string> id, SystemNat64State? state = null, CustomResourceOptions? options = null)
        {
            return new SystemNat64(name, id, state, options);
        }
    }

    public sealed class SystemNat64Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable AAAA record synthesis (default = enable). Valid values: `enable`, `disable`.
        /// </summary>
        ...
        private InputList<Inputs.SystemNat64SecondaryPrefixArgs>? _secondaryPrefixes;

        /// <summary>
        /// Secondary NAT64 prefix. The structure of `secondary_prefix` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemNat64SecondaryPrefixArgs> SecondaryPrefixes
        {
            get => _secondaryPrefixes ?? (_secondaryPrefixes = new InputList<Inputs.SystemNat64SecondaryPrefixArgs>());
        ...
        public SystemNat64Args()
        {
        }
        public static new SystemNat64Args Empty => new SystemNat64Args();
    }

    public sealed class SystemNat64State : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable AAAA record synthesis (default = enable). Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("secondaryPrefixes")]
        private InputList<Inputs.SystemNat64SecondaryPrefixGetArgs>? _secondaryPrefixes;

        /// <summary>
        /// Secondary NAT64 prefix. The structure of `secondary_prefix` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemNat64SecondaryPrefixGetArgs> SecondaryPrefixes
        {
            get => _secondaryPrefixes ?? (_secondaryPrefixes = new InputList<Inputs.SystemNat64SecondaryPrefixGetArgs>());
            set => _secondaryPrefixes = value;
        }
        ...
        public SystemNat64State()
        {
        }
        public static new SystemNat64State Empty => new SystemNat64State();
    }
}
