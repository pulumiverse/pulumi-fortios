...
namespace Pulumiverse.Fortios.Sys
{
    ...
    /// {
    ///     var trname = new Fortios.Sys.Netflow("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:sys/netflow:Netflow")]
    public partial class Netflow : global::Pulumi.CustomResource
    {
        ...
        public Netflow(string name, NetflowArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:sys/netflow:Netflow", name, args ?? new NetflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Netflow(string name, Input<string> id, NetflowState? state = null, CustomResourceOptions? options = null)
            : base("fortios:sys/netflow:Netflow", name, state, MakeResourceOptions(options, id))
        {
        }
