...
namespace Pulumiverse.Fortios.Sys
{
    ...
    /// {
    ///     var trname = new Fortios.Sys.Passwordpolicy("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:sys/passwordpolicy:Passwordpolicy")]
    public partial class Passwordpolicy : global::Pulumi.CustomResource
    {
        ...
        public Passwordpolicy(string name, PasswordpolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:sys/passwordpolicy:Passwordpolicy", name, args ?? new PasswordpolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Passwordpolicy(string name, Input<string> id, PasswordpolicyState? state = null, CustomResourceOptions? options = null)
            : base("fortios:sys/passwordpolicy:Passwordpolicy", name, state, MakeResourceOptions(options, id))
        {
        }
