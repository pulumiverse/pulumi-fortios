...
namespace Pulumiverse.Fortios.Sys.Inputs
{
    ...
    public sealed class VirtualwanlinkHealthCheckGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("members")]
        private InputList<Inputs.VirtualwanlinkHealthCheckMemberGetArgs>? _members;

        /// <summary>
        /// Member sequence number list. The structure of `members` block is documented below.
        /// </summary>
        public InputList<Inputs.VirtualwanlinkHealthCheckMemberGetArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.VirtualwanlinkHealthCheckMemberGetArgs>());
            set => _members = value;
        }
        ...
        [Input("slas")]
        private InputList<Inputs.VirtualwanlinkHealthCheckSlaGetArgs>? _slas;

        /// <summary>
        /// Service level agreement (SLA). The structure of `sla` block is documented below.
        /// </summary>
        public InputList<Inputs.VirtualwanlinkHealthCheckSlaGetArgs> Slas
        {
            get => _slas ?? (_slas = new InputList<Inputs.VirtualwanlinkHealthCheckSlaGetArgs>());
            set => _slas = value;
        }
        ...
        public VirtualwanlinkHealthCheckGetArgs()
        {
        }
        public static new VirtualwanlinkHealthCheckGetArgs Empty => new VirtualwanlinkHealthCheckGetArgs();
    }
}
