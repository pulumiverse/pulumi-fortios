...
namespace Pulumiverse.Fortios.Sys.Inputs
{
    ...
    public sealed class InterfaceIpv6Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.InterfaceIpv6Dhcp6IapdListArgs>? _dhcp6IapdLists;

        /// <summary>
        /// DHCPv6 IA-PD list The structure of `dhcp6_iapd_list` block is documented below.
        /// </summary>
        public InputList<Inputs.InterfaceIpv6Dhcp6IapdListArgs> Dhcp6IapdLists
        {
            get => _dhcp6IapdLists ?? (_dhcp6IapdLists = new InputList<Inputs.InterfaceIpv6Dhcp6IapdListArgs>());
        ...
        private InputList<Inputs.InterfaceIpv6Ip6DelegatedPrefixListArgs>? _ip6DelegatedPrefixLists;

        /// <summary>
        /// Advertised IPv6 delegated prefix list. The structure of `ip6_delegated_prefix_list` block is documented below.
        /// </summary>
        public InputList<Inputs.InterfaceIpv6Ip6DelegatedPrefixListArgs> Ip6DelegatedPrefixLists
        {
            get => _ip6DelegatedPrefixLists ?? (_ip6DelegatedPrefixLists = new InputList<Inputs.InterfaceIpv6Ip6DelegatedPrefixListArgs>());
        ...
        [Input("ip6ExtraAddrs")]
        private InputList<Inputs.InterfaceIpv6Ip6ExtraAddrArgs>? _ip6ExtraAddrs;

        /// <summary>
        /// Extra IPv6 address prefixes of interface. The structure of `ip6_extra_addr` block is documented below.
        /// </summary>
        public InputList<Inputs.InterfaceIpv6Ip6ExtraAddrArgs> Ip6ExtraAddrs
        {
            get => _ip6ExtraAddrs ?? (_ip6ExtraAddrs = new InputList<Inputs.InterfaceIpv6Ip6ExtraAddrArgs>());
        ...
        private InputList<Inputs.InterfaceIpv6Ip6PrefixListArgs>? _ip6PrefixLists;

        /// <summary>
        /// Advertised prefix list. The structure of `ip6_prefix_list` block is documented below.
        /// </summary>
        public InputList<Inputs.InterfaceIpv6Ip6PrefixListArgs> Ip6PrefixLists
        {
            get => _ip6PrefixLists ?? (_ip6PrefixLists = new InputList<Inputs.InterfaceIpv6Ip6PrefixListArgs>());
        ...
        [Input("vrrp6s")]
        private InputList<Inputs.InterfaceIpv6Vrrp6Args>? _vrrp6s;
        ...
        /// </summary>
        public InputList<Inputs.InterfaceIpv6Vrrp6Args> Vrrp6s
        {
            get => _vrrp6s ?? (_vrrp6s = new InputList<Inputs.InterfaceIpv6Vrrp6Args>());
            set => _vrrp6s = value;
        }
        ...
        public InterfaceIpv6Args()
        {
        }
        public static new InterfaceIpv6Args Empty => new InterfaceIpv6Args();
    }
}
