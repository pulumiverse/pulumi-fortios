...
namespace Pulumiverse.Fortios.Sys.Inputs
{
    ...
    public sealed class StandaloneclusterClusterPeerGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("downIntfsBeforeSessSyncs")]
        private InputList<Inputs.StandaloneclusterClusterPeerDownIntfsBeforeSessSyncGetArgs>? _downIntfsBeforeSessSyncs;
        ...
        /// </summary>
        public InputList<Inputs.StandaloneclusterClusterPeerDownIntfsBeforeSessSyncGetArgs> DownIntfsBeforeSessSyncs
        {
            get => _downIntfsBeforeSessSyncs ?? (_downIntfsBeforeSessSyncs = new InputList<Inputs.StandaloneclusterClusterPeerDownIntfsBeforeSessSyncGetArgs>());
        ...
        public Input<Inputs.StandaloneclusterClusterPeerSessionSyncFilterGetArgs>? SessionSyncFilter { get; set; }
        ...
        [Input("syncvds")]
        private InputList<Inputs.StandaloneclusterClusterPeerSyncvdGetArgs>? _syncvds;
        ...
        /// </summary>
        public InputList<Inputs.StandaloneclusterClusterPeerSyncvdGetArgs> Syncvds
        {
            get => _syncvds ?? (_syncvds = new InputList<Inputs.StandaloneclusterClusterPeerSyncvdGetArgs>());
            set => _syncvds = value;
        }

        public StandaloneclusterClusterPeerGetArgs()
        {
        }
        public static new StandaloneclusterClusterPeerGetArgs Empty => new StandaloneclusterClusterPeerGetArgs();
    }
}
