...
namespace Pulumiverse.Fortios.Sys.Inputs
{
    ...
    public sealed class HaVclusterGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("monitor")]
        ...
        [Input("vdoms")]
        private InputList<Inputs.HaVclusterVdomGetArgs>? _vdoms;
        public InputList<Inputs.HaVclusterVdomGetArgs> Vdoms
        {
            get => _vdoms ?? (_vdoms = new InputList<Inputs.HaVclusterVdomGetArgs>());
            set => _vdoms = value;
        }

        public HaVclusterGetArgs()
        {
        }
        public static new HaVclusterGetArgs Empty => new HaVclusterGetArgs();
    }
}
