...
namespace Pulumiverse.Fortios.Sys.Inputs
{
    ...
    public sealed class InterfaceVrrpGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("proxyArps")]
        private InputList<Inputs.InterfaceVrrpProxyArpGetArgs>? _proxyArps;

        /// <summary>
        /// VRRP Proxy ARP configuration. The structure of `proxy_arp` block is documented below.
        /// </summary>
        public InputList<Inputs.InterfaceVrrpProxyArpGetArgs> ProxyArps
        {
            get => _proxyArps ?? (_proxyArps = new InputList<Inputs.InterfaceVrrpProxyArpGetArgs>());
        ...
        public InterfaceVrrpGetArgs()
        {
        }
        public static new InterfaceVrrpGetArgs Empty => new InterfaceVrrpGetArgs();
    }
}
