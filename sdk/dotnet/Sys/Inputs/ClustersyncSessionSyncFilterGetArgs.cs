...
namespace Pulumiverse.Fortios.Sys.Inputs
{
    ...
    public sealed class ClustersyncSessionSyncFilterGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customServices")]
        private InputList<Inputs.ClustersyncSessionSyncFilterCustomServiceGetArgs>? _customServices;
        ...
        /// </summary>
        public InputList<Inputs.ClustersyncSessionSyncFilterCustomServiceGetArgs> CustomServices
        {
            get => _customServices ?? (_customServices = new InputList<Inputs.ClustersyncSessionSyncFilterCustomServiceGetArgs>());
        ...
        public ClustersyncSessionSyncFilterGetArgs()
        {
        }
        public static new ClustersyncSessionSyncFilterGetArgs Empty => new ClustersyncSessionSyncFilterGetArgs();
    }
}
