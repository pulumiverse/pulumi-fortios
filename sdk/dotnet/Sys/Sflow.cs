...
namespace Pulumiverse.Fortios.Sys
{
    ...
    /// {
    ///     var trname = new Fortios.Sys.Sflow("trname", new()
    ///     {
    ///         CollectorIp = "0.0.0.0",
    ///         CollectorPort = 6343,
    ///         SourceIp = "0.0.0.0",
    ...
    /// </summary>
    [FortiosResourceType("fortios:sys/sflow:Sflow")]
    public partial class Sflow : global::Pulumi.CustomResource
    {
        ...
        public Sflow(string name, SflowArgs args, CustomResourceOptions? options = null)
            : base("fortios:sys/sflow:Sflow", name, args ?? new SflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Sflow(string name, Input<string> id, SflowState? state = null, CustomResourceOptions? options = null)
            : base("fortios:sys/sflow:Sflow", name, state, MakeResourceOptions(options, id))
        {
        }
