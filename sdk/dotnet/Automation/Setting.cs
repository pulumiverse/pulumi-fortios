...
namespace Pulumiverse.Fortios.Automation
{
    /// <summary>
    ...
    /// </summary>
    [FortiosResourceType("fortios:automation/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:automation/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:automation/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
