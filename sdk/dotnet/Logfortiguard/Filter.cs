...
namespace Pulumiverse.Fortios.Logfortiguard
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortiguard.Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         DlpArchive = "enable",
    ///         Dns = "enable",
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logfortiguard/filter:Filter labelname LogFortiguardFilter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortiguard/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortiguard/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortiguard/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
