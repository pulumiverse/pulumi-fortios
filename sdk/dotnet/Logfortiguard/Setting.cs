...
namespace Pulumiverse.Fortios.Logfortiguard
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortiguard.Setting("trname", new()
    ///     {
    ///         EncAlgorithm = "high",
    ///         SourceIp = "0.0.0.0",
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortiguard/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortiguard/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortiguard/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
