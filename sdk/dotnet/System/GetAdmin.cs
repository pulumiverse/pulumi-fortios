...
namespace Pulumiverse.Fortios.System
{
    public static class GetAdmin
    {
        ...
        public static Task<GetAdminResult> InvokeAsync(GetAdminArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAdminResult>("fortios:system/getAdmin:getAdmin", args ?? new GetAdminArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system admin
        /// </summary>
        public static Output<GetAdminResult> Invoke(GetAdminInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAdminResult>("fortios:system/getAdmin:getAdmin", args ?? new GetAdminInvokeArgs(), options.WithDefaults());
    }
