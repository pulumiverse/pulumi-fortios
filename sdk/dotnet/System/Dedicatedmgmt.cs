...
namespace Pulumiverse.Fortios.System
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:system/dedicatedmgmt:Dedicatedmgmt")]
    public partial class Dedicatedmgmt : global::Pulumi.CustomResource
    {
        ...
        public Dedicatedmgmt(string name, DedicatedmgmtArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:system/dedicatedmgmt:Dedicatedmgmt", name, args ?? new DedicatedmgmtArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dedicatedmgmt(string name, Input<string> id, DedicatedmgmtState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/dedicatedmgmt:Dedicatedmgmt", name, state, MakeResourceOptions(options, id))
        {
        }
