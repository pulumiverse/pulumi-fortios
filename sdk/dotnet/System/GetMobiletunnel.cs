...
namespace Pulumiverse.Fortios.System
{
    public static class GetMobiletunnel
    {
        ...
        public static Task<GetMobiletunnelResult> InvokeAsync(GetMobiletunnelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMobiletunnelResult>("fortios:system/getMobiletunnel:getMobiletunnel", args ?? new GetMobiletunnelArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system mobiletunnel
        /// </summary>
        public static Output<GetMobiletunnelResult> Invoke(GetMobiletunnelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMobiletunnelResult>("fortios:system/getMobiletunnel:getMobiletunnel", args ?? new GetMobiletunnelInvokeArgs(), options.WithDefaults());
    }
