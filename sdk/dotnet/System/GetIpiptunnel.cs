...
namespace Pulumiverse.Fortios.System
{
    public static class GetIpiptunnel
    {
        ...
        public static Task<GetIpiptunnelResult> InvokeAsync(GetIpiptunnelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpiptunnelResult>("fortios:system/getIpiptunnel:getIpiptunnel", args ?? new GetIpiptunnelArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system ipiptunnel
        /// </summary>
        public static Output<GetIpiptunnelResult> Invoke(GetIpiptunnelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpiptunnelResult>("fortios:system/getIpiptunnel:getIpiptunnel", args ?? new GetIpiptunnelInvokeArgs(), options.WithDefaults());
    }
