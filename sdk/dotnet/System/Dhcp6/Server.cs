...
namespace Pulumiverse.Fortios.System.Dhcp6
{
    /// <summary>
    ...
    /// </summary>
    [FortiosResourceType("fortios:system/dhcp6/server:Server")]
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("fortios:system/dhcp6/server:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, ServerState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/dhcp6/server:Server", name, state, MakeResourceOptions(options, id))
        {
        }
