...
namespace Pulumiverse.Fortios.System
{
    public static class GetClustersync
    {
        ...
        public static Task<GetClustersyncResult> InvokeAsync(GetClustersyncArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClustersyncResult>("fortios:system/getClustersync:getClustersync", args ?? new GetClustersyncArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system clustersync
        /// </summary>
        public static Output<GetClustersyncResult> Invoke(GetClustersyncInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClustersyncResult>("fortios:system/getClustersync:getClustersync", args ?? new GetClustersyncInvokeArgs(), options.WithDefaults());
    }
