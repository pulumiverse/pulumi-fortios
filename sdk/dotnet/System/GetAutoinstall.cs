...
namespace Pulumiverse.Fortios.System
{
    public static class GetAutoinstall
    {
        ...
        public static Task<GetAutoinstallResult> InvokeAsync(GetAutoinstallArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutoinstallResult>("fortios:system/getAutoinstall:getAutoinstall", args ?? new GetAutoinstallArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system autoinstall
        /// </summary>
        public static Output<GetAutoinstallResult> Invoke(GetAutoinstallInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAutoinstallResult>("fortios:system/getAutoinstall:getAutoinstall", args ?? new GetAutoinstallInvokeArgs(), options.WithDefaults());
    }
