...
namespace Pulumiverse.Fortios.System.Autoupdate
{
    public static class GetSchedule
    {
        ...
        public static Task<GetScheduleResult> InvokeAsync(GetScheduleArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScheduleResult>("fortios:system/autoupdate/getSchedule:getSchedule", args ?? new GetScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios systemautoupdate schedule
        /// </summary>
        public static Output<GetScheduleResult> Invoke(GetScheduleInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScheduleResult>("fortios:system/autoupdate/getSchedule:getSchedule", args ?? new GetScheduleInvokeArgs(), options.WithDefaults());
    }
