...
namespace Pulumiverse.Fortios.System
{
    public static class GetAccprofilelist
    {
        ...
        public static Task<GetAccprofilelistResult> InvokeAsync(GetAccprofilelistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccprofilelistResult>("fortios:system/getAccprofilelist:getAccprofilelist", args ?? new GetAccprofilelistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.system.Accprofile`.
        /// </summary>
        public static Output<GetAccprofilelistResult> Invoke(GetAccprofilelistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccprofilelistResult>("fortios:system/getAccprofilelist:getAccprofilelist", args ?? new GetAccprofilelistInvokeArgs(), options.WithDefaults());
    }
