...
namespace Pulumiverse.Fortios.System
{
    public static class GetMobiletunnellist
    {
        ...
        public static Task<GetMobiletunnellistResult> InvokeAsync(GetMobiletunnellistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMobiletunnellistResult>("fortios:system/getMobiletunnellist:getMobiletunnellist", args ?? new GetMobiletunnellistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.system.Mobiletunnel`.
        /// </summary>
        public static Output<GetMobiletunnellistResult> Invoke(GetMobiletunnellistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMobiletunnellistResult>("fortios:system/getMobiletunnellist:getMobiletunnellist", args ?? new GetMobiletunnellistInvokeArgs(), options.WithDefaults());
    }
