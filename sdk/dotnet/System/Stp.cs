...
namespace Pulumiverse.Fortios.System
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:system/stp:Stp")]
    public partial class Stp : global::Pulumi.CustomResource
    {
        ...
        public Stp(string name, StpArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:system/stp:Stp", name, args ?? new StpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Stp(string name, Input<string> id, StpState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/stp:Stp", name, state, MakeResourceOptions(options, id))
        {
        }
