...
namespace Pulumiverse.Fortios.System
{
    public static class GetPppoeinterface
    {
        ...
        public static Task<GetPppoeinterfaceResult> InvokeAsync(GetPppoeinterfaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPppoeinterfaceResult>("fortios:system/getPppoeinterface:getPppoeinterface", args ?? new GetPppoeinterfaceArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system pppoeinterface
        /// </summary>
        public static Output<GetPppoeinterfaceResult> Invoke(GetPppoeinterfaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPppoeinterfaceResult>("fortios:system/getPppoeinterface:getPppoeinterface", args ?? new GetPppoeinterfaceInvokeArgs(), options.WithDefaults());
    }
