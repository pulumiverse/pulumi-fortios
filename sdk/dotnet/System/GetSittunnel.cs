...
namespace Pulumiverse.Fortios.System
{
    public static class GetSittunnel
    {
        ...
        public static Task<GetSittunnelResult> InvokeAsync(GetSittunnelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSittunnelResult>("fortios:system/getSittunnel:getSittunnel", args ?? new GetSittunnelArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system sittunnel
        /// </summary>
        public static Output<GetSittunnelResult> Invoke(GetSittunnelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSittunnelResult>("fortios:system/getSittunnel:getSittunnel", args ?? new GetSittunnelInvokeArgs(), options.WithDefaults());
    }
