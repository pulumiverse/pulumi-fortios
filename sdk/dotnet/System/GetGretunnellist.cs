...
namespace Pulumiverse.Fortios.System
{
    public static class GetGretunnellist
    {
        ...
        public static Task<GetGretunnellistResult> InvokeAsync(GetGretunnellistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGretunnellistResult>("fortios:system/getGretunnellist:getGretunnellist", args ?? new GetGretunnellistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.system.Gretunnel`.
        /// </summary>
        public static Output<GetGretunnellistResult> Invoke(GetGretunnellistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGretunnellistResult>("fortios:system/getGretunnellist:getGretunnellist", args ?? new GetGretunnellistInvokeArgs(), options.WithDefaults());
    }
