...
namespace Pulumiverse.Fortios.System
{
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:system/settingNtp:SettingNtp")]
    public partial class SettingNtp : global::Pulumi.CustomResource
    {
        ...
        public SettingNtp(string name, SettingNtpArgs args, CustomResourceOptions? options = null)
            : base("fortios:system/settingNtp:SettingNtp", name, args ?? new SettingNtpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SettingNtp(string name, Input<string> id, SettingNtpState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/settingNtp:SettingNtp", name, state, MakeResourceOptions(options, id))
        {
        }
