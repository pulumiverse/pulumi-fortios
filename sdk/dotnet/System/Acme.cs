...
namespace Pulumiverse.Fortios.System
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:system/acme:Acme")]
    public partial class Acme : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("useHaDirect")]
        public Output<string> UseHaDirect { get; private set; } = null!;
        ...
        public Acme(string name, AcmeArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:system/acme:Acme", name, args ?? new AcmeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Acme(string name, Input<string> id, AcmeState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/acme:Acme", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AcmeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("useHaDirect")]
        public Input<string>? UseHaDirect { get; set; }
