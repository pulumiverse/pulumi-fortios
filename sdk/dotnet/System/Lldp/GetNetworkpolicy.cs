...
namespace Pulumiverse.Fortios.System.Lldp
{
    public static class GetNetworkpolicy
    {
        ...
        public static Task<GetNetworkpolicyResult> InvokeAsync(GetNetworkpolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkpolicyResult>("fortios:system/lldp/getNetworkpolicy:getNetworkpolicy", args ?? new GetNetworkpolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios systemlldp networkpolicy
        /// </summary>
        public static Output<GetNetworkpolicyResult> Invoke(GetNetworkpolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkpolicyResult>("fortios:system/lldp/getNetworkpolicy:getNetworkpolicy", args ?? new GetNetworkpolicyInvokeArgs(), options.WithDefaults());
    }
