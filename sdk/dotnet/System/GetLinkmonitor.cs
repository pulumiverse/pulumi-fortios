...
namespace Pulumiverse.Fortios.System
{
    public static class GetLinkmonitor
    {
        ...
        public static Task<GetLinkmonitorResult> InvokeAsync(GetLinkmonitorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLinkmonitorResult>("fortios:system/getLinkmonitor:getLinkmonitor", args ?? new GetLinkmonitorArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system linkmonitor
        /// </summary>
        public static Output<GetLinkmonitorResult> Invoke(GetLinkmonitorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLinkmonitorResult>("fortios:system/getLinkmonitor:getLinkmonitor", args ?? new GetLinkmonitorInvokeArgs(), options.WithDefaults());
    }
