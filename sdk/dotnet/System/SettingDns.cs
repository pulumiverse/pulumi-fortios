...
namespace Pulumiverse.Fortios.System
{
    ...
    public partial class SettingDns : global::Pulumi.CustomResource
    {
        ...
        public SettingDns(string name, SettingDnsArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:system/settingDns:SettingDns", name, args ?? new SettingDnsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SettingDns(string name, Input<string> id, SettingDnsState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/settingDns:SettingDns", name, state, MakeResourceOptions(options, id))
        {
        }
