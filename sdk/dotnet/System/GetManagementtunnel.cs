...
namespace Pulumiverse.Fortios.System
{
    public static class GetManagementtunnel
    {
        ...
        public static Task<GetManagementtunnelResult> InvokeAsync(GetManagementtunnelArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagementtunnelResult>("fortios:system/getManagementtunnel:getManagementtunnel", args ?? new GetManagementtunnelArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system managementtunnel
        /// </summary>
        public static Output<GetManagementtunnelResult> Invoke(GetManagementtunnelInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagementtunnelResult>("fortios:system/getManagementtunnel:getManagementtunnel", args ?? new GetManagementtunnelInvokeArgs(), options.WithDefaults());
    }
