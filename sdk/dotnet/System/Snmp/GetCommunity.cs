...
namespace Pulumiverse.Fortios.System.Snmp
{
    public static class GetCommunity
    {
        ...
        public static Task<GetCommunityResult> InvokeAsync(GetCommunityArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCommunityResult>("fortios:system/snmp/getCommunity:getCommunity", args ?? new GetCommunityArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios systemsnmp community
        /// </summary>
        public static Output<GetCommunityResult> Invoke(GetCommunityInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCommunityResult>("fortios:system/snmp/getCommunity:getCommunity", args ?? new GetCommunityInvokeArgs(), options.WithDefaults());
    }
