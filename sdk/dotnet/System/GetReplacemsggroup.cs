...
namespace Pulumiverse.Fortios.System
{
    public static class GetReplacemsggroup
    {
        ...
        public static Task<GetReplacemsggroupResult> InvokeAsync(GetReplacemsggroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplacemsggroupResult>("fortios:system/getReplacemsggroup:getReplacemsggroup", args ?? new GetReplacemsggroupArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system replacemsggroup
        /// </summary>
        public static Output<GetReplacemsggroupResult> Invoke(GetReplacemsggroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplacemsggroupResult>("fortios:system/getReplacemsggroup:getReplacemsggroup", args ?? new GetReplacemsggroupInvokeArgs(), options.WithDefaults());
    }
