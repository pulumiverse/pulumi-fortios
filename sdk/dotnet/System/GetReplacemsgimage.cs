...
namespace Pulumiverse.Fortios.System
{
    public static class GetReplacemsgimage
    {
        ...
        public static Task<GetReplacemsgimageResult> InvokeAsync(GetReplacemsgimageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplacemsgimageResult>("fortios:system/getReplacemsgimage:getReplacemsgimage", args ?? new GetReplacemsgimageArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system replacemsgimage
        /// </summary>
        public static Output<GetReplacemsgimageResult> Invoke(GetReplacemsgimageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplacemsgimageResult>("fortios:system/getReplacemsgimage:getReplacemsgimage", args ?? new GetReplacemsgimageInvokeArgs(), options.WithDefaults());
    }
