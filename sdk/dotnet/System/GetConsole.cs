...
namespace Pulumiverse.Fortios.System
{
    public static class GetConsole
    {
        ...
        public static Task<GetConsoleResult> InvokeAsync(GetConsoleArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConsoleResult>("fortios:system/getConsole:getConsole", args ?? new GetConsoleArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system console
        /// </summary>
        public static Output<GetConsoleResult> Invoke(GetConsoleInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConsoleResult>("fortios:system/getConsole:getConsole", args ?? new GetConsoleInvokeArgs(), options.WithDefaults());
    }
