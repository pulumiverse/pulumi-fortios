...
namespace Pulumiverse.Fortios.System
{
    public static class GetFipscc
    {
        ...
        public static Task<GetFipsccResult> InvokeAsync(GetFipsccArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFipsccResult>("fortios:system/getFipscc:getFipscc", args ?? new GetFipsccArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system fipscc
        /// </summary>
        public static Output<GetFipsccResult> Invoke(GetFipsccInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFipsccResult>("fortios:system/getFipscc:getFipscc", args ?? new GetFipsccInvokeArgs(), options.WithDefaults());
    }
