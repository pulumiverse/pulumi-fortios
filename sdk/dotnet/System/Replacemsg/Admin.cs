...
namespace Pulumiverse.Fortios.System.Replacemsg
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:system/replacemsg/admin:Admin")]
    public partial class Admin : global::Pulumi.CustomResource
    {
        ...
        public Admin(string name, AdminArgs args, CustomResourceOptions? options = null)
            : base("fortios:system/replacemsg/admin:Admin", name, args ?? new AdminArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Admin(string name, Input<string> id, AdminState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/replacemsg/admin:Admin", name, state, MakeResourceOptions(options, id))
        {
        }
