...
namespace Pulumiverse.Fortios.System.Replacemsg
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:system/replacemsg/http:Http")]
    public partial class Http : global::Pulumi.CustomResource
    {
        ...
        public Http(string name, HttpArgs args, CustomResourceOptions? options = null)
            : base("fortios:system/replacemsg/http:Http", name, args ?? new HttpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Http(string name, Input<string> id, HttpState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/replacemsg/http:Http", name, state, MakeResourceOptions(options, id))
        {
        }
