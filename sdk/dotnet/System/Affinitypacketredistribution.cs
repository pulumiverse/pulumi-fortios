...
namespace Pulumiverse.Fortios.System
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:system/affinitypacketredistribution:Affinitypacketredistribution")]
    public partial class Affinitypacketredistribution : global::Pulumi.CustomResource
    {
        ...
        public Affinitypacketredistribution(string name, AffinitypacketredistributionArgs args, CustomResourceOptions? options = null)
            : base("fortios:system/affinitypacketredistribution:Affinitypacketredistribution", name, args ?? new AffinitypacketredistributionArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private Affinitypacketredistribution(string name, Input<string> id, AffinitypacketredistributionState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/affinitypacketredistribution:Affinitypacketredistribution", name, state, MakeResourceOptions(options, id))
        {
        }
