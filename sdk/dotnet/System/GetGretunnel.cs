...
namespace Pulumiverse.Fortios.System
{
    public static class GetGretunnel
    {
        ...
        public static Task<GetGretunnelResult> InvokeAsync(GetGretunnelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGretunnelResult>("fortios:system/getGretunnel:getGretunnel", args ?? new GetGretunnelArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system gretunnel
        /// </summary>
        public static Output<GetGretunnelResult> Invoke(GetGretunnelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGretunnelResult>("fortios:system/getGretunnel:getGretunnel", args ?? new GetGretunnelInvokeArgs(), options.WithDefaults());
    }
