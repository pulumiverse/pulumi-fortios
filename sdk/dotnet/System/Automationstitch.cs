...
namespace Pulumiverse.Fortios.System
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:system/automationstitch:Automationstitch")]
    public partial class Automationstitch : global::Pulumi.CustomResource
    {
        ...
        public Automationstitch(string name, AutomationstitchArgs args, CustomResourceOptions? options = null)
            : base("fortios:system/automationstitch:Automationstitch", name, args ?? new AutomationstitchArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Automationstitch(string name, Input<string> id, AutomationstitchState? state = null, CustomResourceOptions? options = null)
            : base("fortios:system/automationstitch:Automationstitch", name, state, MakeResourceOptions(options, id))
        {
        }
