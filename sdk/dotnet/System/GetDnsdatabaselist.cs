...
namespace Pulumiverse.Fortios.System
{
    public static class GetDnsdatabaselist
    {
        ...
        public static Task<GetDnsdatabaselistResult> InvokeAsync(GetDnsdatabaselistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnsdatabaselistResult>("fortios:system/getDnsdatabaselist:getDnsdatabaselist", args ?? new GetDnsdatabaselistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.system.Dnsdatabase`.
        /// </summary>
        public static Output<GetDnsdatabaselistResult> Invoke(GetDnsdatabaselistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDnsdatabaselistResult>("fortios:system/getDnsdatabaselist:getDnsdatabaselist", args ?? new GetDnsdatabaselistInvokeArgs(), options.WithDefaults());
    }
