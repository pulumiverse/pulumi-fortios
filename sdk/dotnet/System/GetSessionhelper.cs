...
namespace Pulumiverse.Fortios.System
{
    public static class GetSessionhelper
    {
        ...
        public static Task<GetSessionhelperResult> InvokeAsync(GetSessionhelperArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSessionhelperResult>("fortios:system/getSessionhelper:getSessionhelper", args ?? new GetSessionhelperArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios system sessionhelper
        /// </summary>
        public static Output<GetSessionhelperResult> Invoke(GetSessionhelperInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSessionhelperResult>("fortios:system/getSessionhelper:getSessionhelper", args ?? new GetSessionhelperInvokeArgs(), options.WithDefaults());
    }
