...
namespace Pulumiverse.Fortios.System
{
    public static class GetFortisandbox
    {
        ...
        public static Task<GetFortisandboxResult> InvokeAsync(GetFortisandboxArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFortisandboxResult>("fortios:system/getFortisandbox:getFortisandbox", args ?? new GetFortisandboxArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system fortisandbox
        /// </summary>
        public static Output<GetFortisandboxResult> Invoke(GetFortisandboxInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFortisandboxResult>("fortios:system/getFortisandbox:getFortisandbox", args ?? new GetFortisandboxInvokeArgs(), options.WithDefaults());
    }
