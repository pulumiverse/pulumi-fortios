...
namespace Pulumiverse.Fortios.Logsyslogd
{
    /// <summary>
    ...
    /// {
    ///     var trname = new Fortios.Logsyslogd.Overridefilter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// </summary>
    [FortiosResourceType("fortios:logsyslogd/overridefilter:Overridefilter")]
    public partial class Overridefilter : global::Pulumi.CustomResource
    {
        ...
        public Overridefilter(string name, OverridefilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd/overridefilter:Overridefilter", name, args ?? new OverridefilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Overridefilter(string name, Input<string> id, OverridefilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd/overridefilter:Overridefilter", name, state, MakeResourceOptions(options, id))
        {
        }
