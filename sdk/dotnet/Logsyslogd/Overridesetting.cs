...
namespace Pulumiverse.Fortios.Logsyslogd
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:logsyslogd/overridesetting:Overridesetting")]
    public partial class Overridesetting : global::Pulumi.CustomResource
    {
        ...
        public Overridesetting(string name, OverridesettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd/overridesetting:Overridesetting", name, args ?? new OverridesettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Overridesetting(string name, Input<string> id, OverridesettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd/overridesetting:Overridesetting", name, state, MakeResourceOptions(options, id))
        {
        }
