...
namespace Pulumiverse.Fortios.Logsyslogd
{
    ...
    /// {
    ///     var trname = new Fortios.Logsyslogd.Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logsyslogd/filter:Filter labelname LogSyslogdFilter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logsyslogd/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
