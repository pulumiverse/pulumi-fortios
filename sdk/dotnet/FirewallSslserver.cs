...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallSslserver("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallSslserver:FirewallSslserver")]
    public partial class FirewallSslserver : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallSslserver(string name, FirewallSslserverArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/firewallSslserver:FirewallSslserver", name, args ?? new FirewallSslserverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallSslserver(string name, Input<string> id, FirewallSslserverState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallSslserver:FirewallSslserver", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallSslserver Get(string name, Input<string> id, FirewallSslserverState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallSslserver(name, id, state, options);
        }
    }

    public sealed class FirewallSslserverArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding an X-Forwarded-Proto header to forwarded requests. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public FirewallSslserverArgs()
        {
        }
        public static new FirewallSslserverArgs Empty => new FirewallSslserverArgs();
    }

    public sealed class FirewallSslserverState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding an X-Forwarded-Proto header to forwarded requests. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public FirewallSslserverState()
        {
        }
        public static new FirewallSslserverState Empty => new FirewallSslserverState();
    }
}
