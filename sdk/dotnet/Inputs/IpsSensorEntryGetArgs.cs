...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class IpsSensorEntryGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("cves")]
        private InputList<Inputs.IpsSensorEntryCfeGetArgs>? _cves;

        /// <summary>
        /// List of CVE IDs of the signatures to add to the sensor The structure of `cve` block is documented below.
        /// </summary>
        public InputList<Inputs.IpsSensorEntryCfeGetArgs> Cves
        {
            get => _cves ?? (_cves = new InputList<Inputs.IpsSensorEntryCfeGetArgs>());
            set => _cves = value;
        }
        ...
        [Input("exemptIps")]
        private InputList<Inputs.IpsSensorEntryExemptIpGetArgs>? _exemptIps;
        ...
        /// </summary>
        public InputList<Inputs.IpsSensorEntryExemptIpGetArgs> ExemptIps
        {
            get => _exemptIps ?? (_exemptIps = new InputList<Inputs.IpsSensorEntryExemptIpGetArgs>());
        ...
        [Input("rules")]
        private InputList<Inputs.IpsSensorEntryRuleGetArgs>? _rules;

        /// <summary>
        /// Identifies the predefined or custom IPS signatures to add to the sensor. The structure of `rule` block is documented below.
        /// </summary>
        public InputList<Inputs.IpsSensorEntryRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.IpsSensorEntryRuleGetArgs>());
            set => _rules = value;
        }
        ...
        [Input("vulnTypes")]
        private InputList<Inputs.IpsSensorEntryVulnTypeGetArgs>? _vulnTypes;

        /// <summary>
        /// List of signature vulnerability types to filter by. The structure of `vuln_type` block is documented below.
        /// </summary>
        public InputList<Inputs.IpsSensorEntryVulnTypeGetArgs> VulnTypes
        {
            get => _vulnTypes ?? (_vulnTypes = new InputList<Inputs.IpsSensorEntryVulnTypeGetArgs>());
            set => _vulnTypes = value;
        }

        public IpsSensorEntryGetArgs()
        {
        }
        public static new IpsSensorEntryGetArgs Empty => new IpsSensorEntryGetArgs();
    }
}
