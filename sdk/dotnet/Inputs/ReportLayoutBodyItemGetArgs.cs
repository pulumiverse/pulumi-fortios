...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class ReportLayoutBodyItemGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("lists")]
        private InputList<Inputs.ReportLayoutBodyItemListGetArgs>? _lists;

        /// <summary>
        /// Configure report list item. The structure of `list` block is documented below.
        /// </summary>
        public InputList<Inputs.ReportLayoutBodyItemListGetArgs> Lists
        {
            get => _lists ?? (_lists = new InputList<Inputs.ReportLayoutBodyItemListGetArgs>());
            set => _lists = value;
        }
        ...
        [Input("parameters")]
        private InputList<Inputs.ReportLayoutBodyItemParameterGetArgs>? _parameters;

        /// <summary>
        /// Parameters. The structure of `parameters` block is documented below.
        /// </summary>
        public InputList<Inputs.ReportLayoutBodyItemParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ReportLayoutBodyItemParameterGetArgs>());
        ...
        public ReportLayoutBodyItemGetArgs()
        {
        }
        public static new ReportLayoutBodyItemGetArgs Empty => new ReportLayoutBodyItemGetArgs();
    }
}
