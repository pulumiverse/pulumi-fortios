...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxyApiGatewayArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.FirewallAccessproxyApiGatewayApplicationArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGatewayApplicationArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.FirewallAccessproxyApiGatewayApplicationArgs>());
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallAccessproxyApiGatewayRealserverArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGatewayRealserverArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallAccessproxyApiGatewayRealserverArgs>());
        ...
        private InputList<Inputs.FirewallAccessproxyApiGatewaySslCipherSuiteArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGatewaySslCipherSuiteArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallAccessproxyApiGatewaySslCipherSuiteArgs>());
        ...
        public FirewallAccessproxyApiGatewayArgs()
        {
        }
        public static new FirewallAccessproxyApiGatewayArgs Empty => new FirewallAccessproxyApiGatewayArgs();
    }
}
