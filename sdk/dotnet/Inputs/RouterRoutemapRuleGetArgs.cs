...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class RouterRoutemapRuleGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("setAspaths")]
        private InputList<Inputs.RouterRoutemapRuleSetAspathGetArgs>? _setAspaths;

        /// <summary>
        /// Prepend BGP AS path attribute. The structure of `set_aspath` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterRoutemapRuleSetAspathGetArgs> SetAspaths
        {
            get => _setAspaths ?? (_setAspaths = new InputList<Inputs.RouterRoutemapRuleSetAspathGetArgs>());
        ...
        private InputList<Inputs.RouterRoutemapRuleSetCommunityGetArgs>? _setCommunities;

        /// <summary>
        /// BGP community attribute. The structure of `set_community` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterRoutemapRuleSetCommunityGetArgs> SetCommunities
        {
            get => _setCommunities ?? (_setCommunities = new InputList<Inputs.RouterRoutemapRuleSetCommunityGetArgs>());
        ...
        private InputList<Inputs.RouterRoutemapRuleSetExtcommunityRtGetArgs>? _setExtcommunityRts;

        /// <summary>
        /// Route Target extended community. The structure of `set_extcommunity_rt` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterRoutemapRuleSetExtcommunityRtGetArgs> SetExtcommunityRts
        {
            get => _setExtcommunityRts ?? (_setExtcommunityRts = new InputList<Inputs.RouterRoutemapRuleSetExtcommunityRtGetArgs>());
            set => _setExtcommunityRts = value;
        }

        [Input("setExtcommunitySoos")]
        private InputList<Inputs.RouterRoutemapRuleSetExtcommunitySooGetArgs>? _setExtcommunitySoos;

        /// <summary>
        /// Site-of-Origin extended community. The structure of `set_extcommunity_soo` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterRoutemapRuleSetExtcommunitySooGetArgs> SetExtcommunitySoos
        {
            get => _setExtcommunitySoos ?? (_setExtcommunitySoos = new InputList<Inputs.RouterRoutemapRuleSetExtcommunitySooGetArgs>());
        ...
        public RouterRoutemapRuleGetArgs()
        {
        }
        public static new RouterRoutemapRuleGetArgs Empty => new RouterRoutemapRuleGetArgs();
    }
}
