...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxy6ApiGateway6Args : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.FirewallAccessproxy6ApiGateway6ApplicationArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGateway6ApplicationArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.FirewallAccessproxy6ApiGateway6ApplicationArgs>());
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverArgs>());
        ...
        private InputList<Inputs.FirewallAccessproxy6ApiGateway6SslCipherSuiteArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGateway6SslCipherSuiteArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallAccessproxy6ApiGateway6SslCipherSuiteArgs>());
        ...
        public FirewallAccessproxy6ApiGateway6Args()
        {
        }
        public static new FirewallAccessproxy6ApiGateway6Args Empty => new FirewallAccessproxy6ApiGateway6Args();
    }
}
