...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class RouterOspf6AreaArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("ipsecKeys")]
        private InputList<Inputs.RouterOspf6AreaIpsecKeyArgs>? _ipsecKeys;

        /// <summary>
        /// IPsec authentication and encryption keys. The structure of `ipsec_keys` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspf6AreaIpsecKeyArgs> IpsecKeys
        {
            get => _ipsecKeys ?? (_ipsecKeys = new InputList<Inputs.RouterOspf6AreaIpsecKeyArgs>());
        ...
        [Input("ranges")]
        private InputList<Inputs.RouterOspf6AreaRangeArgs>? _ranges;

        /// <summary>
        /// OSPF6 area range configuration. The structure of `range` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspf6AreaRangeArgs> Ranges
        {
            get => _ranges ?? (_ranges = new InputList<Inputs.RouterOspf6AreaRangeArgs>());
            set => _ranges = value;
        }
        ...
        [Input("virtualLinks")]
        private InputList<Inputs.RouterOspf6AreaVirtualLinkArgs>? _virtualLinks;

        /// <summary>
        /// OSPF6 virtual link configuration. The structure of `virtual_link` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspf6AreaVirtualLinkArgs> VirtualLinks
        {
            get => _virtualLinks ?? (_virtualLinks = new InputList<Inputs.RouterOspf6AreaVirtualLinkArgs>());
            set => _virtualLinks = value;
        }

        public RouterOspf6AreaArgs()
        {
        }
        public static new RouterOspf6AreaArgs Empty => new RouterOspf6AreaArgs();
    }
}
