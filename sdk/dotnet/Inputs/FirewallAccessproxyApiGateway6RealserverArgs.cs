...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxyApiGateway6RealserverArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("sshHostKeys")]
        private InputList<Inputs.FirewallAccessproxyApiGateway6RealserverSshHostKeyArgs>? _sshHostKeys;

        /// <summary>
        /// One or more server host key. The structure of `ssh_host_key` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGateway6RealserverSshHostKeyArgs> SshHostKeys
        {
            get => _sshHostKeys ?? (_sshHostKeys = new InputList<Inputs.FirewallAccessproxyApiGateway6RealserverSshHostKeyArgs>());
        ...
        public FirewallAccessproxyApiGateway6RealserverArgs()
        {
        }
        public static new FirewallAccessproxyApiGateway6RealserverArgs Empty => new FirewallAccessproxyApiGateway6RealserverArgs();
    }
}
