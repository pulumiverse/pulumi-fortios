...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class VpnOcvpnOverlayGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("subnets")]
        private InputList<Inputs.VpnOcvpnOverlaySubnetGetArgs>? _subnets;

        /// <summary>
        /// Internal subnets to register with OCVPN service. The structure of `subnets` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnOcvpnOverlaySubnetGetArgs> Subnets
        {
            get => _subnets ?? (_subnets = new InputList<Inputs.VpnOcvpnOverlaySubnetGetArgs>());
            set => _subnets = value;
        }

        public VpnOcvpnOverlayGetArgs()
        {
        }
        public static new VpnOcvpnOverlayGetArgs Empty => new VpnOcvpnOverlayGetArgs();
    }
}
