...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemHaVclusterArgs : global::Pulumi.ResourceArgs
    {
        [Input("monitor")]
        ...
        [Input("vdoms")]
        private InputList<Inputs.SystemHaVclusterVdomArgs>? _vdoms;
        public InputList<Inputs.SystemHaVclusterVdomArgs> Vdoms
        {
            get => _vdoms ?? (_vdoms = new InputList<Inputs.SystemHaVclusterVdomArgs>());
            set => _vdoms = value;
        }

        public SystemHaVclusterArgs()
        {
        }
        public static new SystemHaVclusterArgs Empty => new SystemHaVclusterArgs();
    }
}
