...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxyApiGatewayGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.FirewallAccessproxyApiGatewayApplicationGetArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGatewayApplicationGetArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.FirewallAccessproxyApiGatewayApplicationGetArgs>());
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallAccessproxyApiGatewayRealserverGetArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGatewayRealserverGetArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallAccessproxyApiGatewayRealserverGetArgs>());
        ...
        private InputList<Inputs.FirewallAccessproxyApiGatewaySslCipherSuiteGetArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGatewaySslCipherSuiteGetArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallAccessproxyApiGatewaySslCipherSuiteGetArgs>());
        ...
        public FirewallAccessproxyApiGatewayGetArgs()
        {
        }
        public static new FirewallAccessproxyApiGatewayGetArgs Empty => new FirewallAccessproxyApiGatewayGetArgs();
    }
}
