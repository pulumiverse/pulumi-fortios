...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WirelesscontrollerWtpRadio2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WirelesscontrollerWtpRadio2ChannelArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpRadio2ChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WirelesscontrollerWtpRadio2ChannelArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WirelesscontrollerWtpRadio2VapArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpRadio2VapArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WirelesscontrollerWtpRadio2VapArgs>());
            set => _vaps = value;
        }

        public WirelesscontrollerWtpRadio2Args()
        {
        }
        public static new WirelesscontrollerWtpRadio2Args Empty => new WirelesscontrollerWtpRadio2Args();
    }
}
