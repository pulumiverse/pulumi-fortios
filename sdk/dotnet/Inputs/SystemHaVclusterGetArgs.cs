...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemHaVclusterGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("monitor")]
        ...
        [Input("vdoms")]
        private InputList<Inputs.SystemHaVclusterVdomGetArgs>? _vdoms;
        public InputList<Inputs.SystemHaVclusterVdomGetArgs> Vdoms
        {
            get => _vdoms ?? (_vdoms = new InputList<Inputs.SystemHaVclusterVdomGetArgs>());
            set => _vdoms = value;
        }

        public SystemHaVclusterGetArgs()
        {
        }
        public static new SystemHaVclusterGetArgs Empty => new SystemHaVclusterGetArgs();
    }
}
