...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class DlpProfileRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("sensitivities")]
        private InputList<Inputs.DlpProfileRuleSensitivityArgs>? _sensitivities;

        /// <summary>
        /// Select a DLP file pattern sensitivity to match. The structure of `sensitivity` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpProfileRuleSensitivityArgs> Sensitivities
        {
            get => _sensitivities ?? (_sensitivities = new InputList<Inputs.DlpProfileRuleSensitivityArgs>());
            set => _sensitivities = value;
        }

        [Input("sensors")]
        private InputList<Inputs.DlpProfileRuleSensorArgs>? _sensors;

        /// <summary>
        /// Select DLP sensors. The structure of `sensor` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpProfileRuleSensorArgs> Sensors
        {
            get => _sensors ?? (_sensors = new InputList<Inputs.DlpProfileRuleSensorArgs>());
            set => _sensors = value;
        }
        ...
        public DlpProfileRuleArgs()
        {
        }
        public static new DlpProfileRuleArgs Empty => new DlpProfileRuleArgs();
    }
}
