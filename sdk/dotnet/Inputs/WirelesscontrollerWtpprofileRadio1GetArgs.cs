...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WirelesscontrollerWtpprofileRadio1GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WirelesscontrollerWtpprofileRadio1ChannelGetArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpprofileRadio1ChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WirelesscontrollerWtpprofileRadio1ChannelGetArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WirelesscontrollerWtpprofileRadio1VapGetArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpprofileRadio1VapGetArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WirelesscontrollerWtpprofileRadio1VapGetArgs>());
            set => _vaps = value;
        }
        ...
        public WirelesscontrollerWtpprofileRadio1GetArgs()
        {
        }
        public static new WirelesscontrollerWtpprofileRadio1GetArgs Empty => new WirelesscontrollerWtpprofileRadio1GetArgs();
    }
}
