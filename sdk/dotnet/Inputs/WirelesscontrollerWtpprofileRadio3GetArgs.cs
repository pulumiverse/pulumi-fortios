...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WirelesscontrollerWtpprofileRadio3GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WirelesscontrollerWtpprofileRadio3ChannelGetArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpprofileRadio3ChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WirelesscontrollerWtpprofileRadio3ChannelGetArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WirelesscontrollerWtpprofileRadio3VapGetArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpprofileRadio3VapGetArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WirelesscontrollerWtpprofileRadio3VapGetArgs>());
            set => _vaps = value;
        }
        ...
        public WirelesscontrollerWtpprofileRadio3GetArgs()
        {
        }
        public static new WirelesscontrollerWtpprofileRadio3GetArgs Empty => new WirelesscontrollerWtpprofileRadio3GetArgs();
    }
}
