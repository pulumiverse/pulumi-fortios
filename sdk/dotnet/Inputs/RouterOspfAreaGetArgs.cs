...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class RouterOspfAreaGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication type.
        /// </summary>
        ...
        [Input("filterLists")]
        private InputList<Inputs.RouterOspfAreaFilterListGetArgs>? _filterLists;

        /// <summary>
        /// OSPF area filter-list configuration. The structure of `filter_list` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspfAreaFilterListGetArgs> FilterLists
        {
            get => _filterLists ?? (_filterLists = new InputList<Inputs.RouterOspfAreaFilterListGetArgs>());
        ...
        [Input("ranges")]
        private InputList<Inputs.RouterOspfAreaRangeGetArgs>? _ranges;

        /// <summary>
        /// OSPF area range configuration. The structure of `range` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspfAreaRangeGetArgs> Ranges
        {
            get => _ranges ?? (_ranges = new InputList<Inputs.RouterOspfAreaRangeGetArgs>());
            set => _ranges = value;
        }
        ...
        [Input("virtualLinks")]
        private InputList<Inputs.RouterOspfAreaVirtualLinkGetArgs>? _virtualLinks;

        /// <summary>
        /// OSPF virtual link configuration. The structure of `virtual_link` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspfAreaVirtualLinkGetArgs> VirtualLinks
        {
            get => _virtualLinks ?? (_virtualLinks = new InputList<Inputs.RouterOspfAreaVirtualLinkGetArgs>());
            set => _virtualLinks = value;
        }

        public RouterOspfAreaGetArgs()
        {
        }
        public static new RouterOspfAreaGetArgs Empty => new RouterOspfAreaGetArgs();
    }
}
