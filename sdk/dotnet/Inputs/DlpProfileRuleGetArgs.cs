...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class DlpProfileRuleGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("sensitivities")]
        private InputList<Inputs.DlpProfileRuleSensitivityGetArgs>? _sensitivities;

        /// <summary>
        /// Select a DLP file pattern sensitivity to match. The structure of `sensitivity` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpProfileRuleSensitivityGetArgs> Sensitivities
        {
            get => _sensitivities ?? (_sensitivities = new InputList<Inputs.DlpProfileRuleSensitivityGetArgs>());
            set => _sensitivities = value;
        }

        [Input("sensors")]
        private InputList<Inputs.DlpProfileRuleSensorGetArgs>? _sensors;

        /// <summary>
        /// Select DLP sensors. The structure of `sensor` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpProfileRuleSensorGetArgs> Sensors
        {
            get => _sensors ?? (_sensors = new InputList<Inputs.DlpProfileRuleSensorGetArgs>());
            set => _sensors = value;
        }
        ...
        public DlpProfileRuleGetArgs()
        {
        }
        public static new DlpProfileRuleGetArgs Empty => new DlpProfileRuleGetArgs();
    }
}
