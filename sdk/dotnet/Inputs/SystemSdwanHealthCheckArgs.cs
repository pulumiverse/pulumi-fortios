...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemSdwanHealthCheckArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("members")]
        private InputList<Inputs.SystemSdwanHealthCheckMemberArgs>? _members;

        /// <summary>
        /// Member sequence number list. The structure of `members` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemSdwanHealthCheckMemberArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.SystemSdwanHealthCheckMemberArgs>());
            set => _members = value;
        }
        ...
        [Input("slas")]
        private InputList<Inputs.SystemSdwanHealthCheckSlaArgs>? _slas;

        /// <summary>
        /// Service level agreement (SLA). The structure of `sla` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemSdwanHealthCheckSlaArgs> Slas
        {
            get => _slas ?? (_slas = new InputList<Inputs.SystemSdwanHealthCheckSlaArgs>());
            set => _slas = value;
        }
        ...
        public SystemSdwanHealthCheckArgs()
        {
        }
        public static new SystemSdwanHealthCheckArgs Empty => new SystemSdwanHealthCheckArgs();
    }
}
