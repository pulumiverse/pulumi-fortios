...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WebproxyProfileHeaderGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("dstaddr6s")]
        private InputList<Inputs.WebproxyProfileHeaderDstaddr6GetArgs>? _dstaddr6s;

        /// <summary>
        /// Destination address and address group names (IPv6). The structure of `dstaddr6` block is documented below.
        /// </summary>
        public InputList<Inputs.WebproxyProfileHeaderDstaddr6GetArgs> Dstaddr6s
        {
            get => _dstaddr6s ?? (_dstaddr6s = new InputList<Inputs.WebproxyProfileHeaderDstaddr6GetArgs>());
            set => _dstaddr6s = value;
        }

        [Input("dstaddrs")]
        private InputList<Inputs.WebproxyProfileHeaderDstaddrGetArgs>? _dstaddrs;

        /// <summary>
        /// Destination address and address group names. The structure of `dstaddr` block is documented below.
        /// </summary>
        public InputList<Inputs.WebproxyProfileHeaderDstaddrGetArgs> Dstaddrs
        {
            get => _dstaddrs ?? (_dstaddrs = new InputList<Inputs.WebproxyProfileHeaderDstaddrGetArgs>());
            set => _dstaddrs = value;
        }
        ...
        public WebproxyProfileHeaderGetArgs()
        {
        }
        public static new WebproxyProfileHeaderGetArgs Empty => new WebproxyProfileHeaderGetArgs();
    }
}
