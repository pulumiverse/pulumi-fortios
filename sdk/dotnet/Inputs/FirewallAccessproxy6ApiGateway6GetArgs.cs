...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxy6ApiGateway6GetArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.FirewallAccessproxy6ApiGateway6ApplicationGetArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGateway6ApplicationGetArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.FirewallAccessproxy6ApiGateway6ApplicationGetArgs>());
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverGetArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverGetArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverGetArgs>());
        ...
        private InputList<Inputs.FirewallAccessproxy6ApiGateway6SslCipherSuiteGetArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGateway6SslCipherSuiteGetArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallAccessproxy6ApiGateway6SslCipherSuiteGetArgs>());
        ...
        public FirewallAccessproxy6ApiGateway6GetArgs()
        {
        }
        public static new FirewallAccessproxy6ApiGateway6GetArgs Empty => new FirewallAccessproxy6ApiGateway6GetArgs();
    }
}
