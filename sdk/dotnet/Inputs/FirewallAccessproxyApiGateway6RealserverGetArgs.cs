...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxyApiGateway6RealserverGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("sshHostKeys")]
        private InputList<Inputs.FirewallAccessproxyApiGateway6RealserverSshHostKeyGetArgs>? _sshHostKeys;

        /// <summary>
        /// One or more server host key. The structure of `ssh_host_key` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGateway6RealserverSshHostKeyGetArgs> SshHostKeys
        {
            get => _sshHostKeys ?? (_sshHostKeys = new InputList<Inputs.FirewallAccessproxyApiGateway6RealserverSshHostKeyGetArgs>());
        ...
        public FirewallAccessproxyApiGateway6RealserverGetArgs()
        {
        }
        public static new FirewallAccessproxyApiGateway6RealserverGetArgs Empty => new FirewallAccessproxyApiGateway6RealserverGetArgs();
    }
}
