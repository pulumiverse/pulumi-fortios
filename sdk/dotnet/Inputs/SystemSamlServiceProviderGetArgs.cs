...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemSamlServiceProviderGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("assertionAttributes")]
        private InputList<Inputs.SystemSamlServiceProviderAssertionAttributeGetArgs>? _assertionAttributes;

        /// <summary>
        /// Customized SAML attributes to send along with assertion. The structure of `assertion_attributes` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemSamlServiceProviderAssertionAttributeGetArgs> AssertionAttributes
        {
            get => _assertionAttributes ?? (_assertionAttributes = new InputList<Inputs.SystemSamlServiceProviderAssertionAttributeGetArgs>());
        ...
        public SystemSamlServiceProviderGetArgs()
        {
        }
        public static new SystemSamlServiceProviderGetArgs Empty => new SystemSamlServiceProviderGetArgs();
    }
}
