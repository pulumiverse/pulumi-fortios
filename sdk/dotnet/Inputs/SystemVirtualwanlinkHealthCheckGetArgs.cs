...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemVirtualwanlinkHealthCheckGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("members")]
        private InputList<Inputs.SystemVirtualwanlinkHealthCheckMemberGetArgs>? _members;

        /// <summary>
        /// Member sequence number list. The structure of `members` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemVirtualwanlinkHealthCheckMemberGetArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.SystemVirtualwanlinkHealthCheckMemberGetArgs>());
            set => _members = value;
        }
        ...
        [Input("slas")]
        private InputList<Inputs.SystemVirtualwanlinkHealthCheckSlaGetArgs>? _slas;

        /// <summary>
        /// Service level agreement (SLA). The structure of `sla` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemVirtualwanlinkHealthCheckSlaGetArgs> Slas
        {
            get => _slas ?? (_slas = new InputList<Inputs.SystemVirtualwanlinkHealthCheckSlaGetArgs>());
            set => _slas = value;
        }
        ...
        public SystemVirtualwanlinkHealthCheckGetArgs()
        {
        }
        public static new SystemVirtualwanlinkHealthCheckGetArgs Empty => new SystemVirtualwanlinkHealthCheckGetArgs();
    }
}
