...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class ReportLayoutPageGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("footer")]
        public Input<Inputs.ReportLayoutPageFooterGetArgs>? Footer { get; set; }

        /// <summary>
        /// Configure report page header. The structure of `header` block is documented below.
        /// </summary>
        [Input("header")]
        public Input<Inputs.ReportLayoutPageHeaderGetArgs>? Header { get; set; }
        ...
        public ReportLayoutPageGetArgs()
        {
        }
        public static new ReportLayoutPageGetArgs Empty => new ReportLayoutPageGetArgs();
    }
}
