...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxy6ApiGateway6RealserverGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("sshHostKeys")]
        private InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverSshHostKeyGetArgs>? _sshHostKeys;

        /// <summary>
        /// One or more server host key. The structure of `ssh_host_key` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverSshHostKeyGetArgs> SshHostKeys
        {
            get => _sshHostKeys ?? (_sshHostKeys = new InputList<Inputs.FirewallAccessproxy6ApiGateway6RealserverSshHostKeyGetArgs>());
        ...
        public FirewallAccessproxy6ApiGateway6RealserverGetArgs()
        {
        }
        public static new FirewallAccessproxy6ApiGateway6RealserverGetArgs Empty => new FirewallAccessproxy6ApiGateway6RealserverGetArgs();
    }
}
