...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class RouterOspf6AreaGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("ipsecKeys")]
        private InputList<Inputs.RouterOspf6AreaIpsecKeyGetArgs>? _ipsecKeys;

        /// <summary>
        /// IPsec authentication and encryption keys. The structure of `ipsec_keys` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspf6AreaIpsecKeyGetArgs> IpsecKeys
        {
            get => _ipsecKeys ?? (_ipsecKeys = new InputList<Inputs.RouterOspf6AreaIpsecKeyGetArgs>());
        ...
        [Input("ranges")]
        private InputList<Inputs.RouterOspf6AreaRangeGetArgs>? _ranges;

        /// <summary>
        /// OSPF6 area range configuration. The structure of `range` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspf6AreaRangeGetArgs> Ranges
        {
            get => _ranges ?? (_ranges = new InputList<Inputs.RouterOspf6AreaRangeGetArgs>());
            set => _ranges = value;
        }
        ...
        [Input("virtualLinks")]
        private InputList<Inputs.RouterOspf6AreaVirtualLinkGetArgs>? _virtualLinks;

        /// <summary>
        /// OSPF6 virtual link configuration. The structure of `virtual_link` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterOspf6AreaVirtualLinkGetArgs> VirtualLinks
        {
            get => _virtualLinks ?? (_virtualLinks = new InputList<Inputs.RouterOspf6AreaVirtualLinkGetArgs>());
            set => _virtualLinks = value;
        }

        public RouterOspf6AreaGetArgs()
        {
        }
        public static new RouterOspf6AreaGetArgs Empty => new RouterOspf6AreaGetArgs();
    }
}
