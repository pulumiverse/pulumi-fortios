...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WirelesscontrollerWtpRadio3GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WirelesscontrollerWtpRadio3ChannelGetArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpRadio3ChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WirelesscontrollerWtpRadio3ChannelGetArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WirelesscontrollerWtpRadio3VapGetArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpRadio3VapGetArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WirelesscontrollerWtpRadio3VapGetArgs>());
            set => _vaps = value;
        }

        public WirelesscontrollerWtpRadio3GetArgs()
        {
        }
        public static new WirelesscontrollerWtpRadio3GetArgs Empty => new WirelesscontrollerWtpRadio3GetArgs();
    }
}
