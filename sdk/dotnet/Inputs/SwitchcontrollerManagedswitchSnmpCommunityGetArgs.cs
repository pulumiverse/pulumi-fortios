...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SwitchcontrollerManagedswitchSnmpCommunityGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("hosts")]
        private InputList<Inputs.SwitchcontrollerManagedswitchSnmpCommunityHostGetArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.SwitchcontrollerManagedswitchSnmpCommunityHostGetArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.SwitchcontrollerManagedswitchSnmpCommunityHostGetArgs>());
            set => _hosts = value;
        }
        ...
        public SwitchcontrollerManagedswitchSnmpCommunityGetArgs()
        {
        }
        public static new SwitchcontrollerManagedswitchSnmpCommunityGetArgs Empty => new SwitchcontrollerManagedswitchSnmpCommunityGetArgs();
    }
}
