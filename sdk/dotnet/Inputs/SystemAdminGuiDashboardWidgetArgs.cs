...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemAdminGuiDashboardWidgetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private InputList<Inputs.SystemAdminGuiDashboardWidgetFilterArgs>? _filters;

        /// <summary>
        /// FortiView filters. The structure of `filters` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemAdminGuiDashboardWidgetFilterArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.SystemAdminGuiDashboardWidgetFilterArgs>());
            set => _filters = value;
        }
        ...
        public SystemAdminGuiDashboardWidgetArgs()
        {
        }
        public static new SystemAdminGuiDashboardWidgetArgs Empty => new SystemAdminGuiDashboardWidgetArgs();
    }
}
