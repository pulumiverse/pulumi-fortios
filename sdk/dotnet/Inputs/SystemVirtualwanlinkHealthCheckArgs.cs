...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemVirtualwanlinkHealthCheckArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("members")]
        private InputList<Inputs.SystemVirtualwanlinkHealthCheckMemberArgs>? _members;

        /// <summary>
        /// Member sequence number list. The structure of `members` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemVirtualwanlinkHealthCheckMemberArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.SystemVirtualwanlinkHealthCheckMemberArgs>());
            set => _members = value;
        }
        ...
        [Input("slas")]
        private InputList<Inputs.SystemVirtualwanlinkHealthCheckSlaArgs>? _slas;

        /// <summary>
        /// Service level agreement (SLA). The structure of `sla` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemVirtualwanlinkHealthCheckSlaArgs> Slas
        {
            get => _slas ?? (_slas = new InputList<Inputs.SystemVirtualwanlinkHealthCheckSlaArgs>());
            set => _slas = value;
        }
        ...
        public SystemVirtualwanlinkHealthCheckArgs()
        {
        }
        public static new SystemVirtualwanlinkHealthCheckArgs Empty => new SystemVirtualwanlinkHealthCheckArgs();
    }
}
