...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemInterfaceIpv6Ip6PrefixListGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("dnssls")]
        private InputList<Inputs.SystemInterfaceIpv6Ip6PrefixListDnsslGetArgs>? _dnssls;

        /// <summary>
        /// DNS search list option. The structure of `dnssl` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemInterfaceIpv6Ip6PrefixListDnsslGetArgs> Dnssls
        {
            get => _dnssls ?? (_dnssls = new InputList<Inputs.SystemInterfaceIpv6Ip6PrefixListDnsslGetArgs>());
            set => _dnssls = value;
        }
        ...
        public SystemInterfaceIpv6Ip6PrefixListGetArgs()
        {
        }
        public static new SystemInterfaceIpv6Ip6PrefixListGetArgs Empty => new SystemInterfaceIpv6Ip6PrefixListGetArgs();
    }
}
