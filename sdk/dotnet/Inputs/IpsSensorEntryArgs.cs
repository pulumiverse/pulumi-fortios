...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class IpsSensorEntryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("cves")]
        private InputList<Inputs.IpsSensorEntryCfeArgs>? _cves;

        /// <summary>
        /// List of CVE IDs of the signatures to add to the sensor The structure of `cve` block is documented below.
        /// </summary>
        public InputList<Inputs.IpsSensorEntryCfeArgs> Cves
        {
            get => _cves ?? (_cves = new InputList<Inputs.IpsSensorEntryCfeArgs>());
            set => _cves = value;
        }
        ...
        [Input("exemptIps")]
        private InputList<Inputs.IpsSensorEntryExemptIpArgs>? _exemptIps;
        ...
        /// </summary>
        public InputList<Inputs.IpsSensorEntryExemptIpArgs> ExemptIps
        {
            get => _exemptIps ?? (_exemptIps = new InputList<Inputs.IpsSensorEntryExemptIpArgs>());
        ...
        [Input("rules")]
        private InputList<Inputs.IpsSensorEntryRuleArgs>? _rules;

        /// <summary>
        /// Identifies the predefined or custom IPS signatures to add to the sensor. The structure of `rule` block is documented below.
        /// </summary>
        public InputList<Inputs.IpsSensorEntryRuleArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.IpsSensorEntryRuleArgs>());
            set => _rules = value;
        }
        ...
        [Input("vulnTypes")]
        private InputList<Inputs.IpsSensorEntryVulnTypeArgs>? _vulnTypes;

        /// <summary>
        /// List of signature vulnerability types to filter by. The structure of `vuln_type` block is documented below.
        /// </summary>
        public InputList<Inputs.IpsSensorEntryVulnTypeArgs> VulnTypes
        {
            get => _vulnTypes ?? (_vulnTypes = new InputList<Inputs.IpsSensorEntryVulnTypeArgs>());
            set => _vulnTypes = value;
        }

        public IpsSensorEntryArgs()
        {
        }
        public static new IpsSensorEntryArgs Empty => new IpsSensorEntryArgs();
    }
}
