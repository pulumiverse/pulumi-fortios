...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemSdwanHealthCheckGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("members")]
        private InputList<Inputs.SystemSdwanHealthCheckMemberGetArgs>? _members;

        /// <summary>
        /// Member sequence number list. The structure of `members` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemSdwanHealthCheckMemberGetArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.SystemSdwanHealthCheckMemberGetArgs>());
            set => _members = value;
        }
        ...
        [Input("slas")]
        private InputList<Inputs.SystemSdwanHealthCheckSlaGetArgs>? _slas;

        /// <summary>
        /// Service level agreement (SLA). The structure of `sla` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemSdwanHealthCheckSlaGetArgs> Slas
        {
            get => _slas ?? (_slas = new InputList<Inputs.SystemSdwanHealthCheckSlaGetArgs>());
            set => _slas = value;
        }
        ...
        public SystemSdwanHealthCheckGetArgs()
        {
        }
        public static new SystemSdwanHealthCheckGetArgs Empty => new SystemSdwanHealthCheckGetArgs();
    }
}
