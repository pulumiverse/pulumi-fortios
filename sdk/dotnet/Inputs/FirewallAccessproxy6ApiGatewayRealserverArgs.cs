...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxy6ApiGatewayRealserverArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("sshHostKeys")]
        private InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverSshHostKeyArgs>? _sshHostKeys;

        /// <summary>
        /// One or more server host key. The structure of `ssh_host_key` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverSshHostKeyArgs> SshHostKeys
        {
            get => _sshHostKeys ?? (_sshHostKeys = new InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverSshHostKeyArgs>());
        ...
        public FirewallAccessproxy6ApiGatewayRealserverArgs()
        {
        }
        public static new FirewallAccessproxy6ApiGatewayRealserverArgs Empty => new FirewallAccessproxy6ApiGatewayRealserverArgs();
    }
}
