...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemStandaloneclusterClusterPeerGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("downIntfsBeforeSessSyncs")]
        private InputList<Inputs.SystemStandaloneclusterClusterPeerDownIntfsBeforeSessSyncGetArgs>? _downIntfsBeforeSessSyncs;
        ...
        /// </summary>
        public InputList<Inputs.SystemStandaloneclusterClusterPeerDownIntfsBeforeSessSyncGetArgs> DownIntfsBeforeSessSyncs
        {
            get => _downIntfsBeforeSessSyncs ?? (_downIntfsBeforeSessSyncs = new InputList<Inputs.SystemStandaloneclusterClusterPeerDownIntfsBeforeSessSyncGetArgs>());
        ...
        public Input<Inputs.SystemStandaloneclusterClusterPeerSessionSyncFilterGetArgs>? SessionSyncFilter { get; set; }
        ...
        [Input("syncvds")]
        private InputList<Inputs.SystemStandaloneclusterClusterPeerSyncvdGetArgs>? _syncvds;
        ...
        /// </summary>
        public InputList<Inputs.SystemStandaloneclusterClusterPeerSyncvdGetArgs> Syncvds
        {
            get => _syncvds ?? (_syncvds = new InputList<Inputs.SystemStandaloneclusterClusterPeerSyncvdGetArgs>());
            set => _syncvds = value;
        }

        public SystemStandaloneclusterClusterPeerGetArgs()
        {
        }
        public static new SystemStandaloneclusterClusterPeerGetArgs Empty => new SystemStandaloneclusterClusterPeerGetArgs();
    }
}
