...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class ExtendercontrollerExtender1Modem2GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// FortiExtender auto switch configuration. The structure of `auto_switch` block is documented below.
        /// </summary>
        [Input("autoSwitch")]
        public Input<Inputs.ExtendercontrollerExtender1Modem2AutoSwitchGetArgs>? AutoSwitch { get; set; }
        ...
        public ExtendercontrollerExtender1Modem2GetArgs()
        {
        }
        public static new ExtendercontrollerExtender1Modem2GetArgs Empty => new ExtendercontrollerExtender1Modem2GetArgs();
    }
}
