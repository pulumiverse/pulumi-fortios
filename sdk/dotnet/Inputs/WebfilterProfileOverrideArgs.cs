...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WebfilterProfileOverrideArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.WebfilterProfileOverrideOvrdUserGroupArgs>? _ovrdUserGroups;

        /// <summary>
        /// User groups with permission to use the override. The structure of `ovrd_user_group` block is documented below.
        /// </summary>
        public InputList<Inputs.WebfilterProfileOverrideOvrdUserGroupArgs> OvrdUserGroups
        {
            get => _ovrdUserGroups ?? (_ovrdUserGroups = new InputList<Inputs.WebfilterProfileOverrideOvrdUserGroupArgs>());
        ...
        [Input("profiles")]
        private InputList<Inputs.WebfilterProfileOverrideProfileArgs>? _profiles;

        /// <summary>
        /// Web filter profile with permission to create overrides. The structure of `profile` block is documented below.
        /// </summary>
        public InputList<Inputs.WebfilterProfileOverrideProfileArgs> Profiles
        {
            get => _profiles ?? (_profiles = new InputList<Inputs.WebfilterProfileOverrideProfileArgs>());
            set => _profiles = value;
        }

        public WebfilterProfileOverrideArgs()
        {
        }
        public static new WebfilterProfileOverrideArgs Empty => new WebfilterProfileOverrideArgs();
    }
}
