...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class RouterMulticastInterfaceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("igmp")]
        public Input<Inputs.RouterMulticastInterfaceIgmpGetArgs>? Igmp { get; set; }

        [Input("joinGroups")]
        private InputList<Inputs.RouterMulticastInterfaceJoinGroupGetArgs>? _joinGroups;

        /// <summary>
        /// Join multicast groups. The structure of `join_group` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterMulticastInterfaceJoinGroupGetArgs> JoinGroups
        {
            get => _joinGroups ?? (_joinGroups = new InputList<Inputs.RouterMulticastInterfaceJoinGroupGetArgs>());
        ...
        public RouterMulticastInterfaceGetArgs()
        {
        }
        public static new RouterMulticastInterfaceGetArgs Empty => new RouterMulticastInterfaceGetArgs();
    }
}
