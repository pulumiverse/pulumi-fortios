...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WebfilterProfileFtgdWfFilterGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("authUsrGrps")]
        private InputList<Inputs.WebfilterProfileFtgdWfFilterAuthUsrGrpGetArgs>? _authUsrGrps;

        /// <summary>
        /// Groups with permission to authenticate. The structure of `auth_usr_grp` block is documented below.
        /// </summary>
        public InputList<Inputs.WebfilterProfileFtgdWfFilterAuthUsrGrpGetArgs> AuthUsrGrps
        {
            get => _authUsrGrps ?? (_authUsrGrps = new InputList<Inputs.WebfilterProfileFtgdWfFilterAuthUsrGrpGetArgs>());
        ...
        public WebfilterProfileFtgdWfFilterGetArgs()
        {
        }
        public static new WebfilterProfileFtgdWfFilterGetArgs Empty => new WebfilterProfileFtgdWfFilterGetArgs();
    }
}
