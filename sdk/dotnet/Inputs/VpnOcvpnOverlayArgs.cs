...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class VpnOcvpnOverlayArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("subnets")]
        private InputList<Inputs.VpnOcvpnOverlaySubnetArgs>? _subnets;

        /// <summary>
        /// Internal subnets to register with OCVPN service. The structure of `subnets` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnOcvpnOverlaySubnetArgs> Subnets
        {
            get => _subnets ?? (_subnets = new InputList<Inputs.VpnOcvpnOverlaySubnetArgs>());
            set => _subnets = value;
        }

        public VpnOcvpnOverlayArgs()
        {
        }
        public static new VpnOcvpnOverlayArgs Empty => new VpnOcvpnOverlayArgs();
    }
}
