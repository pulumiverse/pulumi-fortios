...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SwitchcontrollerManagedswitchSnmpCommunityArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("hosts")]
        private InputList<Inputs.SwitchcontrollerManagedswitchSnmpCommunityHostArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.SwitchcontrollerManagedswitchSnmpCommunityHostArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.SwitchcontrollerManagedswitchSnmpCommunityHostArgs>());
            set => _hosts = value;
        }
        ...
        public SwitchcontrollerManagedswitchSnmpCommunityArgs()
        {
        }
        public static new SwitchcontrollerManagedswitchSnmpCommunityArgs Empty => new SwitchcontrollerManagedswitchSnmpCommunityArgs();
    }
}
