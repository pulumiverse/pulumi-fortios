...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxy6ApiGatewayRealserverGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("sshHostKeys")]
        private InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverSshHostKeyGetArgs>? _sshHostKeys;

        /// <summary>
        /// One or more server host key. The structure of `ssh_host_key` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverSshHostKeyGetArgs> SshHostKeys
        {
            get => _sshHostKeys ?? (_sshHostKeys = new InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverSshHostKeyGetArgs>());
        ...
        public FirewallAccessproxy6ApiGatewayRealserverGetArgs()
        {
        }
        public static new FirewallAccessproxy6ApiGatewayRealserverGetArgs Empty => new FirewallAccessproxy6ApiGatewayRealserverGetArgs();
    }
}
