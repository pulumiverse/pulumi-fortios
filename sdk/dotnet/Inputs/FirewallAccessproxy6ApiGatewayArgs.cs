...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxy6ApiGatewayArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.FirewallAccessproxy6ApiGatewayApplicationArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGatewayApplicationArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.FirewallAccessproxy6ApiGatewayApplicationArgs>());
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverArgs>());
        ...
        private InputList<Inputs.FirewallAccessproxy6ApiGatewaySslCipherSuiteArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGatewaySslCipherSuiteArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallAccessproxy6ApiGatewaySslCipherSuiteArgs>());
        ...
        public FirewallAccessproxy6ApiGatewayArgs()
        {
        }
        public static new FirewallAccessproxy6ApiGatewayArgs Empty => new FirewallAccessproxy6ApiGatewayArgs();
    }
}
