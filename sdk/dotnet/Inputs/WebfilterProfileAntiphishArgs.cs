...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WebfilterProfileAntiphishArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.WebfilterProfileAntiphishCustomPatternArgs>? _customPatterns;

        /// <summary>
        /// Custom username and password regex patterns. The structure of `custom_patterns` block is documented below.
        /// </summary>
        public InputList<Inputs.WebfilterProfileAntiphishCustomPatternArgs> CustomPatterns
        {
            get => _customPatterns ?? (_customPatterns = new InputList<Inputs.WebfilterProfileAntiphishCustomPatternArgs>());
        ...
        private InputList<Inputs.WebfilterProfileAntiphishInspectionEntryArgs>? _inspectionEntries;

        /// <summary>
        /// AntiPhishing entries. The structure of `inspection_entries` block is documented below.
        /// </summary>
        public InputList<Inputs.WebfilterProfileAntiphishInspectionEntryArgs> InspectionEntries
        {
            get => _inspectionEntries ?? (_inspectionEntries = new InputList<Inputs.WebfilterProfileAntiphishInspectionEntryArgs>());
        ...
        public WebfilterProfileAntiphishArgs()
        {
        }
        public static new WebfilterProfileAntiphishArgs Empty => new WebfilterProfileAntiphishArgs();
    }
}
