...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WebfilterProfileAntiphishGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.WebfilterProfileAntiphishCustomPatternGetArgs>? _customPatterns;

        /// <summary>
        /// Custom username and password regex patterns. The structure of `custom_patterns` block is documented below.
        /// </summary>
        public InputList<Inputs.WebfilterProfileAntiphishCustomPatternGetArgs> CustomPatterns
        {
            get => _customPatterns ?? (_customPatterns = new InputList<Inputs.WebfilterProfileAntiphishCustomPatternGetArgs>());
        ...
        private InputList<Inputs.WebfilterProfileAntiphishInspectionEntryGetArgs>? _inspectionEntries;

        /// <summary>
        /// AntiPhishing entries. The structure of `inspection_entries` block is documented below.
        /// </summary>
        public InputList<Inputs.WebfilterProfileAntiphishInspectionEntryGetArgs> InspectionEntries
        {
            get => _inspectionEntries ?? (_inspectionEntries = new InputList<Inputs.WebfilterProfileAntiphishInspectionEntryGetArgs>());
        ...
        public WebfilterProfileAntiphishGetArgs()
        {
        }
        public static new WebfilterProfileAntiphishGetArgs Empty => new WebfilterProfileAntiphishGetArgs();
    }
}
