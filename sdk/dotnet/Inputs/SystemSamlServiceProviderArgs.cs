...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemSamlServiceProviderArgs : global::Pulumi.ResourceArgs
    {
        [Input("assertionAttributes")]
        private InputList<Inputs.SystemSamlServiceProviderAssertionAttributeArgs>? _assertionAttributes;

        /// <summary>
        /// Customized SAML attributes to send along with assertion. The structure of `assertion_attributes` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemSamlServiceProviderAssertionAttributeArgs> AssertionAttributes
        {
            get => _assertionAttributes ?? (_assertionAttributes = new InputList<Inputs.SystemSamlServiceProviderAssertionAttributeArgs>());
        ...
        public SystemSamlServiceProviderArgs()
        {
        }
        public static new SystemSamlServiceProviderArgs Empty => new SystemSamlServiceProviderArgs();
    }
}
