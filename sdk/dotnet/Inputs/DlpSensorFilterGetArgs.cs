...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class DlpSensorFilterGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.DlpSensorFilterFpSensitivityGetArgs>? _fpSensitivities;

        /// <summary>
        /// Select a DLP file pattern sensitivity to match. The structure of `fp_sensitivity` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpSensorFilterFpSensitivityGetArgs> FpSensitivities
        {
            get => _fpSensitivities ?? (_fpSensitivities = new InputList<Inputs.DlpSensorFilterFpSensitivityGetArgs>());
        ...
        [Input("sensitivities")]
        private InputList<Inputs.DlpSensorFilterSensitivityGetArgs>? _sensitivities;

        /// <summary>
        /// Select a DLP file pattern sensitivity to match. The structure of `sensitivity` block is documented below.
        /// </summary>
        public InputList<Inputs.DlpSensorFilterSensitivityGetArgs> Sensitivities
        {
            get => _sensitivities ?? (_sensitivities = new InputList<Inputs.DlpSensorFilterSensitivityGetArgs>());
        ...
        public DlpSensorFilterGetArgs()
        {
        }
        public static new DlpSensorFilterGetArgs Empty => new DlpSensorFilterGetArgs();
    }
}
