...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class ReportLayoutBodyItemArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("lists")]
        private InputList<Inputs.ReportLayoutBodyItemListArgs>? _lists;

        /// <summary>
        /// Configure report list item. The structure of `list` block is documented below.
        /// </summary>
        public InputList<Inputs.ReportLayoutBodyItemListArgs> Lists
        {
            get => _lists ?? (_lists = new InputList<Inputs.ReportLayoutBodyItemListArgs>());
            set => _lists = value;
        }
        ...
        [Input("parameters")]
        private InputList<Inputs.ReportLayoutBodyItemParameterArgs>? _parameters;

        /// <summary>
        /// Parameters. The structure of `parameters` block is documented below.
        /// </summary>
        public InputList<Inputs.ReportLayoutBodyItemParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ReportLayoutBodyItemParameterArgs>());
        ...
        public ReportLayoutBodyItemArgs()
        {
        }
        public static new ReportLayoutBodyItemArgs Empty => new ReportLayoutBodyItemArgs();
    }
}
