...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxyApiGateway6Args : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.FirewallAccessproxyApiGateway6ApplicationArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGateway6ApplicationArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.FirewallAccessproxyApiGateway6ApplicationArgs>());
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallAccessproxyApiGateway6RealserverArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGateway6RealserverArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallAccessproxyApiGateway6RealserverArgs>());
        ...
        private InputList<Inputs.FirewallAccessproxyApiGateway6SslCipherSuiteArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGateway6SslCipherSuiteArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallAccessproxyApiGateway6SslCipherSuiteArgs>());
        ...
        public FirewallAccessproxyApiGateway6Args()
        {
        }
        public static new FirewallAccessproxyApiGateway6Args Empty => new FirewallAccessproxyApiGateway6Args();
    }
}
