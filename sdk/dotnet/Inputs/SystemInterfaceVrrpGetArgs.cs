...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemInterfaceVrrpGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("proxyArps")]
        private InputList<Inputs.SystemInterfaceVrrpProxyArpGetArgs>? _proxyArps;

        /// <summary>
        /// VRRP Proxy ARP configuration. The structure of `proxy_arp` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemInterfaceVrrpProxyArpGetArgs> ProxyArps
        {
            get => _proxyArps ?? (_proxyArps = new InputList<Inputs.SystemInterfaceVrrpProxyArpGetArgs>());
        ...
        public SystemInterfaceVrrpGetArgs()
        {
        }
        public static new SystemInterfaceVrrpGetArgs Empty => new SystemInterfaceVrrpGetArgs();
    }
}
