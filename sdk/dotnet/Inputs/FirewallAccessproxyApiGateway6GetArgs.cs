...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxyApiGateway6GetArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.FirewallAccessproxyApiGateway6ApplicationGetArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGateway6ApplicationGetArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.FirewallAccessproxyApiGateway6ApplicationGetArgs>());
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallAccessproxyApiGateway6RealserverGetArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGateway6RealserverGetArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallAccessproxyApiGateway6RealserverGetArgs>());
        ...
        private InputList<Inputs.FirewallAccessproxyApiGateway6SslCipherSuiteGetArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxyApiGateway6SslCipherSuiteGetArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallAccessproxyApiGateway6SslCipherSuiteGetArgs>());
        ...
        public FirewallAccessproxyApiGateway6GetArgs()
        {
        }
        public static new FirewallAccessproxyApiGateway6GetArgs Empty => new FirewallAccessproxyApiGateway6GetArgs();
    }
}
