...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class ApplicationListEntryGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("applications")]
        private InputList<Inputs.ApplicationListEntryApplicationGetArgs>? _applications;

        /// <summary>
        /// ID of allowed applications. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.ApplicationListEntryApplicationGetArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.ApplicationListEntryApplicationGetArgs>());
        ...
        [Input("categories")]
        private InputList<Inputs.ApplicationListEntryCategoryGetArgs>? _categories;

        /// <summary>
        /// Category ID list. The structure of `category` block is documented below.
        /// </summary>
        public InputList<Inputs.ApplicationListEntryCategoryGetArgs> Categories
        {
            get => _categories ?? (_categories = new InputList<Inputs.ApplicationListEntryCategoryGetArgs>());
            set => _categories = value;
        }

        [Input("exclusions")]
        private InputList<Inputs.ApplicationListEntryExclusionGetArgs>? _exclusions;

        /// <summary>
        /// ID of excluded applications. The structure of `exclusion` block is documented below.
        /// </summary>
        public InputList<Inputs.ApplicationListEntryExclusionGetArgs> Exclusions
        {
            get => _exclusions ?? (_exclusions = new InputList<Inputs.ApplicationListEntryExclusionGetArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.ApplicationListEntryParameterGetArgs>? _parameters;

        /// <summary>
        /// Application parameters. The structure of `parameters` block is documented below.
        /// </summary>
        public InputList<Inputs.ApplicationListEntryParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ApplicationListEntryParameterGetArgs>());
        ...
        [Input("risks")]
        private InputList<Inputs.ApplicationListEntryRiskGetArgs>? _risks;
        ...
        /// </summary>
        public InputList<Inputs.ApplicationListEntryRiskGetArgs> Risks
        {
            get => _risks ?? (_risks = new InputList<Inputs.ApplicationListEntryRiskGetArgs>());
            set => _risks = value;
        }
        ...
        [Input("subCategories")]
        private InputList<Inputs.ApplicationListEntrySubCategoryGetArgs>? _subCategories;

        /// <summary>
        /// Application Sub-category ID list. The structure of `sub_category` block is documented below.
        /// </summary>
        public InputList<Inputs.ApplicationListEntrySubCategoryGetArgs> SubCategories
        {
            get => _subCategories ?? (_subCategories = new InputList<Inputs.ApplicationListEntrySubCategoryGetArgs>());
        ...
        public ApplicationListEntryGetArgs()
        {
        }
        public static new ApplicationListEntryGetArgs Empty => new ApplicationListEntryGetArgs();
    }
}
