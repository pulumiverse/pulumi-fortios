...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class FirewallAccessproxy6ApiGatewayGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("applications")]
        private InputList<Inputs.FirewallAccessproxy6ApiGatewayApplicationGetArgs>? _applications;

        /// <summary>
        /// SaaS application controlled by this Access Proxy. The structure of `application` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGatewayApplicationGetArgs> Applications
        {
            get => _applications ?? (_applications = new InputList<Inputs.FirewallAccessproxy6ApiGatewayApplicationGetArgs>());
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverGetArgs>? _realservers;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverGetArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallAccessproxy6ApiGatewayRealserverGetArgs>());
        ...
        private InputList<Inputs.FirewallAccessproxy6ApiGatewaySslCipherSuiteGetArgs>? _sslCipherSuites;
        ...
        /// </summary>
        public InputList<Inputs.FirewallAccessproxy6ApiGatewaySslCipherSuiteGetArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallAccessproxy6ApiGatewaySslCipherSuiteGetArgs>());
        ...
        public FirewallAccessproxy6ApiGatewayGetArgs()
        {
        }
        public static new FirewallAccessproxy6ApiGatewayGetArgs Empty => new FirewallAccessproxy6ApiGatewayGetArgs();
    }
}
