...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WirelesscontrollerSnmpCommunityGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("hosts")]
        private InputList<Inputs.WirelesscontrollerSnmpCommunityHostGetArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerSnmpCommunityHostGetArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.WirelesscontrollerSnmpCommunityHostGetArgs>());
            set => _hosts = value;
        }
        ...
        public WirelesscontrollerSnmpCommunityGetArgs()
        {
        }
        public static new WirelesscontrollerSnmpCommunityGetArgs Empty => new WirelesscontrollerSnmpCommunityGetArgs();
    }
}
