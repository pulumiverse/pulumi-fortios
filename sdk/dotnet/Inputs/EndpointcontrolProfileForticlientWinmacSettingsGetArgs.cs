...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class EndpointcontrolProfileForticlientWinmacSettingsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientEmsEntryGetArgs>? _forticlientEmsEntries;

        /// <summary>
        /// FortiClient EMS entries. The structure of `forticlient_ems_entries` block is documented below.
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientEmsEntryGetArgs> ForticlientEmsEntries
        {
            get => _forticlientEmsEntries ?? (_forticlientEmsEntries = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientEmsEntryGetArgs>());
        ...
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOperatingSystemGetArgs>? _forticlientOperatingSystems;

        /// <summary>
        /// FortiClient operating system. The structure of `forticlient_operating_system` block is documented below.
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOperatingSystemGetArgs> ForticlientOperatingSystems
        {
            get => _forticlientOperatingSystems ?? (_forticlientOperatingSystems = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOperatingSystemGetArgs>());
            set => _forticlientOperatingSystems = value;
        }

        [Input("forticlientOwnFiles")]
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOwnFileGetArgs>? _forticlientOwnFiles;
        ...
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOwnFileGetArgs> ForticlientOwnFiles
        {
            get => _forticlientOwnFiles ?? (_forticlientOwnFiles = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOwnFileGetArgs>());
        ...
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRegistryEntryGetArgs>? _forticlientRegistryEntries;

        /// <summary>
        /// FortiClient registry entry. The structure of `forticlient_registry_entry` block is documented below.
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRegistryEntryGetArgs> ForticlientRegistryEntries
        {
            get => _forticlientRegistryEntries ?? (_forticlientRegistryEntries = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRegistryEntryGetArgs>());
            set => _forticlientRegistryEntries = value;
        }

        [Input("forticlientRunningApps")]
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRunningAppGetArgs>? _forticlientRunningApps;
        ...
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRunningAppGetArgs> ForticlientRunningApps
        {
            get => _forticlientRunningApps ?? (_forticlientRunningApps = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRunningAppGetArgs>());
        ...
        public EndpointcontrolProfileForticlientWinmacSettingsGetArgs()
        {
        }
        public static new EndpointcontrolProfileForticlientWinmacSettingsGetArgs Empty => new EndpointcontrolProfileForticlientWinmacSettingsGetArgs();
    }
}
