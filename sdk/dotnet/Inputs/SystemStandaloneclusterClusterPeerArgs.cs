...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class SystemStandaloneclusterClusterPeerArgs : global::Pulumi.ResourceArgs
    {
        [Input("downIntfsBeforeSessSyncs")]
        private InputList<Inputs.SystemStandaloneclusterClusterPeerDownIntfsBeforeSessSyncArgs>? _downIntfsBeforeSessSyncs;
        ...
        /// </summary>
        public InputList<Inputs.SystemStandaloneclusterClusterPeerDownIntfsBeforeSessSyncArgs> DownIntfsBeforeSessSyncs
        {
            get => _downIntfsBeforeSessSyncs ?? (_downIntfsBeforeSessSyncs = new InputList<Inputs.SystemStandaloneclusterClusterPeerDownIntfsBeforeSessSyncArgs>());
        ...
        public Input<Inputs.SystemStandaloneclusterClusterPeerSessionSyncFilterArgs>? SessionSyncFilter { get; set; }
        ...
        [Input("syncvds")]
        private InputList<Inputs.SystemStandaloneclusterClusterPeerSyncvdArgs>? _syncvds;
        ...
        /// </summary>
        public InputList<Inputs.SystemStandaloneclusterClusterPeerSyncvdArgs> Syncvds
        {
            get => _syncvds ?? (_syncvds = new InputList<Inputs.SystemStandaloneclusterClusterPeerSyncvdArgs>());
            set => _syncvds = value;
        }

        public SystemStandaloneclusterClusterPeerArgs()
        {
        }
        public static new SystemStandaloneclusterClusterPeerArgs Empty => new SystemStandaloneclusterClusterPeerArgs();
    }
}
