...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WirelesscontrollerSnmpCommunityArgs : global::Pulumi.ResourceArgs
    {
        [Input("hosts")]
        private InputList<Inputs.WirelesscontrollerSnmpCommunityHostArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerSnmpCommunityHostArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.WirelesscontrollerSnmpCommunityHostArgs>());
            set => _hosts = value;
        }
        ...
        public WirelesscontrollerSnmpCommunityArgs()
        {
        }
        public static new WirelesscontrollerSnmpCommunityArgs Empty => new WirelesscontrollerSnmpCommunityArgs();
    }
}
