...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class WirelesscontrollerWtpprofileRadio4Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WirelesscontrollerWtpprofileRadio4ChannelArgs>? _channels;

        /// <summary>
        /// Selected list of wireless radio channels. The structure of `channel` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpprofileRadio4ChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WirelesscontrollerWtpprofileRadio4ChannelArgs>());
            set => _channels = value;
        }
        ...
        [Input("vaps")]
        private InputList<Inputs.WirelesscontrollerWtpprofileRadio4VapArgs>? _vaps;

        /// <summary>
        /// Manually selected list of Virtual Access Points (VAPs). The structure of `vaps` block is documented below.
        /// </summary>
        public InputList<Inputs.WirelesscontrollerWtpprofileRadio4VapArgs> Vaps
        {
            get => _vaps ?? (_vaps = new InputList<Inputs.WirelesscontrollerWtpprofileRadio4VapArgs>());
            set => _vaps = value;
        }
        ...
        public WirelesscontrollerWtpprofileRadio4Args()
        {
        }
        public static new WirelesscontrollerWtpprofileRadio4Args Empty => new WirelesscontrollerWtpprofileRadio4Args();
    }
}
