...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class ExtendercontrollerExtender1Modem1GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// FortiExtender auto switch configuration. The structure of `auto_switch` block is documented below.
        /// </summary>
        [Input("autoSwitch")]
        public Input<Inputs.ExtendercontrollerExtender1Modem1AutoSwitchGetArgs>? AutoSwitch { get; set; }
        ...
        public ExtendercontrollerExtender1Modem1GetArgs()
        {
        }
        public static new ExtendercontrollerExtender1Modem1GetArgs Empty => new ExtendercontrollerExtender1Modem1GetArgs();
    }
}
