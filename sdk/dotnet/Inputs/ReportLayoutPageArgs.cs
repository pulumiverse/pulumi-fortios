...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class ReportLayoutPageArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("footer")]
        public Input<Inputs.ReportLayoutPageFooterArgs>? Footer { get; set; }

        /// <summary>
        /// Configure report page header. The structure of `header` block is documented below.
        /// </summary>
        [Input("header")]
        public Input<Inputs.ReportLayoutPageHeaderArgs>? Header { get; set; }
        ...
        public ReportLayoutPageArgs()
        {
        }
        public static new ReportLayoutPageArgs Empty => new ReportLayoutPageArgs();
    }
}
