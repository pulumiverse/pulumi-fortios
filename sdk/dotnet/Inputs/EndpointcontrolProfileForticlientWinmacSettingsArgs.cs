...
namespace Pulumiverse.Fortios.Inputs
{
    ...
    public sealed class EndpointcontrolProfileForticlientWinmacSettingsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientEmsEntryArgs>? _forticlientEmsEntries;

        /// <summary>
        /// FortiClient EMS entries. The structure of `forticlient_ems_entries` block is documented below.
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientEmsEntryArgs> ForticlientEmsEntries
        {
            get => _forticlientEmsEntries ?? (_forticlientEmsEntries = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientEmsEntryArgs>());
        ...
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOperatingSystemArgs>? _forticlientOperatingSystems;

        /// <summary>
        /// FortiClient operating system. The structure of `forticlient_operating_system` block is documented below.
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOperatingSystemArgs> ForticlientOperatingSystems
        {
            get => _forticlientOperatingSystems ?? (_forticlientOperatingSystems = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOperatingSystemArgs>());
            set => _forticlientOperatingSystems = value;
        }

        [Input("forticlientOwnFiles")]
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOwnFileArgs>? _forticlientOwnFiles;
        ...
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOwnFileArgs> ForticlientOwnFiles
        {
            get => _forticlientOwnFiles ?? (_forticlientOwnFiles = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientOwnFileArgs>());
        ...
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRegistryEntryArgs>? _forticlientRegistryEntries;

        /// <summary>
        /// FortiClient registry entry. The structure of `forticlient_registry_entry` block is documented below.
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRegistryEntryArgs> ForticlientRegistryEntries
        {
            get => _forticlientRegistryEntries ?? (_forticlientRegistryEntries = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRegistryEntryArgs>());
            set => _forticlientRegistryEntries = value;
        }

        [Input("forticlientRunningApps")]
        private InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRunningAppArgs>? _forticlientRunningApps;
        ...
        /// </summary>
        public InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRunningAppArgs> ForticlientRunningApps
        {
            get => _forticlientRunningApps ?? (_forticlientRunningApps = new InputList<Inputs.EndpointcontrolProfileForticlientWinmacSettingsForticlientRunningAppArgs>());
        ...
        public EndpointcontrolProfileForticlientWinmacSettingsArgs()
        {
        }
        public static new EndpointcontrolProfileForticlientWinmacSettingsArgs Empty => new EndpointcontrolProfileForticlientWinmacSettingsArgs();
    }
}
