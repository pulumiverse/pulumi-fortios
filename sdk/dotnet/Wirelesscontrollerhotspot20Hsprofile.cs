...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/wirelesscontrollerhotspot20Hsprofile:Wirelesscontrollerhotspot20Hsprofile")]
    public partial class Wirelesscontrollerhotspot20Hsprofile : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("osuProviders")]
        public Output<ImmutableArray<Outputs.Wirelesscontrollerhotspot20HsprofileOsuProvider>> OsuProviders { get; private set; } = null!;
        ...
        public Wirelesscontrollerhotspot20Hsprofile(string name, Wirelesscontrollerhotspot20HsprofileArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/wirelesscontrollerhotspot20Hsprofile:Wirelesscontrollerhotspot20Hsprofile", name, args ?? new Wirelesscontrollerhotspot20HsprofileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Wirelesscontrollerhotspot20Hsprofile(string name, Input<string> id, Wirelesscontrollerhotspot20HsprofileState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/wirelesscontrollerhotspot20Hsprofile:Wirelesscontrollerhotspot20Hsprofile", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Wirelesscontrollerhotspot20Hsprofile Get(string name, Input<string> id, Wirelesscontrollerhotspot20HsprofileState? state = null, CustomResourceOptions? options = null)
        {
            return new Wirelesscontrollerhotspot20Hsprofile(name, id, state, options);
        }
    }

    public sealed class Wirelesscontrollerhotspot20HsprofileArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable additional step required for access (ASRA). Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("osuProviders")]
        private InputList<Inputs.Wirelesscontrollerhotspot20HsprofileOsuProviderArgs>? _osuProviders;

        /// <summary>
        /// Manually selected list of OSU provider(s). The structure of `osu_provider` block is documented below.
        /// </summary>
        public InputList<Inputs.Wirelesscontrollerhotspot20HsprofileOsuProviderArgs> OsuProviders
        {
            get => _osuProviders ?? (_osuProviders = new InputList<Inputs.Wirelesscontrollerhotspot20HsprofileOsuProviderArgs>());
        ...
        public Wirelesscontrollerhotspot20HsprofileArgs()
        {
        }
        public static new Wirelesscontrollerhotspot20HsprofileArgs Empty => new Wirelesscontrollerhotspot20HsprofileArgs();
    }

    public sealed class Wirelesscontrollerhotspot20HsprofileState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable additional step required for access (ASRA). Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("osuProviders")]
        private InputList<Inputs.Wirelesscontrollerhotspot20HsprofileOsuProviderGetArgs>? _osuProviders;

        /// <summary>
        /// Manually selected list of OSU provider(s). The structure of `osu_provider` block is documented below.
        /// </summary>
        public InputList<Inputs.Wirelesscontrollerhotspot20HsprofileOsuProviderGetArgs> OsuProviders
        {
            get => _osuProviders ?? (_osuProviders = new InputList<Inputs.Wirelesscontrollerhotspot20HsprofileOsuProviderGetArgs>());
            set => _osuProviders = value;
        }
        ...
        public Wirelesscontrollerhotspot20HsprofileState()
        {
        }
        public static new Wirelesscontrollerhotspot20HsprofileState Empty => new Wirelesscontrollerhotspot20HsprofileState();
    }
}
