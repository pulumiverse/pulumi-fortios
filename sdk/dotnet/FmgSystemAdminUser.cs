...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var test1 = new Fortios.FmgSystemAdminUser("test1", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var test2 = new Fortios.FmgSystemAdminUser("test2", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:index/fmgSystemAdminUser:FmgSystemAdminUser")]
    public partial class FmgSystemAdminUser : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Description.
        /// </summary>
        ...
        public FmgSystemAdminUser(string name, FmgSystemAdminUserArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/fmgSystemAdminUser:FmgSystemAdminUser", name, args ?? new FmgSystemAdminUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FmgSystemAdminUser(string name, Input<string> id, FmgSystemAdminUserState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/fmgSystemAdminUser:FmgSystemAdminUser", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FmgSystemAdminUser Get(string name, Input<string> id, FmgSystemAdminUserState? state = null, CustomResourceOptions? options = null)
        {
            return new FmgSystemAdminUser(name, id, state, options);
        }
    }

    public sealed class FmgSystemAdminUserArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Description.
        /// </summary>
        ...
        public FmgSystemAdminUserArgs()
        {
        }
        public static new FmgSystemAdminUserArgs Empty => new FmgSystemAdminUserArgs();
    }

    public sealed class FmgSystemAdminUserState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Description.
        /// </summary>
        ...
        public FmgSystemAdminUserState()
        {
        }
        public static new FmgSystemAdminUserState Empty => new FmgSystemAdminUserState();
    }
}
