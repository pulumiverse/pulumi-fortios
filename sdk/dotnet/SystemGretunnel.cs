...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemGretunnel("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemGretunnel:SystemGretunnel")]
    public partial class SystemGretunnel : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemGretunnel(string name, SystemGretunnelArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemGretunnel:SystemGretunnel", name, args ?? new SystemGretunnelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemGretunnel(string name, Input<string> id, SystemGretunnelState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemGretunnel:SystemGretunnel", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemGretunnel Get(string name, Input<string> id, SystemGretunnelState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemGretunnel(name, id, state, options);
        }
    }

    public sealed class SystemGretunnelArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable validating checksums in received GRE packets. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public SystemGretunnelArgs()
        {
        }
        public static new SystemGretunnelArgs Empty => new SystemGretunnelArgs();
    }

    public sealed class SystemGretunnelState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable validating checksums in received GRE packets. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public SystemGretunnelState()
        {
        }
        public static new SystemGretunnelState Empty => new SystemGretunnelState();
    }
}
