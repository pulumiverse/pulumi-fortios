...
namespace Pulumiverse.Fortios.Vpnsslweb.Inputs
{
    ...
    public sealed class UsergroupbookmarkBookmarkGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("formDatas")]
        private InputList<Inputs.UsergroupbookmarkBookmarkFormDataGetArgs>? _formDatas;

        /// <summary>
        /// Form data. The structure of `form_data` block is documented below.
        /// </summary>
        public InputList<Inputs.UsergroupbookmarkBookmarkFormDataGetArgs> FormDatas
        {
            get => _formDatas ?? (_formDatas = new InputList<Inputs.UsergroupbookmarkBookmarkFormDataGetArgs>());
        ...
        public UsergroupbookmarkBookmarkGetArgs()
        {
        }
        public static new UsergroupbookmarkBookmarkGetArgs Empty => new UsergroupbookmarkBookmarkGetArgs();
    }
}
