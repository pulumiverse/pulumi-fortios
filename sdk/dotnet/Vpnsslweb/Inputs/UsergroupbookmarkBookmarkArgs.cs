...
namespace Pulumiverse.Fortios.Vpnsslweb.Inputs
{
    ...
    public sealed class UsergroupbookmarkBookmarkArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("formDatas")]
        private InputList<Inputs.UsergroupbookmarkBookmarkFormDataArgs>? _formDatas;

        /// <summary>
        /// Form data. The structure of `form_data` block is documented below.
        /// </summary>
        public InputList<Inputs.UsergroupbookmarkBookmarkFormDataArgs> FormDatas
        {
            get => _formDatas ?? (_formDatas = new InputList<Inputs.UsergroupbookmarkBookmarkFormDataArgs>());
        ...
        public UsergroupbookmarkBookmarkArgs()
        {
        }
        public static new UsergroupbookmarkBookmarkArgs Empty => new UsergroupbookmarkBookmarkArgs();
    }
}
