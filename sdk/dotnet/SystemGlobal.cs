...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemGlobal("trname", new()
    ///     {
    ///         AdminSport = 443,
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemGlobal:SystemGlobal")]
    public partial class SystemGlobal : global::Pulumi.CustomResource
    {
        ...
        public SystemGlobal(string name, SystemGlobalArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemGlobal:SystemGlobal", name, args ?? new SystemGlobalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemGlobal(string name, Input<string> id, SystemGlobalState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemGlobal:SystemGlobal", name, state, MakeResourceOptions(options, id))
        {
        }
