...
{
    public static class GetSystemPasswordpolicy
    {
        /// <summary>
        /// Use this data source to get information on fortios system passwordpolicy
        /// </summary>
        public static Task<GetSystemPasswordpolicyResult> InvokeAsync(GetSystemPasswordpolicyArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSystemPasswordpolicyResult>("fortios:index/getSystemPasswordpolicy:getSystemPasswordpolicy", args ?? new GetSystemPasswordpolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system passwordpolicy
        /// </summary>
        public static Output<GetSystemPasswordpolicyResult> Invoke(GetSystemPasswordpolicyInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSystemPasswordpolicyResult>("fortios:index/getSystemPasswordpolicy:getSystemPasswordpolicy", args ?? new GetSystemPasswordpolicyInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetSystemPasswordpolicyArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetSystemPasswordpolicyArgs()
        {
        }
        public static new GetSystemPasswordpolicyArgs Empty => new GetSystemPasswordpolicyArgs();
    }

    public sealed class GetSystemPasswordpolicyInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Specifies the vdom to which the data source will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        /// </summary>
        ...
        public GetSystemPasswordpolicyInvokeArgs()
        {
        }
        public static new GetSystemPasswordpolicyInvokeArgs Empty => new GetSystemPasswordpolicyInvokeArgs();
    }


    [OutputType]
    public sealed class GetSystemPasswordpolicyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetSystemPasswordpolicyResult(
            string applyTo,
