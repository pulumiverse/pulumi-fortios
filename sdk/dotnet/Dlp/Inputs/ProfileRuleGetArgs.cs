...
namespace Pulumiverse.Fortios.Dlp.Inputs
{
    ...
    public sealed class ProfileRuleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("sensitivities")]
        private InputList<Inputs.ProfileRuleSensitivityGetArgs>? _sensitivities;

        /// <summary>
        /// Select a DLP file pattern sensitivity to match. The structure of `sensitivity` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileRuleSensitivityGetArgs> Sensitivities
        {
            get => _sensitivities ?? (_sensitivities = new InputList<Inputs.ProfileRuleSensitivityGetArgs>());
            set => _sensitivities = value;
        }

        [Input("sensors")]
        private InputList<Inputs.ProfileRuleSensorGetArgs>? _sensors;

        /// <summary>
        /// Select DLP sensors. The structure of `sensor` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileRuleSensorGetArgs> Sensors
        {
            get => _sensors ?? (_sensors = new InputList<Inputs.ProfileRuleSensorGetArgs>());
            set => _sensors = value;
        }
