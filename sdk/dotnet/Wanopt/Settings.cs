...
namespace Pulumiverse.Fortios.Wanopt
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:wanopt/settings:Settings")]
    public partial class Settings : global::Pulumi.CustomResource
    {
        ...
        public Settings(string name, SettingsArgs args, CustomResourceOptions? options = null)
            : base("fortios:wanopt/settings:Settings", name, args ?? new SettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Settings(string name, Input<string> id, SettingsState? state = null, CustomResourceOptions? options = null)
            : base("fortios:wanopt/settings:Settings", name, state, MakeResourceOptions(options, id))
        {
        }
