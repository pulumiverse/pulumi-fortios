...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.Logsyslogd3Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logsyslogd3Filter:Logsyslogd3Filter")]
    public partial class Logsyslogd3Filter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.Logsyslogd3FilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        public Logsyslogd3Filter(string name, Logsyslogd3FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logsyslogd3Filter:Logsyslogd3Filter", name, args ?? new Logsyslogd3FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logsyslogd3Filter(string name, Input<string> id, Logsyslogd3FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logsyslogd3Filter:Logsyslogd3Filter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Logsyslogd3Filter Get(string name, Input<string> id, Logsyslogd3FilterState? state = null, CustomResourceOptions? options = null)
        {
            return new Logsyslogd3Filter(name, id, state, options);
        }
    }

    public sealed class Logsyslogd3FilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logsyslogd3FilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logsyslogd3FilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logsyslogd3FilterFreeStyleArgs>());
        ...
        public Logsyslogd3FilterArgs()
        {
        }
        public static new Logsyslogd3FilterArgs Empty => new Logsyslogd3FilterArgs();
    }

    public sealed class Logsyslogd3FilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logsyslogd3FilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logsyslogd3FilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logsyslogd3FilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public Logsyslogd3FilterState()
        {
        }
        public static new Logsyslogd3FilterState Empty => new Logsyslogd3FilterState();
    }
}
