...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.VpnsslwebPortal("trname", new()
    ///     {
    ...
    ///         IpPools = new[]
    ///         {
    ///             new Fortios.Inputs.VpnsslwebPortalIpPoolArgs
    ///             {
    ...
    ///         Ipv6Pools = new[]
    ///         {
    ///             new Fortios.Inputs.VpnsslwebPortalIpv6PoolArgs
    ///             {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/vpnsslwebPortal:VpnsslwebPortal")]
    public partial class VpnsslwebPortal : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.VpnsslwebPortalBookmarkGroup>> BookmarkGroups { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.VpnsslwebPortalHostCheckPolicy>> HostCheckPolicies { get; private set; } = null!;
        ...
        /// </summary>
        [Output("ipPools")]
        public Output<ImmutableArray<Outputs.VpnsslwebPortalIpPool>> IpPools { get; private set; } = null!;
        ...
        /// </summary>
        [Output("ipv6Pools")]
        public Output<ImmutableArray<Outputs.VpnsslwebPortalIpv6Pool>> Ipv6Pools { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.VpnsslwebPortalIpv6SplitTunnelingRoutingAddress>> Ipv6SplitTunnelingRoutingAddresses { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.VpnsslwebPortalMacAddrCheckRule>> MacAddrCheckRules { get; private set; } = null!;
        ...
        /// </summary>
        [Output("osCheckLists")]
        public Output<ImmutableArray<Outputs.VpnsslwebPortalOsCheckList>> OsCheckLists { get; private set; } = null!;
        ...
        /// </summary>
        [Output("splitDns")]
        public Output<ImmutableArray<Outputs.VpnsslwebPortalSplitDn>> SplitDns { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.VpnsslwebPortalSplitTunnelingRoutingAddress>> SplitTunnelingRoutingAddresses { get; private set; } = null!;
        ...
        public VpnsslwebPortal(string name, VpnsslwebPortalArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpnsslwebPortal:VpnsslwebPortal", name, args ?? new VpnsslwebPortalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnsslwebPortal(string name, Input<string> id, VpnsslwebPortalState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpnsslwebPortal:VpnsslwebPortal", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VpnsslwebPortal Get(string name, Input<string> id, VpnsslwebPortalState? state = null, CustomResourceOptions? options = null)
        {
            return new VpnsslwebPortal(name, id, state, options);
        }
    }

    public sealed class VpnsslwebPortalArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Allow user access to SSL-VPN applications.
        /// </summary>
        ...
        private InputList<Inputs.VpnsslwebPortalBookmarkGroupArgs>? _bookmarkGroups;

        /// <summary>
        /// Portal bookmark group. The structure of `bookmark_group` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalBookmarkGroupArgs> BookmarkGroups
        {
            get => _bookmarkGroups ?? (_bookmarkGroups = new InputList<Inputs.VpnsslwebPortalBookmarkGroupArgs>());
        ...
        private InputList<Inputs.VpnsslwebPortalHostCheckPolicyArgs>? _hostCheckPolicies;

        /// <summary>
        /// One or more policies to require the endpoint to have specific security software. The structure of `host_check_policy` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalHostCheckPolicyArgs> HostCheckPolicies
        {
            get => _hostCheckPolicies ?? (_hostCheckPolicies = new InputList<Inputs.VpnsslwebPortalHostCheckPolicyArgs>());
        ...
        [Input("ipPools")]
        private InputList<Inputs.VpnsslwebPortalIpPoolArgs>? _ipPools;

        /// <summary>
        /// IPv4 firewall source address objects reserved for SSL-VPN tunnel mode clients. The structure of `ip_pools` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalIpPoolArgs> IpPools
        {
            get => _ipPools ?? (_ipPools = new InputList<Inputs.VpnsslwebPortalIpPoolArgs>());
            set => _ipPools = value;
        }
        ...
        [Input("ipv6Pools")]
        private InputList<Inputs.VpnsslwebPortalIpv6PoolArgs>? _ipv6Pools;

        /// <summary>
        /// IPv4 firewall source address objects reserved for SSL-VPN tunnel mode clients. The structure of `ipv6_pools` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalIpv6PoolArgs> Ipv6Pools
        {
            get => _ipv6Pools ?? (_ipv6Pools = new InputList<Inputs.VpnsslwebPortalIpv6PoolArgs>());
        ...
        private InputList<Inputs.VpnsslwebPortalIpv6SplitTunnelingRoutingAddressArgs>? _ipv6SplitTunnelingRoutingAddresses;

        /// <summary>
        /// IPv6 SSL-VPN tunnel mode firewall address objects that override firewall policy destination addresses to control split-tunneling access. The structure of `ipv6_split_tunneling_routing_address` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalIpv6SplitTunnelingRoutingAddressArgs> Ipv6SplitTunnelingRoutingAddresses
        {
            get => _ipv6SplitTunnelingRoutingAddresses ?? (_ipv6SplitTunnelingRoutingAddresses = new InputList<Inputs.VpnsslwebPortalIpv6SplitTunnelingRoutingAddressArgs>());
        ...
        private InputList<Inputs.VpnsslwebPortalMacAddrCheckRuleArgs>? _macAddrCheckRules;

        /// <summary>
        /// Client MAC address check rule. The structure of `mac_addr_check_rule` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalMacAddrCheckRuleArgs> MacAddrCheckRules
        {
            get => _macAddrCheckRules ?? (_macAddrCheckRules = new InputList<Inputs.VpnsslwebPortalMacAddrCheckRuleArgs>());
        ...
        [Input("osCheckLists")]
        private InputList<Inputs.VpnsslwebPortalOsCheckListArgs>? _osCheckLists;

        /// <summary>
        /// SSL VPN OS checks. The structure of `os_check_list` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalOsCheckListArgs> OsCheckLists
        {
            get => _osCheckLists ?? (_osCheckLists = new InputList<Inputs.VpnsslwebPortalOsCheckListArgs>());
        ...
        [Input("splitDns")]
        private InputList<Inputs.VpnsslwebPortalSplitDnArgs>? _splitDns;

        /// <summary>
        /// Split DNS for SSL VPN. The structure of `split_dns` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalSplitDnArgs> SplitDns
        {
            get => _splitDns ?? (_splitDns = new InputList<Inputs.VpnsslwebPortalSplitDnArgs>());
            set => _splitDns = value;
        }
        ...
        private InputList<Inputs.VpnsslwebPortalSplitTunnelingRoutingAddressArgs>? _splitTunnelingRoutingAddresses;

        /// <summary>
        /// IPv4 SSL-VPN tunnel mode firewall address objects that override firewall policy destination addresses to control split-tunneling access. The structure of `split_tunneling_routing_address` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalSplitTunnelingRoutingAddressArgs> SplitTunnelingRoutingAddresses
        {
            get => _splitTunnelingRoutingAddresses ?? (_splitTunnelingRoutingAddresses = new InputList<Inputs.VpnsslwebPortalSplitTunnelingRoutingAddressArgs>());
        ...
        public VpnsslwebPortalArgs()
        {
        }
        public static new VpnsslwebPortalArgs Empty => new VpnsslwebPortalArgs();
    }

    public sealed class VpnsslwebPortalState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Allow user access to SSL-VPN applications.
        /// </summary>
        ...
        [Input("bookmarkGroups")]
        private InputList<Inputs.VpnsslwebPortalBookmarkGroupGetArgs>? _bookmarkGroups;

        /// <summary>
        /// Portal bookmark group. The structure of `bookmark_group` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalBookmarkGroupGetArgs> BookmarkGroups
        {
            get => _bookmarkGroups ?? (_bookmarkGroups = new InputList<Inputs.VpnsslwebPortalBookmarkGroupGetArgs>());
            set => _bookmarkGroups = value;
        }
        ...
        [Input("hostCheckPolicies")]
        private InputList<Inputs.VpnsslwebPortalHostCheckPolicyGetArgs>? _hostCheckPolicies;

        /// <summary>
        /// One or more policies to require the endpoint to have specific security software. The structure of `host_check_policy` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalHostCheckPolicyGetArgs> HostCheckPolicies
        {
            get => _hostCheckPolicies ?? (_hostCheckPolicies = new InputList<Inputs.VpnsslwebPortalHostCheckPolicyGetArgs>());
            set => _hostCheckPolicies = value;
        }
        ...
        [Input("ipPools")]
        private InputList<Inputs.VpnsslwebPortalIpPoolGetArgs>? _ipPools;

        /// <summary>
        /// IPv4 firewall source address objects reserved for SSL-VPN tunnel mode clients. The structure of `ip_pools` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalIpPoolGetArgs> IpPools
        {
            get => _ipPools ?? (_ipPools = new InputList<Inputs.VpnsslwebPortalIpPoolGetArgs>());
            set => _ipPools = value;
        }
        ...
        [Input("ipv6Pools")]
        private InputList<Inputs.VpnsslwebPortalIpv6PoolGetArgs>? _ipv6Pools;

        /// <summary>
        /// IPv4 firewall source address objects reserved for SSL-VPN tunnel mode clients. The structure of `ipv6_pools` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalIpv6PoolGetArgs> Ipv6Pools
        {
            get => _ipv6Pools ?? (_ipv6Pools = new InputList<Inputs.VpnsslwebPortalIpv6PoolGetArgs>());
            set => _ipv6Pools = value;
        }
        ...
        [Input("ipv6SplitTunnelingRoutingAddresses")]
        private InputList<Inputs.VpnsslwebPortalIpv6SplitTunnelingRoutingAddressGetArgs>? _ipv6SplitTunnelingRoutingAddresses;

        /// <summary>
        /// IPv6 SSL-VPN tunnel mode firewall address objects that override firewall policy destination addresses to control split-tunneling access. The structure of `ipv6_split_tunneling_routing_address` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalIpv6SplitTunnelingRoutingAddressGetArgs> Ipv6SplitTunnelingRoutingAddresses
        {
            get => _ipv6SplitTunnelingRoutingAddresses ?? (_ipv6SplitTunnelingRoutingAddresses = new InputList<Inputs.VpnsslwebPortalIpv6SplitTunnelingRoutingAddressGetArgs>());
            set => _ipv6SplitTunnelingRoutingAddresses = value;
        }
        ...
        [Input("macAddrCheckRules")]
        private InputList<Inputs.VpnsslwebPortalMacAddrCheckRuleGetArgs>? _macAddrCheckRules;

        /// <summary>
        /// Client MAC address check rule. The structure of `mac_addr_check_rule` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalMacAddrCheckRuleGetArgs> MacAddrCheckRules
        {
            get => _macAddrCheckRules ?? (_macAddrCheckRules = new InputList<Inputs.VpnsslwebPortalMacAddrCheckRuleGetArgs>());
            set => _macAddrCheckRules = value;
        }
        ...
        [Input("osCheckLists")]
        private InputList<Inputs.VpnsslwebPortalOsCheckListGetArgs>? _osCheckLists;

        /// <summary>
        /// SSL VPN OS checks. The structure of `os_check_list` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalOsCheckListGetArgs> OsCheckLists
        {
            get => _osCheckLists ?? (_osCheckLists = new InputList<Inputs.VpnsslwebPortalOsCheckListGetArgs>());
            set => _osCheckLists = value;
        }
        ...
        [Input("splitDns")]
        private InputList<Inputs.VpnsslwebPortalSplitDnGetArgs>? _splitDns;

        /// <summary>
        /// Split DNS for SSL VPN. The structure of `split_dns` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalSplitDnGetArgs> SplitDns
        {
            get => _splitDns ?? (_splitDns = new InputList<Inputs.VpnsslwebPortalSplitDnGetArgs>());
            set => _splitDns = value;
        }
        ...
        [Input("splitTunnelingRoutingAddresses")]
        private InputList<Inputs.VpnsslwebPortalSplitTunnelingRoutingAddressGetArgs>? _splitTunnelingRoutingAddresses;

        /// <summary>
        /// IPv4 SSL-VPN tunnel mode firewall address objects that override firewall policy destination addresses to control split-tunneling access. The structure of `split_tunneling_routing_address` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnsslwebPortalSplitTunnelingRoutingAddressGetArgs> SplitTunnelingRoutingAddresses
        {
            get => _splitTunnelingRoutingAddresses ?? (_splitTunnelingRoutingAddresses = new InputList<Inputs.VpnsslwebPortalSplitTunnelingRoutingAddressGetArgs>());
            set => _splitTunnelingRoutingAddresses = value;
        }
        ...
        public VpnsslwebPortalState()
        {
        }
        public static new VpnsslwebPortalState Empty => new VpnsslwebPortalState();
    }
}
