...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/routerbgpNeighbor:RouterbgpNeighbor")]
    public partial class RouterbgpNeighbor : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.RouterbgpNeighborConditionalAdvertise6>> ConditionalAdvertise6s { get; private set; } = null!;

        /// <summary>
        /// Conditional advertisement. The structure of `conditional_advertise` block is documented below.
        /// </summary>
        [Output("conditionalAdvertises")]
        public Output<ImmutableArray<Outputs.RouterbgpNeighborConditionalAdvertise>> ConditionalAdvertises { get; private set; } = null!;
        ...
        public RouterbgpNeighbor(string name, RouterbgpNeighborArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/routerbgpNeighbor:RouterbgpNeighbor", name, args ?? new RouterbgpNeighborArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouterbgpNeighbor(string name, Input<string> id, RouterbgpNeighborState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/routerbgpNeighbor:RouterbgpNeighbor", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RouterbgpNeighbor Get(string name, Input<string> id, RouterbgpNeighborState? state = null, CustomResourceOptions? options = null)
        {
            return new RouterbgpNeighbor(name, id, state, options);
        }
    }

    public sealed class RouterbgpNeighborArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable address family IPv4 for this neighbor. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        private InputList<Inputs.RouterbgpNeighborConditionalAdvertise6Args>? _conditionalAdvertise6s;

        /// <summary>
        /// IPv6 conditional advertisement. The structure of `conditional_advertise6` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterbgpNeighborConditionalAdvertise6Args> ConditionalAdvertise6s
        {
            get => _conditionalAdvertise6s ?? (_conditionalAdvertise6s = new InputList<Inputs.RouterbgpNeighborConditionalAdvertise6Args>());
            set => _conditionalAdvertise6s = value;
        }

        [Input("conditionalAdvertises")]
        private InputList<Inputs.RouterbgpNeighborConditionalAdvertiseArgs>? _conditionalAdvertises;

        /// <summary>
        /// Conditional advertisement. The structure of `conditional_advertise` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterbgpNeighborConditionalAdvertiseArgs> ConditionalAdvertises
        {
            get => _conditionalAdvertises ?? (_conditionalAdvertises = new InputList<Inputs.RouterbgpNeighborConditionalAdvertiseArgs>());
        ...
        public RouterbgpNeighborArgs()
        {
        }
        public static new RouterbgpNeighborArgs Empty => new RouterbgpNeighborArgs();
    }

    public sealed class RouterbgpNeighborState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable address family IPv4 for this neighbor. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("conditionalAdvertise6s")]
        private InputList<Inputs.RouterbgpNeighborConditionalAdvertise6GetArgs>? _conditionalAdvertise6s;

        /// <summary>
        /// IPv6 conditional advertisement. The structure of `conditional_advertise6` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterbgpNeighborConditionalAdvertise6GetArgs> ConditionalAdvertise6s
        {
            get => _conditionalAdvertise6s ?? (_conditionalAdvertise6s = new InputList<Inputs.RouterbgpNeighborConditionalAdvertise6GetArgs>());
            set => _conditionalAdvertise6s = value;
        }

        [Input("conditionalAdvertises")]
        private InputList<Inputs.RouterbgpNeighborConditionalAdvertiseGetArgs>? _conditionalAdvertises;

        /// <summary>
        /// Conditional advertisement. The structure of `conditional_advertise` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterbgpNeighborConditionalAdvertiseGetArgs> ConditionalAdvertises
        {
            get => _conditionalAdvertises ?? (_conditionalAdvertises = new InputList<Inputs.RouterbgpNeighborConditionalAdvertiseGetArgs>());
            set => _conditionalAdvertises = value;
        }
        ...
        public RouterbgpNeighborState()
        {
        }
        public static new RouterbgpNeighborState Empty => new RouterbgpNeighborState();
    }
}
