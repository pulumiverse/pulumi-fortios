...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemStandalonecluster:SystemStandalonecluster")]
    public partial class SystemStandalonecluster : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("clusterPeers")]
        public Output<ImmutableArray<Outputs.SystemStandaloneclusterClusterPeer>> ClusterPeers { get; private set; } = null!;
        ...
        public SystemStandalonecluster(string name, SystemStandaloneclusterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemStandalonecluster:SystemStandalonecluster", name, args ?? new SystemStandaloneclusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemStandalonecluster(string name, Input<string> id, SystemStandaloneclusterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemStandalonecluster:SystemStandalonecluster", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemStandalonecluster Get(string name, Input<string> id, SystemStandaloneclusterState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemStandalonecluster(name, id, state, options);
        }
    }

    public sealed class SystemStandaloneclusterArgs : global::Pulumi.ResourceArgs
    {
        [Input("clusterPeers")]
        private InputList<Inputs.SystemStandaloneclusterClusterPeerArgs>? _clusterPeers;

        /// <summary>
        /// Configure FortiGate Session Life Support Protocol (FGSP) session synchronization. The structure of `cluster_peer` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemStandaloneclusterClusterPeerArgs> ClusterPeers
        {
            get => _clusterPeers ?? (_clusterPeers = new InputList<Inputs.SystemStandaloneclusterClusterPeerArgs>());
        ...
        public SystemStandaloneclusterArgs()
        {
        }
        public static new SystemStandaloneclusterArgs Empty => new SystemStandaloneclusterArgs();
    }

    public sealed class SystemStandaloneclusterState : global::Pulumi.ResourceArgs
    {
        [Input("clusterPeers")]
        private InputList<Inputs.SystemStandaloneclusterClusterPeerGetArgs>? _clusterPeers;

        /// <summary>
        /// Configure FortiGate Session Life Support Protocol (FGSP) session synchronization. The structure of `cluster_peer` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemStandaloneclusterClusterPeerGetArgs> ClusterPeers
        {
            get => _clusterPeers ?? (_clusterPeers = new InputList<Inputs.SystemStandaloneclusterClusterPeerGetArgs>());
            set => _clusterPeers = value;
        }
        ...
        public SystemStandaloneclusterState()
        {
        }
        public static new SystemStandaloneclusterState Empty => new SystemStandaloneclusterState();
    }
}
