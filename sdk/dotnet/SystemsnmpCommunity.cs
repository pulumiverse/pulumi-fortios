...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemsnmpCommunity("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemsnmpCommunity:SystemsnmpCommunity")]
    public partial class SystemsnmpCommunity : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("hosts")]
        public Output<ImmutableArray<Outputs.SystemsnmpCommunityHost>> Hosts { get; private set; } = null!;

        /// <summary>
        /// Configure IPv6 SNMP managers. The structure of `hosts6` block is documented below.
        /// </summary>
        [Output("hosts6s")]
        public Output<ImmutableArray<Outputs.SystemsnmpCommunityHosts6>> Hosts6s { get; private set; } = null!;
        ...
        /// </summary>
        [Output("vdoms")]
        public Output<ImmutableArray<Outputs.SystemsnmpCommunityVdom>> Vdoms { get; private set; } = null!;
        ...
        public SystemsnmpCommunity(string name, SystemsnmpCommunityArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemsnmpCommunity:SystemsnmpCommunity", name, args ?? new SystemsnmpCommunityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemsnmpCommunity(string name, Input<string> id, SystemsnmpCommunityState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemsnmpCommunity:SystemsnmpCommunity", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemsnmpCommunity Get(string name, Input<string> id, SystemsnmpCommunityState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemsnmpCommunity(name, id, state, options);
        }
    }

    public sealed class SystemsnmpCommunityArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -&gt; [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -&gt; [ a10, a2 ].
        /// </summary>
        ...
        [Input("hosts")]
        private InputList<Inputs.SystemsnmpCommunityHostArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemsnmpCommunityHostArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.SystemsnmpCommunityHostArgs>());
            set => _hosts = value;
        }

        [Input("hosts6s")]
        private InputList<Inputs.SystemsnmpCommunityHosts6Args>? _hosts6s;

        /// <summary>
        /// Configure IPv6 SNMP managers. The structure of `hosts6` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemsnmpCommunityHosts6Args> Hosts6s
        {
            get => _hosts6s ?? (_hosts6s = new InputList<Inputs.SystemsnmpCommunityHosts6Args>());
            set => _hosts6s = value;
        }
        ...
        [Input("vdoms")]
        private InputList<Inputs.SystemsnmpCommunityVdomArgs>? _vdoms;

        /// <summary>
        /// SNMP access control VDOMs. The structure of `vdoms` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemsnmpCommunityVdomArgs> Vdoms
        {
            get => _vdoms ?? (_vdoms = new InputList<Inputs.SystemsnmpCommunityVdomArgs>());
            set => _vdoms = value;
        }

        public SystemsnmpCommunityArgs()
        {
        }
        public static new SystemsnmpCommunityArgs Empty => new SystemsnmpCommunityArgs();
    }

    public sealed class SystemsnmpCommunityState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -&gt; [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -&gt; [ a10, a2 ].
        /// </summary>
        ...
        [Input("hosts")]
        private InputList<Inputs.SystemsnmpCommunityHostGetArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemsnmpCommunityHostGetArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.SystemsnmpCommunityHostGetArgs>());
            set => _hosts = value;
        }

        [Input("hosts6s")]
        private InputList<Inputs.SystemsnmpCommunityHosts6GetArgs>? _hosts6s;

        /// <summary>
        /// Configure IPv6 SNMP managers. The structure of `hosts6` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemsnmpCommunityHosts6GetArgs> Hosts6s
        {
            get => _hosts6s ?? (_hosts6s = new InputList<Inputs.SystemsnmpCommunityHosts6GetArgs>());
            set => _hosts6s = value;
        }
        ...
        [Input("vdoms")]
        private InputList<Inputs.SystemsnmpCommunityVdomGetArgs>? _vdoms;

        /// <summary>
        /// SNMP access control VDOMs. The structure of `vdoms` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemsnmpCommunityVdomGetArgs> Vdoms
        {
            get => _vdoms ?? (_vdoms = new InputList<Inputs.SystemsnmpCommunityVdomGetArgs>());
            set => _vdoms = value;
        }

        public SystemsnmpCommunityState()
        {
        }
        public static new SystemsnmpCommunityState Empty => new SystemsnmpCommunityState();
    }
}
