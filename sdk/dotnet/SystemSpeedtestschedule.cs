...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemSpeedtestschedule:SystemSpeedtestschedule")]
    public partial class SystemSpeedtestschedule : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("schedules")]
        public Output<ImmutableArray<Outputs.SystemSpeedtestscheduleSchedule>> Schedules { get; private set; } = null!;
        ...
        public SystemSpeedtestschedule(string name, SystemSpeedtestscheduleArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemSpeedtestschedule:SystemSpeedtestschedule", name, args ?? new SystemSpeedtestscheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemSpeedtestschedule(string name, Input<string> id, SystemSpeedtestscheduleState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemSpeedtestschedule:SystemSpeedtestschedule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemSpeedtestschedule Get(string name, Input<string> id, SystemSpeedtestscheduleState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemSpeedtestschedule(name, id, state, options);
        }
    }

    public sealed class SystemSpeedtestscheduleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// DSCP used for speed test.
        /// </summary>
        ...
        [Input("schedules")]
        private InputList<Inputs.SystemSpeedtestscheduleScheduleArgs>? _schedules;

        /// <summary>
        /// Schedules for the interface. The structure of `schedules` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemSpeedtestscheduleScheduleArgs> Schedules
        {
            get => _schedules ?? (_schedules = new InputList<Inputs.SystemSpeedtestscheduleScheduleArgs>());
        ...
        public SystemSpeedtestscheduleArgs()
        {
        }
        public static new SystemSpeedtestscheduleArgs Empty => new SystemSpeedtestscheduleArgs();
    }

    public sealed class SystemSpeedtestscheduleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// DSCP used for speed test.
        /// </summary>
        ...
        [Input("schedules")]
        private InputList<Inputs.SystemSpeedtestscheduleScheduleGetArgs>? _schedules;

        /// <summary>
        /// Schedules for the interface. The structure of `schedules` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemSpeedtestscheduleScheduleGetArgs> Schedules
        {
            get => _schedules ?? (_schedules = new InputList<Inputs.SystemSpeedtestscheduleScheduleGetArgs>());
            set => _schedules = value;
        }
        ...
        public SystemSpeedtestscheduleState()
        {
        }
        public static new SystemSpeedtestscheduleState Empty => new SystemSpeedtestscheduleState();
    }
}
