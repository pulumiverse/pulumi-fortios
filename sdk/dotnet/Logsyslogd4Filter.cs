...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.Logsyslogd4Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logsyslogd4Filter:Logsyslogd4Filter")]
    public partial class Logsyslogd4Filter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.Logsyslogd4FilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        public Logsyslogd4Filter(string name, Logsyslogd4FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logsyslogd4Filter:Logsyslogd4Filter", name, args ?? new Logsyslogd4FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logsyslogd4Filter(string name, Input<string> id, Logsyslogd4FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logsyslogd4Filter:Logsyslogd4Filter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Logsyslogd4Filter Get(string name, Input<string> id, Logsyslogd4FilterState? state = null, CustomResourceOptions? options = null)
        {
            return new Logsyslogd4Filter(name, id, state, options);
        }
    }

    public sealed class Logsyslogd4FilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logsyslogd4FilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logsyslogd4FilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logsyslogd4FilterFreeStyleArgs>());
        ...
        public Logsyslogd4FilterArgs()
        {
        }
        public static new Logsyslogd4FilterArgs Empty => new Logsyslogd4FilterArgs();
    }

    public sealed class Logsyslogd4FilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logsyslogd4FilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logsyslogd4FilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logsyslogd4FilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public Logsyslogd4FilterState()
        {
        }
        public static new Logsyslogd4FilterState Empty => new Logsyslogd4FilterState();
    }
}
