...
namespace Pulumiverse.Fortios.Logsyslogd2
{
    ...
    /// {
    ///     var trname = new Fortios.Logsyslogd2.Setting("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:logsyslogd2/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd2/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd2/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
