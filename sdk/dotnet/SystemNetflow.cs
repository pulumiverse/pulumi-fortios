...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemNetflow("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemNetflow:SystemNetflow")]
    public partial class SystemNetflow : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemNetflow(string name, SystemNetflowArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemNetflow:SystemNetflow", name, args ?? new SystemNetflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemNetflow(string name, Input<string> id, SystemNetflowState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemNetflow:SystemNetflow", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemNetflow Get(string name, Input<string> id, SystemNetflowState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemNetflow(name, id, state, options);
        }
    }

    public sealed class SystemNetflowArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Timeout to report active flows (1 - 60 min, default = 30).
        /// </summary>
        ...
        public SystemNetflowArgs()
        {
        }
        public static new SystemNetflowArgs Empty => new SystemNetflowArgs();
    }

    public sealed class SystemNetflowState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Timeout to report active flows (1 - 60 min, default = 30).
        /// </summary>
        ...
        public SystemNetflowState()
        {
        }
        public static new SystemNetflowState Empty => new SystemNetflowState();
    }
}
