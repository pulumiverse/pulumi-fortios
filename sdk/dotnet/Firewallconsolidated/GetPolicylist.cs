...
namespace Pulumiverse.Fortios.Firewallconsolidated
{
    ...
    {
        /// <summary>
        /// Provides a list of `fortios.firewallconsolidated.Policy`.
        /// </summary>
        public static Task<GetPolicylistResult> InvokeAsync(GetPolicylistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicylistResult>("fortios:firewallconsolidated/getPolicylist:getPolicylist", args ?? new GetPolicylistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.firewallconsolidated.Policy`.
        /// </summary>
        public static Output<GetPolicylistResult> Invoke(GetPolicylistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicylistResult>("fortios:firewallconsolidated/getPolicylist:getPolicylist", args ?? new GetPolicylistInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetPolicylistResult
    {
        ...
        /// <summary>
        /// A list of the `fortios.firewallconsolidated.Policy`.
        /// </summary>
