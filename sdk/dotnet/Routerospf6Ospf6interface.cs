...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/routerospf6Ospf6interface:Routerospf6Ospf6interface")]
    public partial class Routerospf6Ospf6interface : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("ipsecKeys")]
        public Output<ImmutableArray<Outputs.Routerospf6Ospf6interfaceIpsecKey>> IpsecKeys { get; private set; } = null!;
        ...
        /// </summary>
        [Output("neighbors")]
        public Output<ImmutableArray<Outputs.Routerospf6Ospf6interfaceNeighbor>> Neighbors { get; private set; } = null!;
        ...
        public Routerospf6Ospf6interface(string name, Routerospf6Ospf6interfaceArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/routerospf6Ospf6interface:Routerospf6Ospf6interface", name, args ?? new Routerospf6Ospf6interfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Routerospf6Ospf6interface(string name, Input<string> id, Routerospf6Ospf6interfaceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/routerospf6Ospf6interface:Routerospf6Ospf6interface", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Routerospf6Ospf6interface Get(string name, Input<string> id, Routerospf6Ospf6interfaceState? state = null, CustomResourceOptions? options = null)
        {
            return new Routerospf6Ospf6interface(name, id, state, options);
        }
    }

    public sealed class Routerospf6Ospf6interfaceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A.B.C.D, in IPv4 address format.
        /// </summary>
        ...
        [Input("ipsecKeys")]
        private InputList<Inputs.Routerospf6Ospf6interfaceIpsecKeyArgs>? _ipsecKeys;

        /// <summary>
        /// IPsec authentication and encryption keys. The structure of `ipsec_keys` block is documented below.
        /// </summary>
        public InputList<Inputs.Routerospf6Ospf6interfaceIpsecKeyArgs> IpsecKeys
        {
            get => _ipsecKeys ?? (_ipsecKeys = new InputList<Inputs.Routerospf6Ospf6interfaceIpsecKeyArgs>());
        ...
        [Input("neighbors")]
        private InputList<Inputs.Routerospf6Ospf6interfaceNeighborArgs>? _neighbors;

        /// <summary>
        /// OSPFv3 neighbors are used when OSPFv3 runs on non-broadcast media The structure of `neighbor` block is documented below.
        /// </summary>
        public InputList<Inputs.Routerospf6Ospf6interfaceNeighborArgs> Neighbors
        {
            get => _neighbors ?? (_neighbors = new InputList<Inputs.Routerospf6Ospf6interfaceNeighborArgs>());
        ...
        public Routerospf6Ospf6interfaceArgs()
        {
        }
        public static new Routerospf6Ospf6interfaceArgs Empty => new Routerospf6Ospf6interfaceArgs();
    }

    public sealed class Routerospf6Ospf6interfaceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A.B.C.D, in IPv4 address format.
        /// </summary>
        ...
        [Input("ipsecKeys")]
        private InputList<Inputs.Routerospf6Ospf6interfaceIpsecKeyGetArgs>? _ipsecKeys;

        /// <summary>
        /// IPsec authentication and encryption keys. The structure of `ipsec_keys` block is documented below.
        /// </summary>
        public InputList<Inputs.Routerospf6Ospf6interfaceIpsecKeyGetArgs> IpsecKeys
        {
            get => _ipsecKeys ?? (_ipsecKeys = new InputList<Inputs.Routerospf6Ospf6interfaceIpsecKeyGetArgs>());
            set => _ipsecKeys = value;
        }
        ...
        [Input("neighbors")]
        private InputList<Inputs.Routerospf6Ospf6interfaceNeighborGetArgs>? _neighbors;

        /// <summary>
        /// OSPFv3 neighbors are used when OSPFv3 runs on non-broadcast media The structure of `neighbor` block is documented below.
        /// </summary>
        public InputList<Inputs.Routerospf6Ospf6interfaceNeighborGetArgs> Neighbors
        {
            get => _neighbors ?? (_neighbors = new InputList<Inputs.Routerospf6Ospf6interfaceNeighborGetArgs>());
            set => _neighbors = value;
        }
        ...
        public Routerospf6Ospf6interfaceState()
        {
        }
        public static new Routerospf6Ospf6interfaceState Empty => new Routerospf6Ospf6interfaceState();
    }
}
