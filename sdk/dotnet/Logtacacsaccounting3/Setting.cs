...
namespace Pulumiverse.Fortios.Logtacacsaccounting3
{
    /// <summary>
    ...
    /// </summary>
    [FortiosResourceType("fortios:logtacacsaccounting3/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logtacacsaccounting3/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logtacacsaccounting3/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
