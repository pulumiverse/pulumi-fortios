...
namespace Pulumiverse.Fortios.Logtacacsaccounting3
{
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logtacacsaccounting3/filter:Filter labelname LogTacacsAccounting3Filter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logtacacsaccounting3/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logtacacsaccounting3/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logtacacsaccounting3/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
