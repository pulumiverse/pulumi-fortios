...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.LogdiskFilter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         DlpArchive = "enable",
    ///         Dns = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logdiskFilter:LogdiskFilter")]
    public partial class LogdiskFilter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.LogdiskFilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        public LogdiskFilter(string name, LogdiskFilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logdiskFilter:LogdiskFilter", name, args ?? new LogdiskFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogdiskFilter(string name, Input<string> id, LogdiskFilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logdiskFilter:LogdiskFilter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogdiskFilter Get(string name, Input<string> id, LogdiskFilterState? state = null, CustomResourceOptions? options = null)
        {
            return new LogdiskFilter(name, id, state, options);
        }
    }

    public sealed class LogdiskFilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable admin login/logout logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.LogdiskFilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.LogdiskFilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.LogdiskFilterFreeStyleArgs>());
        ...
        public LogdiskFilterArgs()
        {
        }
        public static new LogdiskFilterArgs Empty => new LogdiskFilterArgs();
    }

    public sealed class LogdiskFilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable admin login/logout logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.LogdiskFilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.LogdiskFilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.LogdiskFilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public LogdiskFilterState()
        {
        }
        public static new LogdiskFilterState Empty => new LogdiskFilterState();
    }
}
