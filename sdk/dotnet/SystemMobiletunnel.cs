...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemMobiletunnel("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemMobiletunnel:SystemMobiletunnel")]
    public partial class SystemMobiletunnel : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("networks")]
        public Output<ImmutableArray<Outputs.SystemMobiletunnelNetwork>> Networks { get; private set; } = null!;
        ...
        public SystemMobiletunnel(string name, SystemMobiletunnelArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemMobiletunnel:SystemMobiletunnel", name, args ?? new SystemMobiletunnelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemMobiletunnel(string name, Input<string> id, SystemMobiletunnelState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemMobiletunnel:SystemMobiletunnel", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemMobiletunnel Get(string name, Input<string> id, SystemMobiletunnelState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemMobiletunnel(name, id, state, options);
        }
    }

    public sealed class SystemMobiletunnelArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -&gt; [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -&gt; [ a10, a2 ].
        /// </summary>
        ...
        [Input("networks")]
        private InputList<Inputs.SystemMobiletunnelNetworkArgs>? _networks;

        /// <summary>
        /// NEMO network configuration. The structure of `network` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemMobiletunnelNetworkArgs> Networks
        {
            get => _networks ?? (_networks = new InputList<Inputs.SystemMobiletunnelNetworkArgs>());
            set => _networks = value;
        }
        ...
        public SystemMobiletunnelArgs()
        {
        }
        public static new SystemMobiletunnelArgs Empty => new SystemMobiletunnelArgs();
    }

    public sealed class SystemMobiletunnelState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -&gt; [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -&gt; [ a10, a2 ].
        /// </summary>
        ...
        [Input("networks")]
        private InputList<Inputs.SystemMobiletunnelNetworkGetArgs>? _networks;

        /// <summary>
        /// NEMO network configuration. The structure of `network` block is documented below.
        /// </summary>
        public InputList<Inputs.SystemMobiletunnelNetworkGetArgs> Networks
        {
            get => _networks ?? (_networks = new InputList<Inputs.SystemMobiletunnelNetworkGetArgs>());
            set => _networks = value;
        }
        ...
        public SystemMobiletunnelState()
        {
        }
        public static new SystemMobiletunnelState Empty => new SystemMobiletunnelState();
    }
}
