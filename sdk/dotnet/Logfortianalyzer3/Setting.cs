...
namespace Pulumiverse.Fortios.Logfortianalyzer3
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer3.Setting("trname", new()
    ///     {
    ///         __changeIp = 0,
    ///         ConnTimeout = 10,
    ///         EncAlgorithm = "high",
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortianalyzer3/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer3/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer3/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
