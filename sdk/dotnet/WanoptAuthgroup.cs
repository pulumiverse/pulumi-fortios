...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.WanoptAuthgroup("trname", new()
    ///     {
    ///         AuthMethod = "cert",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/wanoptAuthgroup:WanoptAuthgroup")]
    public partial class WanoptAuthgroup : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public WanoptAuthgroup(string name, WanoptAuthgroupArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/wanoptAuthgroup:WanoptAuthgroup", name, args ?? new WanoptAuthgroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WanoptAuthgroup(string name, Input<string> id, WanoptAuthgroupState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/wanoptAuthgroup:WanoptAuthgroup", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WanoptAuthgroup Get(string name, Input<string> id, WanoptAuthgroupState? state = null, CustomResourceOptions? options = null)
        {
            return new WanoptAuthgroup(name, id, state, options);
        }
    }

    public sealed class WanoptAuthgroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Select certificate or pre-shared key authentication for this authentication group. Valid values: `cert`, `psk`.
        /// </summary>
        ...
        public WanoptAuthgroupArgs()
        {
        }
        public static new WanoptAuthgroupArgs Empty => new WanoptAuthgroupArgs();
    }

    public sealed class WanoptAuthgroupState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Select certificate or pre-shared key authentication for this authentication group. Valid values: `cert`, `psk`.
        /// </summary>
        ...
        public WanoptAuthgroupState()
        {
        }
        public static new WanoptAuthgroupState Empty => new WanoptAuthgroupState();
    }
}
