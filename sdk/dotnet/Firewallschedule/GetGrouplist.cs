...
namespace Pulumiverse.Fortios.Firewallschedule
{
    ...
    {
        /// <summary>
        /// Provides a list of `fortios.firewallschedule.Group`.
        /// </summary>
        public static Task<GetGrouplistResult> InvokeAsync(GetGrouplistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGrouplistResult>("fortios:firewallschedule/getGrouplist:getGrouplist", args ?? new GetGrouplistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.firewallschedule.Group`.
        /// </summary>
        public static Output<GetGrouplistResult> Invoke(GetGrouplistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGrouplistResult>("fortios:firewallschedule/getGrouplist:getGrouplist", args ?? new GetGrouplistInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetGrouplistResult
    {
        ...
        /// <summary>
        /// A list of the `fortios.firewallschedule.Group`.
        /// </summary>
