...
namespace Pulumiverse.Fortios.Firewallschedule
{
    ...
    /// {
    ///     var trname1 = new Fortios.Firewallschedule.Recurring("trname1", new()
    ///     {
    ///         Color = 0,
    ///         Day = "sunday",
    ///         End = "00:00",
    ...
    ///     });
    /// 
    ///     var trname = new Fortios.Firewallschedule.Group("trname", new()
    ///     {
    ///         Color = 0,
    ///         Members = new[]
    ///         {
    ///             new Fortios.Firewallschedule.Inputs.GroupMemberArgs
    ///             {
    ///                 Name = trname1.Name,
    ///             },
    ///         },
    ...
    /// </summary>
    [FortiosResourceType("fortios:firewallschedule/group:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("fortios:firewallschedule/group:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, GroupState? state = null, CustomResourceOptions? options = null)
            : base("fortios:firewallschedule/group:Group", name, state, MakeResourceOptions(options, id))
        {
        }
