...
namespace Aspyrmedia.Fortios
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/aspyrmedia/pulumi-fortios/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Aspyrmedia.Fortios.version.txt");
    ...
    internal sealed class FortiosResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FortiosResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
