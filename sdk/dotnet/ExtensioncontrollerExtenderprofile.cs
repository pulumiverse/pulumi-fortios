...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/extensioncontrollerExtenderprofile:ExtensioncontrollerExtenderprofile")]
    public partial class ExtensioncontrollerExtenderprofile : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("cellular")]
        public Output<Outputs.ExtensioncontrollerExtenderprofileCellular> Cellular { get; private set; } = null!;
        ...
        /// </summary>
        [Output("lanExtension")]
        public Output<Outputs.ExtensioncontrollerExtenderprofileLanExtension> LanExtension { get; private set; } = null!;
        ...
        public ExtensioncontrollerExtenderprofile(string name, ExtensioncontrollerExtenderprofileArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/extensioncontrollerExtenderprofile:ExtensioncontrollerExtenderprofile", name, args ?? new ExtensioncontrollerExtenderprofileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExtensioncontrollerExtenderprofile(string name, Input<string> id, ExtensioncontrollerExtenderprofileState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/extensioncontrollerExtenderprofile:ExtensioncontrollerExtenderprofile", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ExtensioncontrollerExtenderprofile Get(string name, Input<string> id, ExtensioncontrollerExtenderprofileState? state = null, CustomResourceOptions? options = null)
        {
            return new ExtensioncontrollerExtenderprofile(name, id, state, options);
        }
    }

    public sealed class ExtensioncontrollerExtenderprofileArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Control management access to the managed extender. Separate entries with a space. Valid values: `ping`, `telnet`, `http`, `https`, `ssh`, `snmp`.
        /// </summary>
        ...
        /// </summary>
        [Input("cellular")]
        public Input<Inputs.ExtensioncontrollerExtenderprofileCellularArgs>? Cellular { get; set; }
        ...
        /// </summary>
        [Input("lanExtension")]
        public Input<Inputs.ExtensioncontrollerExtenderprofileLanExtensionArgs>? LanExtension { get; set; }
        ...
        public ExtensioncontrollerExtenderprofileArgs()
        {
        }
        public static new ExtensioncontrollerExtenderprofileArgs Empty => new ExtensioncontrollerExtenderprofileArgs();
    }

    public sealed class ExtensioncontrollerExtenderprofileState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Control management access to the managed extender. Separate entries with a space. Valid values: `ping`, `telnet`, `http`, `https`, `ssh`, `snmp`.
        /// </summary>
        ...
        /// </summary>
        [Input("cellular")]
        public Input<Inputs.ExtensioncontrollerExtenderprofileCellularGetArgs>? Cellular { get; set; }
        ...
        /// </summary>
        [Input("lanExtension")]
        public Input<Inputs.ExtensioncontrollerExtenderprofileLanExtensionGetArgs>? LanExtension { get; set; }
        ...
        public ExtensioncontrollerExtenderprofileState()
        {
        }
        public static new ExtensioncontrollerExtenderprofileState Empty => new ExtensioncontrollerExtenderprofileState();
    }
}
