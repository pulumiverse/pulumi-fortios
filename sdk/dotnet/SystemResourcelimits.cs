...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemResourcelimits("trname", new()
    ///     {
    ///         CustomService = 0,
    ///         DialupTunnel = 0,
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemResourcelimits:SystemResourcelimits")]
    public partial class SystemResourcelimits : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemResourcelimits(string name, SystemResourcelimitsArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemResourcelimits:SystemResourcelimits", name, args ?? new SystemResourcelimitsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemResourcelimits(string name, Input<string> id, SystemResourcelimitsState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemResourcelimits:SystemResourcelimits", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemResourcelimits Get(string name, Input<string> id, SystemResourcelimitsState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemResourcelimits(name, id, state, options);
        }
    }

    public sealed class SystemResourcelimitsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Maximum number of firewall custom services.
        /// </summary>
        ...
        public SystemResourcelimitsArgs()
        {
        }
        public static new SystemResourcelimitsArgs Empty => new SystemResourcelimitsArgs();
    }

    public sealed class SystemResourcelimitsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Maximum number of firewall custom services.
        /// </summary>
        ...
        public SystemResourcelimitsState()
        {
        }
        public static new SystemResourcelimitsState Empty => new SystemResourcelimitsState();
    }
}
