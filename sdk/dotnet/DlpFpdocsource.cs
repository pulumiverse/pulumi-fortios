...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.DlpFpdocsource("trname", new()
    ///     {
    ///         Date = 1,
    ///         FilePath = "/",
    ///         FilePattern = "*",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/dlpFpdocsource:DlpFpdocsource")]
    public partial class DlpFpdocsource : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DlpFpdocsource(string name, DlpFpdocsourceArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/dlpFpdocsource:DlpFpdocsource", name, args ?? new DlpFpdocsourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DlpFpdocsource(string name, Input<string> id, DlpFpdocsourceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/dlpFpdocsource:DlpFpdocsource", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DlpFpdocsource Get(string name, Input<string> id, DlpFpdocsourceState? state = null, CustomResourceOptions? options = null)
        {
            return new DlpFpdocsource(name, id, state, options);
        }
    }

    public sealed class DlpFpdocsourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Day of the month on which to scan the server (1 - 31).
        /// </summary>
        ...
        public DlpFpdocsourceArgs()
        {
        }
        public static new DlpFpdocsourceArgs Empty => new DlpFpdocsourceArgs();
    }

    public sealed class DlpFpdocsourceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Day of the month on which to scan the server (1 - 31).
        /// </summary>
        ...
        public DlpFpdocsourceState()
        {
        }
        public static new DlpFpdocsourceState Empty => new DlpFpdocsourceState();
    }
}
