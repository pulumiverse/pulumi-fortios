...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer3Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         DlpArchive = "enable",
    ///         Dns = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logfortianalyzer3Filter:Logfortianalyzer3Filter")]
    public partial class Logfortianalyzer3Filter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.Logfortianalyzer3FilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        public Logfortianalyzer3Filter(string name, Logfortianalyzer3FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortianalyzer3Filter:Logfortianalyzer3Filter", name, args ?? new Logfortianalyzer3FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logfortianalyzer3Filter(string name, Input<string> id, Logfortianalyzer3FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortianalyzer3Filter:Logfortianalyzer3Filter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Logfortianalyzer3Filter Get(string name, Input<string> id, Logfortianalyzer3FilterState? state = null, CustomResourceOptions? options = null)
        {
            return new Logfortianalyzer3Filter(name, id, state, options);
        }
    }

    public sealed class Logfortianalyzer3FilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logfortianalyzer3FilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logfortianalyzer3FilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logfortianalyzer3FilterFreeStyleArgs>());
        ...
        public Logfortianalyzer3FilterArgs()
        {
        }
        public static new Logfortianalyzer3FilterArgs Empty => new Logfortianalyzer3FilterArgs();
    }

    public sealed class Logfortianalyzer3FilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logfortianalyzer3FilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logfortianalyzer3FilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logfortianalyzer3FilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public Logfortianalyzer3FilterState()
        {
        }
        public static new Logfortianalyzer3FilterState Empty => new Logfortianalyzer3FilterState();
    }
}
