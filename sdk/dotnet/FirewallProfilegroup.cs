...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallProfilegroup("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallProfilegroup:FirewallProfilegroup")]
    public partial class FirewallProfilegroup : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallProfilegroup(string name, FirewallProfilegroupArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallProfilegroup:FirewallProfilegroup", name, args ?? new FirewallProfilegroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallProfilegroup(string name, Input<string> id, FirewallProfilegroupState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallProfilegroup:FirewallProfilegroup", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallProfilegroup Get(string name, Input<string> id, FirewallProfilegroupState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallProfilegroup(name, id, state, options);
        }
    }

    public sealed class FirewallProfilegroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of an existing Application list.
        /// </summary>
        ...
        public FirewallProfilegroupArgs()
        {
        }
        public static new FirewallProfilegroupArgs Empty => new FirewallProfilegroupArgs();
    }

    public sealed class FirewallProfilegroupState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of an existing Application list.
        /// </summary>
        ...
        public FirewallProfilegroupState()
        {
        }
        public static new FirewallProfilegroupState Empty => new FirewallProfilegroupState();
    }
}
