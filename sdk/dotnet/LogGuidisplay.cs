...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.LogGuidisplay("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logGuidisplay:LogGuidisplay")]
    public partial class LogGuidisplay : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LogGuidisplay(string name, LogGuidisplayArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logGuidisplay:LogGuidisplay", name, args ?? new LogGuidisplayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogGuidisplay(string name, Input<string> id, LogGuidisplayState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logGuidisplay:LogGuidisplay", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogGuidisplay Get(string name, Input<string> id, LogGuidisplayState? state = null, CustomResourceOptions? options = null)
        {
            return new LogGuidisplay(name, id, state, options);
        }
    }

    public sealed class LogGuidisplayArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable showing unscanned traffic in FortiView application charts. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public LogGuidisplayArgs()
        {
        }
        public static new LogGuidisplayArgs Empty => new LogGuidisplayArgs();
    }

    public sealed class LogGuidisplayState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable showing unscanned traffic in FortiView application charts. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public LogGuidisplayState()
        {
        }
        public static new LogGuidisplayState Empty => new LogGuidisplayState();
    }
}
