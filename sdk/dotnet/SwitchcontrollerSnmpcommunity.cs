...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/switchcontrollerSnmpcommunity:SwitchcontrollerSnmpcommunity")]
    public partial class SwitchcontrollerSnmpcommunity : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("hosts")]
        public Output<ImmutableArray<Outputs.SwitchcontrollerSnmpcommunityHost>> Hosts { get; private set; } = null!;
        ...
        public SwitchcontrollerSnmpcommunity(string name, SwitchcontrollerSnmpcommunityArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerSnmpcommunity:SwitchcontrollerSnmpcommunity", name, args ?? new SwitchcontrollerSnmpcommunityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SwitchcontrollerSnmpcommunity(string name, Input<string> id, SwitchcontrollerSnmpcommunityState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerSnmpcommunity:SwitchcontrollerSnmpcommunity", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SwitchcontrollerSnmpcommunity Get(string name, Input<string> id, SwitchcontrollerSnmpcommunityState? state = null, CustomResourceOptions? options = null)
        {
            return new SwitchcontrollerSnmpcommunity(name, id, state, options);
        }
    }

    public sealed class SwitchcontrollerSnmpcommunityArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -&gt; [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -&gt; [ a10, a2 ].
        /// </summary>
        ...
        [Input("hosts")]
        private InputList<Inputs.SwitchcontrollerSnmpcommunityHostArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.SwitchcontrollerSnmpcommunityHostArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.SwitchcontrollerSnmpcommunityHostArgs>());
            set => _hosts = value;
        }
        ...
        public SwitchcontrollerSnmpcommunityArgs()
        {
        }
        public static new SwitchcontrollerSnmpcommunityArgs Empty => new SwitchcontrollerSnmpcommunityArgs();
    }

    public sealed class SwitchcontrollerSnmpcommunityState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Sort sub-tables, please do not set this parameter when configuring static sub-tables. Options: [ false, true, natural, alphabetical ]. false: Default value, do not sort tables; true/natural: sort tables in natural order. For example: [ a10, a2 ] -&gt; [ a2, a10 ]; alphabetical: sort tables in alphabetical order. For example: [ a10, a2 ] -&gt; [ a10, a2 ].
        /// </summary>
        ...
        [Input("hosts")]
        private InputList<Inputs.SwitchcontrollerSnmpcommunityHostGetArgs>? _hosts;

        /// <summary>
        /// Configure IPv4 SNMP managers (hosts). The structure of `hosts` block is documented below.
        /// </summary>
        public InputList<Inputs.SwitchcontrollerSnmpcommunityHostGetArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.SwitchcontrollerSnmpcommunityHostGetArgs>());
            set => _hosts = value;
        }
        ...
        public SwitchcontrollerSnmpcommunityState()
        {
        }
        public static new SwitchcontrollerSnmpcommunityState Empty => new SwitchcontrollerSnmpcommunityState();
    }
}
