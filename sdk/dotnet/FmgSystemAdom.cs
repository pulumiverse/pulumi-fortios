...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var test1 = new Fortios.FmgSystemAdom("test1", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:index/fmgSystemAdom:FmgSystemAdom")]
    public partial class FmgSystemAdom : global::Pulumi.CustomResource
    {
        /// <summary>
        /// True or False.
        /// </summary>
        ...
        /// <summary>
        /// Create a FmgSystemAdom resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public FmgSystemAdom(string name, FmgSystemAdomArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/fmgSystemAdom:FmgSystemAdom", name, args ?? new FmgSystemAdomArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FmgSystemAdom(string name, Input<string> id, FmgSystemAdomState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/fmgSystemAdom:FmgSystemAdom", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing FmgSystemAdom resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FmgSystemAdom Get(string name, Input<string> id, FmgSystemAdomState? state = null, CustomResourceOptions? options = null)
        {
            return new FmgSystemAdom(name, id, state, options);
        }
    }

    public sealed class FmgSystemAdomArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// True or False.
        /// </summary>
        ...
        public FmgSystemAdomArgs()
        {
        }
        public static new FmgSystemAdomArgs Empty => new FmgSystemAdomArgs();
    }

    public sealed class FmgSystemAdomState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// True or False.
        /// </summary>
        ...
        public FmgSystemAdomState()
        {
        }
        public static new FmgSystemAdomState Empty => new FmgSystemAdomState();
    }
}
