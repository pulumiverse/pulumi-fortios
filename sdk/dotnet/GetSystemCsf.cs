...
{
    public static class GetSystemCsf
    {
        /// <summary>
        /// Use this data source to get information on fortios system csf
        /// </summary>
        public static Task<GetSystemCsfResult> InvokeAsync(GetSystemCsfArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSystemCsfResult>("fortios:index/getSystemCsf:getSystemCsf", args ?? new GetSystemCsfArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system csf
        /// </summary>
        public static Output<GetSystemCsfResult> Invoke(GetSystemCsfInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSystemCsfResult>("fortios:index/getSystemCsf:getSystemCsf", args ?? new GetSystemCsfInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetSystemCsfArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetSystemCsfArgs()
        {
        }
        public static new GetSystemCsfArgs Empty => new GetSystemCsfArgs();
    }

    public sealed class GetSystemCsfInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Specifies the vdom to which the data source will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        /// </summary>
        ...
        public GetSystemCsfInvokeArgs()
        {
        }
        public static new GetSystemCsfInvokeArgs Empty => new GetSystemCsfInvokeArgs();
    }


    [OutputType]
    public sealed class GetSystemCsfResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemCsfFabricConnectorResult> FabricConnectors;
        /// <summary>
        /// Fabric device configuration. The structure of `fabric_device` block is documented below.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemCsfFabricDeviceResult> FabricDevices;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSystemCsfTrustedListResult> TrustedLists;
        /// <summary>
        ...
        private GetSystemCsfResult(
            ...
            ImmutableArray<Outputs.GetSystemCsfFabricConnectorResult> fabricConnectors,

            ImmutableArray<Outputs.GetSystemCsfFabricDeviceResult> fabricDevices,
            ...
            ImmutableArray<Outputs.GetSystemCsfTrustedListResult> trustedLists,
