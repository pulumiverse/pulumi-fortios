...
namespace Pulumiverse.Fortios.Lognulldevice
{
    /// <summary>
    ...
    /// {
    ///     var trname = new Fortios.Lognulldevice.Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// </summary>
    [FortiosResourceType("fortios:lognulldevice/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:lognulldevice/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:lognulldevice/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
