...
namespace Pulumiverse.Fortios.Lognulldevice
{
    ...
    /// {
    ///     var trname = new Fortios.Lognulldevice.Setting("trname", new()
    ///     {
    ///         Status = "disable",
    ///     });
    /// 
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:lognulldevice/setting:Setting labelname LogNullDeviceSetting
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:lognulldevice/setting:Setting")]
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs args, CustomResourceOptions? options = null)
            : base("fortios:lognulldevice/setting:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, SettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:lognulldevice/setting:Setting", name, state, MakeResourceOptions(options, id))
        {
        }
