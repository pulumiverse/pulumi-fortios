...
{
    public static class GetFirewallserviceCustom
    {
        /// <summary>
        /// Use this data source to get information on an fortios firewallservice custom
        /// </summary>
        public static Task<GetFirewallserviceCustomResult> InvokeAsync(GetFirewallserviceCustomArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallserviceCustomResult>("fortios:index/getFirewallserviceCustom:getFirewallserviceCustom", args ?? new GetFirewallserviceCustomArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on an fortios firewallservice custom
        /// </summary>
        public static Output<GetFirewallserviceCustomResult> Invoke(GetFirewallserviceCustomInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallserviceCustomResult>("fortios:index/getFirewallserviceCustom:getFirewallserviceCustom", args ?? new GetFirewallserviceCustomInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetFirewallserviceCustomArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetFirewallserviceCustomArgs()
        {
        }
        public static new GetFirewallserviceCustomArgs Empty => new GetFirewallserviceCustomArgs();
    }

    public sealed class GetFirewallserviceCustomInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Specify the name of the desired firewallservice custom.
        /// </summary>
        ...
        public GetFirewallserviceCustomInvokeArgs()
        {
        }
        public static new GetFirewallserviceCustomInvokeArgs Empty => new GetFirewallserviceCustomInvokeArgs();
    }


    [OutputType]
    public sealed class GetFirewallserviceCustomResult
    {
        /// <summary>
        /// Application category ID. The structure of `app_category` block is documented below.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetFirewallserviceCustomAppCategoryResult> AppCategories;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetFirewallserviceCustomApplicationResult> Applications;
        /// <summary>
        /// Service category.
        /// </summary>
        ...
        [OutputConstructor]
        private GetFirewallserviceCustomResult(
            ImmutableArray<Outputs.GetFirewallserviceCustomAppCategoryResult> appCategories,

            string appServiceType,

            ImmutableArray<Outputs.GetFirewallserviceCustomApplicationResult> applications,
