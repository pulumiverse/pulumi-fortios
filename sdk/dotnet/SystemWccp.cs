...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SystemWccp("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemWccp:SystemWccp")]
    public partial class SystemWccp : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemWccp(string name, SystemWccpArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemWccp:SystemWccp", name, args ?? new SystemWccpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemWccp(string name, Input<string> id, SystemWccpState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemWccp:SystemWccp", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemWccp Get(string name, Input<string> id, SystemWccpState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemWccp(name, id, state, options);
        }
    }

    public sealed class SystemWccpArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Assignment bucket format for the WCCP cache engine. Valid values: `wccp-v2`, `cisco-implementation`.
        /// </summary>
        ...
        public SystemWccpArgs()
        {
        }
        public static new SystemWccpArgs Empty => new SystemWccpArgs();
    }

    public sealed class SystemWccpState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Assignment bucket format for the WCCP cache engine. Valid values: `wccp-v2`, `cisco-implementation`.
        /// </summary>
        ...
        public SystemWccpState()
        {
        }
        public static new SystemWccpState Empty => new SystemWccpState();
    }
}
