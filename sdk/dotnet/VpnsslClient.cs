...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/vpnsslClient:VpnsslClient")]
    public partial class VpnsslClient : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public VpnsslClient(string name, VpnsslClientArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpnsslClient:VpnsslClient", name, args ?? new VpnsslClientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnsslClient(string name, Input<string> id, VpnsslClientState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpnsslClient:VpnsslClient", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VpnsslClient Get(string name, Input<string> id, VpnsslClientState? state = null, CustomResourceOptions? options = null)
        {
            return new VpnsslClient(name, id, state, options);
        }
    }

    public sealed class VpnsslClientArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Certificate to offer to SSL-VPN server if it requests one.
        /// </summary>
        ...
        public VpnsslClientArgs()
        {
        }
        public static new VpnsslClientArgs Empty => new VpnsslClientArgs();
    }

    public sealed class VpnsslClientState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Certificate to offer to SSL-VPN server if it requests one.
        /// </summary>
        ...
        public VpnsslClientState()
        {
        }
        public static new VpnsslClientState Empty => new VpnsslClientState();
    }
}
