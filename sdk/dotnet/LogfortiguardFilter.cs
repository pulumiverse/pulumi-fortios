...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.LogfortiguardFilter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         DlpArchive = "enable",
    ///         Dns = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logfortiguardFilter:LogfortiguardFilter")]
    public partial class LogfortiguardFilter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.LogfortiguardFilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a LogfortiguardFilter resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public LogfortiguardFilter(string name, LogfortiguardFilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortiguardFilter:LogfortiguardFilter", name, args ?? new LogfortiguardFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogfortiguardFilter(string name, Input<string> id, LogfortiguardFilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortiguardFilter:LogfortiguardFilter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogfortiguardFilter Get(string name, Input<string> id, LogfortiguardFilterState? state = null, CustomResourceOptions? options = null)
        {
            return new LogfortiguardFilter(name, id, state, options);
        }
    }

    public sealed class LogfortiguardFilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.LogfortiguardFilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.LogfortiguardFilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.LogfortiguardFilterFreeStyleArgs>());
        ...
        public LogfortiguardFilterArgs()
        {
        }
        public static new LogfortiguardFilterArgs Empty => new LogfortiguardFilterArgs();
    }

    public sealed class LogfortiguardFilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.LogfortiguardFilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.LogfortiguardFilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.LogfortiguardFilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public LogfortiguardFilterState()
        {
        }
        public static new LogfortiguardFilterState Empty => new LogfortiguardFilterState();
    }
}
