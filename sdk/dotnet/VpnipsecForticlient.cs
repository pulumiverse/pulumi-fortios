...
namespace Pulumiverse.Fortios
{
    ...
    ///     var trname4 = new Fortios.VpnipsecPhase1interface("trname4", new()
    ///     {
    ///         AcctVerify = "disable",
    ///         AddGwRoute = "disable",
    ///         AddRoute = "enable",
    ...
    ///     var trname3 = new Fortios.VpnipsecPhase2interface("trname3", new()
    ///     {
    ///         AddRoute = "phase1",
    ...
    ///     });
    /// 
    ///     var trname = new Fortios.VpnipsecForticlient("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/vpnipsecForticlient:VpnipsecForticlient")]
    public partial class VpnipsecForticlient : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public VpnipsecForticlient(string name, VpnipsecForticlientArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/vpnipsecForticlient:VpnipsecForticlient", name, args ?? new VpnipsecForticlientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnipsecForticlient(string name, Input<string> id, VpnipsecForticlientState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpnipsecForticlient:VpnipsecForticlient", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VpnipsecForticlient Get(string name, Input<string> id, VpnipsecForticlientState? state = null, CustomResourceOptions? options = null)
        {
            return new VpnipsecForticlient(name, id, state, options);
        }
    }

    public sealed class VpnipsecForticlientArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Phase 2 tunnel name that you defined in the FortiClient dialup configuration.
        /// </summary>
        ...
        public VpnipsecForticlientArgs()
        {
        }
        public static new VpnipsecForticlientArgs Empty => new VpnipsecForticlientArgs();
    }

    public sealed class VpnipsecForticlientState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Phase 2 tunnel name that you defined in the FortiClient dialup configuration.
        /// </summary>
        ...
        public VpnipsecForticlientState()
        {
        }
        public static new VpnipsecForticlientState Empty => new VpnipsecForticlientState();
    }
}
