...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallInterfacepolicy6("trname", new()
    ///     {
    ///         AddressType = "ipv6",
    ...
    ///         Dstaddr6s = new[]
    ///         {
    ///             new Fortios.Inputs.FirewallInterfacepolicy6Dstaddr6Args
    ///             {
    ///                 Name = "all",
    ///             },
    ///         },
    ...
    ///         Service6s = new[]
    ///         {
    ///             new Fortios.Inputs.FirewallInterfacepolicy6Service6Args
    ///             {
    ///                 Name = "ALL",
    ///             },
    ///         },
    ...
    ///         Srcaddr6s = new[]
    ///         {
    ///             new Fortios.Inputs.FirewallInterfacepolicy6Srcaddr6Args
    ///             {
    ///                 Name = "all",
    ///             },
    ///         },
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallInterfacepolicy6:FirewallInterfacepolicy6")]
    public partial class FirewallInterfacepolicy6 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("dstaddr6s")]
        public Output<ImmutableArray<Outputs.FirewallInterfacepolicy6Dstaddr6>> Dstaddr6s { get; private set; } = null!;
        ...
        /// </summary>
        [Output("service6s")]
        public Output<ImmutableArray<Outputs.FirewallInterfacepolicy6Service6>> Service6s { get; private set; } = null!;
        ...
        /// </summary>
        [Output("srcaddr6s")]
        public Output<ImmutableArray<Outputs.FirewallInterfacepolicy6Srcaddr6>> Srcaddr6s { get; private set; } = null!;
        ...
        public FirewallInterfacepolicy6(string name, FirewallInterfacepolicy6Args args, CustomResourceOptions? options = null)
            : base("fortios:index/firewallInterfacepolicy6:FirewallInterfacepolicy6", name, args ?? new FirewallInterfacepolicy6Args(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallInterfacepolicy6(string name, Input<string> id, FirewallInterfacepolicy6State? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallInterfacepolicy6:FirewallInterfacepolicy6", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallInterfacepolicy6 Get(string name, Input<string> id, FirewallInterfacepolicy6State? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallInterfacepolicy6(name, id, state, options);
        }
    }

    public sealed class FirewallInterfacepolicy6Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Policy address type (IPv4 or IPv6). Valid values: `ipv4`, `ipv6`.
        /// </summary>
        ...
        private InputList<Inputs.FirewallInterfacepolicy6Dstaddr6Args>? _dstaddr6s;

        /// <summary>
        /// IPv6 address object to limit traffic monitoring to network traffic sent to the specified address or range. The structure of `dstaddr6` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallInterfacepolicy6Dstaddr6Args> Dstaddr6s
        {
            get => _dstaddr6s ?? (_dstaddr6s = new InputList<Inputs.FirewallInterfacepolicy6Dstaddr6Args>());
        ...
        [Input("service6s")]
        private InputList<Inputs.FirewallInterfacepolicy6Service6Args>? _service6s;

        /// <summary>
        /// Service name. The structure of `service6` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallInterfacepolicy6Service6Args> Service6s
        {
            get => _service6s ?? (_service6s = new InputList<Inputs.FirewallInterfacepolicy6Service6Args>());
        ...
        private InputList<Inputs.FirewallInterfacepolicy6Srcaddr6Args>? _srcaddr6s;

        /// <summary>
        /// IPv6 address object to limit traffic monitoring to network traffic sent from the specified address or range. The structure of `srcaddr6` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallInterfacepolicy6Srcaddr6Args> Srcaddr6s
        {
            get => _srcaddr6s ?? (_srcaddr6s = new InputList<Inputs.FirewallInterfacepolicy6Srcaddr6Args>());
        ...
        public FirewallInterfacepolicy6Args()
        {
        }
        public static new FirewallInterfacepolicy6Args Empty => new FirewallInterfacepolicy6Args();
    }

    public sealed class FirewallInterfacepolicy6State : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Policy address type (IPv4 or IPv6). Valid values: `ipv4`, `ipv6`.
        /// </summary>
        ...
        [Input("dstaddr6s")]
        private InputList<Inputs.FirewallInterfacepolicy6Dstaddr6GetArgs>? _dstaddr6s;

        /// <summary>
        /// IPv6 address object to limit traffic monitoring to network traffic sent to the specified address or range. The structure of `dstaddr6` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallInterfacepolicy6Dstaddr6GetArgs> Dstaddr6s
        {
            get => _dstaddr6s ?? (_dstaddr6s = new InputList<Inputs.FirewallInterfacepolicy6Dstaddr6GetArgs>());
            set => _dstaddr6s = value;
        }
        ...
        [Input("service6s")]
        private InputList<Inputs.FirewallInterfacepolicy6Service6GetArgs>? _service6s;

        /// <summary>
        /// Service name. The structure of `service6` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallInterfacepolicy6Service6GetArgs> Service6s
        {
            get => _service6s ?? (_service6s = new InputList<Inputs.FirewallInterfacepolicy6Service6GetArgs>());
            set => _service6s = value;
        }
        ...
        [Input("srcaddr6s")]
        private InputList<Inputs.FirewallInterfacepolicy6Srcaddr6GetArgs>? _srcaddr6s;

        /// <summary>
        /// IPv6 address object to limit traffic monitoring to network traffic sent from the specified address or range. The structure of `srcaddr6` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallInterfacepolicy6Srcaddr6GetArgs> Srcaddr6s
        {
            get => _srcaddr6s ?? (_srcaddr6s = new InputList<Inputs.FirewallInterfacepolicy6Srcaddr6GetArgs>());
            set => _srcaddr6s = value;
        }
        ...
        public FirewallInterfacepolicy6State()
        {
        }
        public static new FirewallInterfacepolicy6State Empty => new FirewallInterfacepolicy6State();
    }
}
