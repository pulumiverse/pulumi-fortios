...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/certificateCa:CertificateCa")]
    public partial class CertificateCa : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CertificateCa(string name, CertificateCaArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/certificateCa:CertificateCa", name, args ?? new CertificateCaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CertificateCa(string name, Input<string> id, CertificateCaState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/certificateCa:CertificateCa", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CertificateCa Get(string name, Input<string> id, CertificateCaState? state = null, CustomResourceOptions? options = null)
        {
            return new CertificateCa(name, id, state, options);
        }
    }

    public sealed class CertificateCaArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Number of days to wait before requesting an updated CA certificate (0 - 4294967295, 0 = disabled).
        /// </summary>
        ...
        public CertificateCaArgs()
        {
        }
        public static new CertificateCaArgs Empty => new CertificateCaArgs();
    }

    public sealed class CertificateCaState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Number of days to wait before requesting an updated CA certificate (0 - 4294967295, 0 = disabled).
        /// </summary>
        ...
        public CertificateCaState()
        {
        }
        public static new CertificateCaState Empty => new CertificateCaState();
    }
}
