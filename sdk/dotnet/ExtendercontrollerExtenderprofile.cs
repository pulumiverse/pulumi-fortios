...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/extendercontrollerExtenderprofile:ExtendercontrollerExtenderprofile")]
    public partial class ExtendercontrollerExtenderprofile : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("cellular")]
        public Output<Outputs.ExtendercontrollerExtenderprofileCellular> Cellular { get; private set; } = null!;
        ...
        /// </summary>
        [Output("lanExtension")]
        public Output<Outputs.ExtendercontrollerExtenderprofileLanExtension> LanExtension { get; private set; } = null!;
        ...
        public ExtendercontrollerExtenderprofile(string name, ExtendercontrollerExtenderprofileArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/extendercontrollerExtenderprofile:ExtendercontrollerExtenderprofile", name, args ?? new ExtendercontrollerExtenderprofileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExtendercontrollerExtenderprofile(string name, Input<string> id, ExtendercontrollerExtenderprofileState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/extendercontrollerExtenderprofile:ExtendercontrollerExtenderprofile", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ExtendercontrollerExtenderprofile Get(string name, Input<string> id, ExtendercontrollerExtenderprofileState? state = null, CustomResourceOptions? options = null)
        {
            return new ExtendercontrollerExtenderprofile(name, id, state, options);
        }
    }

    public sealed class ExtendercontrollerExtenderprofileArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Control management access to the managed extender. Separate entries with a space. Valid values: `ping`, `telnet`, `http`, `https`, `ssh`, `snmp`.
        /// </summary>
        ...
        /// </summary>
        [Input("cellular")]
        public Input<Inputs.ExtendercontrollerExtenderprofileCellularArgs>? Cellular { get; set; }
        ...
        /// </summary>
        [Input("lanExtension")]
        public Input<Inputs.ExtendercontrollerExtenderprofileLanExtensionArgs>? LanExtension { get; set; }
        ...
        public ExtendercontrollerExtenderprofileArgs()
        {
        }
        public static new ExtendercontrollerExtenderprofileArgs Empty => new ExtendercontrollerExtenderprofileArgs();
    }

    public sealed class ExtendercontrollerExtenderprofileState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Control management access to the managed extender. Separate entries with a space. Valid values: `ping`, `telnet`, `http`, `https`, `ssh`, `snmp`.
        /// </summary>
        ...
        /// </summary>
        [Input("cellular")]
        public Input<Inputs.ExtendercontrollerExtenderprofileCellularGetArgs>? Cellular { get; set; }
        ...
        /// </summary>
        [Input("lanExtension")]
        public Input<Inputs.ExtendercontrollerExtenderprofileLanExtensionGetArgs>? LanExtension { get; set; }
        ...
        public ExtendercontrollerExtenderprofileState()
        {
        }
        public static new ExtendercontrollerExtenderprofileState Empty => new ExtendercontrollerExtenderprofileState();
    }
}
