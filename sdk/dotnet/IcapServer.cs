...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.IcapServer("trname", new()
    ///     {
    ///         Ip6Address = "::",
    ///         IpAddress = "1.1.1.1",
    ///         IpVersion = "4",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/icapServer:IcapServer")]
    public partial class IcapServer : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IcapServer(string name, IcapServerArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/icapServer:IcapServer", name, args ?? new IcapServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IcapServer(string name, Input<string> id, IcapServerState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/icapServer:IcapServer", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IcapServer Get(string name, Input<string> id, IcapServerState? state = null, CustomResourceOptions? options = null)
        {
            return new IcapServer(name, id, state, options);
        }
    }

    public sealed class IcapServerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Address type of the remote ICAP server: IPv4, IPv6 or FQDN. Valid values: `ip4`, `ip6`, `fqdn`.
        /// </summary>
        ...
        public IcapServerArgs()
        {
        }
        public static new IcapServerArgs Empty => new IcapServerArgs();
    }

    public sealed class IcapServerState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Address type of the remote ICAP server: IPv4, IPv6 or FQDN. Valid values: `ip4`, `ip6`, `fqdn`.
        /// </summary>
        ...
        public IcapServerState()
        {
        }
        public static new IcapServerState Empty => new IcapServerState();
    }
}
