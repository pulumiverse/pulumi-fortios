...
namespace Pulumiverse.Fortios.Router.Inputs
{
    ...
    public sealed class Ospf6SummaryAddressGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Ospf6SummaryAddressGetArgs()
        {
        }
        public static new Ospf6SummaryAddressGetArgs Empty => new Ospf6SummaryAddressGetArgs();
    }
}
