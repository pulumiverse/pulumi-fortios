...
namespace Pulumiverse.Fortios.Router.Inputs
{
    ...
    public sealed class MulticastInterfaceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("igmp")]
        public Input<Inputs.MulticastInterfaceIgmpArgs>? Igmp { get; set; }

        [Input("joinGroups")]
        private InputList<Inputs.MulticastInterfaceJoinGroupArgs>? _joinGroups;

        /// <summary>
        /// Join multicast groups. The structure of `join_group` block is documented below.
        /// </summary>
        public InputList<Inputs.MulticastInterfaceJoinGroupArgs> JoinGroups
        {
            get => _joinGroups ?? (_joinGroups = new InputList<Inputs.MulticastInterfaceJoinGroupArgs>());
        ...
        public MulticastInterfaceArgs()
        {
        }
        public static new MulticastInterfaceArgs Empty => new MulticastInterfaceArgs();
    }
}
