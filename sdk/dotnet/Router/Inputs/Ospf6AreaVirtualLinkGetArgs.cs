...
namespace Pulumiverse.Fortios.Router.Inputs
{
    ...
    public sealed class Ospf6AreaVirtualLinkGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("ipsecKeys")]
        private InputList<Inputs.Ospf6AreaVirtualLinkIpsecKeyGetArgs>? _ipsecKeys;

        /// <summary>
        /// IPsec authentication and encryption keys. The structure of `ipsec_keys` block is documented below.
        /// </summary>
        public InputList<Inputs.Ospf6AreaVirtualLinkIpsecKeyGetArgs> IpsecKeys
        {
            get => _ipsecKeys ?? (_ipsecKeys = new InputList<Inputs.Ospf6AreaVirtualLinkIpsecKeyGetArgs>());
        ...
        public Ospf6AreaVirtualLinkGetArgs()
        {
        }
        public static new Ospf6AreaVirtualLinkGetArgs Empty => new Ospf6AreaVirtualLinkGetArgs();
    }
}
