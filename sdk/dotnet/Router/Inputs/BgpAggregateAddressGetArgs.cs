...
namespace Pulumiverse.Fortios.Router.Inputs
{
    ...
    public sealed class BgpAggregateAddressGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public BgpAggregateAddressGetArgs()
        {
        }
        public static new BgpAggregateAddressGetArgs Empty => new BgpAggregateAddressGetArgs();
    }
}
