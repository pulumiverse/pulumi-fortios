...
namespace Pulumiverse.Fortios.Router.Inputs
{
    ...
    public sealed class MulticastPimSmGlobalGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("rpAddresses")]
        private InputList<Inputs.MulticastPimSmGlobalRpAddressGetArgs>? _rpAddresses;

        /// <summary>
        /// Statically configure RP addresses. The structure of `rp_address` block is documented below.
        /// </summary>
        public InputList<Inputs.MulticastPimSmGlobalRpAddressGetArgs> RpAddresses
        {
            get => _rpAddresses ?? (_rpAddresses = new InputList<Inputs.MulticastPimSmGlobalRpAddressGetArgs>());
        ...
        public MulticastPimSmGlobalGetArgs()
        {
        }
        public static new MulticastPimSmGlobalGetArgs Empty => new MulticastPimSmGlobalGetArgs();
    }
}
