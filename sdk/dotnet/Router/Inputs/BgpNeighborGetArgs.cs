...
namespace Pulumiverse.Fortios.Router.Inputs
{
    ...
    public sealed class BgpNeighborGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.BgpNeighborConditionalAdvertise6GetArgs>? _conditionalAdvertise6s;

        /// <summary>
        /// IPv6 conditional advertisement. The structure of `conditional_advertise6` block is documented below.
        /// </summary>
        public InputList<Inputs.BgpNeighborConditionalAdvertise6GetArgs> ConditionalAdvertise6s
        {
            get => _conditionalAdvertise6s ?? (_conditionalAdvertise6s = new InputList<Inputs.BgpNeighborConditionalAdvertise6GetArgs>());
            set => _conditionalAdvertise6s = value;
        }

        [Input("conditionalAdvertises")]
        private InputList<Inputs.BgpNeighborConditionalAdvertiseGetArgs>? _conditionalAdvertises;

        /// <summary>
        /// Conditional advertisement. The structure of `conditional_advertise` block is documented below.
        /// </summary>
        public InputList<Inputs.BgpNeighborConditionalAdvertiseGetArgs> ConditionalAdvertises
        {
            get => _conditionalAdvertises ?? (_conditionalAdvertises = new InputList<Inputs.BgpNeighborConditionalAdvertiseGetArgs>());
        ...
        public BgpNeighborGetArgs()
        {
        }
        public static new BgpNeighborGetArgs Empty => new BgpNeighborGetArgs();
    }
}
