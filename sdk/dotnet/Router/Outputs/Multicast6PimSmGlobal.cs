...
namespace Pulumiverse.Fortios.Router.Outputs
{
    ...
    [OutputType]
    public sealed class Multicast6PimSmGlobal
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.Multicast6PimSmGlobalRpAddress> RpAddresses;

        [OutputConstructor]
        private Multicast6PimSmGlobal(
            int? registerRateLimit,

            ImmutableArray<Outputs.Multicast6PimSmGlobalRpAddress> rpAddresses)
        {
