...
namespace Pulumiverse.Fortios.Router.Ospf
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:router/ospf/neighbor:Neighbor")]
    public partial class Neighbor : global::Pulumi.CustomResource
    {
        ...
        public Neighbor(string name, NeighborArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:router/ospf/neighbor:Neighbor", name, args ?? new NeighborArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Neighbor(string name, Input<string> id, NeighborState? state = null, CustomResourceOptions? options = null)
            : base("fortios:router/ospf/neighbor:Neighbor", name, state, MakeResourceOptions(options, id))
        {
        }
