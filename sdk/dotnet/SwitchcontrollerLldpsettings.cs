...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.SwitchcontrollerLldpsettings("trname", new()
    ///     {
    ///         FastStartInterval = 2,
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/switchcontrollerLldpsettings:SwitchcontrollerLldpsettings")]
    public partial class SwitchcontrollerLldpsettings : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SwitchcontrollerLldpsettings(string name, SwitchcontrollerLldpsettingsArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerLldpsettings:SwitchcontrollerLldpsettings", name, args ?? new SwitchcontrollerLldpsettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SwitchcontrollerLldpsettings(string name, Input<string> id, SwitchcontrollerLldpsettingsState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollerLldpsettings:SwitchcontrollerLldpsettings", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SwitchcontrollerLldpsettings Get(string name, Input<string> id, SwitchcontrollerLldpsettingsState? state = null, CustomResourceOptions? options = null)
        {
            return new SwitchcontrollerLldpsettings(name, id, state, options);
        }
    }

    public sealed class SwitchcontrollerLldpsettingsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable dynamic detection of LLDP neighbor devices for VLAN assignment. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public SwitchcontrollerLldpsettingsArgs()
        {
        }
        public static new SwitchcontrollerLldpsettingsArgs Empty => new SwitchcontrollerLldpsettingsArgs();
    }

    public sealed class SwitchcontrollerLldpsettingsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable dynamic detection of LLDP neighbor devices for VLAN assignment. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public SwitchcontrollerLldpsettingsState()
        {
        }
        public static new SwitchcontrollerLldpsettingsState Empty => new SwitchcontrollerLldpsettingsState();
    }
}
