...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallIppool6("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallIppool6:FirewallIppool6")]
    public partial class FirewallIppool6 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FirewallIppool6(string name, FirewallIppool6Args args, CustomResourceOptions? options = null)
            : base("fortios:index/firewallIppool6:FirewallIppool6", name, args ?? new FirewallIppool6Args(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallIppool6(string name, Input<string> id, FirewallIppool6State? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallIppool6:FirewallIppool6", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallIppool6 Get(string name, Input<string> id, FirewallIppool6State? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallIppool6(name, id, state, options);
        }
    }

    public sealed class FirewallIppool6Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding NAT46 route. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public FirewallIppool6Args()
        {
        }
        public static new FirewallIppool6Args Empty => new FirewallIppool6Args();
    }

    public sealed class FirewallIppool6State : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding NAT46 route. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        public FirewallIppool6State()
        {
        }
        public static new FirewallIppool6State Empty => new FirewallIppool6State();
    }
}
