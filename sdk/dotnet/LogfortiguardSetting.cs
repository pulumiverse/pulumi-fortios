...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.LogfortiguardSetting("trname", new()
    ///     {
    ///         EncAlgorithm = "high",
    ///         SourceIp = "0.0.0.0",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logfortiguardSetting:LogfortiguardSetting")]
    public partial class LogfortiguardSetting : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LogfortiguardSetting(string name, LogfortiguardSettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortiguardSetting:LogfortiguardSetting", name, args ?? new LogfortiguardSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogfortiguardSetting(string name, Input<string> id, LogfortiguardSettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortiguardSetting:LogfortiguardSetting", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogfortiguardSetting Get(string name, Input<string> id, LogfortiguardSettingState? state = null, CustomResourceOptions? options = null)
        {
            return new LogfortiguardSetting(name, id, state, options);
        }
    }

    public sealed class LogfortiguardSettingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable FortiCloud access to configuration and data. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public LogfortiguardSettingArgs()
        {
        }
        public static new LogfortiguardSettingArgs Empty => new LogfortiguardSettingArgs();
    }

    public sealed class LogfortiguardSettingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable FortiCloud access to configuration and data. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public LogfortiguardSettingState()
        {
        }
        public static new LogfortiguardSettingState Empty => new LogfortiguardSettingState();
    }
}
