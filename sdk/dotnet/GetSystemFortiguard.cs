...
{
    public static class GetSystemFortiguard
    {
        /// <summary>
        /// Use this data source to get information on fortios system fortiguard
        /// </summary>
        public static Task<GetSystemFortiguardResult> InvokeAsync(GetSystemFortiguardArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSystemFortiguardResult>("fortios:index/getSystemFortiguard:getSystemFortiguard", args ?? new GetSystemFortiguardArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system fortiguard
        /// </summary>
        public static Output<GetSystemFortiguardResult> Invoke(GetSystemFortiguardInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSystemFortiguardResult>("fortios:index/getSystemFortiguard:getSystemFortiguard", args ?? new GetSystemFortiguardInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetSystemFortiguardArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetSystemFortiguardArgs()
        {
        }
        public static new GetSystemFortiguardArgs Empty => new GetSystemFortiguardArgs();
    }

    public sealed class GetSystemFortiguardInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Specifies the vdom to which the data source will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        /// </summary>
        ...
        public GetSystemFortiguardInvokeArgs()
        {
        }
        public static new GetSystemFortiguardInvokeArgs Empty => new GetSystemFortiguardInvokeArgs();
    }


    [OutputType]
    public sealed class GetSystemFortiguardResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetSystemFortiguardResult(
