...
namespace Pulumiverse.Fortios.Webfilter
{
    ...
    /// {
    ///     var trname = new Fortios.Webfilter.Contentheader("trname", new()
    ///     {
    ///         Fosid = 1,
    ///     });
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:webfilter/contentheader:Contentheader")]
    public partial class Contentheader : global::Pulumi.CustomResource
    {
        ...
        public Contentheader(string name, ContentheaderArgs args, CustomResourceOptions? options = null)
            : base("fortios:webfilter/contentheader:Contentheader", name, args ?? new ContentheaderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Contentheader(string name, Input<string> id, ContentheaderState? state = null, CustomResourceOptions? options = null)
            : base("fortios:webfilter/contentheader:Contentheader", name, state, MakeResourceOptions(options, id))
        {
        }
