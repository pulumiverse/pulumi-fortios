...
namespace Pulumiverse.Fortios.Webfilter.Inputs
{
    ...
    public sealed class ProfileFtgdWfFilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("authUsrGrps")]
        private InputList<Inputs.ProfileFtgdWfFilterAuthUsrGrpArgs>? _authUsrGrps;

        /// <summary>
        /// Groups with permission to authenticate. The structure of `auth_usr_grp` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileFtgdWfFilterAuthUsrGrpArgs> AuthUsrGrps
        {
            get => _authUsrGrps ?? (_authUsrGrps = new InputList<Inputs.ProfileFtgdWfFilterAuthUsrGrpArgs>());
        ...
        public ProfileFtgdWfFilterArgs()
        {
        }
        public static new ProfileFtgdWfFilterArgs Empty => new ProfileFtgdWfFilterArgs();
    }
}
