...
namespace Pulumiverse.Fortios.Webfilter.Inputs
{
    ...
    public sealed class ProfileFtgdWfGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private InputList<Inputs.ProfileFtgdWfFilterGetArgs>? _filters;

        /// <summary>
        /// FortiGuard filters. The structure of `filters` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileFtgdWfFilterGetArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.ProfileFtgdWfFilterGetArgs>());
            set => _filters = value;
        }
        ...
        [Input("quotas")]
        private InputList<Inputs.ProfileFtgdWfQuotaGetArgs>? _quotas;

        /// <summary>
        /// FortiGuard traffic quota settings. The structure of `quota` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileFtgdWfQuotaGetArgs> Quotas
        {
            get => _quotas ?? (_quotas = new InputList<Inputs.ProfileFtgdWfQuotaGetArgs>());
            set => _quotas = value;
        }
        ...
        public ProfileFtgdWfGetArgs()
        {
        }
        public static new ProfileFtgdWfGetArgs Empty => new ProfileFtgdWfGetArgs();
    }
}
