...
namespace Pulumiverse.Fortios.Webfilter.Inputs
{
    ...
    public sealed class ProfileOverrideGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ProfileOverrideOvrdUserGroupGetArgs>? _ovrdUserGroups;

        /// <summary>
        /// User groups with permission to use the override. The structure of `ovrd_user_group` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileOverrideOvrdUserGroupGetArgs> OvrdUserGroups
        {
            get => _ovrdUserGroups ?? (_ovrdUserGroups = new InputList<Inputs.ProfileOverrideOvrdUserGroupGetArgs>());
        ...
        [Input("profiles")]
        private InputList<Inputs.ProfileOverrideProfileGetArgs>? _profiles;

        /// <summary>
        /// Web filter profile with permission to create overrides. The structure of `profile` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileOverrideProfileGetArgs> Profiles
        {
            get => _profiles ?? (_profiles = new InputList<Inputs.ProfileOverrideProfileGetArgs>());
            set => _profiles = value;
        }

        public ProfileOverrideGetArgs()
        {
        }
        public static new ProfileOverrideGetArgs Empty => new ProfileOverrideGetArgs();
    }
}
