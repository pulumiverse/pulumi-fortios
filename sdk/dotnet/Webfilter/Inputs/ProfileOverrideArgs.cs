...
namespace Pulumiverse.Fortios.Webfilter.Inputs
{
    ...
    public sealed class ProfileOverrideArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ProfileOverrideOvrdUserGroupArgs>? _ovrdUserGroups;

        /// <summary>
        /// User groups with permission to use the override. The structure of `ovrd_user_group` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileOverrideOvrdUserGroupArgs> OvrdUserGroups
        {
            get => _ovrdUserGroups ?? (_ovrdUserGroups = new InputList<Inputs.ProfileOverrideOvrdUserGroupArgs>());
        ...
        [Input("profiles")]
        private InputList<Inputs.ProfileOverrideProfileArgs>? _profiles;

        /// <summary>
        /// Web filter profile with permission to create overrides. The structure of `profile` block is documented below.
        /// </summary>
        public InputList<Inputs.ProfileOverrideProfileArgs> Profiles
        {
            get => _profiles ?? (_profiles = new InputList<Inputs.ProfileOverrideProfileArgs>());
            set => _profiles = value;
        }

        public ProfileOverrideArgs()
        {
        }
        public static new ProfileOverrideArgs Empty => new ProfileOverrideArgs();
    }
}
