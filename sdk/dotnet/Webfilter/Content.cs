...
namespace Pulumiverse.Fortios.Webfilter
{
    ...
    /// {
    ///     var trname = new Fortios.Webfilter.Content("trname", new()
    ///     {
    ///         Fosid = 1,
    ///     });
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:webfilter/content:Content")]
    public partial class Content : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("entries")]
        public Output<ImmutableArray<Outputs.ContentEntry>> Entries { get; private set; } = null!;
        ...
        public Content(string name, ContentArgs args, CustomResourceOptions? options = null)
            : base("fortios:webfilter/content:Content", name, args ?? new ContentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Content(string name, Input<string> id, ContentState? state = null, CustomResourceOptions? options = null)
            : base("fortios:webfilter/content:Content", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContentArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("entries")]
        private InputList<Inputs.ContentEntryArgs>? _entries;

        /// <summary>
        /// Configure banned word entries. The structure of `entries` block is documented below.
        /// </summary>
        public InputList<Inputs.ContentEntryArgs> Entries
        {
            get => _entries ?? (_entries = new InputList<Inputs.ContentEntryArgs>());
            set => _entries = value;
        }
    ...
    public sealed class ContentState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("entries")]
        private InputList<Inputs.ContentEntryGetArgs>? _entries;

        /// <summary>
        /// Configure banned word entries. The structure of `entries` block is documented below.
        /// </summary>
        public InputList<Inputs.ContentEntryGetArgs> Entries
        {
            get => _entries ?? (_entries = new InputList<Inputs.ContentEntryGetArgs>());
            set => _entries = value;
        }
