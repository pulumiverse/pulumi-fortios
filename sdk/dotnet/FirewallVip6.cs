...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallVip6("trname", new()
    ///     {
    ///         ArpReply = "enable",
    ///         Color = 0,
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallVip6:FirewallVip6")]
    public partial class FirewallVip6 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("monitors")]
        public Output<ImmutableArray<Outputs.FirewallVip6Monitor>> Monitors { get; private set; } = null!;
        ...
        /// </summary>
        [Output("realservers")]
        public Output<ImmutableArray<Outputs.FirewallVip6Realserver>> Realservers { get; private set; } = null!;
        ...
        /// </summary>
        [Output("srcFilters")]
        public Output<ImmutableArray<Outputs.FirewallVip6SrcFilter>> SrcFilters { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.FirewallVip6SslCipherSuite>> SslCipherSuites { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.FirewallVip6SslServerCipherSuite>> SslServerCipherSuites { get; private set; } = null!;
        ...
        public FirewallVip6(string name, FirewallVip6Args args, CustomResourceOptions? options = null)
            : base("fortios:index/firewallVip6:FirewallVip6", name, args ?? new FirewallVip6Args(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallVip6(string name, Input<string> id, FirewallVip6State? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallVip6:FirewallVip6", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallVip6 Get(string name, Input<string> id, FirewallVip6State? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallVip6(name, id, state, options);
        }
    }

    public sealed class FirewallVip6Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding NAT64 route. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        [Input("monitors")]
        private InputList<Inputs.FirewallVip6MonitorArgs>? _monitors;

        /// <summary>
        /// Name of the health check monitor to use when polling to determine a virtual server's connectivity status. The structure of `monitor` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6MonitorArgs> Monitors
        {
            get => _monitors ?? (_monitors = new InputList<Inputs.FirewallVip6MonitorArgs>());
            set => _monitors = value;
        }
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallVip6RealserverArgs>? _realservers;

        /// <summary>
        /// Select the real servers that this server load balancing VIP will distribute traffic to. The structure of `realservers` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6RealserverArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallVip6RealserverArgs>());
        ...
        [Input("srcFilters")]
        private InputList<Inputs.FirewallVip6SrcFilterArgs>? _srcFilters;

        /// <summary>
        /// Source IP6 filter (x:x:x:x:x:x:x:x/x). Separate addresses with spaces. The structure of `src_filter` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6SrcFilterArgs> SrcFilters
        {
            get => _srcFilters ?? (_srcFilters = new InputList<Inputs.FirewallVip6SrcFilterArgs>());
        ...
        private InputList<Inputs.FirewallVip6SslCipherSuiteArgs>? _sslCipherSuites;

        /// <summary>
        /// SSL/TLS cipher suites acceptable from a client, ordered by priority. The structure of `ssl_cipher_suites` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6SslCipherSuiteArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallVip6SslCipherSuiteArgs>());
        ...
        private InputList<Inputs.FirewallVip6SslServerCipherSuiteArgs>? _sslServerCipherSuites;

        /// <summary>
        /// SSL/TLS cipher suites to offer to a server, ordered by priority. The structure of `ssl_server_cipher_suites` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6SslServerCipherSuiteArgs> SslServerCipherSuites
        {
            get => _sslServerCipherSuites ?? (_sslServerCipherSuites = new InputList<Inputs.FirewallVip6SslServerCipherSuiteArgs>());
        ...
        public FirewallVip6Args()
        {
        }
        public static new FirewallVip6Args Empty => new FirewallVip6Args();
    }

    public sealed class FirewallVip6State : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding NAT64 route. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        [Input("monitors")]
        private InputList<Inputs.FirewallVip6MonitorGetArgs>? _monitors;

        /// <summary>
        /// Name of the health check monitor to use when polling to determine a virtual server's connectivity status. The structure of `monitor` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6MonitorGetArgs> Monitors
        {
            get => _monitors ?? (_monitors = new InputList<Inputs.FirewallVip6MonitorGetArgs>());
            set => _monitors = value;
        }
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallVip6RealserverGetArgs>? _realservers;

        /// <summary>
        /// Select the real servers that this server load balancing VIP will distribute traffic to. The structure of `realservers` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6RealserverGetArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallVip6RealserverGetArgs>());
            set => _realservers = value;
        }
        ...
        [Input("srcFilters")]
        private InputList<Inputs.FirewallVip6SrcFilterGetArgs>? _srcFilters;

        /// <summary>
        /// Source IP6 filter (x:x:x:x:x:x:x:x/x). Separate addresses with spaces. The structure of `src_filter` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6SrcFilterGetArgs> SrcFilters
        {
            get => _srcFilters ?? (_srcFilters = new InputList<Inputs.FirewallVip6SrcFilterGetArgs>());
            set => _srcFilters = value;
        }
        ...
        [Input("sslCipherSuites")]
        private InputList<Inputs.FirewallVip6SslCipherSuiteGetArgs>? _sslCipherSuites;

        /// <summary>
        /// SSL/TLS cipher suites acceptable from a client, ordered by priority. The structure of `ssl_cipher_suites` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6SslCipherSuiteGetArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallVip6SslCipherSuiteGetArgs>());
            set => _sslCipherSuites = value;
        }
        ...
        [Input("sslServerCipherSuites")]
        private InputList<Inputs.FirewallVip6SslServerCipherSuiteGetArgs>? _sslServerCipherSuites;

        /// <summary>
        /// SSL/TLS cipher suites to offer to a server, ordered by priority. The structure of `ssl_server_cipher_suites` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVip6SslServerCipherSuiteGetArgs> SslServerCipherSuites
        {
            get => _sslServerCipherSuites ?? (_sslServerCipherSuites = new InputList<Inputs.FirewallVip6SslServerCipherSuiteGetArgs>());
            set => _sslServerCipherSuites = value;
        }
        ...
        public FirewallVip6State()
        {
        }
        public static new FirewallVip6State Empty => new FirewallVip6State();
    }
}
