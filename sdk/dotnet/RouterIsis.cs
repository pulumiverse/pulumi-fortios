...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.RouterIsis("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/routerIsis:RouterIsis")]
    public partial class RouterIsis : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.RouterIsisIsisInterface>> IsisInterfaces { get; private set; } = null!;

        /// <summary>
        /// IS-IS net configuration. The structure of `isis_net` block is documented below.
        /// </summary>
        [Output("isisNets")]
        public Output<ImmutableArray<Outputs.RouterIsisIsisNet>> IsisNets { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.RouterIsisRedistribute6>> Redistribute6s { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.RouterIsisRedistribute>> Redistributes { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.RouterIsisSummaryAddress6>> SummaryAddress6s { get; private set; } = null!;

        /// <summary>
        /// IS-IS summary addresses. The structure of `summary_address` block is documented below.
        /// </summary>
        [Output("summaryAddresses")]
        public Output<ImmutableArray<Outputs.RouterIsisSummaryAddress>> SummaryAddresses { get; private set; } = null!;
        ...
        public RouterIsis(string name, RouterIsisArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/routerIsis:RouterIsis", name, args ?? new RouterIsisArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouterIsis(string name, Input<string> id, RouterIsisState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/routerIsis:RouterIsis", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RouterIsis Get(string name, Input<string> id, RouterIsisState? state = null, CustomResourceOptions? options = null)
        {
            return new RouterIsis(name, id, state, options);
        }
    }

    public sealed class RouterIsisArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adjacency check. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        private InputList<Inputs.RouterIsisIsisInterfaceArgs>? _isisInterfaces;

        /// <summary>
        /// IS-IS interface configuration. The structure of `isis_interface` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisIsisInterfaceArgs> IsisInterfaces
        {
            get => _isisInterfaces ?? (_isisInterfaces = new InputList<Inputs.RouterIsisIsisInterfaceArgs>());
            set => _isisInterfaces = value;
        }

        [Input("isisNets")]
        private InputList<Inputs.RouterIsisIsisNetArgs>? _isisNets;

        /// <summary>
        /// IS-IS net configuration. The structure of `isis_net` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisIsisNetArgs> IsisNets
        {
            get => _isisNets ?? (_isisNets = new InputList<Inputs.RouterIsisIsisNetArgs>());
            set => _isisNets = value;
        }
        ...
        private InputList<Inputs.RouterIsisRedistribute6Args>? _redistribute6s;

        /// <summary>
        /// IS-IS IPv6 redistribution for routing protocols. The structure of `redistribute6` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisRedistribute6Args> Redistribute6s
        {
            get => _redistribute6s ?? (_redistribute6s = new InputList<Inputs.RouterIsisRedistribute6Args>());
        ...
        [Input("redistributes")]
        private InputList<Inputs.RouterIsisRedistributeArgs>? _redistributes;

        /// <summary>
        /// IS-IS redistribute protocols. The structure of `redistribute` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisRedistributeArgs> Redistributes
        {
            get => _redistributes ?? (_redistributes = new InputList<Inputs.RouterIsisRedistributeArgs>());
        ...
        private InputList<Inputs.RouterIsisSummaryAddress6Args>? _summaryAddress6s;

        /// <summary>
        /// IS-IS IPv6 summary address. The structure of `summary_address6` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisSummaryAddress6Args> SummaryAddress6s
        {
            get => _summaryAddress6s ?? (_summaryAddress6s = new InputList<Inputs.RouterIsisSummaryAddress6Args>());
            set => _summaryAddress6s = value;
        }

        [Input("summaryAddresses")]
        private InputList<Inputs.RouterIsisSummaryAddressArgs>? _summaryAddresses;

        /// <summary>
        /// IS-IS summary addresses. The structure of `summary_address` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisSummaryAddressArgs> SummaryAddresses
        {
            get => _summaryAddresses ?? (_summaryAddresses = new InputList<Inputs.RouterIsisSummaryAddressArgs>());
        ...
        public RouterIsisArgs()
        {
        }
        public static new RouterIsisArgs Empty => new RouterIsisArgs();
    }

    public sealed class RouterIsisState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adjacency check. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("isisInterfaces")]
        private InputList<Inputs.RouterIsisIsisInterfaceGetArgs>? _isisInterfaces;

        /// <summary>
        /// IS-IS interface configuration. The structure of `isis_interface` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisIsisInterfaceGetArgs> IsisInterfaces
        {
            get => _isisInterfaces ?? (_isisInterfaces = new InputList<Inputs.RouterIsisIsisInterfaceGetArgs>());
            set => _isisInterfaces = value;
        }

        [Input("isisNets")]
        private InputList<Inputs.RouterIsisIsisNetGetArgs>? _isisNets;

        /// <summary>
        /// IS-IS net configuration. The structure of `isis_net` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisIsisNetGetArgs> IsisNets
        {
            get => _isisNets ?? (_isisNets = new InputList<Inputs.RouterIsisIsisNetGetArgs>());
            set => _isisNets = value;
        }
        ...
        [Input("redistribute6s")]
        private InputList<Inputs.RouterIsisRedistribute6GetArgs>? _redistribute6s;

        /// <summary>
        /// IS-IS IPv6 redistribution for routing protocols. The structure of `redistribute6` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisRedistribute6GetArgs> Redistribute6s
        {
            get => _redistribute6s ?? (_redistribute6s = new InputList<Inputs.RouterIsisRedistribute6GetArgs>());
            set => _redistribute6s = value;
        }
        ...
        [Input("redistributes")]
        private InputList<Inputs.RouterIsisRedistributeGetArgs>? _redistributes;

        /// <summary>
        /// IS-IS redistribute protocols. The structure of `redistribute` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisRedistributeGetArgs> Redistributes
        {
            get => _redistributes ?? (_redistributes = new InputList<Inputs.RouterIsisRedistributeGetArgs>());
            set => _redistributes = value;
        }
        ...
        [Input("summaryAddress6s")]
        private InputList<Inputs.RouterIsisSummaryAddress6GetArgs>? _summaryAddress6s;

        /// <summary>
        /// IS-IS IPv6 summary address. The structure of `summary_address6` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisSummaryAddress6GetArgs> SummaryAddress6s
        {
            get => _summaryAddress6s ?? (_summaryAddress6s = new InputList<Inputs.RouterIsisSummaryAddress6GetArgs>());
            set => _summaryAddress6s = value;
        }

        [Input("summaryAddresses")]
        private InputList<Inputs.RouterIsisSummaryAddressGetArgs>? _summaryAddresses;

        /// <summary>
        /// IS-IS summary addresses. The structure of `summary_address` block is documented below.
        /// </summary>
        public InputList<Inputs.RouterIsisSummaryAddressGetArgs> SummaryAddresses
        {
            get => _summaryAddresses ?? (_summaryAddresses = new InputList<Inputs.RouterIsisSummaryAddressGetArgs>());
            set => _summaryAddresses = value;
        }
        ...
        public RouterIsisState()
        {
        }
        public static new RouterIsisState Empty => new RouterIsisState();
    }
}
