...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var loopback1 = new Fortios.NetworkingInterfacePort("loopback1", new()
    ///     {
    ///         Alias = "cc1",
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var vlan1 = new Fortios.NetworkingInterfacePort("vlan1", new()
    ///     {
    ///         Allowaccess = "ping",
    ///         Defaultgw = "enable",
    ///         Distance = "33",
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var test1 = new Fortios.NetworkingInterfacePort("test1", new()
    ///     {
    ///         Alias = "dkeeew",
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:index/networkingInterfacePort:NetworkingInterfacePort")]
    public partial class NetworkingInterfacePort : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public NetworkingInterfacePort(string name, NetworkingInterfacePortArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/networkingInterfacePort:NetworkingInterfacePort", name, args ?? new NetworkingInterfacePortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkingInterfacePort(string name, Input<string> id, NetworkingInterfacePortState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/networkingInterfacePort:NetworkingInterfacePort", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkingInterfacePort Get(string name, Input<string> id, NetworkingInterfacePortState? state = null, CustomResourceOptions? options = null)
        {
            return new NetworkingInterfacePort(name, id, state, options);
        }
    }

    public sealed class NetworkingInterfacePortArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Alias will be displayed with the interface name to make it easier to distinguish.
        /// </summary>
        ...
        public NetworkingInterfacePortArgs()
        {
        }
        public static new NetworkingInterfacePortArgs Empty => new NetworkingInterfacePortArgs();
    }

    public sealed class NetworkingInterfacePortState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Alias will be displayed with the interface name to make it easier to distinguish.
        /// </summary>
        ...
        public NetworkingInterfacePortState()
        {
        }
        public static new NetworkingInterfacePortState Empty => new NetworkingInterfacePortState();
    }
}
