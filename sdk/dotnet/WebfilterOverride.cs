...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.WebfilterOverride("trname", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/webfilterOverride:WebfilterOverride")]
    public partial class WebfilterOverride : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public WebfilterOverride(string name, WebfilterOverrideArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/webfilterOverride:WebfilterOverride", name, args ?? new WebfilterOverrideArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebfilterOverride(string name, Input<string> id, WebfilterOverrideState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/webfilterOverride:WebfilterOverride", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WebfilterOverride Get(string name, Input<string> id, WebfilterOverrideState? state = null, CustomResourceOptions? options = null)
        {
            return new WebfilterOverride(name, id, state, options);
        }
    }

    public sealed class WebfilterOverrideArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Override expiration date and time, from 5 minutes to 365 from now (format: yyyy/mm/dd hh:mm:ss).
        /// </summary>
        ...
        public WebfilterOverrideArgs()
        {
        }
        public static new WebfilterOverrideArgs Empty => new WebfilterOverrideArgs();
    }

    public sealed class WebfilterOverrideState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Override expiration date and time, from 5 minutes to 365 from now (format: yyyy/mm/dd hh:mm:ss).
        /// </summary>
        ...
        public WebfilterOverrideState()
        {
        }
        public static new WebfilterOverrideState Empty => new WebfilterOverrideState();
    }
}
