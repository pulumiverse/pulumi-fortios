...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.FirewallVip("trname", new()
    ///     {
    ///         ArpReply = "enable",
    ///         Color = 0,
    ///         DnsMappingTtl = 0,
    ...
    ///         Mappedips = new[]
    ///         {
    ///             new Fortios.Inputs.FirewallVipMappedipArgs
    ///             {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallVip:FirewallVip")]
    public partial class FirewallVip : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("extaddrs")]
        public Output<ImmutableArray<Outputs.FirewallVipExtaddr>> Extaddrs { get; private set; } = null!;
        ...
        /// </summary>
        [Output("mappedips")]
        public Output<ImmutableArray<Outputs.FirewallVipMappedip>> Mappedips { get; private set; } = null!;
        ...
        /// </summary>
        [Output("monitors")]
        public Output<ImmutableArray<Outputs.FirewallVipMonitor>> Monitors { get; private set; } = null!;
        ...
        /// </summary>
        [Output("realservers")]
        public Output<ImmutableArray<Outputs.FirewallVipRealserver>> Realservers { get; private set; } = null!;
        ...
        /// </summary>
        [Output("services")]
        public Output<ImmutableArray<Outputs.FirewallVipService>> Services { get; private set; } = null!;
        ...
        /// </summary>
        [Output("srcFilters")]
        public Output<ImmutableArray<Outputs.FirewallVipSrcFilter>> SrcFilters { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.FirewallVipSrcintfFilter>> SrcintfFilters { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.FirewallVipSslCipherSuite>> SslCipherSuites { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.FirewallVipSslServerCipherSuite>> SslServerCipherSuites { get; private set; } = null!;
        ...
        public FirewallVip(string name, FirewallVipArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallVip:FirewallVip", name, args ?? new FirewallVipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallVip(string name, Input<string> id, FirewallVipState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallVip:FirewallVip", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallVip Get(string name, Input<string> id, FirewallVipState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallVip(name, id, state, options);
        }
    }

    public sealed class FirewallVipArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding NAT46 route. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        [Input("extaddrs")]
        private InputList<Inputs.FirewallVipExtaddrArgs>? _extaddrs;

        /// <summary>
        /// External FQDN address name. The structure of `extaddr` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipExtaddrArgs> Extaddrs
        {
            get => _extaddrs ?? (_extaddrs = new InputList<Inputs.FirewallVipExtaddrArgs>());
            set => _extaddrs = value;
        }
        ...
        [Input("mappedips")]
        private InputList<Inputs.FirewallVipMappedipArgs>? _mappedips;

        /// <summary>
        /// IP address or address range on the destination network to which the external IP address is mapped. The structure of `mappedip` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipMappedipArgs> Mappedips
        {
            get => _mappedips ?? (_mappedips = new InputList<Inputs.FirewallVipMappedipArgs>());
        ...
        [Input("monitors")]
        private InputList<Inputs.FirewallVipMonitorArgs>? _monitors;

        /// <summary>
        /// Name of the health check monitor to use when polling to determine a virtual server's connectivity status. The structure of `monitor` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipMonitorArgs> Monitors
        {
            get => _monitors ?? (_monitors = new InputList<Inputs.FirewallVipMonitorArgs>());
            set => _monitors = value;
        }
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallVipRealserverArgs>? _realservers;

        /// <summary>
        /// Select the real servers that this server load balancing VIP will distribute traffic to. The structure of `realservers` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipRealserverArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallVipRealserverArgs>());
        ...
        [Input("services")]
        private InputList<Inputs.FirewallVipServiceArgs>? _services;

        /// <summary>
        /// Service name. The structure of `service` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipServiceArgs> Services
        {
            get => _services ?? (_services = new InputList<Inputs.FirewallVipServiceArgs>());
            set => _services = value;
        }

        [Input("srcFilters")]
        private InputList<Inputs.FirewallVipSrcFilterArgs>? _srcFilters;

        /// <summary>
        /// Source address filter. Each address must be either an IP/subnet (x.x.x.x/n) or a range (x.x.x.x-y.y.y.y). Separate addresses with spaces. The structure of `src_filter` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipSrcFilterArgs> SrcFilters
        {
            get => _srcFilters ?? (_srcFilters = new InputList<Inputs.FirewallVipSrcFilterArgs>());
            set => _srcFilters = value;
        }

        [Input("srcintfFilters")]
        private InputList<Inputs.FirewallVipSrcintfFilterArgs>? _srcintfFilters;

        /// <summary>
        /// Interfaces to which the VIP applies. Separate the names with spaces. The structure of `srcintf_filter` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipSrcintfFilterArgs> SrcintfFilters
        {
            get => _srcintfFilters ?? (_srcintfFilters = new InputList<Inputs.FirewallVipSrcintfFilterArgs>());
        ...
        private InputList<Inputs.FirewallVipSslCipherSuiteArgs>? _sslCipherSuites;

        /// <summary>
        /// SSL/TLS cipher suites acceptable from a client, ordered by priority. The structure of `ssl_cipher_suites` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipSslCipherSuiteArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallVipSslCipherSuiteArgs>());
        ...
        private InputList<Inputs.FirewallVipSslServerCipherSuiteArgs>? _sslServerCipherSuites;

        /// <summary>
        /// SSL/TLS cipher suites to offer to a server, ordered by priority. The structure of `ssl_server_cipher_suites` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipSslServerCipherSuiteArgs> SslServerCipherSuites
        {
            get => _sslServerCipherSuites ?? (_sslServerCipherSuites = new InputList<Inputs.FirewallVipSslServerCipherSuiteArgs>());
        ...
        public FirewallVipArgs()
        {
        }
        public static new FirewallVipArgs Empty => new FirewallVipArgs();
    }

    public sealed class FirewallVipState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable adding NAT46 route. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        [Input("extaddrs")]
        private InputList<Inputs.FirewallVipExtaddrGetArgs>? _extaddrs;

        /// <summary>
        /// External FQDN address name. The structure of `extaddr` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipExtaddrGetArgs> Extaddrs
        {
            get => _extaddrs ?? (_extaddrs = new InputList<Inputs.FirewallVipExtaddrGetArgs>());
            set => _extaddrs = value;
        }
        ...
        [Input("mappedips")]
        private InputList<Inputs.FirewallVipMappedipGetArgs>? _mappedips;

        /// <summary>
        /// IP address or address range on the destination network to which the external IP address is mapped. The structure of `mappedip` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipMappedipGetArgs> Mappedips
        {
            get => _mappedips ?? (_mappedips = new InputList<Inputs.FirewallVipMappedipGetArgs>());
            set => _mappedips = value;
        }
        ...
        [Input("monitors")]
        private InputList<Inputs.FirewallVipMonitorGetArgs>? _monitors;

        /// <summary>
        /// Name of the health check monitor to use when polling to determine a virtual server's connectivity status. The structure of `monitor` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipMonitorGetArgs> Monitors
        {
            get => _monitors ?? (_monitors = new InputList<Inputs.FirewallVipMonitorGetArgs>());
            set => _monitors = value;
        }
        ...
        [Input("realservers")]
        private InputList<Inputs.FirewallVipRealserverGetArgs>? _realservers;

        /// <summary>
        /// Select the real servers that this server load balancing VIP will distribute traffic to. The structure of `realservers` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipRealserverGetArgs> Realservers
        {
            get => _realservers ?? (_realservers = new InputList<Inputs.FirewallVipRealserverGetArgs>());
            set => _realservers = value;
        }
        ...
        [Input("services")]
        private InputList<Inputs.FirewallVipServiceGetArgs>? _services;

        /// <summary>
        /// Service name. The structure of `service` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipServiceGetArgs> Services
        {
            get => _services ?? (_services = new InputList<Inputs.FirewallVipServiceGetArgs>());
            set => _services = value;
        }

        [Input("srcFilters")]
        private InputList<Inputs.FirewallVipSrcFilterGetArgs>? _srcFilters;

        /// <summary>
        /// Source address filter. Each address must be either an IP/subnet (x.x.x.x/n) or a range (x.x.x.x-y.y.y.y). Separate addresses with spaces. The structure of `src_filter` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipSrcFilterGetArgs> SrcFilters
        {
            get => _srcFilters ?? (_srcFilters = new InputList<Inputs.FirewallVipSrcFilterGetArgs>());
            set => _srcFilters = value;
        }

        [Input("srcintfFilters")]
        private InputList<Inputs.FirewallVipSrcintfFilterGetArgs>? _srcintfFilters;

        /// <summary>
        /// Interfaces to which the VIP applies. Separate the names with spaces. The structure of `srcintf_filter` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipSrcintfFilterGetArgs> SrcintfFilters
        {
            get => _srcintfFilters ?? (_srcintfFilters = new InputList<Inputs.FirewallVipSrcintfFilterGetArgs>());
            set => _srcintfFilters = value;
        }
        ...
        [Input("sslCipherSuites")]
        private InputList<Inputs.FirewallVipSslCipherSuiteGetArgs>? _sslCipherSuites;

        /// <summary>
        /// SSL/TLS cipher suites acceptable from a client, ordered by priority. The structure of `ssl_cipher_suites` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipSslCipherSuiteGetArgs> SslCipherSuites
        {
            get => _sslCipherSuites ?? (_sslCipherSuites = new InputList<Inputs.FirewallVipSslCipherSuiteGetArgs>());
            set => _sslCipherSuites = value;
        }
        ...
        [Input("sslServerCipherSuites")]
        private InputList<Inputs.FirewallVipSslServerCipherSuiteGetArgs>? _sslServerCipherSuites;

        /// <summary>
        /// SSL/TLS cipher suites to offer to a server, ordered by priority. The structure of `ssl_server_cipher_suites` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallVipSslServerCipherSuiteGetArgs> SslServerCipherSuites
        {
            get => _sslServerCipherSuites ?? (_sslServerCipherSuites = new InputList<Inputs.FirewallVipSslServerCipherSuiteGetArgs>());
            set => _sslServerCipherSuites = value;
        }
        ...
        public FirewallVipState()
        {
        }
        public static new FirewallVipState Empty => new FirewallVipState();
    }
}
