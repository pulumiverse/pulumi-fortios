...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer2Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         DlpArchive = "enable",
    ///         Dns = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logfortianalyzer2Filter:Logfortianalyzer2Filter")]
    public partial class Logfortianalyzer2Filter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.Logfortianalyzer2FilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        public Logfortianalyzer2Filter(string name, Logfortianalyzer2FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortianalyzer2Filter:Logfortianalyzer2Filter", name, args ?? new Logfortianalyzer2FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logfortianalyzer2Filter(string name, Input<string> id, Logfortianalyzer2FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logfortianalyzer2Filter:Logfortianalyzer2Filter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Logfortianalyzer2Filter Get(string name, Input<string> id, Logfortianalyzer2FilterState? state = null, CustomResourceOptions? options = null)
        {
            return new Logfortianalyzer2Filter(name, id, state, options);
        }
    }

    public sealed class Logfortianalyzer2FilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logfortianalyzer2FilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logfortianalyzer2FilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logfortianalyzer2FilterFreeStyleArgs>());
        ...
        public Logfortianalyzer2FilterArgs()
        {
        }
        public static new Logfortianalyzer2FilterArgs Empty => new Logfortianalyzer2FilterArgs();
    }

    public sealed class Logfortianalyzer2FilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.Logfortianalyzer2FilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.Logfortianalyzer2FilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.Logfortianalyzer2FilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public Logfortianalyzer2FilterState()
        {
        }
        public static new Logfortianalyzer2FilterState Empty => new Logfortianalyzer2FilterState();
    }
}
