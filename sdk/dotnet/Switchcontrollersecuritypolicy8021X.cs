...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.Switchcontrollersecuritypolicy8021X("trname", new()
    ///     {
    ...
    ///         UserGroups = new[]
    ///         {
    ///             new Fortios.Inputs.Switchcontrollersecuritypolicy8021XUserGroupArgs
    ///             {
    ///                 Name = "Guest-group",
    ///             },
    ///         },
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/switchcontrollersecuritypolicy8021X:Switchcontrollersecuritypolicy8021X")]
    public partial class Switchcontrollersecuritypolicy8021X : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("userGroups")]
        public Output<ImmutableArray<Outputs.Switchcontrollersecuritypolicy8021XUserGroup>> UserGroups { get; private set; } = null!;
        ...
        public Switchcontrollersecuritypolicy8021X(string name, Switchcontrollersecuritypolicy8021XArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollersecuritypolicy8021X:Switchcontrollersecuritypolicy8021X", name, args ?? new Switchcontrollersecuritypolicy8021XArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Switchcontrollersecuritypolicy8021X(string name, Input<string> id, Switchcontrollersecuritypolicy8021XState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/switchcontrollersecuritypolicy8021X:Switchcontrollersecuritypolicy8021X", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Switchcontrollersecuritypolicy8021X Get(string name, Input<string> id, Switchcontrollersecuritypolicy8021XState? state = null, CustomResourceOptions? options = null)
        {
            return new Switchcontrollersecuritypolicy8021X(name, id, state, options);
        }
    }

    public sealed class Switchcontrollersecuritypolicy8021XArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable to allow limited access to clients that cannot authenticate. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        [Input("userGroups")]
        private InputList<Inputs.Switchcontrollersecuritypolicy8021XUserGroupArgs>? _userGroups;

        /// <summary>
        /// Name of user-group to assign to this MAC Authentication Bypass (MAB) policy. The structure of `user_group` block is documented below.
        /// </summary>
        public InputList<Inputs.Switchcontrollersecuritypolicy8021XUserGroupArgs> UserGroups
        {
            get => _userGroups ?? (_userGroups = new InputList<Inputs.Switchcontrollersecuritypolicy8021XUserGroupArgs>());
        ...
        public Switchcontrollersecuritypolicy8021XArgs()
        {
        }
        public static new Switchcontrollersecuritypolicy8021XArgs Empty => new Switchcontrollersecuritypolicy8021XArgs();
    }

    public sealed class Switchcontrollersecuritypolicy8021XState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable to allow limited access to clients that cannot authenticate. Valid values: `disable`, `enable`.
        /// </summary>
        ...
        [Input("userGroups")]
        private InputList<Inputs.Switchcontrollersecuritypolicy8021XUserGroupGetArgs>? _userGroups;

        /// <summary>
        /// Name of user-group to assign to this MAC Authentication Bypass (MAB) policy. The structure of `user_group` block is documented below.
        /// </summary>
        public InputList<Inputs.Switchcontrollersecuritypolicy8021XUserGroupGetArgs> UserGroups
        {
            get => _userGroups ?? (_userGroups = new InputList<Inputs.Switchcontrollersecuritypolicy8021XUserGroupGetArgs>());
            set => _userGroups = value;
        }
        ...
        public Switchcontrollersecuritypolicy8021XState()
        {
        }
        public static new Switchcontrollersecuritypolicy8021XState Empty => new Switchcontrollersecuritypolicy8021XState();
    }
}
