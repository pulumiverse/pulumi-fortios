...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.UserGroup("trname", new()
    ///     {
    ///         Company = "optional",
    ///         Email = "enable",
    ///         Expire = 14400,
    ...
    ///         Members = new[]
    ///         {
    ///             new Fortios.Inputs.UserGroupMemberArgs
    ///             {
    ///                 Name = "guest",
    ///             },
    ///         },
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/userGroup:UserGroup")]
    public partial class UserGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("guests")]
        public Output<ImmutableArray<Outputs.UserGroupGuest>> Guests { get; private set; } = null!;
        ...
        /// </summary>
        [Output("matches")]
        public Output<ImmutableArray<Outputs.UserGroupMatch>> Matches { get; private set; } = null!;
        ...
        /// </summary>
        [Output("members")]
        public Output<ImmutableArray<Outputs.UserGroupMember>> Members { get; private set; } = null!;
        ...
        public UserGroup(string name, UserGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/userGroup:UserGroup", name, args ?? new UserGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserGroup(string name, Input<string> id, UserGroupState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/userGroup:UserGroup", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("guests")]
        private InputList<Inputs.UserGroupGuestArgs>? _guests;

        /// <summary>
        /// Guest User. The structure of `guest` block is documented below.
        /// </summary>
        public InputList<Inputs.UserGroupGuestArgs> Guests
        {
            get => _guests ?? (_guests = new InputList<Inputs.UserGroupGuestArgs>());
            set => _guests = value;
        }
        ...
        [Input("matches")]
        private InputList<Inputs.UserGroupMatchArgs>? _matches;

        /// <summary>
        /// Group matches. The structure of `match` block is documented below.
        /// </summary>
        public InputList<Inputs.UserGroupMatchArgs> Matches
        {
            get => _matches ?? (_matches = new InputList<Inputs.UserGroupMatchArgs>());
            set => _matches = value;
        }
        ...
        [Input("members")]
        private InputList<Inputs.UserGroupMemberArgs>? _members;

        /// <summary>
        /// Names of users, peers, LDAP severs, or RADIUS servers to add to the user group. The structure of `member` block is documented below.
        /// </summary>
        public InputList<Inputs.UserGroupMemberArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.UserGroupMemberArgs>());
            set => _members = value;
        }
    ...
    public sealed class UserGroupState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("guests")]
        private InputList<Inputs.UserGroupGuestGetArgs>? _guests;

        /// <summary>
        /// Guest User. The structure of `guest` block is documented below.
        /// </summary>
        public InputList<Inputs.UserGroupGuestGetArgs> Guests
        {
            get => _guests ?? (_guests = new InputList<Inputs.UserGroupGuestGetArgs>());
            set => _guests = value;
        }
        ...
        [Input("matches")]
        private InputList<Inputs.UserGroupMatchGetArgs>? _matches;

        /// <summary>
        /// Group matches. The structure of `match` block is documented below.
        /// </summary>
        public InputList<Inputs.UserGroupMatchGetArgs> Matches
        {
            get => _matches ?? (_matches = new InputList<Inputs.UserGroupMatchGetArgs>());
            set => _matches = value;
        }
        ...
        [Input("members")]
        private InputList<Inputs.UserGroupMemberGetArgs>? _members;

        /// <summary>
        /// Names of users, peers, LDAP severs, or RADIUS servers to add to the user group. The structure of `member` block is documented below.
        /// </summary>
        public InputList<Inputs.UserGroupMemberGetArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.UserGroupMemberGetArgs>());
            set => _members = value;
        }
