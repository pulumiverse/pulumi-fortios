...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var test1 = new Fortios.FmgSystemAdminProfiles("test1", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:index/fmgSystemAdminProfiles:FmgSystemAdminProfiles")]
    public partial class FmgSystemAdminProfiles : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FmgSystemAdminProfiles(string name, FmgSystemAdminProfilesArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/fmgSystemAdminProfiles:FmgSystemAdminProfiles", name, args ?? new FmgSystemAdminProfilesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FmgSystemAdminProfiles(string name, Input<string> id, FmgSystemAdminProfilesState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/fmgSystemAdminProfiles:FmgSystemAdminProfiles", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FmgSystemAdminProfiles Get(string name, Input<string> id, FmgSystemAdminProfilesState? state = null, CustomResourceOptions? options = null)
        {
            return new FmgSystemAdminProfiles(name, id, state, options);
        }
    }

    public sealed class FmgSystemAdminProfilesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Adom policy packages.
        /// </summary>
        ...
        public FmgSystemAdminProfilesArgs()
        {
        }
        public static new FmgSystemAdminProfilesArgs Empty => new FmgSystemAdminProfilesArgs();
    }

    public sealed class FmgSystemAdminProfilesState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Adom policy packages.
        /// </summary>
        ...
        public FmgSystemAdminProfilesState()
        {
        }
        public static new FmgSystemAdminProfilesState Empty => new FmgSystemAdminProfilesState();
    }
}
