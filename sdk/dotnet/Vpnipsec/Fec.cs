...
namespace Pulumiverse.Fortios.Vpnipsec
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:vpnipsec/fec:Fec")]
    public partial class Fec : global::Pulumi.CustomResource
    {
        ...
        public Fec(string name, FecArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:vpnipsec/fec:Fec", name, args ?? new FecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fec(string name, Input<string> id, FecState? state = null, CustomResourceOptions? options = null)
            : base("fortios:vpnipsec/fec:Fec", name, state, MakeResourceOptions(options, id))
        {
        }
