...
namespace Pulumiverse.Fortios.Vpnipsec
{
    ...
    /// {
    ///     var trname2 = new Fortios.Vpnipsec.Phase1interface("trname2", new()
    ///     {
    ///         AcctVerify = "disable",
    ///         AddGwRoute = "disable",
    ///         AddRoute = "enable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:vpnipsec/phase1interface:Phase1interface")]
    public partial class Phase1interface : global::Pulumi.CustomResource
    {
        ...
        public Phase1interface(string name, Phase1interfaceArgs args, CustomResourceOptions? options = null)
            : base("fortios:vpnipsec/phase1interface:Phase1interface", name, args ?? new Phase1interfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Phase1interface(string name, Input<string> id, Phase1interfaceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:vpnipsec/phase1interface:Phase1interface", name, state, MakeResourceOptions(options, id))
        {
        }
