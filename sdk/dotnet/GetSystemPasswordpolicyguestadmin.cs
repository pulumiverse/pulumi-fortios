...
{
    public static class GetSystemPasswordpolicyguestadmin
    {
        /// <summary>
        /// Use this data source to get information on fortios system passwordpolicyguestadmin
        /// </summary>
        public static Task<GetSystemPasswordpolicyguestadminResult> InvokeAsync(GetSystemPasswordpolicyguestadminArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSystemPasswordpolicyguestadminResult>("fortios:index/getSystemPasswordpolicyguestadmin:getSystemPasswordpolicyguestadmin", args ?? new GetSystemPasswordpolicyguestadminArgs(), options.WithDefaults());

        /// <summary>
        /// Use this data source to get information on fortios system passwordpolicyguestadmin
        /// </summary>
        public static Output<GetSystemPasswordpolicyguestadminResult> Invoke(GetSystemPasswordpolicyguestadminInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSystemPasswordpolicyguestadminResult>("fortios:index/getSystemPasswordpolicyguestadmin:getSystemPasswordpolicyguestadmin", args ?? new GetSystemPasswordpolicyguestadminInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetSystemPasswordpolicyguestadminArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetSystemPasswordpolicyguestadminArgs()
        {
        }
        public static new GetSystemPasswordpolicyguestadminArgs Empty => new GetSystemPasswordpolicyguestadminArgs();
    }

    public sealed class GetSystemPasswordpolicyguestadminInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Specifies the vdom to which the data source will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
        /// </summary>
        ...
        public GetSystemPasswordpolicyguestadminInvokeArgs()
        {
        }
        public static new GetSystemPasswordpolicyguestadminInvokeArgs Empty => new GetSystemPasswordpolicyguestadminInvokeArgs();
    }


    [OutputType]
    public sealed class GetSystemPasswordpolicyguestadminResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetSystemPasswordpolicyguestadminResult(
            string applyTo,
