...
namespace Pulumiverse.Fortios.Firewallservice
{
    ...
    /// {
    ///     var trname1 = new Fortios.Firewallservice.Custom("trname1", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var trname = new Fortios.Firewallservice.Group("trname", new()
    ///     {
    ///         Color = 0,
    ///         Proxy = "disable",
    ///         Members = new[]
    ///         {
    ///             new Fortios.Firewallservice.Inputs.GroupMemberArgs
    ///             {
    ///                 Name = trname1.Name,
    ///             },
    ///         },
    ...
    /// </summary>
    [FortiosResourceType("fortios:firewallservice/group:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:firewallservice/group:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, GroupState? state = null, CustomResourceOptions? options = null)
            : base("fortios:firewallservice/group:Group", name, state, MakeResourceOptions(options, id))
        {
        }
