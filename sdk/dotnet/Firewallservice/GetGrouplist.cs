...
namespace Pulumiverse.Fortios.Firewallservice
{
    public static class GetGrouplist
    {
        ...
        public static Task<GetGrouplistResult> InvokeAsync(GetGrouplistArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGrouplistResult>("fortios:firewallservice/getGrouplist:getGrouplist", args ?? new GetGrouplistArgs(), options.WithDefaults());

        /// <summary>
        /// Provides a list of `fortios.firewallservice.Group`.
        /// </summary>
        public static Output<GetGrouplistResult> Invoke(GetGrouplistInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGrouplistResult>("fortios:firewallservice/getGrouplist:getGrouplist", args ?? new GetGrouplistInvokeArgs(), options.WithDefaults());
    }
