...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.LogsyslogdFilter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/logsyslogdFilter:LogsyslogdFilter")]
    public partial class LogsyslogdFilter : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("freeStyles")]
        public Output<ImmutableArray<Outputs.LogsyslogdFilterFreeStyle>> FreeStyles { get; private set; } = null!;
        ...
        public LogsyslogdFilter(string name, LogsyslogdFilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/logsyslogdFilter:LogsyslogdFilter", name, args ?? new LogsyslogdFilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogsyslogdFilter(string name, Input<string> id, LogsyslogdFilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/logsyslogdFilter:LogsyslogdFilter", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogsyslogdFilter Get(string name, Input<string> id, LogsyslogdFilterState? state = null, CustomResourceOptions? options = null)
        {
            return new LogsyslogdFilter(name, id, state, options);
        }
    }

    public sealed class LogsyslogdFilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.LogsyslogdFilterFreeStyleArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.LogsyslogdFilterFreeStyleArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.LogsyslogdFilterFreeStyleArgs>());
        ...
        public LogsyslogdFilterArgs()
        {
        }
        public static new LogsyslogdFilterArgs Empty => new LogsyslogdFilterArgs();
    }

    public sealed class LogsyslogdFilterState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable anomaly logging. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("freeStyles")]
        private InputList<Inputs.LogsyslogdFilterFreeStyleGetArgs>? _freeStyles;

        /// <summary>
        /// Free Style Filters The structure of `free_style` block is documented below.
        /// </summary>
        public InputList<Inputs.LogsyslogdFilterFreeStyleGetArgs> FreeStyles
        {
            get => _freeStyles ?? (_freeStyles = new InputList<Inputs.LogsyslogdFilterFreeStyleGetArgs>());
            set => _freeStyles = value;
        }
        ...
        public LogsyslogdFilterState()
        {
        }
        public static new LogsyslogdFilterState Empty => new LogsyslogdFilterState();
    }
}
