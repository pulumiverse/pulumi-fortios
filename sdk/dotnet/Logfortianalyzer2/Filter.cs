...
namespace Pulumiverse.Fortios.Logfortianalyzer2
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer2.Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         DlpArchive = "enable",
    ///         Dns = "enable",
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logfortianalyzer2/filter:Filter labelname LogFortianalyzer2Filter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortianalyzer2/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer2/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer2/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
