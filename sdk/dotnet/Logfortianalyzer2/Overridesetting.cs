...
namespace Pulumiverse.Fortios.Logfortianalyzer2
{
    ...
    /// {
    ///     var trname = new Fortios.Logfortianalyzer2.Overridesetting("trname", new()
    ///     {
    ///         __changeIp = 0,
    ///         ConnTimeout = 10,
    ///         EncAlgorithm = "high",
    ...
    /// </summary>
    [FortiosResourceType("fortios:logfortianalyzer2/overridesetting:Overridesetting")]
    public partial class Overridesetting : global::Pulumi.CustomResource
    {
        ...
        public Overridesetting(string name, OverridesettingArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer2/overridesetting:Overridesetting", name, args ?? new OverridesettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Overridesetting(string name, Input<string> id, OverridesettingState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logfortianalyzer2/overridesetting:Overridesetting", name, state, MakeResourceOptions(options, id))
        {
        }
