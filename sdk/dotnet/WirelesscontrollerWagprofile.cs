...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/wirelesscontrollerWagprofile:WirelesscontrollerWagprofile")]
    public partial class WirelesscontrollerWagprofile : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        public WirelesscontrollerWagprofile(string name, WirelesscontrollerWagprofileArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/wirelesscontrollerWagprofile:WirelesscontrollerWagprofile", name, args ?? new WirelesscontrollerWagprofileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WirelesscontrollerWagprofile(string name, Input<string> id, WirelesscontrollerWagprofileState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/wirelesscontrollerWagprofile:WirelesscontrollerWagprofile", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WirelesscontrollerWagprofile Get(string name, Input<string> id, WirelesscontrollerWagprofileState? state = null, CustomResourceOptions? options = null)
        {
            return new WirelesscontrollerWagprofile(name, id, state, options);
        }
    }

    public sealed class WirelesscontrollerWagprofileArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        public WirelesscontrollerWagprofileArgs()
        {
        }
        public static new WirelesscontrollerWagprofileArgs Empty => new WirelesscontrollerWagprofileArgs();
    }

    public sealed class WirelesscontrollerWagprofileState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Comment.
        /// </summary>
        ...
        public WirelesscontrollerWagprofileState()
        {
        }
        public static new WirelesscontrollerWagprofileState Empty => new WirelesscontrollerWagprofileState();
    }
}
