...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trnamex1 = new Fortios.VpnipsecPhase1("trnamex1", new()
    ///     {
    ///         AcctVerify = "disable",
    ///         AddGwRoute = "disable",
    ///         AddRoute = "disable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/vpnipsecPhase1:VpnipsecPhase1")]
    public partial class VpnipsecPhase1 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.VpnipsecPhase1BackupGateway>> BackupGateways { get; private set; } = null!;
        ...
        /// </summary>
        [Output("certificates")]
        public Output<ImmutableArray<Outputs.VpnipsecPhase1Certificate>> Certificates { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.VpnipsecPhase1Ipv4ExcludeRange>> Ipv4ExcludeRanges { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.VpnipsecPhase1Ipv6ExcludeRange>> Ipv6ExcludeRanges { get; private set; } = null!;
        ...
        public VpnipsecPhase1(string name, VpnipsecPhase1Args args, CustomResourceOptions? options = null)
            : base("fortios:index/vpnipsecPhase1:VpnipsecPhase1", name, args ?? new VpnipsecPhase1Args(), MakeResourceOptions(options, ""))
        {
        }

        private VpnipsecPhase1(string name, Input<string> id, VpnipsecPhase1State? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpnipsecPhase1:VpnipsecPhase1", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VpnipsecPhase1 Get(string name, Input<string> id, VpnipsecPhase1State? state = null, CustomResourceOptions? options = null)
        {
            return new VpnipsecPhase1(name, id, state, options);
        }
    }

    public sealed class VpnipsecPhase1Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable verification of RADIUS accounting record. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        private InputList<Inputs.VpnipsecPhase1BackupGatewayArgs>? _backupGateways;

        /// <summary>
        /// Instruct unity clients about the backup gateway address(es). The structure of `backup_gateway` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1BackupGatewayArgs> BackupGateways
        {
            get => _backupGateways ?? (_backupGateways = new InputList<Inputs.VpnipsecPhase1BackupGatewayArgs>());
        ...
        [Input("certificates")]
        private InputList<Inputs.VpnipsecPhase1CertificateArgs>? _certificates;

        /// <summary>
        /// Names of up to 4 signed personal certificates. The structure of `certificate` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1CertificateArgs> Certificates
        {
            get => _certificates ?? (_certificates = new InputList<Inputs.VpnipsecPhase1CertificateArgs>());
        ...
        private InputList<Inputs.VpnipsecPhase1Ipv4ExcludeRangeArgs>? _ipv4ExcludeRanges;

        /// <summary>
        /// Configuration Method IPv4 exclude ranges. The structure of `ipv4_exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1Ipv4ExcludeRangeArgs> Ipv4ExcludeRanges
        {
            get => _ipv4ExcludeRanges ?? (_ipv4ExcludeRanges = new InputList<Inputs.VpnipsecPhase1Ipv4ExcludeRangeArgs>());
        ...
        private InputList<Inputs.VpnipsecPhase1Ipv6ExcludeRangeArgs>? _ipv6ExcludeRanges;

        /// <summary>
        /// Configuration method IPv6 exclude ranges. The structure of `ipv6_exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1Ipv6ExcludeRangeArgs> Ipv6ExcludeRanges
        {
            get => _ipv6ExcludeRanges ?? (_ipv6ExcludeRanges = new InputList<Inputs.VpnipsecPhase1Ipv6ExcludeRangeArgs>());
        ...
        public VpnipsecPhase1Args()
        {
        }
        public static new VpnipsecPhase1Args Empty => new VpnipsecPhase1Args();
    }

    public sealed class VpnipsecPhase1State : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable verification of RADIUS accounting record. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        [Input("backupGateways")]
        private InputList<Inputs.VpnipsecPhase1BackupGatewayGetArgs>? _backupGateways;

        /// <summary>
        /// Instruct unity clients about the backup gateway address(es). The structure of `backup_gateway` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1BackupGatewayGetArgs> BackupGateways
        {
            get => _backupGateways ?? (_backupGateways = new InputList<Inputs.VpnipsecPhase1BackupGatewayGetArgs>());
            set => _backupGateways = value;
        }
        ...
        [Input("certificates")]
        private InputList<Inputs.VpnipsecPhase1CertificateGetArgs>? _certificates;

        /// <summary>
        /// Names of up to 4 signed personal certificates. The structure of `certificate` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1CertificateGetArgs> Certificates
        {
            get => _certificates ?? (_certificates = new InputList<Inputs.VpnipsecPhase1CertificateGetArgs>());
            set => _certificates = value;
        }
        ...
        [Input("ipv4ExcludeRanges")]
        private InputList<Inputs.VpnipsecPhase1Ipv4ExcludeRangeGetArgs>? _ipv4ExcludeRanges;

        /// <summary>
        /// Configuration Method IPv4 exclude ranges. The structure of `ipv4_exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1Ipv4ExcludeRangeGetArgs> Ipv4ExcludeRanges
        {
            get => _ipv4ExcludeRanges ?? (_ipv4ExcludeRanges = new InputList<Inputs.VpnipsecPhase1Ipv4ExcludeRangeGetArgs>());
            set => _ipv4ExcludeRanges = value;
        }
        ...
        [Input("ipv6ExcludeRanges")]
        private InputList<Inputs.VpnipsecPhase1Ipv6ExcludeRangeGetArgs>? _ipv6ExcludeRanges;

        /// <summary>
        /// Configuration method IPv6 exclude ranges. The structure of `ipv6_exclude_range` block is documented below.
        /// </summary>
        public InputList<Inputs.VpnipsecPhase1Ipv6ExcludeRangeGetArgs> Ipv6ExcludeRanges
        {
            get => _ipv6ExcludeRanges ?? (_ipv6ExcludeRanges = new InputList<Inputs.VpnipsecPhase1Ipv6ExcludeRangeGetArgs>());
            set => _ipv6ExcludeRanges = value;
        }
        ...
        public VpnipsecPhase1State()
        {
        }
        public static new VpnipsecPhase1State Empty => new VpnipsecPhase1State();
    }
}
