...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var tr3 = new Fortios.UserSaml("tr3", new()
    ///     {
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/userSaml:UserSaml")]
    public partial class UserSaml : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public UserSaml(string name, UserSamlArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/userSaml:UserSaml", name, args ?? new UserSamlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserSaml(string name, Input<string> id, UserSamlState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/userSaml:UserSaml", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static UserSaml Get(string name, Input<string> id, UserSamlState? state = null, CustomResourceOptions? options = null)
        {
            return new UserSaml(name, id, state, options);
        }
    }

    public sealed class UserSamlArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable ADFS Claim for user/group attribute in assertion statement (default = disable). Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public static new UserSamlArgs Empty => new UserSamlArgs();
    }

    public sealed class UserSamlState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable ADFS Claim for user/group attribute in assertion statement (default = disable). Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public UserSamlState()
        {
        }
        public static new UserSamlState Empty => new UserSamlState();
    }
}
