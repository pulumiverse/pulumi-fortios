...
namespace Pulumiverse.Fortios.User
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:user/quarantine:Quarantine")]
    public partial class Quarantine : global::Pulumi.CustomResource
    {
        ...
        public Quarantine(string name, QuarantineArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:user/quarantine:Quarantine", name, args ?? new QuarantineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Quarantine(string name, Input<string> id, QuarantineState? state = null, CustomResourceOptions? options = null)
            : base("fortios:user/quarantine:Quarantine", name, state, MakeResourceOptions(options, id))
        {
        }
