...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var admintest = new Fortios.SystemAdminAdministrator("admintest", new()
    ///     {
    ///         Accprofile = "3d3",
    ///         Comments = "comments",
    ///         Password = "cc37331AC1",
    ...
    /// ```
    /// </summary>
    [FortiosResourceType("fortios:index/systemAdminAdministrator:SystemAdminAdministrator")]
    public partial class SystemAdminAdministrator : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemAdminAdministrator(string name, SystemAdminAdministratorArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/systemAdminAdministrator:SystemAdminAdministrator", name, args ?? new SystemAdminAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemAdminAdministrator(string name, Input<string> id, SystemAdminAdministratorState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemAdminAdministrator:SystemAdminAdministrator", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemAdminAdministrator Get(string name, Input<string> id, SystemAdminAdministratorState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemAdminAdministrator(name, id, state, options);
        }
    }

    public sealed class SystemAdminAdministratorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Access profile for this administrator. Access profiles control administrator access to FortiGate features.
        /// </summary>
        ...
        public SystemAdminAdministratorArgs()
        {
        }
        public static new SystemAdminAdministratorArgs Empty => new SystemAdminAdministratorArgs();
    }

    public sealed class SystemAdminAdministratorState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Access profile for this administrator. Access profiles control administrator access to FortiGate features.
        /// </summary>
        ...
        public SystemAdminAdministratorState()
        {
        }
        public static new SystemAdminAdministratorState Empty => new SystemAdminAdministratorState();
    }
}
