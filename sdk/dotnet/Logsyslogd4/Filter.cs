...
namespace Pulumiverse.Fortios.Logsyslogd4
{
    ...
    /// {
    ///     var trname = new Fortios.Logsyslogd4.Filter("trname", new()
    ///     {
    ///         Anomaly = "enable",
    ///         Dns = "enable",
    ///         FilterType = "include",
    ...
    /// 
    /// ```sh
    ///  $ pulumi import fortios:logsyslogd4/filter:Filter labelname LogSyslogd4Filter
    /// ```
    /// 
    ...
    /// </summary>
    [FortiosResourceType("fortios:logsyslogd4/filter:Filter")]
    public partial class Filter : global::Pulumi.CustomResource
    {
        ...
        public Filter(string name, FilterArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd4/filter:Filter", name, args ?? new FilterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Filter(string name, Input<string> id, FilterState? state = null, CustomResourceOptions? options = null)
            : base("fortios:logsyslogd4/filter:Filter", name, state, MakeResourceOptions(options, id))
        {
        }
