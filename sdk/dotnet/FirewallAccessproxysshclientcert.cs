...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/firewallAccessproxysshclientcert:FirewallAccessproxysshclientcert")]
    public partial class FirewallAccessproxysshclientcert : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.FirewallAccessproxysshclientcertCertExtension>> CertExtensions { get; private set; } = null!;
        ...
        public FirewallAccessproxysshclientcert(string name, FirewallAccessproxysshclientcertArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallAccessproxysshclientcert:FirewallAccessproxysshclientcert", name, args ?? new FirewallAccessproxysshclientcertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallAccessproxysshclientcert(string name, Input<string> id, FirewallAccessproxysshclientcertState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/firewallAccessproxysshclientcert:FirewallAccessproxysshclientcert", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallAccessproxysshclientcert Get(string name, Input<string> id, FirewallAccessproxysshclientcertState? state = null, CustomResourceOptions? options = null)
        {
            return new FirewallAccessproxysshclientcert(name, id, state, options);
        }
    }

    public sealed class FirewallAccessproxysshclientcertArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of the SSH server public key authentication CA.
        /// </summary>
        ...
        private InputList<Inputs.FirewallAccessproxysshclientcertCertExtensionArgs>? _certExtensions;

        /// <summary>
        /// Configure certificate extension for user certificate. The structure of `cert_extension` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxysshclientcertCertExtensionArgs> CertExtensions
        {
            get => _certExtensions ?? (_certExtensions = new InputList<Inputs.FirewallAccessproxysshclientcertCertExtensionArgs>());
        ...
        public FirewallAccessproxysshclientcertArgs()
        {
        }
        public static new FirewallAccessproxysshclientcertArgs Empty => new FirewallAccessproxysshclientcertArgs();
    }

    public sealed class FirewallAccessproxysshclientcertState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of the SSH server public key authentication CA.
        /// </summary>
        ...
        [Input("certExtensions")]
        private InputList<Inputs.FirewallAccessproxysshclientcertCertExtensionGetArgs>? _certExtensions;

        /// <summary>
        /// Configure certificate extension for user certificate. The structure of `cert_extension` block is documented below.
        /// </summary>
        public InputList<Inputs.FirewallAccessproxysshclientcertCertExtensionGetArgs> CertExtensions
        {
            get => _certExtensions ?? (_certExtensions = new InputList<Inputs.FirewallAccessproxysshclientcertCertExtensionGetArgs>());
            set => _certExtensions = value;
        }
        ...
        public FirewallAccessproxysshclientcertState()
        {
        }
        public static new FirewallAccessproxysshclientcertState Empty => new FirewallAccessproxysshclientcertState();
    }
}
