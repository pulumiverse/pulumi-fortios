...
namespace Pulumiverse.Fortios.Systemreplacemsg
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:systemreplacemsg/nacquar:Nacquar")]
    public partial class Nacquar : global::Pulumi.CustomResource
    {
        ...
        public Nacquar(string name, NacquarArgs args, CustomResourceOptions? options = null)
            : base("fortios:systemreplacemsg/nacquar:Nacquar", name, args ?? new NacquarArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Nacquar(string name, Input<string> id, NacquarState? state = null, CustomResourceOptions? options = null)
            : base("fortios:systemreplacemsg/nacquar:Nacquar", name, state, MakeResourceOptions(options, id))
        {
        }
