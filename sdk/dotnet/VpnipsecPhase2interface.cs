...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname3 = new Fortios.VpnipsecPhase1interface("trname3", new()
    ///     {
    ///         AcctVerify = "disable",
    ///         AddGwRoute = "disable",
    ///         AddRoute = "enable",
    ...
    ///     });
    /// 
    ///     var trname2 = new Fortios.VpnipsecPhase2interface("trname2", new()
    ///     {
    ///         AddRoute = "phase1",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/vpnipsecPhase2interface:VpnipsecPhase2interface")]
    public partial class VpnipsecPhase2interface : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public VpnipsecPhase2interface(string name, VpnipsecPhase2interfaceArgs args, CustomResourceOptions? options = null)
            : base("fortios:index/vpnipsecPhase2interface:VpnipsecPhase2interface", name, args ?? new VpnipsecPhase2interfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnipsecPhase2interface(string name, Input<string> id, VpnipsecPhase2interfaceState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/vpnipsecPhase2interface:VpnipsecPhase2interface", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VpnipsecPhase2interface Get(string name, Input<string> id, VpnipsecPhase2interfaceState? state = null, CustomResourceOptions? options = null)
        {
            return new VpnipsecPhase2interface(name, id, state, options);
        }
    }

    public sealed class VpnipsecPhase2interfaceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable automatic route addition. Valid values: `phase1`, `enable`, `disable`.
        /// </summary>
        ...
        public VpnipsecPhase2interfaceArgs()
        {
        }
        public static new VpnipsecPhase2interfaceArgs Empty => new VpnipsecPhase2interfaceArgs();
    }

    public sealed class VpnipsecPhase2interfaceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable automatic route addition. Valid values: `phase1`, `enable`, `disable`.
        /// </summary>
        ...
        public VpnipsecPhase2interfaceState()
        {
        }
        public static new VpnipsecPhase2interfaceState Empty => new VpnipsecPhase2interfaceState();
    }
}
