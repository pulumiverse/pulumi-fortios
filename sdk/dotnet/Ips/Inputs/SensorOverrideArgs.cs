...
namespace Pulumiverse.Fortios.Ips.Inputs
{
    ...
    public sealed class SensorOverrideArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("exemptIps")]
        private InputList<Inputs.SensorOverrideExemptIpArgs>? _exemptIps;

        /// <summary>
        /// Exempted IP. The structure of `exempt_ip` block is documented below.
        /// </summary>
        public InputList<Inputs.SensorOverrideExemptIpArgs> ExemptIps
        {
            get => _exemptIps ?? (_exemptIps = new InputList<Inputs.SensorOverrideExemptIpArgs>());
        ...
        public SensorOverrideArgs()
        {
        }
        public static new SensorOverrideArgs Empty => new SensorOverrideArgs();
    }
}
