...
namespace Pulumiverse.Fortios.Ips.Inputs
{
    ...
    public sealed class SensorEntryGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("cves")]
        private InputList<Inputs.SensorEntryCfeGetArgs>? _cves;

        /// <summary>
        /// List of CVE IDs of the signatures to add to the sensor The structure of `cve` block is documented below.
        /// </summary>
        public InputList<Inputs.SensorEntryCfeGetArgs> Cves
        {
            get => _cves ?? (_cves = new InputList<Inputs.SensorEntryCfeGetArgs>());
            set => _cves = value;
        }
        ...
        [Input("exemptIps")]
        private InputList<Inputs.SensorEntryExemptIpGetArgs>? _exemptIps;
        ...
        /// </summary>
        public InputList<Inputs.SensorEntryExemptIpGetArgs> ExemptIps
        {
            get => _exemptIps ?? (_exemptIps = new InputList<Inputs.SensorEntryExemptIpGetArgs>());
        ...
        [Input("rules")]
        private InputList<Inputs.SensorEntryRuleGetArgs>? _rules;

        /// <summary>
        /// Identifies the predefined or custom IPS signatures to add to the sensor. The structure of `rule` block is documented below.
        /// </summary>
        public InputList<Inputs.SensorEntryRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.SensorEntryRuleGetArgs>());
            set => _rules = value;
        }
        ...
        [Input("vulnTypes")]
        private InputList<Inputs.SensorEntryVulnTypeGetArgs>? _vulnTypes;

        /// <summary>
        /// List of signature vulnerability types to filter by. The structure of `vuln_type` block is documented below.
        /// </summary>
        public InputList<Inputs.SensorEntryVulnTypeGetArgs> VulnTypes
        {
            get => _vulnTypes ?? (_vulnTypes = new InputList<Inputs.SensorEntryVulnTypeGetArgs>());
            set => _vulnTypes = value;
        }

        public SensorEntryGetArgs()
        {
        }
        public static new SensorEntryGetArgs Empty => new SensorEntryGetArgs();
    }
}
