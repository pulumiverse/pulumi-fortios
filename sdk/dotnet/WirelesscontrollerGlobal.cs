...
namespace Pulumiverse.Fortios
{
    ...
    /// {
    ///     var trname = new Fortios.WirelesscontrollerGlobal("trname", new()
    ///     {
    ///         ApLogServer = "disable",
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/wirelesscontrollerGlobal:WirelesscontrollerGlobal")]
    public partial class WirelesscontrollerGlobal : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public WirelesscontrollerGlobal(string name, WirelesscontrollerGlobalArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/wirelesscontrollerGlobal:WirelesscontrollerGlobal", name, args ?? new WirelesscontrollerGlobalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WirelesscontrollerGlobal(string name, Input<string> id, WirelesscontrollerGlobalState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/wirelesscontrollerGlobal:WirelesscontrollerGlobal", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WirelesscontrollerGlobal Get(string name, Input<string> id, WirelesscontrollerGlobalState? state = null, CustomResourceOptions? options = null)
        {
            return new WirelesscontrollerGlobal(name, id, state, options);
        }
    }

    public sealed class WirelesscontrollerGlobalArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable configuring APs or FortiAPs to send log messages to a syslog server (default = disable). Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public WirelesscontrollerGlobalArgs()
        {
        }
        public static new WirelesscontrollerGlobalArgs Empty => new WirelesscontrollerGlobalArgs();
    }

    public sealed class WirelesscontrollerGlobalState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable configuring APs or FortiAPs to send log messages to a syslog server (default = disable). Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public WirelesscontrollerGlobalState()
        {
        }
        public static new WirelesscontrollerGlobalState Empty => new WirelesscontrollerGlobalState();
    }
}
