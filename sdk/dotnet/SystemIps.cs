...
namespace Pulumiverse.Fortios
{
    ...
    /// </summary>
    [FortiosResourceType("fortios:index/systemIps:SystemIps")]
    public partial class SystemIps : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemIps(string name, SystemIpsArgs? args = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemIps:SystemIps", name, args ?? new SystemIpsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemIps(string name, Input<string> id, SystemIpsState? state = null, CustomResourceOptions? options = null)
            : base("fortios:index/systemIps:SystemIps", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemIps Get(string name, Input<string> id, SystemIpsState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemIps(name, id, state, options);
        }
    }

    public sealed class SystemIpsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable override of hold of triggering signatures that are specified by IDs regardless of hold. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public SystemIpsArgs()
        {
        }
        public static new SystemIpsArgs Empty => new SystemIpsArgs();
    }

    public sealed class SystemIpsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable/disable override of hold of triggering signatures that are specified by IDs regardless of hold. Valid values: `enable`, `disable`.
        /// </summary>
        ...
        public SystemIpsState()
        {
        }
        public static new SystemIpsState Empty => new SystemIpsState();
    }
}
