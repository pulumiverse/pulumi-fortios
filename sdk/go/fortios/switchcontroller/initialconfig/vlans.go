...
func NewVlans(ctx *pulumi.Context,
	...
	var resource Vlans
	err := ctx.RegisterResource("fortios:switchcontroller/initialconfig/vlans:Vlans", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVlans(ctx *pulumi.Context,
	...
	var resource Vlans
	err := ctx.ReadResource("fortios:switchcontroller/initialconfig/vlans:Vlans", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
