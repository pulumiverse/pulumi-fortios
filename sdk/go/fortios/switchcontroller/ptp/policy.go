...
func NewPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.RegisterResource("fortios:switchcontroller/ptp/policy:Policy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.ReadResource("fortios:switchcontroller/ptp/policy:Policy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
