...
func NewDefault(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:switchcontroller/autoconfig/default:Default", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefault(ctx *pulumi.Context,
	...
	var resource Default
	err := ctx.ReadResource("fortios:switchcontroller/autoconfig/default:Default", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
func (o DefaultOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *Default) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
