...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:filter/file/profile:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("fortios:filter/file/profile:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
