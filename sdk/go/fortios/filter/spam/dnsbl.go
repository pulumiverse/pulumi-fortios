...
func NewDnsbl(ctx *pulumi.Context,
	...
	var resource Dnsbl
	err := ctx.RegisterResource("fortios:filter/spam/dnsbl:Dnsbl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsbl(ctx *pulumi.Context,
	...
	var resource Dnsbl
	err := ctx.ReadResource("fortios:filter/spam/dnsbl:Dnsbl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
func (o DnsblOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *Dnsbl) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
