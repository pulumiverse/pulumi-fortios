...
func NewMheader(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:filter/spam/mheader:Mheader", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMheader(ctx *pulumi.Context,
	...
	var resource Mheader
	err := ctx.ReadResource("fortios:filter/spam/mheader:Mheader", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
func (o MheaderOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *Mheader) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
