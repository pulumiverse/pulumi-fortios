...
func NewFtgdlocalcat(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:filter/web/ftgdlocalcat:Ftgdlocalcat", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFtgdlocalcat(ctx *pulumi.Context,
	...
	var resource Ftgdlocalcat
	err := ctx.ReadResource("fortios:filter/web/ftgdlocalcat:Ftgdlocalcat", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
