...
func NewFtgdlocalrating(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:filter/web/ftgdlocalrating:Ftgdlocalrating", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFtgdlocalrating(ctx *pulumi.Context,
	...
	var resource Ftgdlocalrating
	err := ctx.ReadResource("fortios:filter/web/ftgdlocalrating:Ftgdlocalrating", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
