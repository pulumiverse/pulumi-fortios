...
func NewBwl(ctx *pulumi.Context,
	...
	var resource Bwl
	err := ctx.RegisterResource("fortios:filter/email/bwl:Bwl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBwl(ctx *pulumi.Context,
	...
	var resource Bwl
	err := ctx.ReadResource("fortios:filter/email/bwl:Bwl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
func (o BwlOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *Bwl) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
