...
func NewOptions(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:filter/email/options:Options", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOptions(ctx *pulumi.Context,
	...
	var resource Options
	err := ctx.ReadResource("fortios:filter/email/options:Options", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
