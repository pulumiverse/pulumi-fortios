...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:casb/profile:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("fortios:casb/profile:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type profileState struct {
	...
	// CASB profile SaaS application. The structure of `saasApplication` block is documented below.
	SaasApplications []ProfileSaasApplication `pulumi:"saasApplications"`
	// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
...
func (o ProfileOutput) SaasApplications() ProfileSaasApplicationArrayOutput {
	return o.ApplyT(func(v *Profile) ProfileSaasApplicationArrayOutput { return v.SaasApplications }).(ProfileSaasApplicationArrayOutput)
}
