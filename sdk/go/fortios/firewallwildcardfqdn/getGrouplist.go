...
// Provides a list of `firewallwildcardfqdn.Group`.
func GetGrouplist(ctx *pulumi.Context, args *GetGrouplistArgs, opts ...pulumi.InvokeOption) (*GetGrouplistResult, error) {
	...
	err := ctx.Invoke("fortios:firewallwildcardfqdn/getGrouplist:getGrouplist", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetGrouplistResult struct {
	...
	Id string `pulumi:"id"`
	// A list of the `firewallwildcardfqdn.Group`.
