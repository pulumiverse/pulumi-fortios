...
//			_, err := logsyslogd3.NewSetting(ctx, "trname", &logsyslogd3.SettingArgs{
...
func NewSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logsyslogd3/setting:Setting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSetting(ctx *pulumi.Context,
	...
	var resource Setting
	err := ctx.ReadResource("fortios:logsyslogd3/setting:Setting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
