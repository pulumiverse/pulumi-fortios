...
//			_, err := spamfilter.NewFortishield(ctx, "trname", &spamfilter.FortishieldArgs{
...
func NewFortishield(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:spamfilter/fortishield:Fortishield", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFortishield(ctx *pulumi.Context,
	...
	var resource Fortishield
	err := ctx.ReadResource("fortios:spamfilter/fortishield:Fortishield", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
