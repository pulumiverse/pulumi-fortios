...
//			_, err := spamfilter.NewBwl(ctx, "trname", &spamfilter.BwlArgs{
//				Comment: pulumi.String("test"),
//				Entries: spamfilter.BwlEntryArray{
//					&spamfilter.BwlEntryArgs{
...
func NewBwl(ctx *pulumi.Context,
	...
	var resource Bwl
	err := ctx.RegisterResource("fortios:spamfilter/bwl:Bwl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBwl(ctx *pulumi.Context,
	...
	var resource Bwl
	err := ctx.ReadResource("fortios:spamfilter/bwl:Bwl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
