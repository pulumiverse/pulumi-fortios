...
//			_, err := spamfilter.NewProfile(ctx, "trname", &spamfilter.ProfileArgs{
//				Comment:   pulumi.String("terraform test"),
//				External:  pulumi.String("disable"),
//				FlowBased: pulumi.String("disable"),
//				Gmail: &spamfilter.ProfileGmailArgs{
//					Log: pulumi.String("disable"),
//				},
//				Imap: &spamfilter.ProfileImapArgs{
//					Action:  pulumi.String("tag"),
//					Log:     pulumi.String("disable"),
//					TagMsg:  pulumi.String("Spam"),
//					TagType: pulumi.String("subject spaminfo"),
//				},
//				Mapi: &spamfilter.ProfileMapiArgs{
//					Action: pulumi.String("discard"),
//					Log:    pulumi.String("disable"),
//				},
//				MsnHotmail: &spamfilter.ProfileMsnHotmailArgs{
//					Log: pulumi.String("disable"),
//				},
//				Pop3: &spamfilter.ProfilePop3Args{
//					Action:  pulumi.String("tag"),
//					Log:     pulumi.String("disable"),
//					TagMsg:  pulumi.String("Spam"),
//					TagType: pulumi.String("subject spaminfo"),
//				},
//				Smtp: &spamfilter.ProfileSmtpArgs{
//					Action:        pulumi.String("discard"),
...
//				YahooMail: &spamfilter.ProfileYahooMailArgs{
//					Log: pulumi.String("disable"),
//				},
//			})
//			if err != nil {
...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:spamfilter/profile:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("fortios:spamfilter/profile:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
