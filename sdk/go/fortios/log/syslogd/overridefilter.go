...
func NewOverridefilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:log/syslogd/overridefilter:Overridefilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOverridefilter(ctx *pulumi.Context,
	...
	var resource Overridefilter
	err := ctx.ReadResource("fortios:log/syslogd/overridefilter:Overridefilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
