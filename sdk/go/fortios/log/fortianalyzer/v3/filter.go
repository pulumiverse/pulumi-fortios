...
func NewFilter(ctx *pulumi.Context,
	...
	var resource Filter
	err := ctx.RegisterResource("fortios:log/fortianalyzer/v3/filter:Filter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFilter(ctx *pulumi.Context,
	...
	var resource Filter
	err := ctx.ReadResource("fortios:log/fortianalyzer/v3/filter:Filter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
