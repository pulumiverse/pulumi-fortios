...
func NewGlobalsetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:log/memory/globalsetting:Globalsetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalsetting(ctx *pulumi.Context,
	...
	var resource Globalsetting
	err := ctx.ReadResource("fortios:log/memory/globalsetting:Globalsetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
