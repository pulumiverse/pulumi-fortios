...
//			_, err := logsyslogd.NewSetting(ctx, "trname", &logsyslogd.SettingArgs{
...
func NewSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logsyslogd/setting:Setting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSetting(ctx *pulumi.Context,
	...
	var resource Setting
	err := ctx.ReadResource("fortios:logsyslogd/setting:Setting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
