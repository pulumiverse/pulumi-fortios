...
func NewOverridesetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logsyslogd/overridesetting:Overridesetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOverridesetting(ctx *pulumi.Context,
	...
	var resource Overridesetting
	err := ctx.ReadResource("fortios:logsyslogd/overridesetting:Overridesetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
