...
func NewAntivirusHeuristic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:antivirus/antivirusHeuristic:antivirusHeuristic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAntivirusHeuristic(ctx *pulumi.Context,
	...
	var resource AntivirusHeuristic
	err := ctx.ReadResource("fortios:antivirus/antivirusHeuristic:antivirusHeuristic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
