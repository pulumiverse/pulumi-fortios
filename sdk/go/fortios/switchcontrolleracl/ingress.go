...
func NewIngress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:switchcontrolleracl/ingress:Ingress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIngress(ctx *pulumi.Context,
	...
	var resource Ingress
	err := ctx.ReadResource("fortios:switchcontrolleracl/ingress:Ingress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
