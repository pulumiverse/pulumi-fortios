...
func NewGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.RegisterResource("fortios:switchcontrolleracl/group:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("fortios:switchcontrolleracl/group:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
