...
func NewFortiguard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:system/fortiguard:Fortiguard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFortiguard(ctx *pulumi.Context,
	...
	var resource Fortiguard
	err := ctx.ReadResource("fortios:system/fortiguard:Fortiguard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
