...
func NewSettingGlobal(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:system/settingGlobal:SettingGlobal", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSettingGlobal(ctx *pulumi.Context,
	...
	var resource SettingGlobal
	err := ctx.ReadResource("fortios:system/settingGlobal:SettingGlobal", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
