...
func NewZone(ctx *pulumi.Context,
	...
	var resource Zone
	err := ctx.RegisterResource("fortios:system/zone:Zone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZone(ctx *pulumi.Context,
	...
	var resource Zone
	err := ctx.ReadResource("fortios:system/zone:Zone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Get all sub-tables including unconfigured tables. Do not set this variable to true if you configure sub-table in another resource, otherwish conflicts and overwrite will occur. Options: [ false, true ]. false: Default value, do not get unconfigured tables; true: get all tables including unconfigured tables.
func (o ZoneOutput) GetAllTables() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Zone) pulumi.StringPtrOutput { return v.GetAllTables }).(pulumi.StringPtrOutput)
}
