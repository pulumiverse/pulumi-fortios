...
func NewAdmin(ctx *pulumi.Context,
	...
	var resource Admin
	err := ctx.RegisterResource("fortios:system/admin:Admin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdmin(ctx *pulumi.Context,
	...
	var resource Admin
	err := ctx.ReadResource("fortios:system/admin:Admin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
