...
func NewAlarm(ctx *pulumi.Context,
	...
	var resource Alarm
	err := ctx.RegisterResource("fortios:system/alarm:Alarm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlarm(ctx *pulumi.Context,
	...
	var resource Alarm
	err := ctx.ReadResource("fortios:system/alarm:Alarm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Get all sub-tables including unconfigured tables. Do not set this variable to true if you configure sub-table in another resource, otherwish conflicts and overwrite will occur. Options: [ false, true ]. false: Default value, do not get unconfigured tables; true: get all tables including unconfigured tables.
func (o AlarmOutput) GetAllTables() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Alarm) pulumi.StringPtrOutput { return v.GetAllTables }).(pulumi.StringPtrOutput)
}
