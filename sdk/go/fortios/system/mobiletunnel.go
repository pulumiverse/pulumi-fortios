...
func NewMobiletunnel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:system/mobiletunnel:Mobiletunnel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMobiletunnel(ctx *pulumi.Context,
	...
	var resource Mobiletunnel
	err := ctx.ReadResource("fortios:system/mobiletunnel:Mobiletunnel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
