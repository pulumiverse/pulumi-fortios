...
func NewAlertmail(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:system/replacemsg/alertmail:Alertmail", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertmail(ctx *pulumi.Context,
	...
	var resource Alertmail
	err := ctx.ReadResource("fortios:system/replacemsg/alertmail:Alertmail", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
func (o AlertmailOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *Alertmail) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
