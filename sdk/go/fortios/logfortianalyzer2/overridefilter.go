...
//			_, err := logfortianalyzer2.NewOverridefilter(ctx, "trname", &logfortianalyzer2.OverridefilterArgs{
...
func NewOverridefilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logfortianalyzer2/overridefilter:Overridefilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOverridefilter(ctx *pulumi.Context,
	...
	var resource Overridefilter
	err := ctx.ReadResource("fortios:logfortianalyzer2/overridefilter:Overridefilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
