...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/pulumiverse/pulumi-fortios/sdk/go/fortios/logfortianalyzer"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := logfortianalyzer.NewOverridesetting(ctx, "trname", &logfortianalyzer.OverridesettingArgs{
...
func NewOverridesetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logfortianalyzer/overridesetting:Overridesetting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOverridesetting(ctx *pulumi.Context,
	...
	var resource Overridesetting
	err := ctx.ReadResource("fortios:logfortianalyzer/overridesetting:Overridesetting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
