...
func NewDnsbl(ctx *pulumi.Context,
	...
	var resource Dnsbl
	err := ctx.RegisterResource("fortios:emailfilter/dnsbl:Dnsbl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsbl(ctx *pulumi.Context,
	...
	var resource Dnsbl
	err := ctx.ReadResource("fortios:emailfilter/dnsbl:Dnsbl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
