...
func NewMheader(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:emailfilter/mheader:Mheader", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMheader(ctx *pulumi.Context,
	...
	var resource Mheader
	err := ctx.ReadResource("fortios:emailfilter/mheader:Mheader", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
