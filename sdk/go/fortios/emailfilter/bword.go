...
func NewBword(ctx *pulumi.Context,
	...
	var resource Bword
	err := ctx.RegisterResource("fortios:emailfilter/bword:Bword", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBword(ctx *pulumi.Context,
	...
	var resource Bword
	err := ctx.ReadResource("fortios:emailfilter/bword:Bword", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
