...
func NewIptrust(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:emailfilter/iptrust:Iptrust", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIptrust(ctx *pulumi.Context,
	...
	var resource Iptrust
	err := ctx.ReadResource("fortios:emailfilter/iptrust:Iptrust", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
