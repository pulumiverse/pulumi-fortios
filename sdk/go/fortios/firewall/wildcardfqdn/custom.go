...
func NewCustom(ctx *pulumi.Context,
	...
	var resource Custom
	err := ctx.RegisterResource("fortios:firewall/wildcardfqdn/custom:Custom", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustom(ctx *pulumi.Context,
	...
	var resource Custom
	err := ctx.ReadResource("fortios:firewall/wildcardfqdn/custom:Custom", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
