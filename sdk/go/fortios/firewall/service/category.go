...
func NewCategory(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:firewall/service/category:Category", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCategory(ctx *pulumi.Context,
	...
	var resource Category
	err := ctx.ReadResource("fortios:firewall/service/category:Category", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
