...
func NewTable(ctx *pulumi.Context,
	...
	var resource Table
	err := ctx.RegisterResource("fortios:firewall/ipmacbinding/table:Table", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTable(ctx *pulumi.Context,
	...
	var resource Table
	err := ctx.ReadResource("fortios:firewall/ipmacbinding/table:Table", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
func (o TableOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *Table) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
