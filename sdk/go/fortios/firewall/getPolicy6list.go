...
func GetPolicy6list(ctx *pulumi.Context, args *GetPolicy6listArgs, opts ...pulumi.InvokeOption) (*GetPolicy6listResult, error) {
	...
	err := ctx.Invoke("fortios:firewall/getPolicy6list:getPolicy6list", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// A list of the `firewall.Policy6`.
func (o GetPolicy6listResultOutput) Policyidlists() pulumi.IntArrayOutput {
	return o.ApplyT(func(v GetPolicy6listResult) []int { return v.Policyidlists }).(pulumi.IntArrayOutput)
}
