...
//			trname1, err := firewallservice.NewCustom(ctx, "trname1", &firewallservice.CustomArgs{
...
//				return err
//			}
//			_, err = firewallservice.NewGroup(ctx, "trname", &firewallservice.GroupArgs{
//				Color: pulumi.Int(0),
//				Proxy: pulumi.String("disable"),
//				Members: firewallservice.GroupMemberArray{
//					&firewallservice.GroupMemberArgs{
//						Name: trname1.Name,
//					},
//				},
//			})
...
func NewGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.RegisterResource("fortios:firewallservice/group:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("fortios:firewallservice/group:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
