...
func NewDomaincontroller(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:cifs/domaincontroller:Domaincontroller", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomaincontroller(ctx *pulumi.Context,
	...
	var resource Domaincontroller
	err := ctx.ReadResource("fortios:cifs/domaincontroller:Domaincontroller", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
