...
func NewRulesettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:ips/rulesettings:Rulesettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRulesettings(ctx *pulumi.Context,
	...
	var resource Rulesettings
	err := ctx.ReadResource("fortios:ips/rulesettings:Rulesettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
