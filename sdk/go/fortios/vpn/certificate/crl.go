...
func NewCrl(ctx *pulumi.Context,
	...
	var resource Crl
	err := ctx.RegisterResource("fortios:vpn/certificate/crl:Crl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCrl(ctx *pulumi.Context,
	...
	var resource Crl
	err := ctx.ReadResource("fortios:vpn/certificate/crl:Crl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
