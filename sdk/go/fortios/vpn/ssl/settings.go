...
func NewSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:vpn/ssl/settings:Settings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSettings(ctx *pulumi.Context,
	...
	var resource Settings
	err := ctx.ReadResource("fortios:vpn/ssl/settings:Settings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
