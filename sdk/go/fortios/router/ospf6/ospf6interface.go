...
func NewOspf6interface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:router/ospf6/ospf6interface:Ospf6interface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOspf6interface(ctx *pulumi.Context,
	...
	var resource Ospf6interface
	err := ctx.ReadResource("fortios:router/ospf6/ospf6interface:Ospf6interface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o Ospf6interfaceOutput) GetAllTables() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Ospf6interface) pulumi.StringPtrOutput { return v.GetAllTables }).(pulumi.StringPtrOutput)
}
