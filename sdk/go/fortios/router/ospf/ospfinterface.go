...
func NewOspfinterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:router/ospf/ospfinterface:Ospfinterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOspfinterface(ctx *pulumi.Context,
	...
	var resource Ospfinterface
	err := ctx.ReadResource("fortios:router/ospf/ospfinterface:Ospfinterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o OspfinterfaceOutput) GetAllTables() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Ospfinterface) pulumi.StringPtrOutput { return v.GetAllTables }).(pulumi.StringPtrOutput)
}
