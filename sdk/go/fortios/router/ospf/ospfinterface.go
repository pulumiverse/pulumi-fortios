...
//
// The `md5Keys` block supports:
func (o OspfinterfaceOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *Ospfinterface) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
