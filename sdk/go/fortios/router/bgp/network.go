...
func NewNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:router/bgp/network:Network", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetwork(ctx *pulumi.Context,
	...
	var resource Network
	err := ctx.ReadResource("fortios:router/bgp/network:Network", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
