...
func NewProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:sctpfilter/profile:Profile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProfile(ctx *pulumi.Context,
	...
	var resource Profile
	err := ctx.ReadResource("fortios:sctpfilter/profile:Profile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type profileState struct {
	...
	// PPID filters list. The structure of `ppidFilters` block is documented below.
	PpidFilters []ProfilePpidFilter `pulumi:"ppidFilters"`
	// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
...
// PPID filters list. The structure of `ppidFilters` block is documented below.
func (o ProfileOutput) PpidFilters() ProfilePpidFilterArrayOutput {
	return o.ApplyT(func(v *Profile) ProfilePpidFilterArrayOutput { return v.PpidFilters }).(ProfilePpidFilterArrayOutput)
}
