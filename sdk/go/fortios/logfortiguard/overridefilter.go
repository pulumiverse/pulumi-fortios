...
//			_, err := logfortiguard.NewOverridefilter(ctx, "trname", &logfortiguard.OverridefilterArgs{
...
func NewOverridefilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logfortiguard/overridefilter:Overridefilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOverridefilter(ctx *pulumi.Context,
	...
	var resource Overridefilter
	err := ctx.ReadResource("fortios:logfortiguard/overridefilter:Overridefilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
