...
//
// The `layer3Ipv4Rules` block supports:
func (o AccesscontrollistOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *Accesscontrollist) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
