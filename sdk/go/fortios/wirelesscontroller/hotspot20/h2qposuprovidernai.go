...
func NewH2qposuprovidernai(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:wirelesscontroller/hotspot20/h2qposuprovidernai:H2qposuprovidernai", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetH2qposuprovidernai(ctx *pulumi.Context,
	...
	var resource H2qposuprovidernai
	err := ctx.ReadResource("fortios:wirelesscontroller/hotspot20/h2qposuprovidernai:H2qposuprovidernai", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Get all sub-tables including unconfigured tables. Do not set this variable to true if you configure sub-table in another resource, otherwise, conflicts and overwrite will occur. Options: [ false, true ]. false: Default value, do not get unconfigured tables; true: get all tables including unconfigured tables.
func (o H2qposuprovidernaiOutput) GetAllTables() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *H2qposuprovidernai) pulumi.StringPtrOutput { return v.GetAllTables }).(pulumi.StringPtrOutput)
}
...
// Specifies the vdom to which the resource will be applied when the FortiGate unit is running in VDOM mode. Only one vdom can be specified. If you want to inherit the vdom configuration of the provider, please do not set this parameter.
func (o H2qposuprovidernaiOutput) Vdomparam() pulumi.StringOutput {
	return o.ApplyT(func(v *H2qposuprovidernai) pulumi.StringOutput { return v.Vdomparam }).(pulumi.StringOutput)
}
