...
func NewAnqpnetworkauthtype(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:wirelesscontroller/hotspot20/anqpnetworkauthtype:Anqpnetworkauthtype", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAnqpnetworkauthtype(ctx *pulumi.Context,
	...
	var resource Anqpnetworkauthtype
	err := ctx.ReadResource("fortios:wirelesscontroller/hotspot20/anqpnetworkauthtype:Anqpnetworkauthtype", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
