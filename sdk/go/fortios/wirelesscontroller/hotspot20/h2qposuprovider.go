...
func NewH2qposuprovider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:wirelesscontroller/hotspot20/h2qposuprovider:H2qposuprovider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetH2qposuprovider(ctx *pulumi.Context,
	...
	var resource H2qposuprovider
	err := ctx.ReadResource("fortios:wirelesscontroller/hotspot20/h2qposuprovider:H2qposuprovider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
