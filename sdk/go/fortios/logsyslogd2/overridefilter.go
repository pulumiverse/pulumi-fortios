...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/pulumiverse/pulumi-fortios/sdk/go/fortios/logsyslogd2"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := logsyslogd2.NewOverridefilter(ctx, "trname", &logsyslogd2.OverridefilterArgs{
...
func NewOverridefilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logsyslogd2/overridefilter:Overridefilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOverridefilter(ctx *pulumi.Context,
	...
	var resource Overridefilter
	err := ctx.ReadResource("fortios:logsyslogd2/overridefilter:Overridefilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
