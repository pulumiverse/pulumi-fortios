...
func NewRemote(ctx *pulumi.Context,
	...
	var resource Remote
	err := ctx.RegisterResource("fortios:certificate/remote:Remote", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRemote(ctx *pulumi.Context,
	...
	var resource Remote
	err := ctx.ReadResource("fortios:certificate/remote:Remote", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
