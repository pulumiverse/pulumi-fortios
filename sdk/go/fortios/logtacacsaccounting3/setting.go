...
func NewSetting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logtacacsaccounting3/setting:Setting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSetting(ctx *pulumi.Context,
	...
	var resource Setting
	err := ctx.ReadResource("fortios:logtacacsaccounting3/setting:Setting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
