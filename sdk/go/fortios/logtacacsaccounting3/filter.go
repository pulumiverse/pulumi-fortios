...
func NewFilter(ctx *pulumi.Context,
	...
	var resource Filter
	err := ctx.RegisterResource("fortios:logtacacsaccounting3/filter:Filter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFilter(ctx *pulumi.Context,
	...
	var resource Filter
	err := ctx.ReadResource("fortios:logtacacsaccounting3/filter:Filter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
