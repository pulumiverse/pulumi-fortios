...
// Provides a list of `firewallschedule.Group`.
func GetGrouplist(ctx *pulumi.Context, args *GetGrouplistArgs, opts ...pulumi.InvokeOption) (*GetGrouplistResult, error) {
	...
	err := ctx.Invoke("fortios:firewallschedule/getGrouplist:getGrouplist", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetGrouplistResult struct {
	...
	Id string `pulumi:"id"`
	// A list of the `firewallschedule.Group`.
