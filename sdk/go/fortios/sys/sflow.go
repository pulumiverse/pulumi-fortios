...
//			_, err := sys.NewSflow(ctx, "trname", &sys.SflowArgs{
...
func NewSflow(ctx *pulumi.Context,
	...
	var resource Sflow
	err := ctx.RegisterResource("fortios:sys/sflow:Sflow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSflow(ctx *pulumi.Context,
	...
	var resource Sflow
	err := ctx.ReadResource("fortios:sys/sflow:Sflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
