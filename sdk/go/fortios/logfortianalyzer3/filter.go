...
//			_, err := logfortianalyzer3.NewFilter(ctx, "trname", &logfortianalyzer3.FilterArgs{
...
// ```sh
//
//	$ pulumi import fortios:logfortianalyzer3/filter:Filter labelname LogFortianalyzer3Filter
//
// ```
//
...
func NewFilter(ctx *pulumi.Context,
	...
	var resource Filter
	err := ctx.RegisterResource("fortios:logfortianalyzer3/filter:Filter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFilter(ctx *pulumi.Context,
	...
	var resource Filter
	err := ctx.ReadResource("fortios:logfortianalyzer3/filter:Filter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
