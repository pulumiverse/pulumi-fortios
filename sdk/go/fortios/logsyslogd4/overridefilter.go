...
//			_, err := logsyslogd4.NewOverridefilter(ctx, "trname", &logsyslogd4.OverridefilterArgs{
...
func NewOverridefilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("fortios:logsyslogd4/overridefilter:Overridefilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOverridefilter(ctx *pulumi.Context,
	...
	var resource Overridefilter
	err := ctx.ReadResource("fortios:logsyslogd4/overridefilter:Overridefilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
